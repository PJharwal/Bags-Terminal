  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "39c8a6e5-d040-b0b1-5009-50a2c014710c");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    let n = (t, e, i) => Math.max(Math.min(t, i), e);
    function r(t) {
      return n(a(2.55 * t), 0, 255);
    }
    function o(t) {
      return n(a(255 * t), 0, 255);
    }
    function l(t) {
      return n(a(t / 2.55) / 100, 0, 1);
    }
    function h(t) {
      return n(a(100 * t), 0, 100);
    }
    let d = {
        0: 0,
        1: 1,
    ...
    class L {
                ...
                return "r" === t.charAt(0)
                  ? (function (t) {
                      ...
                      if (a) {
                        if (a[7] !== e) {
                          let t = +a[7];
                          o = a[8] ? r(t) : n(255 * t, 0, 255);
                        }
                        return (
                          (e = +a[1]),
                          (i = +a[3]),
                          (s = +a[5]),
                          (e = 255 & (a[2] ? r(e) : n(e, 0, 255))),
                          {
                            r: e,
                            g: (i = 255 & (a[4] ? r(i) : n(i, 0, 255))),
                            b: (s = 255 & (a[6] ? r(s) : n(s, 0, 255))),
                            a: o,
                          }
                        );
                      }
      ...
      hexString() {
        ...
        return this._valid
          ? ((e =
              g((i = t = this._rgb).r) && g(i.g) && g(i.b) && g(i.a) ? u : f),
            t
              ? "#" +
                e(t.r) +
                e(t.g) +
    ...
    function N(t) {
      if (R(t)) return t.map(N);
      if (z(t)) {
        let e = Object.create(null),
          i = Object.keys(t),
          s = i.length,
          a = 0;
        for (; a < s; ++a) e[i[a]] = N(t[i[a]]);
        return e;
      }
      return t;
    }
    ...
    function q(t, e, i) {
      ...
      z(s) && z(a)
        ? X(s, a)
        : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = N(a));
    }
    let K = { "": (t) => t, x: (t) => t.x, y: (t) => t.y };
    function Z(t, e) {
      let i;
      return (
        K[e] ||
    ...
    function tu(t) {
      let e = Math.round(t),
        i = Math.pow(10, Math.floor(th((t = tc(t, e, t / 1e3) ? e : t)))),
        s = t / i;
    ...
    function tb(t, e) {
      let i = e.x - t.x,
        ...
        a = Math.sqrt(i * i + s * s),
        n = Math.atan2(s, i);
      return n < -0.5 * te && (n += ti), { angle: n, distance: a };
    }
    function tx(t, e) {
    ...
    let tP = (t, e, i, s) =>
      ...
      tS = (t, e, i) => tk(t, i, (s) => t[s][e] >= i),
      tD = ["push", "pop", "shift", "splice", "unshift"];
    function tC(t, e) {
      let i = t._chartjs;
      if (!i) return;
      let s = i.listeners,
    ...
    let tT = (t) => ("start" === t ? "left" : "end" === t ? "right" : "center"),
      tE = (t, e, i) => ("start" === t ? e : "end" === t ? i : (e + i) / 2);
    function tR(t, e, i) {
      let s = e.length,
        a = 0,
        n = s;
      if (t._sorted) {
        let { iScale: r, vScale: o, _parsed: l } = t,
          ...
          d = r.axis,
          { min: c, max: u, minDefined: f, maxDefined: g } = r.getUserBounds();
        if (f) {
          if (
            ((a = Math.min(
              tP(l, d, c).lo,
              i ? s : tP(e, d, r.getPixelForValue(c)).lo
            )),
            h)
          ) {
            let t = l
        ...
        if (g) {
          let t = Math.max(
            tP(l, r.axis, u, !0).hi + 1,
            i ? 0 : tP(e, d, r.getPixelForValue(u), !0).hi + 1
          );
          if (h) {
            let e = l.slice(t - 1).findIndex((t) => !E(t[o.axis]));
            t += Math.max(0, e);
          }
          n = tM(t, a, s) - a;
        } else n = s - a;
    ...
    let tF = (t) => 0 === t || 1 === t,
      tV = (t, e, i) =>
        -(Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * ti) / i)),
      tB = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * ti) / i) + 1,
      tI = {
        linear: (t) => t,
        easeInQuad: (t) => t * t,
        easeOutQuad: (t) => -t * (t - 2),
        ...
        easeInOutQuint: (t) =>
          (t /= 0.5) < 1
            ? 0.5 * t * t * t * t * t
            : 0.5 * ((t -= 2) * t * t * t * t + 2),
        easeInSine: (t) => -Math.cos(t * tr) + 1,
        easeOutSine: (t) => Math.sin(t * tr),
        ...
        easeInElastic: (t) => (tF(t) ? t : tV(t, 0.075, 0.3)),
        easeOutElastic: (t) => (tF(t) ? t : tB(t, 0.075, 0.3)),
        easeInOutElastic: (t) =>
          tF(t)
            ? t
            : t < 0.5
            ? 0.5 * tV(2 * t, 0.1125, 0.45)
            : 0.5 + 0.5 * tB(2 * t - 1, 0.1125, 0.45),
    ...
    function tH(t) {
      return tW(t) ? t : new L(t);
    }
    function tj(t) {
      return tW(t) ? t : new L(t).saturate(0.5).darken(0.1).hexString();
    }
    let tN = ["x", "y", "borderWidth", "radius", "tension"],
      t$ = ["color", "borderColor", "backgroundColor"],
      tU = new Map();
    function tY(t, e, i) {
      var s;
      let a, n;
      return ((a = e + JSON.stringify((s = (s = i) || {}))),
      !(n = tU.get(a)) && ((n = new Intl.NumberFormat(e, s)), tU.set(a, n)),
      n).format(t);
    }
    let tX = {
        values: (t) => (R(t) ? t : "" + t),
        numeric(t, e, i) {
          ...
          return Object.assign(d, this.options.ticks.format), tY(t, a, d);
        },
        logarithmic(t, e, i) {
          return 0 === t
            ? "0"
            : [1, 2, 3, 5, 10, 15].includes(
                i[e].significand || t / Math.pow(10, Math.floor(th(t)))
              ) || e > 0.8 * i.length
            ? tX.numeric.call(this, t, e, i)
            : "";
        },
      },
    ...
    function tJ(t, e, i) {
      return "string" == typeof e ? Y(tZ(t, e), i) : Y(tZ(t, ""), e);
    }
    var tQ = new (class {
      constructor(t, e) {
        (this.animation = void 0),
          ...
          (this.hover = {}),
          (this.hoverBackgroundColor = (t, e) => tj(e.backgroundColor)),
          (this.hoverBorderColor = (t, e) => tj(e.borderColor)),
          (this.hoverColor = (t, e) => tj(e.color)),
          (this.indexAxis = "x"),
          (this.interaction = {
            mode: "nearest",
            intersect: !0,
        ...
        function (t) {
          t.set("animation", {
            ...
            t.set("animations", {
              ...
              numbers: { type: "number", properties: tN },
            }),
    ...
    function t5(t, e, i, s, a) {
      ...
      if (!isNaN(p) && !(p <= 0)) {
        switch ((t.beginPath(), f)) {
          default:
            a ? t.ellipse(i, s, a / 2, p, 0, 0, ti) : t.arc(i, s, p, 0, ti),
              t.closePath();
            break;
          case "triangle":
            (d = a ? a / 2 : p),
          ...
          case "rectRounded":
            (h = 0.516 * p),
              (r = Math.cos(m + to) * (l = p - h)),
              (c = Math.cos(m + to) * (a ? a / 2 - h : l)),
              (o = Math.sin(m + to) * l),
              (u = Math.sin(m + to) * (a ? a / 2 - h : l)),
              t.arc(i - c, s - o, h, m - te, m - tr),
              t.arc(i + u, s - r, h, m - tr, m),
              t.arc(i + c, s + o, h, m, m + tr),
              t.arc(i - u, s + r, h, m + tr, m + te),
              t.closePath();
            break;
          case "rect":
            if (!g) {
    ...
    function t9(t, e, i, s, a, n = {}) {
      ...
      for (
        t.save(),
          t.font = a.string,
          n.translation && t.translate(n.translation[0], n.translation[1]),
          E(n.rotation) || t.rotate(n.rotation),
          n.color && (t.fillStyle = n.color),
          n.textAlign && (t.textAlign = n.textAlign),
          n.textBaseline && (t.textBaseline = n.textBaseline),
          r = 0;
        r < l.length;
        ++r
      )
        (o = l[r]),
          ...
          h &&
            ...
            E(n.strokeWidth) || (t.lineWidth = n.strokeWidth),
    ...
    function et(t, e) {
      ...
      t.arc(i + r.topLeft, s + r.topLeft, r.topLeft, 1.5 * te, te, !0),
        t.lineTo(i, s + n - r.bottomLeft),
        t.arc(i + r.bottomLeft, s + n - r.bottomLeft, r.bottomLeft, te, tr, !0),
        ...
        t.arc(i + a - r.topRight, s + r.topRight, r.topRight, 0, -tr, !0),
        t.lineTo(i + r.topLeft, s);
    }
    let ee = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
      ei =
    ...
    function ea(t, e) {
      let i = {},
        s = z(e),
        a = s ? Object.keys(e) : e,
        n = z(t) ? (s ? (i) => B(t[i], t[e[i]]) : (e) => t[e]) : () => t;
      for (let t of a) i[t] = es(n(t));
      return i;
    }
    function en(t) {
      return ea(t, { top: "y", right: "x", bottom: "y", left: "x" });
    }
    function er(t) {
      return ea(t, ["topLeft", "topRight", "bottomLeft", "bottomRight"]);
    }
    function eo(t) {
      let e = en(t);
    ...
    function eh(t, e, i, s) {
      ...
      for (a = 0, n = t.length; a < n; ++a)
        if (
          ...
          void 0 !== i && R(r) && ((r = r[i % r.length]), (o = !1)),
          void 0 !== r)
        )
    ...
    function ec(t, e = [""], i, s, a = () => t[0]) {
      let n = i || t;
      return (
        void 0 === s && (s = ey("_fallback", t)),
        new Proxy(
          {
            ...
            get: (i, s) =>
              em(i, s, () =>
                (function (t, e, i, s) {
                  let a;
                  for (let n of e)
                    if (void 0 !== (a = ey(eg(n, t), i)))
                      return ep(t, a) ? ex(i, s, t, a) : a;
                })(s, e, t, i)
              ),
            getOwnPropertyDescriptor: (t, e) =>
              Reflect.getOwnPropertyDescriptor(t._scopes[0], e),
            getPrototypeOf: () => Reflect.getPrototypeOf(t[0]),
            has: (t, e) => ev(t).includes(e),
            ownKeys: (t) => ev(t),
            set(t, e, i) {
      ...
      return new Proxy(
        {
          ...
          _stack: new Set(),
          _descriptors: ef(t, s),
          setContext: (e) => eu(t, e, i, s),
          override: (a) => eu(t.override(a), e, i, s),
        },
        {
                ...
                return (
                  G(o) &&
                    ...
                    (o = (function (t, e, i, s) {
                      ...
                      let l = e(n, r || s);
                      return (
                        o.delete(t), ep(t, l) && (l = ex(a._scopes, a, t, l)), l
                      );
                    })(e, o, t, i)),
                  R(o) &&
                    o.length &&
                    (o = (function (t, e, i, s) {
                      ...
                      if (z(e[0])) {
                        ...
                        for (let l of ((e = []), i)) {
                          let i = ex(s, a, t, l);
                          e.push(eu(i, n, r && r[t], o));
                        }
                      }
                      return e;
                    })(e, o, t, r.isIndexable)),
                  ep(e, o) && (o = eu(o, a, n && n[e], r)),
                  o
                );
              })(t, e, i)
            ),
    ...
    function ef(t, e = { scriptable: !0, indexable: !0 }) {
      let {
      ...
      return {
        ...
        scriptable: i,
        indexable: s,
        isScriptable: G(i) ? i : () => i,
        isIndexable: G(s) ? s : () => s,
      };
    }
    let eg = (t, e) => (t ? t + J(e) : e),
      ep = (t, e) =>
        z(e) &&
        "adapters" !== t &&
    ...
    let eb = (t, e) => (!0 === t ? e : "string" == typeof t ? Z(e, t) : void 0);
    function ex(t, e, i, s) {
      var a;
      let n = e._rootScopes,
        r = ((a = e._fallback), G(a) ? a(i, s) : a),
        o = [...t, ...n],
        l = new Set();
      l.add(s);
      let h = e_(l, o, i, r || i, s);
      return (
        null !== h &&
        (void 0 === r || r === i || null !== (h = e_(l, o, r, h, s))) &&
        ec(Array.from(l), [""], n, r, () => {
          var t, a, n;
          let r, o;
          return (
            ...
            (a = i),
            (n = s),
            a in (r = t._getTarget()) || (r[a] = {}),
            R((o = r[a])) && z(n) ? n : o || {}
          );
        })
      );
    }
    function e_(t, e, i, s, a) {
      for (; i; )
        i = (function (t, e, i, s, a) {
          for (let r of e) {
            ...
            if (e) {
              var n;
              t.add(e);
              let r = ((n = e._fallback), G(n) ? n(i, a) : n);
    ...
    function eM(t, e, i, s) {
      let a,
        ...
        h = Array(s);
      for (a = 0; a < s; ++a)
        (r = e[(n = a + i)]), (h[a] = { r: o.parse(Z(r, l), n) });
      return h;
    }
    let ew = Number.EPSILON || 1e-14,
      ek = (t, e) => e < t.length && !t[e].skip && t[e],
      eP = (t) => ("x" === t ? "y" : "x");
    function eS(t, e, i) {
    ...
    let eL = (t) => t.ownerDocument.defaultView.getComputedStyle(t, null),
    ...
    function ez(t, e, i) {
      ...
      return (
        ...
        (t.currentDevicePixelRatio !== s || r.height !== a || r.width !== n) &&
    ...
    function e$(t) {
      return "angle" === t
        ? { between: tv, compare: t_, normalize: ty }
        : { between: tw, compare: (t, e) => t - e, normalize: (t) => t };
    }
    function eU({ start: t, end: e, count: i, loop: s, style: a }) {
      return {
        start: t % i,
        end: e % i,
        loop: s && (e - t + 1) % i == 0,
    ...
    function eY(t, e, i) {
      ...
      let { property: r, start: o, end: l } = i,
        h = e.length,
        { compare: d, between: c, normalize: u } = e$(r),
        {
          start: f,
          end: g,
          loop: p,
          ...
          let s,
            ...
            { between: o, normalize: l } = e$(a),
            h = e.length,
            { start: d, end: c, loop: u } = t;
          if (u) {
            for (d += h, c += h, s = 0; s < h && o(l(e[d % h][a]), n, r); ++s)
              d--, c--;
            (d %= h), (c %= h);
          }
          return (
      ...
      for (let t = f, i = f; t <= g; ++t)
        (a = e[t % h]).skip ||
          ((s = u(a[r])) !== n &&
            ...
            null !== _ &&
              v() &&
              (b.push(eU({ start: _, end: t, loop: p, count: h, style: m })),
              (_ = null)),
            (i = t),
            (n = s)));
      return (
        null !== _ &&
          b.push(eU({ start: _, end: g, loop: p, count: h, style: m })),
        b
      );
    }
    function eX(t, e) {
    ...
    class eG {
      constructor(t, e, i, s) {
        const a = e[i];
        s = eh([t.to, s, a, t.from]);
        const n = eh([t.from, a, s]);
        (this._active = !0),
          (this._fn = t.fn || eQ[t.type || typeof n]),
      ...
      update(t, e, i) {
        if (this._active) {
          ...
          (this._start = i),
            ...
            (this._total += a),
            (this._loop = !!t.loop),
            (this._to = eh([t.to, e, s, t.from])),
            (this._from = eh([t.from, s, e]));
        }
      }
      cancel() {
        this._active &&
    ...
    class e0 {
      ...
      configure(t) {
        if (!z(t)) return;
        let e = Object.keys(tQ.animation),
          i = this._properties;
        Object.getOwnPropertyNames(t).forEach((s) => {
          ...
          ((R(a.properties) && a.properties) || [s]).forEach((t) => {
    ...
    function e5(t, e, i, s = {}) {
      ...
      for (a = 0, n = l.length; a < n; ++a) {
        ...
        F((o = t.values[r])) && (h || 0 === e || td(e) === td(o)) && (e += o);
      }
      return d || s.all ? e : 0;
    }
    function e8(t, e) {
    ...
    function e4(t, e) {
      ...
      for (let t = 0; t < u; ++t) {
        ...
        ((i = (s._stacks || (s._stacks = {}))[d] =
          ...
          (i._top = e3(i, o, !0, a.type)),
          (i._bottom = e3(i, o, !1, a.type)),
    ...
    let e9 = (t) => "reset" === t || "none" === t,
      it = (t, e) => (e ? t : Object.assign({}, t));
    class ie {
      static defaults = {};
      ...
      updateIndex(t) {
        this.index !== t && e7(this._cachedMeta), (this.index = t);
      }
      linkScales() {
        let t = this.chart,
          e = this._cachedMeta,
          ...
          a = (e.xAxisID = B(i.xAxisID, e6(t, "x"))),
          n = (e.yAxisID = B(i.yAxisID, e6(t, "y"))),
          r = (e.rAxisID = B(i.rAxisID, e6(t, "r"))),
          o = e.indexAxis,
      ...
      _destroy() {
        let t = this._cachedMeta;
        this._data && tC(this._data, this), t._stacked && e7(t);
      }
      _dataCheck() {
        ...
        if (z(e)) {
          ...
          e &&
            ...
            (e._chartjs
              ? e._chartjs.listeners.push(this)
      ...
      buildOrUpdateElements(t) {
        ...
        this._dataCheck();
        let a = e._stacked;
        (e._stacked = e8(e.vScale, e)),
          e.stack !== i.stack && ((s = !0), e7(e), (e.stack = i.stack)),
          this._resyncElements(t),
          (s || a !== e._stacked) &&
            (e4(this, e._parsed), (e._stacked = e8(e.vScale, e)));
      }
      configure() {
      ...
      parse(t, e) {
        let i,
          ...
          c = t > 0 && n._parsed[t - 1];
        if (!1 === this._parsing) (n._parsed = r), (n._sorted = !0), (a = r);
        else {
          a = R(r[t])
      ...
      parseObjectData(t, e, i, s) {
        ...
        for (a = 0; a < s; ++a)
          (r = e[(n = a + i)]),
            (c[a] = { x: o.parse(Z(r, h), n), y: l.parse(Z(r, d), n) });
        return c;
      }
      getParsed(t) {
      ...
      applyStack(t, e, i) {
        let s = this.chart,
          ...
          n = e[t.axis];
        return e5(
          { keys: e2(s, !0), values: e._stacks[t.axis]._visualValues },
          n,
          a.index,
          { mode: i }
        );
      ...
      updateRangeFromParsed(t, e, i, s) {
        ...
        s && r && ((s.values = r), (n = e5(s, a, this._cachedMeta.index))),
      ...
      getMinMax(t, e) {
        let i,
          ...
          d =
            ((a = this.chart),
            e && !n.hidden && n._stacked && { keys: e2(a, !0), values: null }),
          c = { min: 1 / 0, max: -1 / 0 },
      ...
      getContext(t, e, i) {
        ...
        if (t >= 0 && t < this._cachedMeta.data.length) {
          ...
          ((n =
            this.$context ||
            (this.$context = ed(this.chart.getContext(), {
              active: !1,
              dataset: void 0,
      ...
      _resolveElementOptions(t, e = "default", i) {
        let s = "active" === e,
          ...
          n = t + "-" + e,
          r = a[n],
          o = this.enableOptionSharing && Q(i);
        if (r) return it(r, o);
        let l = this.chart.config,
          h = l.datasetElementScopeKeys(this._type, t),
          d = s ? [`${t}Hover`, "hover", t, ""] : [t, ""],
          c = l.getOptionScopes(this.getDataset(), h),
          u = Object.keys(tQ.elements[t]),
          f = () => this.getContext(i, s, e),
          g = l.resolveNamedOptions(c, u, f, d);
        return (
          g.$shared && ((g.$shared = o), (a[n] = Object.freeze(it(g, o)))), g
        );
      }
      ...
      includeOptions(t, e) {
        return !e || e9(t) || this.chart._animationsDisabled;
      }
      ...
      updateSharedOptions(t, e, i) {
        t && !e9(e) && this._resolveAnimations(void 0, e).update(t, i);
      }
      _setStyle(t, e, i, s) {
        t.active = s;
    ...
    class il extends ie {
      ...
      parseObjectData(t, e, i, s) {
        ...
        for (a = i, n = i + s; a < n; ++a)
          (o = e[a]),
            ((r = {})[l.axis] = l.parse(Z(o, u), a)),
            g.push(ii(Z(o, f), r, h, a));
        return g;
      }
      updateRangeFromParsed(t, e, i, s) {
        ...
        for (let u = e; u < e + i; u++) {
          let e = this.getParsed(u),
            ...
            p = {
              ...
              base: i.base,
              enableBorderRadius:
                !g || ia(e._custom) || n === g._top || n === g._bottom,
              x: l ? i.head : f.center,
              y: l ? f.center : i.head,
              ...
              let e,
                ...
                r = (function (t, e) {
                  if (!t._cache.$bar) {
                    ...
                    t._cache.$bar = tO(s.sort((t, e) => t - e));
                  }
                  return t._cache.$bar;
                })(n, t.type),
                o = n._length,
                l = () => {
                  32767 !== s &&
                    -32768 !== s &&
                    (Q(a) && (o = Math.min(o, Math.abs(s - a) || o)), (a = s));
                };
      ...
      _calculateBarValuePixels(t) {
        ...
        if (m === s.getPixelForValue(l)) {
          let t = (td(i) * s.getLineWidthForValue(l)) / 2;
          (m += t), (i -= t);
        }
      ...
      _calculateBarIndexPixels(t, e) {
        ...
        if (e.grouped) {
          let a,
            ...
            g,
            p,
            m = r ? this._getStackCount(t) : e.stackCount,
            b =
              "flex" === n.barThickness
                ? ((l = (a = e.pixels)[t]),
                  (h = t > 0 ? a[t - 1] : null),
                  (d = t < a.length - 1 ? a[t + 1] : null),
                  (c = n.categoryPercentage),
                  null === h &&
                    (h = l - (null === d ? e.end - e.start : d - l)),
                  null === d && (d = l + l - h),
                  (u = l - ((l - Math.min(h, d)) / 2) * c),
                  {
                    chunk: ((Math.abs(d - h) / 2) * c) / m,
                    ratio: n.barPercentage,
                    start: u,
                  })
                : (E((p = n.barThickness))
                    ? ((f = e.min * n.categoryPercentage),
                      (g = n.barPercentage))
                    : ((f = p * m), (g = 1)),
                  { chunk: f / m, ratio: g, start: e.pixels[t] - f / 2 }),
            x = this._getStackIndex(
              this.index,
              this._cachedMeta.stack,
              r ? t : void 0
            );
          (i = b.start + b.chunk * x + b.chunk / 2),
            (s = Math.min(o, b.chunk * b.ratio));
        } else
    ...
    class ih extends ie {
      ...
      parseArrayData(t, e, i, s) {
        ...
        for (let t = 0; t < a.length; t++) {
          let s = e[i + t];
          a[t]._custom = B(s[2], this.resolveDataElementOptions(t + i).radius);
        }
        return a;
      }
      parseObjectData(t, e, i, s) {
    ...
    class id extends ie {
      ...
      _getRotation() {
        return tp(this.options.rotation - 90);
      }
      _getCircumference() {
        return tp(this.options.circumference);
      }
      _getRotationExtents() {
        let t = ti,
          e = -ti;
      ...
      update(t) {
        let e,
          ...
          { circumference: h, rotation: d } = this._getRotationExtents(),
          {
            ...
            if (e < ti) {
              let o = t + e,
                ...
                c = Math.sin(o),
                u = (e, s, a) =>
                  tv(e, t, o, !0) ? 1 : Math.max(s, s * i, a, a * i),
                f = (e, s, a) =>
                  tv(e, t, o, !0) ? -1 : Math.min(s, s * i, a, a * i),
                g = u(0, l, d),
                p = u(tr, h, c),
                m = f(te, l, d),
                b = f(te + tr, h, c);
          ...
          p = Math.max(Math.min((i.width - n) / c, (i.height - n) / u) / 2, 0),
          m = I(this.options.radius, p),
          b = Math.max(m * o, 0),
          x = (m - b) / this._getVisibleDatasetWeightTotal();
        (this.offsetX = f * m),
          (this.offsetY = g * m),
          (s.total = this.calculateTotal()),
          (this.outerRadius = m - x * this._getRingWeightOffset(this.index)),
      ...
      _circumference(t, e) {
        ...
        return (e && i.animation.animateRotate) ||
          ...
          s.data[t].hidden
          ? 0
          : this.calculateCircumference((s._parsed[t] * a) / ti);
      }
      updateElements(t, e, i, s) {
        let a,
          n = "reset" === s,
        ...
        for (a = e; a < e + i; ++a) {
          ...
          p &&
            (r.options =
              g || this.resolveDataElementOptions(a, i.active ? "active" : s)),
            (m += e),
      ...
      calculateCircumference(t) {
        ...
        return e > 0 && !isNaN(t) ? (Math.abs(t) / e) * ti : 0;
      }
      getLabelAndValue(t) {
        let e = this._cachedMeta,
          i = this.chart,
          s = i.data.labels || [],
          a = tY(e._parsed[t], i.options.locale);
    ...
    class ic extends ie {
      ...
      updateElements(t, e, i, s) {
        let a = "reset" === s,
          { iScale: n, vScale: r, _stacked: o, _dataset: l } = this._cachedMeta,
        ...
        for (let i = 0; i < x; ++i) {
          ...
          let y = this.getParsed(i),
            ...
            w = (x[u] =
              a || v
                ? r.getBasePixel()
                : r.getPixelForValue(o ? this.applyStack(r, y, o) : y[u], i));
      ...
      getMaxOverflow() {
        ...
        return s.length
          ? Math.max(
              ...
              s[s.length - 1].size(this.resolveDataElementOptions(s.length - 1))
            ) / 2
          : i;
      }
      draw() {
    ...
    class iu extends ie {
      ...
      getLabelAndValue(t) {
        let e = this._cachedMeta,
          i = this.chart,
          s = i.data.labels || [],
          a = tY(e._parsed[t].r, i.options.locale);
        return { label: s[t] || "", value: a };
      }
      parseObjectData(t, e, i, s) {
        return eM.bind(this)(t, e, i, s);
      }
      update(t) {
        let e = this._cachedMeta.data;
        ...
        for (a = e; a < e + i; a++) {
          let e = t[a],
            ...
            p = r.getDataVisibility(a)
              ...
              : 0;
          (u = g),
            n && (o.animateScale && (p = 0), o.animateRotate && (i = g = c));
          let m = {
            x: h,
            y: d,
            innerRadius: 0,
            ...
            startAngle: i,
            endAngle: g,
            options: this.resolveDataElementOptions(a, e.active ? "active" : s),
          };
      ...
      _computeAngle(t, e, i) {
        return this.chart.getDataVisibility(t)
          ? tp(this.resolveDataElementOptions(t, e).angle || i)
          : 0;
      }
    }
    class ig extends id {
        ...
        for (let h = e; h < e + i; ++h) {
          let e = t[h],
            ...
            v = (g[f] =
              a || _
                ? r.getBasePixel()
                : r.getPixelForValue(o ? this.applyStack(r, i, o) : i[f], h));
                ...
                if (l) {
                  let { vScale: e } = a._cachedMeta,
                    ...
                    n = i
                      .slice(0, s.lo + 1)
                      .reverse()
                      .findIndex((t) => !E(t[e.axis]));
                  s.lo -= Math.max(0, n);
                  let r = i.slice(s.hi).findIndex((t) => !E(t[e.axis]));
                  s.hi += Math.max(0, r);
                }
                return s;
              }
      ...
      return n || t.isPointInArea(e)
        ? "r" !== i || s
          ? ((r = []),
            ...
            (h = function (t, e) {
              return Math.sqrt(
                Math.pow(o ? Math.abs(t.x - e.x) : 0, 2) +
                  Math.pow(l ? Math.abs(t.y - e.y) : 0, 2)
              );
            }),
            (d = 1 / 0),
            i_(t, i, e, function (i, o, l) {
              ...
              let f = h(e, u);
              f < d
                ? ((r = [{ element: i, datasetIndex: o, index: l }]), (d = f))
                : f === d && r.push({ element: i, datasetIndex: o, index: l });
            }),
            r)
          : ((c = []),
            i_(t, i, e, function (t, i, s) {
              let { startAngle: n, endAngle: r } = t.getProps(
                  ["startAngle", "endAngle"],
                  a
                ),
                { angle: o } = tb(t, { x: e.x, y: e.y });
              tv(o, n, r) && c.push({ element: t, datasetIndex: i, index: s });
            }),
            c)
        : [];
    }
    function iM(t, e, i, s, a) {
      let n = [],
        r = "x" === i ? "inXRange" : "inYRange",
        o = !1;
      return (i_(t, i, e, (t, s, l) => {
        t[r] &&
          t[r](e[i], a) &&
      ...
      modes: {
        index(t, e, i, s) {
          let a = eE(e, t),
            ...
            o = i.intersect ? iy(t, a, n, s, r) : iv(t, a, n, !1, s, r),
            l = [];
          return o.length
        ...
        point(t, e, i, s) {
          let a = eE(e, t);
          return iy(t, a, i.axis || "xy", s, i.includeInvisible || !1);
        },
        nearest(t, e, i, s) {
          let a = eE(e, t),
            n = i.axis || "xy",
            r = i.includeInvisible || !1;
          return iv(t, a, n, i.intersect, s, r);
        },
        x(t, e, i, s) {
          let a = eE(e, t);
          return iM(t, a, "x", i.intersect, s);
        },
        y(t, e, i, s) {
          let a = eE(e, t);
          return iM(t, a, "y", i.intersect, s);
        },
      },
    };
    let ik = ["left", "top", "right", "bottom"];
    function iP(t, e) {
      return t.filter((t) => t.pos === e);
    }
    function iS(t, e) {
      return t.filter((t) => -1 === ik.indexOf(t.pos) && t.box.axis === e);
    }
    function iD(t, e) {
      return t.sort((t, i) => {
        let s = e ? i : t,
    ...
    function iL(t, e, i, s) {
      ...
      for (a = 0, n = t.length, l = 0; a < n; ++a) {
        ...
        let { same: n, other: c } = (function (t, e, i, s) {
          ...
          n.getPadding && iO(r, n.getPadding());
          let o = Math.max(0, e.outerWidth - iC(r, t, "left", "right")),
            l = Math.max(0, e.outerHeight - iC(r, t, "top", "bottom")),
            h = o !== t.w,
            d = l !== t.h;
          return (
            (t.w = o),
    ...
    function iT(t, e, i, s) {
      ...
      for (let o of t) {
        ...
        if (o.horizontal) {
          ...
          Q(l.start) && (r = l.start),
            t.fullSize
              ? iA(t, a.left, r, i.outerWidth - a.right - a.left, n)
              : iA(t, e.left + l.placed, r, s, n),
            (l.start = r),
            (l.placed += s),
            (r = t.bottom);
        } else {
          ...
          Q(l.start) && (n = l.start),
            t.fullSize
              ? iA(t, n, a.top, r, i.outerHeight - a.bottom - a.top)
              : iA(t, n, e.top + l.placed, r, s),
            (l.start = n),
            (l.placed += s),
            (n = t.right);
        }
    ...
    var iE = {
      ...
      update(t, e, i, s) {
        let a, n, r, o, l, h, d, c;
        if (!t) return;
        let u = eo(t.options.layout.padding),
          f = Math.max(e - u.width, 0),
          g = Math.max(i - u.height, 0),
          p =
            ((n = iD(
              (a = (function (t) {
                let e,
                ...
                return o;
              })(t.boxes)).filter((t) => t.box.fullSize),
              !0
            )),
            (r = iD(iP(a, "left"), !0)),
            (o = iD(iP(a, "right"))),
            ...
            {
              fullSize: n,
              leftAndTop: r.concat(l),
              rightAndBottom: o.concat(c).concat(h).concat(d),
              chartArea: iP(a, "chartArea"),
              vertical: r.concat(o).concat(c),
              horizontal: l.concat(h).concat(d),
            }),
          m = p.vertical,
          b = p.horizontal;
        H(t.boxes, (t) => {
        ...
        iO(_, eo(s));
        let y = Object.assign(
            { maxPadding: _, w: f, h: g, x: u.left, y: u.top },
            u
          ),
          v = (function (t, e) {
            let i,
        ...
        iL(p.fullSize, y, x, v),
          iL(m, y, x, v),
          iL(b, y, x, v) && iL(m, y, x, v);
        let M = y.maxPadding;
        function w(t) {
          let e = Math.max(M[t] - y[t], 0);
          return (y[t] += e), e;
        }
        (y.y += w("top")),
          (y.x += w("left")),
          w("right"),
          w("bottom"),
          iT(p.leftAndTop, y, x, v),
          (y.x += y.w),
          (y.y += y.h),
          iT(p.rightAndBottom, y, x, v),
          (t.chartArea = {
            left: y.left,
            top: y.top,
            right: y.left + y.w,
          ...
          H(p.chartArea, (e) => {
            ...
            Object.assign(i, t.chartArea),
              i.update(y.w, y.h, { left: 0, top: 0, right: 0, bottom: 0 });
          });
      },
    };
    class iR {
    ...
    function iH(t, e, i) {
      let s = t.canvas,
        a = new MutationObserver((t) => {
          let e = !1;
          for (let i of t)
            e = (e = e || iW(i.addedNodes, s)) && !iW(i.removedNodes, s);
          e && i();
        });
    ...
    function ij(t, e, i) {
      let s = t.canvas,
        a = new MutationObserver((t) => {
          let e = !1;
          for (let i of t)
            e = (e = e || iW(i.removedNodes, s)) && !iW(i.addedNodes, s);
          e && i();
        });
      return a.observe(document, { childList: !0, subtree: !0 }), a;
    }
    ...
    function iY(t, e, i) {
      ...
      return (
        r.observe(a),
        iN.size || window.addEventListener("resize", iU),
        iN.set(t, n),
        r
      );
    }
    function iX(t, e, i) {
      i && i.disconnect(),
        "resize" === e &&
          (iN.delete(t), iN.size || window.removeEventListener("resize", iU));
    }
    function iq(t, e, i) {
      let s = t.canvas,
        a = tA((e) => {
      ...
      return s && s.addEventListener(e, a, iI), a;
    }
    class iK extends iR {
      acquireContext(t, e) {
      ...
      releaseContext(t) {
        ...
        ["height", "width"].forEach((t) => {
          let s = i[t];
          E(s) ? e.removeAttribute(t) : e.setAttribute(t, s);
        });
        let s = i.style || {};
        return (
      ...
      addEventListener(t, e, i) {
        ...
        let s = t.$proxies || (t.$proxies = {}),
          a = { attach: iH, detach: ij, resize: iY }[e] || iq;
        s[e] = a(t, e, i);
      }
      removeEventListener(t, e) {
        ...
        s &&
          ((
            { attach: iX, detach: iX, resize: iX }[e] ||
            function (t, e, i) {
              t && t.canvas && t.canvas.removeEventListener(e, i, iI);
            }
          )(t, e, s),
          (i[e] = void 0));
      }
      ...
      getMaximumSize(t, e, i, s) {
        return (function (t, e, i, s) {
          let a = eL(t),
            n = eT(a, "margin"),
            r = eO(a.maxWidth, t, "clientWidth") || ta,
            o = eO(a.maxHeight, t, "clientHeight") || ta,
            l = (function (t, e, i) {
              let s, a;
              if (void 0 === e || void 0 === i) {
                ...
                if (n) {
                  ...
                  (e = t.width - l.width - o.width),
                    ...
                    (s = eO(r.maxWidth, n, "clientWidth")),
                    (a = eO(r.maxHeight, n, "clientHeight"));
          ...
          return (
            ...
            (h = eR(Math.min(h, r, l.maxWidth))),
            (d = eR(Math.min(d, o, l.maxHeight))),
            h && !d && (d = eR(h / 2)),
            (void 0 !== e || void 0 !== i) &&
              s &&
              l.height &&
              d > l.height &&
              (h = eR(Math.floor((d = l.height) * s))),
            { width: h, height: d }
          );
        })(t, e, i, s);
      }
    ...
    function iJ(t, e, i, s, a) {
      let n,
        ...
        o,
        l = B(s, 0),
        h = Math.min(B(a, t.length), t.length),
        d = 0;
      for (
    ...
    let iQ = (t, e, i) => ("top" === e || "left" === e ? t[e] + i : t[e] - i),
      iG = (t, e) => Math.min(e || t, t);
    function i0(t, e) {
      let i = [],
        s = t.length / e,
        a = t.length,
    ...
    function i2(t, e) {
      ...
      let i = el(t.font, e),
        s = eo(t.padding);
      return (R(t.text) ? t.text.length : 1) * i.lineHeight + s.height;
    }
    class i5 extends iZ {
      constructor(t) {
        super(),
      ...
      getUserBounds() {
        ...
        return (
          ...
          (i = V(i, 1 / 0)),
          (s = V(s, -1 / 0)),
          { min: V(t, i), max: V(e, s), minDefined: F(t), maxDefined: F(e) }
        );
      }
      getMinMax(t) {
        let e,
      ...
      update(t, e, i) {
        ...
        this._convertTicksToLabels(o ? i0(this.ticks, r) : this.ticks),
          this.configure(),
          ...
          n.display &&
            ...
            ((this.ticks = (function (t, e) {
              ...
              let s,
                ...
                n = t.options.ticks,
                r =
                  ((s = (i = t).options.offset),
                  (a = i._tickSize()),
                  Math.floor(Math.min(i._length / a + +!s, i._maxLength / a))),
                o = Math.min(n.maxTicksLimit || r, r),
                l = n.major.enabled
                  ? (function (t) {
                      let e,
                        i,
              ...
              let f = (function (t, e, i) {
                ...
                let n = (function (t) {
                  ...
                  return (
                    s === (0 | s) && i.push(s), i.sort((t, e) => t - e).pop(), i
                  );
                })(s);
              ...
              if (h > 0) {
                let t,
                  i,
                  s = h > 1 ? Math.round((c - d) / (h - 1)) : null;
                for (
                  iJ(e, u, f, E(s) ? 0 : d - s, d), t = 0, i = h - 1;
                  t < i;
                  t++
                )
                  iJ(e, u, f, l[t], l[t + 1]);
                return iJ(e, u, f, c, E(s) ? e.length : c + s), u;
              }
              return iJ(e, u, f), u;
            })(this, this.ticks)),
            (this._labelSizes = null),
      ...
      generateTickLabels(t) {
        ...
        for (e = 0, i = t.length; e < i; e++)
          (s = t[e]).label = W(a.callback, [s.value, e, t], this);
      }
      ...
      calculateLabelRotation() {
        let t,
          ...
          s = this.options,
          a = s.ticks,
          n = iG(this.ticks.length, s.ticks.maxTicksLimit),
          r = a.minRotation || 0,
          o = a.maxRotation,
          l = r;
        if (
        ...
        let h = this._getLabelSizes(),
          d = h.widest.width,
          c = h.highest.height,
          u = tM(this.chart.width - d, 0, this.maxWidth);
        d + 6 > (t = s.offset ? this.maxWidth / n : u / (n - 1)) &&
          ...
          (e =
            ...
            i1(s.grid) -
            a.padding -
            i2(s.title, this.chart.options.font)),
          (i = Math.sqrt(d * d + c * c)),
          (l = Math.max(
            r,
            Math.min(
              ...
              (l =
                (180 / te) *
                Math.min(
                  Math.asin(tM((h.highest.height + 6) / t, -1, 1)),
                  Math.asin(tM(e / i, -1, 1)) - Math.asin(tM(c / i, -1, 1))
                ))
            )
          ))),
      ...
      fit() {
        let t = { width: 0, height: 0 },
          ...
          r = this.isHorizontal();
        if (n) {
          let n = i2(s, e.options.font);
          if (
            (r
              ? ((t.width = this.maxWidth), (t.height = i1(a) + n))
              : ((t.height = this.maxHeight), (t.width = i1(a) + n)),
          ...
          if (
            ...
            if (R(r))
              for (a = 0, n = r.length; a < n; ++a)
                E((f = r[a])) ||
                  R(f) ||
                  ((c = tG(g, h.data, h.gc, c, f)), (u += d));
          } else (c = tG(g, h.data, h.gc, c, r)), (u = d);
      ...
      getPixelForDecimal(t) {
        ...
        return tM(
          this._alignToPixels ? t0(this.chart, e, 0) : e,
          -32768,
          32767
        );
      }
      ...
      getContext(t) {
        ...
        if (t >= 0 && t < s.length) {
          ...
          return (
            i.$context ||
            ((e = this.getContext()),
            (i.$context = ed(e, { tick: i, index: t, type: "tick" })))
          );
        }
        return (
          this.$context ||
          (this.$context =
            ...
            ed(i, { scale: this, type: "scale" })))
        );
      }
      _tickSize() {
        let t = this.options.ticks,
          e = tp(this.labelRotation),
      ...
      _computeGridLineItems(t) {
        ...
        let C = B(p.ticks.maxTicksLimit, v),
          ...
          if (
            (m
              ? ((a = o),
                ...
                v && (c *= -1),
                0 === P || u.showLabelBackdrop || (a += (h / 2) * Math.sin(P)))
              : ((n = o), (c = ((1 - d) * h) / 2)),
            u.showLabelBackdrop)
          ) {
            let s = eo(u.backdropPadding),
              a = C.heights[e],
              n = C.widths[e],
              o = c - s.top,
              l = 0 - s.left;
      ...
      _getXAxisLabelAlignment() {
        ...
        if (-tp(this.labelRotation)) return "top" === t ? "left" : "right";
        let i = "center";
        return (
          "start" === e.align
            ? (i = "left")
      ...
      drawBorder() {
        ...
        let d = o.setContext(this.getContext(0)).lineWidth,
          c = this._borderValue;
        this.isHorizontal()
          ? ((t = t0(a, this.left, h) - h / 2),
            (e = t0(a, this.right, d) + d / 2),
            (i = s = c))
          : ((i = t0(a, this.top, h) - h / 2),
            (s = t0(a, this.bottom, d) + d / 2),
            (t = e = c)),
          n.save(),
          (n.lineWidth = l.width),
      ...
      drawLabels(t) {
        ...
        for (let s of (i && t3(e, i), this.getLabelItems(t))) {
          let t = s.options,
            i = s.font;
          t9(e, s.label, 0, s.textOffset, i, t);
        }
        i && t4(e);
      }
      drawTitle() {
        ...
        let r = el(a.font),
          ...
          l = a.align,
          h = r.lineHeight / 2;
        "bottom" === s || "center" === s || z(s)
          ? ((h += o.bottom),
            R(a.text) && (h += r.lineHeight * (a.text.length - 1)))
          : (h += o.top);
        let {
          titleX: d,
          titleY: c,
          ...
          if (t.isHorizontal()) {
            if (((n = tE(s, l, d)), z(i))) {
              ...
              r = "center" === i ? (u.bottom + u.top) / 2 + p - e : iQ(t, i, e);
            a = d - l;
          } else {
            if (z(i)) {
              let t = Object.keys(i)[0],
              ...
              n = "center" === i ? (u.left + u.right) / 2 - m + e : iQ(t, i, e);
            (r = tE(s, h, o)), (g = "left" === i ? -tr : tr);
          }
        ...
        t9(i, a.text, 0, 0, r, {
          ...
          textAlign:
            ((t = tT(l)),
            ((n && "right" !== s) || (!n && "right" === s)) &&
              (t = "left" === (e = t) ? "right" : "right" === e ? "left" : e),
            t),
          textBaseline: "middle",
          translation: [d, c],
        });
      ...
      _layers() {
        ...
        return this._isVisible() && this.draw === i5.prototype.draw
          ? [
              {
                z: i,
                draw: (t) => {
      ...
      _resolveTickFontOptions(t) {
        return el(this.options.ticks.setContext(this.getContext(t)).font);
      }
      _maxDigits() {
    ...
    class i8 {
      ...
      register(t) {
        ...
        let o,
          l,
          h = Object.getPrototypeOf(t);
        "id" in (e = h) && "defaults" in e && (l = this.register(h));
        let d = this.items,
          c = t.id,
          u = this.scope + "." + c;
        ...
        return (
          c in d ||
            ...
            i.defaultRoutes &&
              ((n = s),
              Object.keys((r = i.defaultRoutes)).forEach((t) => {
                let e = t.split("."),
                  i = e.pop(),
                  s = [n].concat(e).join("."),
                  a = r[t].split("."),
            ...
            i.descriptors && tQ.describe(s, i.descriptors),
            this.override && tQ.override(t.id, t.overrides)),
          u
        );
      }
      get(t) {
      ...
      unregister(t) {
        let e = this.items,
          ...
          s = this.scope;
        i in e && delete e[i],
          s && i in tQ[s] && (delete tQ[s][i], this.override && delete tq[i]);
      }
    }
    var i3 = new (class {
      constructor() {
        (this.controllers = new i8(ie, "datasets", !0)),
          (this.elements = new i8(iZ, "elements")),
          (this.plugins = new i8(Object, "plugins")),
          (this.scales = new i8(i5, "scales")),
      ...
      _exec(t, e, i) {
        let s = J(t);
        W(i["before" + s], [], i), e[t](i), W(i["after" + s], [], i);
      }
    ...
    class i4 {
      ...
      _notify(t, e, i, s) {
        for (let a of ((s = s || {}), t)) {
          let t = a.plugin;
          if (!1 === W(t[i], [e, s, a.options], t) && s.cancelable) return !1;
        }
        return !0;
      }
      invalidate() {
      ...
      _createDescriptors(t, e) {
        let i = t && t.config,
          ...
          a = (function (t) {
            let e = {},
              i = [],
              s = Object.keys(i3.plugins.items);
            for (let t = 0; t < s.length; t++) i.push(i3.getPlugin(s[t]));
            let a = t.plugins || [];
            for (let t = 0; t < a.length; t++) {
              let s = a[t];
    ...
    function se(t) {
      ...
      (n.plugins = B(n.plugins, {})),
        ...
        Object.keys(i).forEach((n) => {
          ...
          if (r._proxy)
            return console.warn(
              `Ignoring resolver passed as options for scale: ${n}`
            );
          let o = i9(
              n,
              r,
            ...
            l = o === s ? "_index_" : "_value_",
            h = e.scales || {};
          a[n] = X(Object.create(null), [{ axis: o }, r, h[o], h[l]]);
        }),
        t.data.datasets.forEach((e) => {
          let s = e.type || t.type,
            r = e.indexAxis || i6(s, n),
            o = (tq[s] || {}).scales || {};
          Object.keys(o).forEach((t) => {
            let s,
              n =
                ...
                s),
              l = e[n + "AxisID"] || n;
            (a[l] = a[l] || Object.create(null)),
              X(a[l], [{ axis: n }, i[l], o[t]]);
          });
        }),
        Object.keys(a).forEach((t) => {
          let e = a[t];
          X(e, [tQ.scales[e.type], tQ.scale]);
        }),
        (n.scales = a);
    }
    function si(t) {
    ...
    function sn(t, e) {
      let i = ss.get(t);
      return i || ((i = e()), ss.set(t, i), sa.add(i)), i;
    }
    let sr = (t, e, i) => {
      let s = Z(e, i);
      void 0 !== s && t.add(s);
    ...
    class so {
      constructor(t) {
        (this._config = (function (t) {
          return ((t = t || {}).data = si(t.data)), se(t), t;
        })(t)),
      ...
      getOptionScopes(t, e, i) {
        ...
        let o = new Set();
        e.forEach((e) => {
          t && (o.add(t), e.forEach((e) => sr(o, t, e))),
            e.forEach((t) => sr(o, s, t)),
            e.forEach((t) => sr(o, tq[a] || {}, t)),
            e.forEach((t) => sr(o, tQ, t)),
            e.forEach((t) => sr(o, tK, t));
        });
        let l = Array.from(o);
        return (
      ...
      chartOptionScopes() {
        ...
        return [t, tq[e] || {}, tQ.datasets[e] || {}, { type: e }, tQ, tK];
      }
      resolveNamedOptions(t, e, i, s = [""]) {
        let a = { $shared: !0 },
          { resolver: n, subPrefixes: r } = sl(this._resolverCache, t, s),
          o = n;
        if (
          (function (t, e) {
            let { isScriptable: i, isIndexable: s } = ef(t);
            for (let a of e) {
              let e = i(a),
                n = s(a),
                r = (n || e) && t[a];
              if ((e && (G(r) || sh(r))) || (n && R(r))) return !0;
            }
            return !1;
          })(n, e)
        ) {
          (a.$shared = !1), (i = G(i) ? i() : i);
      ...
      createResolver(t, e, i = [""], s) {
        let { resolver: a } = sl(this._resolverCache, t, i);
        return z(e) ? eu(a, e, void 0, s) : a;
      }
    }
    function sl(t, e, i) {
      let s = t.get(e);
    ...
    let sh = (t) => z(t) && Object.getOwnPropertyNames(t).some((e) => G(t[e])),
      sd = ["top", "bottom", "left", "right", "chartArea"];
    function sc(t, e) {
      return (
        "top" === t || "bottom" === t || (-1 === sd.indexOf(t) && "x" === e)
      );
    }
    function su(t, e) {
      return function (i, s) {
    ...
    function sf(t) {
      ...
      e.notifyPlugins("afterRender"), W(i && i.onComplete, [t], e);
    }
    function sg(t) {
      let e = t.chart,
        i = e.options.animation;
      W(i && i.onProgress, [t], e);
    }
    function sp(t) {
      return (
        eD() && "string" == typeof t
    ...
    class s_ {
      ...
      constructor(t, e) {
        ...
        const r = this.platform.acquireContext(s, n.aspectRatio),
          o = r && r.canvas,
          l = o && o.height,
          h = o && o.width;
        if (
        ...
        eZ.listen(this, "complete", sf),
          eZ.listen(this, "progress", sg),
          this._initialize(),
      ...
      _initialize() {
        return (
          ...
          this.options.responsive
            ? this.resize()
            : ez(this, this.options.devicePixelRatio),
          this.bindEvents(),
      ...
      clear() {
        return t1(this.canvas, this.ctx), this;
      }
      stop() {
        ...
        e &&
          ...
          H(a, (e) => {
            let a = e.options,
              ...
              r = i9(n, a),
              o = B(a.type, e.dtype);
            (void 0 === a.position || sc(a.position, r) !== sc(e.dposition)) &&
          ...
          H(i, (t) => {
            iE.configure(this, t, t.options), iE.addBox(this, t);
          });
      }
      _updateMetasets() {
        ...
        this._sortedMetasets = t.slice(0).sort(su("order", "index"));
      }
      ...
      buildOrUpdateControllers() {
        ...
        for (
          ...
          if (
            ...
            (a.type = n),
            (a.indexAxis = e.indexAxis || i6(n, this.options)),
            (a.order = e.order || 0),
            (a.index = t),
            (a.label = "" + e.label),
            ...
            let e = i3.getController(n),
              { datasetElementType: s, dataElementType: r } = tQ.datasets[n];
            Object.assign(e, {
              dataElementType: i3.getElement(r),
              datasetElementType: s && i3.getElement(s),
            }),
      ...
      _checkEventBindings() {
        let t = this.options;
        (tt(new Set(Object.keys(this._listeners)), new Set(t.events)) &&
      ...
      _getUniformDataChanges() {
        ...
        let e = this.data.datasets.length,
          ...
          s = i(0);
        for (let t = 1; t < e; t++) if (!tt(s, i(t))) return;
        return Array.from(s)
          .map((t) => t.split(","))
      ...
      _updateDatasets(t) {
        if (
          ...
          for (let e = 0, i = this.data.datasets.length; e < i; ++e)
            this._updateDataset(e, G(t) ? t({ datasetIndex: e }) : t);
      ...
      render() {
        !1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) &&
          (eZ.has(this)
            ? this.attached && !eZ.running(this) && eZ.start(this)
      ...
      isPointInArea(t) {
        return t8(t, this.chartArea, this._minPadding);
      }
      ...
      getContext() {
        return (
          this.$context ||
          (this.$context = ed(null, { chart: this, type: "chart" }))
        );
      }
      ...
      _stop() {
        let t, e;
        for (
          this.stop(), eZ.remove(this), t = 0, e = this.data.datasets.length;
          t < e;
          ++t
        )
      ...
      _handleEvent(t, e, i) {
        ...
        i &&
          ((this._lastEvent = null),
          W(n.onHover, [t, r, this], this),
          o && W(n.onClick, [t, r, this], this));
        let h = !j(r, a);
        return (
    ...
    function sy() {
      return H(s_.instances, (t) => t._plugins.invalidate());
    }
    function sv(t, e, i, s) {
      return { x: i + t * Math.cos(e), y: s + t * Math.sin(e) };
    }
    function sM(t, e, i, s, a, n) {
      var r, o, l, h;
      let d,
        c,
        u,
        f,
        { x: g, y: p, startAngle: m, pixelMargin: b, innerRadius: x } = e,
        _ = Math.max(e.outerRadius + s + i - b, 0),
        y = x > 0 ? x + s + i + b : 0,
        v = 0,
        M = a - m;
      if (s) {
      ...
      let w = Math.max(0.001, M * _ - i / te) / _,
        k = (M - w) / 2,
        P = m + k + v,
        S = a - k - v,
        {
        ...
        (l = _),
        (h = S - P),
        (d = ea(r.options.borderRadius, [
          "outerStart",
          "outerEnd",
          "innerStart",
          "innerEnd",
        ])),
        (u = Math.min((c = (l - o) / 2), (h * o) / 2)),
        {
          outerStart: (f = (t) => {
            let e = ((l - Math.min(c, t)) * h) / 2;
            return tM(t, 0, Math.min(c, e));
          })(d.outerStart),
          outerEnd: f(d.outerEnd),
          innerStart: tM(d.innerStart, 0, u),
          innerEnd: tM(d.innerEnd, 0, u),
        }),
        A = _ - D,
        T = _ - C,
        E = P + D / A,
      ...
      if ((t.beginPath(), n)) {
        let e = (E + R) / 2;
        if ((t.arc(g, p, _, E, e), t.arc(g, p, _, e, R), C > 0)) {
          let e = sv(T, R, g, p);
          t.arc(e.x, e.y, C, R, S + tr);
        }
        let i = sv(F, S, g, p);
        if ((t.lineTo(i.x, i.y), L > 0)) {
          let e = sv(F, B, g, p);
          t.arc(e.x, e.y, L, S + tr, B + Math.PI);
        }
        let s = (S - L / y + (P + O / y)) / 2;
        if (
          (t.arc(g, p, y, S - L / y, s, !0),
          t.arc(g, p, y, s, P + O / y, !0),
          O > 0)
        ) {
          let e = sv(z, V, g, p);
          t.arc(e.x, e.y, O, V + Math.PI, P - tr);
        }
        let a = sv(A, P, g, p);
        if ((t.lineTo(a.x, a.y), D > 0)) {
          let e = sv(A, E, g, p);
          t.arc(e.x, e.y, D, P - tr, E);
        }
      } else {
        t.moveTo(g, p);
        let e = Math.cos(E) * _ + g,
          i = Math.sin(E) * _ + p;
        t.lineTo(e, i);
        let s = Math.cos(R) * _ + g,
          a = Math.sin(R) * _ + p;
        t.lineTo(s, a);
      }
      t.closePath();
    ...
    class sw extends iZ {
      ...
      inRange(t, e, i) {
        let { angle: s, distance: a } = tb(this.getProps(["x", "y"], i), {
            x: t,
            y: e,
          }),
          {
      ...
      draw(t) {
        ...
        if (
          ...
          (this.fullCircles = i > ti ? Math.floor(i / ti) : 0),
        ...
        let o = s * (1 - Math.sin(Math.min(te, i || 0)));
              ...
              (function (t, e, i) {
                ...
                t.beginPath(),
                  ...
                  l > a
                    ...
                    : t.arc(n, r, a, i + tr, s - tr),
                  t.closePath(),
                  t.clip();
              })(t, e, g),
              n || (sM(t, e, i, s, g, a), t.stroke());
          })(t, this, o, a, n),
          t.restore();
      }
    }
    ...
    function sD(t, e, i, s) {
      let a,
        ...
        { count: h, start: d, loop: c, ilen: u } = sS(o, i, s),
        f = l.stepped
          ? t6
      ...
      for (a = 0; a <= u; ++a)
        (n = o[(d + (p ? u - a : a)) % h]).skip ||
          ...
          (r = n));
      return c && f(t, r, (n = o[(d + (p ? u : 0)) % h]), p, l.stepped), !!c;
    }
    function sC(t, e, i, s) {
      let a,
        n,
        ...
        h,
        d = e.points,
        { count: c, start: u, ilen: f } = sS(d, i, s),
        { move: g = !0, reverse: p } = s || {},
        m = 0,
        b = 0,
        x = (t) => (u + (p ? f - t : t)) % c,
    ...
    class sA extends iZ {
          ...
          !(function (t, e, i, s, a) {
            ...
            if (
                ...
                !(function (t, e, i) {
                  ...
                  (function (t, e, i = "x") {
                    let s,
                      ...
                      l = ek(t, 0);
                    for (let h = 0; h < o; ++h) {
                      if (((a = n), (n = l), (l = ek(t, h + 1)), !n)) continue;
                      let o = n[i],
                        d = n[r];
                      a &&
                        ((s = (o - a[i]) / 3),
              ...
              for (n = 0, r = t.length; n < r; ++n)
                ...
                })(i, (o = t[n]), t[Math.min(n + 1, r - !s) % r], e.tension)),
                  (o.cp1x = l.previous.x),
                  (o.cp1y = l.previous.y),
                  (o.cp2x = l.next.x),
                  (o.cp2y = l.next.y),
                ...
                for (i = 0, s = t.length; i < s; ++i)
                  (r = n),
                    ...
                    n &&
                      ((a = t[i]),
                      r &&
                        ((a.cp1x = eS(a.cp1x, e.left, e.right)),
                        (a.cp1y = eS(a.cp1y, e.top, e.bottom))),
                      o &&
                        ((a.cp2x = eS(a.cp2x, e.left, e.right)),
                        (a.cp2y = eS(a.cp2y, e.top, e.bottom))));
              })(t, i);
      ...
      get segments() {
        return (
          ...
          (this._segments = (function (t, e) {
            ...
            if (!0 === s) return eq(t, [{ start: r, end: o, loop: n }], i, e);
            let l = o < r ? o + a : o,
            ...
            return eq(
              ...
              (function (t, e, i, s) {
                ...
                return (
                  null !== o && r.push({ start: e % n, end: o % n, loop: s }), r
                );
              })(i, r, l, h),
              i,
              e
      ...
      interpolate(t, e) {
        let i,
          ...
          n = t[e],
          r = this.points,
          o = eX(this, { property: e, start: n, end: n });
        if (!o.length) return;
        let l = [],
          h = a.stepped
            ? eI
    ...
    class sE extends iZ {
      ...
      inXRange(t, e) {
        return sT(this, t, "x", e);
      }
      inYRange(t, e) {
        return sT(this, t, "y", e);
      }
      getCenterPoint(t) {
        let { x: e, y: i } = this.getProps(["x", "y"], t);
        return { x: e, y: i };
      ...
      draw(t, e) {
        ...
        !this.skip &&
          !(i.radius < 0.1) &&
          t8(this, e, this.size(i) / 2) &&
          ((t.strokeStyle = i.borderColor),
          (t.lineWidth = i.borderWidth),
          (t.fillStyle = i.backgroundColor),
          t2(t, i, this.x, this.y));
      }
      getRange() {
        let t = this.options || {};
    ...
    function sF(t, e, i, s) {
      let a = null === e,
        ...
        r = t && !(a && n) && sR(t, s);
      return (
        r && (a || tw(e, r.left, r.right)) && (n || tw(i, r.top, r.bottom))
      );
    }
    function sV(t, e) {
    ...
    class sI extends iZ {
      ...
      draw(t) {
        ...
        let a,
          ...
          {
            inflateAmount: u,
            options: { borderColor: f, backgroundColor: g },
          } = this,
          { inner: p, outer: m } =
            ((n = (a = sR(this)).right - a.left),
            (r = a.bottom - a.top),
            (e = n / 2),
            (i = r / 2),
            (o = this.options.borderWidth),
            (l = this.borderSkipped),
            (h = en(o)),
            (d = {
              t: sz(l.top, h.top, 0, i),
              r: sz(l.right, h.right, 0, e),
              b: sz(l.bottom, h.bottom, 0, i),
              l: sz(l.left, h.left, 0, e),
            }),
            (c = (function (t, e, i) {
              let { enableBorderRadius: s } = t.getProps([
                ...
                l = s || z(a);
              return {
                topLeft: sz(!l || o.top || o.left, n.topLeft, 0, r),
                topRight: sz(!l || o.top || o.right, n.topRight, 0, r),
                bottomLeft: sz(!l || o.bottom || o.left, n.bottomLeft, 0, r),
                bottomRight: sz(!l || o.bottom || o.right, n.bottomRight, 0, r),
              };
            })(this, n / 2, r / 2)),
            {
              outer: { x: a.left, y: a.top, w: n, h: r, radius: c },
              inner: {
                x: a.left + d.l,
                y: a.top + d.t,
                w: n - d.l - d.r,
                h: r - d.t - d.b,
                radius: {
                  topLeft: Math.max(0, c.topLeft - Math.max(d.t, d.l)),
                  topRight: Math.max(0, c.topRight - Math.max(d.t, d.r)),
                  bottomLeft: Math.max(0, c.bottomLeft - Math.max(d.b, d.l)),
                  bottomRight: Math.max(0, c.bottomRight - Math.max(d.b, d.r)),
                },
              },
            }),
          b =
      ...
      inRange(t, e, i) {
        return sF(this, t, e, i);
      }
      inXRange(t, e) {
        return sF(this, t, null, e);
      }
      inYRange(t, e) {
        return sF(this, null, t, e);
      }
      getCenterPoint(t) {
        let {
          x: e,
    ...
    let sW = [
      ...
      sH = sW.map((t) => t.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
    function sj(t, e, i, s) {
      if (s) return;
      let a = e[t],
        n = i[t];
      return (
        "angle" === t && ((a = ty(a)), (n = ty(n))),
    ...
    function sq(t, e, i) {
      let s = (function (t) {
          var e, i, s;
          let { chart: a, fill: n, line: r } = t;
          if (F(n)) {
            let t;
            return (
              (e = a),
              (i = n),
              (t = e.getDatasetMeta(i)) && e.isDatasetVisible(i)
                ? t.dataset
                : null
            );
          }
          if ("stack" === n)
            return (function (t) {
              ...
              return new sA({ points: a, options: {} });
            })(t);
          if ("shape" === n) return !0;
          let o = ((s = t).scale || {}).getPointPositionForValue
            ? (function (t) {
          ...
          return o instanceof sX ? o : sU(o, r);
        })(e),
        { line: a, scale: n, axis: r } = e,
        o = a.options,
        l = o.fill,
        h = o.backgroundColor,
        { above: d = h, below: c = h } = l || {};
      s &&
        a.points.length &&
        (t3(t, i),
        (function (t, e) {
          ...
          t.save(),
            "x" === l &&
              n !== a &&
              (sK(t, s, r.top),
              sZ(t, { line: i, target: s, color: a, scale: o, property: l }),
              t.restore(),
              t.save(),
              sK(t, s, r.bottom)),
            sZ(t, { line: i, target: s, color: n, scale: o, property: l }),
            t.restore();
        })(t, {
          line: a,
          target: s,
    ...
    function sZ(t, e) {
      ...
      for (let { source: e, target: o, start: l, end: h } of (function (
        t,
        e,
        i
      ) {
        ...
        for (let t of s) {
          let { start: s, end: o } = t;
          o = sN(s, o, a);
          let l = sj(i, a[s], a[o], t.loop);
          if (!e.segments) {
            r.push({ source: t, target: l, start: a[s], end: a[o] });
            continue;
          }
          for (let s of eX(e, l)) {
            let e = sj(i, n[s.start], n[s.end], s.loop);
            for (let n of eY(t, a, e))
              r.push({
                source: n,
                target: s,
                start: { [i]: s$(l, e, "start", Math.max) },
                end: { [i]: s$(l, e, "end", Math.min) },
              });
          }
        }
        return r;
        ...
        t.save(),
          ...
          t.beginPath();
        let f = !!i.pathSegment(t, e);
        if (u) {
          f ? t.closePath() : sJ(t, s, h, a);
          let e = !!s.pathSegment(t, o, { move: f, reverse: !0 });
          (d = f && e) || sJ(t, s, l, a);
        }
            ...
            n &&
              ...
              (r = {
                ...
                fill: (function (t, e, i) {
                  ...
                  if (z(o)) return !isNaN(o.value) && o;
                  let l = parseFloat(o);
                  return F(l) && Math.floor(l) === l
                    ? ((s = o[0]),
                      (a = e),
                      (n = l),
                      (r = i),
                      ("-" === s || "+" === s) && (n = a + n),
                      n !== a && !(n < 0) && !(n >= r) && n)
                    : ["origin", "start", "end", "stack", "shape"].indexOf(o) >=
                        0 && o;
                })(n, a, o),
                chart: t,
    ...
    class s0 extends iZ {
      ...
      fit() {
        ...
        let a = i.labels,
          ...
          { boxWidth: l, itemHeight: h } = sG(a, r);
        (s.font = n.string),
          this.isHorizontal()
        ...
        return (
          this.legendItems.forEach((t, f) => {
            ...
            (0 === f || l[l.length - 1] + g + 2 * r > n) &&
              ((d += h), (l[l.length - (f > 0 ? 0 : 1)] = 0), (u += h), c++),
        ...
        return (
          this.legendItems.forEach((t, n) => {
              ...
              { itemWidth: O, itemHeight: L } =
                ...
                (_ = s),
                {
                  itemWidth:
                    ...
                    (D = y.text) &&
                      "string" != typeof D &&
                      (D = D.reduce((t, e) => (t.length > e.length ? t : e))),
            ...
            n > 0 &&
              ...
              g++,
              (c = u = 0)),
              (o[n] = { left: f, top: u, col: g, width: O, height: L }),
              (c = Math.max(c, O)),
              (u += L + r);
          }),
          (d += c),
      ...
      adjustHitBoxes() {
        ...
        let t = this._computeTitleHeight(),
          ...
          n = eH(a, this.left, this.width);
        if (this.isHorizontal()) {
          let a = 0,
            r = tE(i, this.left + s, this.right - this.lineWidths[a]);
          for (let o of e)
            a !== o.row &&
              ((a = o.row),
              (r = tE(i, this.left + s, this.right - this.lineWidths[a]))),
      ...
      _draw() {
        let t,
          ...
          { align: n, labels: r } = e,
          o = tQ.color,
          l = eH(e.rtl, this.left, this.width),
          h = el(r.font),
          { padding: d } = r,
          c = h.size,
          u = c / 2;
        this.drawTitle(),
          ...
          (a.lineWidth = 0.5),
          (a.font = h.string);
        let { boxWidth: f, boxHeight: g, itemHeight: p } = sG(r, c),
          m = function (t, e, i) {
            if (isNaN(f) || f <= 0 || isNaN(g) || g < 0) return;
            a.save();
            let s = B(i.lineWidth, 1);
            if (
              ((a.fillStyle = B(i.fillStyle, o)),
              (a.lineCap = B(i.lineCap, "butt")),
              (a.lineDashOffset = B(i.lineDashOffset, 0)),
              (a.lineJoin = B(i.lineJoin, "miter")),
              (a.lineWidth = s),
              (a.strokeStyle = B(i.strokeStyle, o)),
              a.setLineDash(B(i.lineDash, [])),
              r.usePointStyle)
            )
              t5(
                a,
        ...
        (t = x
          ? {
              x: tE(n, this.left + d, this.right - s[0]),
              y: this.top + d + _,
              line: 0,
            }
          : {
              x: this.left + d,
              y: tE(n, this.top + _ + d, this.bottom - i[0].height),
              line: 0,
            }),
          ej(this.ctx, e.textDirection);
        let y = p + d;
          ...
          if (
            ...
            x
              ? c > 0 &&
                ...
                ((P = t.y += y),
                t.line++,
                (k = t.x = tE(n, this.left + d, this.right - s[t.line])))
              : c > 0 &&
                P + y > this.bottom &&
                ((k = t.x = k + i[t.line].width + d),
                t.line++,
                (P = t.y =
                  tE(n, this.top + _ + d, this.bottom - i[t.line].height))),
            m(l.x(k), P, o),
            (g = k + f + u),
            (p = x ? k + w : this.right),
            (k =
      ...
      drawTitle() {
        let t,
          ...
          a = eo(i.padding);
        if (!i.display) return;
        let n = eH(e.rtl, this.left, this.width),
          r = this.ctx,
          o = i.position,
          l = s.size / 2,
          h = a.top + l,
      ...
      _getLegendItemAt(t, e) {
        let i, s, a;
        if (tw(t, this.left, this.right) && tw(e, this.top, this.bottom)) {
          for (i = 0, a = this.legendHitBoxes; i < a.length; ++i)
            if (
              tw(t, (s = a[i]).left, s.left + s.width) &&
              tw(e, s.top, s.top + s.height)
            )
        ...
        if ("mousemove" === t.type || "mouseout" === t.type) {
          let e = this._hoveredItem,
            i =
              ...
              e.index === a.index;
          e && !i && W(s.onLeave, [t, e, this], this),
            (this._hoveredItem = a),
            a && !i && W(s.onHover, [t, a, this], this);
        } else a && W(s.onClick, [t, a, this], this);
      }
    }
    function s1(t, e) {
    ...
    var s2 = {
      ...
      _element: s0,
      start(t, e, i) {
        let s = (t.legend = new s0({ ctx: t.ctx, options: i, chart: t }));
        iE.configure(t, s, i), iE.addBox(t, s);
      },
      stop(t) {
      ...
      beforeUpdate(t, e, i) {
        let s = t.legend;
        iE.configure(t, s, i), (s.options = i);
      },
      afterUpdate(t) {
        let e = t.legend;
    ...
    class s5 extends iZ {
      ...
      update(t, e) {
        ...
        let s = R(i.text) ? i.text.length : 1;
        this._padding = eo(i.padding);
        let a = s * el(i.font).lineHeight + this._padding.height;
      ...
      _drawArgs(t) {
        ...
        return (
          this.isHorizontal()
            ? ((i = tE(h, n, o)), (s = a + t), (e = o - n))
            : ("left" === l.position
                ? ((i = n + t), (s = tE(h, r, a)), (d = -0.5 * te))
                : ((i = o - t), (s = tE(h, a, r)), (d = 0.5 * te)),
              (e = r - a)),
    ...
    var s8 = {
      ...
      start(t, e, i) {
        let s;
        (s = new s5({ ctx: t.ctx, options: i, chart: t })),
          iE.configure(t, s, i),
          iE.addBox(t, s),
          (t.titleBlock = s);
      },
    ...
    function s4(t, e) {
      return e && (R(e) ? Array.prototype.push.apply(t, e) : t.push(e)), t;
    }
    function s6(t) {
    ...
    function s7(t, e) {
      ...
      (b += t.beforeBody.length + t.afterBody.length),
        c &&
          (p +=
            c * h.lineHeight + (c - 1) * e.titleSpacing + e.titleMarginBottom),
        b &&
          (p +=
            f * (e.displayColors ? Math.max(o, l.lineHeight) : l.lineHeight) +
            (b - f) * l.lineHeight +
            (b - 1) * e.bodySpacing),
        u &&
          (p +=
            e.footerMarginTop + u * d.lineHeight + (u - 1) * e.footerSpacing);
      let x = 0,
        _ = function (t) {
    ...
    function at(t, e, i, s) {
      let { caretSize: a, caretPadding: n, cornerRadius: r } = t,
        { xAlign: o, yAlign: l } = i,
        h = a + n,
        { topLeft: d, topRight: c, bottomLeft: u, bottomRight: f } = er(r),
        g = (function (t, e) {
          let { x: i, width: s } = t;
      ...
      return (
        ...
        { x: tM(g, 0, s.width - e.width), y: tM(p, 0, s.height - e.height) }
      );
    }
    function ae(t, e, i) {
      let s = eo(i.padding);
    ...
    function aa(t, e, i, s) {
      let a = t[e].call(i, s);
      return void 0 === a ? as[e].call(i, s) : a;
    }
    class an extends iZ {
      static positioners = s3;
      constructor(t) {
        super(),
          (this.opacity = 0),
          (this._active = []),
      ...
      getTitle(t, e) {
        let { callbacks: i } = e,
          ...
          a = aa(i, "title", this, t),
          n = aa(i, "afterTitle", this, t),
          r = [];
        return (r = s4(r, s6(s))), (r = s4(r, s6(a))), (r = s4(r, s6(n)));
      }
      getBeforeBody(t, e) {
        return s4([], s6(aa(e.callbacks, "beforeBody", this, t)));
      }
      getBody(t, e) {
        let { callbacks: i } = e,
          s = [];
        return (
          H(t, (t) => {
            let e = { before: [], lines: [], after: [] },
              a = ai(i, t);
            s4(e.before, s6(aa(a, "beforeLabel", this, t))),
              s4(e.lines, aa(a, "label", this, t)),
              s4(e.after, s6(aa(a, "afterLabel", this, t))),
              s.push(e);
          }),
          s
        );
      ...
      getAfterBody(t, e) {
        return s4([], s6(aa(e.callbacks, "afterBody", this, t)));
      }
      getFooter(t, e) {
        let { callbacks: i } = e,
          s = aa(i, "beforeFooter", this, t),
          a = aa(i, "footer", this, t),
          n = aa(i, "afterFooter", this, t),
          r = [];
        return (r = s4(r, s6(s))), (r = s4(r, s6(a))), (r = s4(r, s6(n)));
      }
      _createItems(t) {
        ...
        return (
          ...
          H(l, (e) => {
            let i = ai(t.callbacks, e);
            n.push(aa(i, "labelColor", this, e)),
              r.push(aa(i, "labelPointStyle", this, e)),
      ...
      update(t, e) {
        let i,
          ...
          n = [];
        if (a.length) {
          let t = s3[s.position].call(this, a, this._eventPosition);
          ...
          let e = (this._size = s7(this, s)),
            r = Object.assign({}, t, e),
            o = s9(this.chart, s, r),
            l = at(s, r, o, this.chart);
      ...
      getCaretPosition(t, e, i) {
        let s,
          ...
          { topLeft: f, topRight: g, bottomLeft: p, bottomRight: m } = er(u),
          { x: b, y: x } = t,
          { width: _, height: y } = e;
        return (
          "center" === d
      ...
      drawTitle(t, e, i) {
        let s,
          ...
          o = r.length;
        if (o) {
          let l = eH(i.rtl, this.x, this.width);
          for (
            n = 0,
              t.x = ae(this, i.titleAlign, i),
      ...
      _drawColorBox(t, e, i, s, a) {
        ...
        if (a.usePointStyle) {
          ...
          Object.values(r).some((t) => 0 !== t)
            ? (t.beginPath(),
              (t.fillStyle = a.multiKeyBackground),
              et(t, { x: e, y: f, w: l, h: o, radius: r }),
              t.fill(),
              t.stroke(),
              (t.fillStyle = n.backgroundColor),
              t.beginPath(),
              et(t, { x: i, y: f + 1, w: l - 2, h: o - 2, radius: r }),
              t.fill())
            : ((t.fillStyle = a.multiKeyBackground),
              t.fillRect(e, f, l, o),
      ...
      drawBody(t, e, i) {
        ...
        for (
          e.textAlign = c,
            ...
            H(this.beforeBody, y),
            x =
              u && "right" !== v ? ("center" === c ? g / 2 + p : g + 2 + p) : 0,
            n = 0,
            o = h.length;
          n < o;
          ++n
        ...
        (x = 0), (b = m.lineHeight), H(this.afterBody, y), (t.y -= d);
      }
      drawFooter(t, e, i) {
        let s,
          a,
          ...
          r = n.length;
        if (r) {
          let o = eH(i.rtl, this.x, this.width);
          for (
            t.x = ae(this, i.footerAlign, i),
      ...
      _updateAnimationTarget(t) {
        let e = this.chart,
          ...
          a = i && i.y;
        if (s || a) {
          let i = s3[t.position].call(this, this._active, this._eventPosition);
          if (!i) return;
          let n = (this._size = s7(this, t)),
    ...
    var ar = {
      ...
      positioners: s3,
      afterInit(t, e, i) {
        i && (t.tooltip = new an({ chart: t, options: i }));
      },
      beforeUpdate(t, e, i) {
          ...
          (i = e =
            isFinite(e) && a[e] === t
              ...
              : (function (t, e, i, s) {
                ...
                })(a, t, B(e, t), this._addedLabels)),
          (s = a.length - 1),
          null === i ? null : tM(Math.round(i), 0, s)
        );
      }
      determineDataLimits() {
    ...
    function ah(t, e, { horizontal: i, minRotation: s }) {
      let a = tp(s),
    ...
    class ad extends i5 {
      ...
      buildTicks() {
        let t = this.options,
          ...
          s = (function (t, e) {
            ...
            let a,
              ...
              S = (M - v) / (b + 1),
              D = tu((M - v) / y / _) * _;
            if (D < 1e-14 && !w && !k) return [{ value: v }, { value: M }];
            (o = Math.ceil(M / D) - Math.floor(v / D)) > y &&
              (D = tu((o * D) / y / _) * _),
              E(g) || (D = Math.ceil(D * (a = Math.pow(10, g))) / a),
              "ticks" === d
                ? ((n = Math.floor(v / D) * D), (r = Math.ceil(M / D) * D))
                : ((n = v), (r = M)),
              w &&
              k &&
              c &&
              ((i = (f - u) / c),
              (s = D / 1e3),
              (l = Math.round(i)) - s <= i && l + s >= i)
                ? ((o = Math.round(Math.min((f - u) / D, m))),
                  (D = (f - u) / o),
                  (n = u),
                  (r = f))
                : P
                ? ((n = w ? u : n), (D = ((r = k ? f : r) - n) / (o = p - 1)))
                : (o = tc((o = (r - n) / D), Math.round(o), D / 1e3)
                    ? Math.round(o)
                    : Math.ceil(o));
            let C = Math.max(tm(D), tm(n));
            (n = Math.round(n * (a = Math.pow(10, E(g) ? C : g))) / a),
              (r = Math.round(r * a) / a);
            let O = 0;
            for (
              w &&
              (x && n !== u
                ? (h.push({ value: u }),
                  n < u && O++,
                  tc(Math.round((n + O * D) * a) / a, u, ah(u, S, t)) && O++)
                : n < u && O++);
              O < o;
              ++O
            ) {
              let t = Math.round((n + O * D) * a) / a;
              if (k && t > f) break;
              h.push({ value: t });
            }
            return (
              k && x && r !== f
                ? h.length && tc(h[h.length - 1].value, f, ah(f, S, t))
                  ? (h[h.length - 1].value = f)
                  : h.push({ value: f })
                : (k && r !== f) || h.push({ value: r }),
              h
            );
          })(
            {
        ...
        return (
          "ticks" === t.bounds && tg(s, this, "value"),
          t.reverse
      ...
      getLabelForValue(t) {
        return tY(t, this.chart.options.locale, this.options.ticks.format);
      }
    }
    class ac extends ad {
      static id = "linear";
      static defaults = { ticks: { callback: tX.numeric } };
      determineDataLimits() {
      ...
      computeTickLimit() {
        let t = this.isHorizontal(),
          ...
          i = tp(this.options.ticks.minRotation),
    ...
    let au = (t) => Math.floor(th(t)),
      af = (t, e) => Math.pow(10, au(t) + e);
    function ag(t) {
      return 1 == t / Math.pow(10, au(t));
    }
    function ap(t, e, i) {
      let s = Math.pow(10, i),
        a = Math.floor(t / s);
    ...
    class am extends i5 {
      ...
      static defaults = {
        ticks: { callback: tX.logarithmic, major: { enabled: !0 } },
      };
      constructor(t) {
        super(t),
          (this.start = void 0),
      ...
      parse(t, e) {
        let i = ad.prototype.parse.apply(this, [t, e]);
        if (0 === i) {
          this._zero = !0;
          return;
        }
      ...
      determineDataLimits() {
        ...
        (this.min = F(t) ? Math.max(0, t) : null),
          ...
          this._zero &&
            ...
            !F(this._userMin) &&
            (this.min =
              t === af(this.min, 0) ? af(this.min, -1) : af(this.min, 0)),
          this.handleTickRangeOptions();
      }
      handleTickRangeOptions() {
        let { minDefined: t, maxDefined: e } = this.getUserBounds(),
          ...
          a = (e) => (i = t ? i : e),
          n = (t) => (s = e ? s : t);
        i === s && (i <= 0 ? (a(1), n(10)) : (a(af(i, -1)), n(af(s, 1)))),
          i <= 0 && a(af(s, -1)),
          s <= 0 && n(af(i, 1)),
          (this.min = i),
          (this.max = s);
        ...
        let t = this.options,
          e = (function (t, { min: e, max: i }) {
            ...
            let s = [],
              ...
              c = Math.floor((h - d) / Math.pow(10, n)),
              u = V(t.min, Math.round((l + d + c * Math.pow(10, n)) * r) / r);
            for (; u < i; )
              s.push({ value: u, major: ag(u), significand: c }),
                c >= 10 ? (c = c < 15 ? 15 : 20) : c++,
                c >= 20 && ((c = 2), (r = ++n >= 0 ? 1 : r)),
                (u = Math.round((l + d + c * Math.pow(10, n)) * r) / r);
            let f = V(t.max, u);
            return s.push({ value: f, major: ag(f), significand: c }), s;
          })({ min: this._userMin, max: this._userMax }, this);
        return (
          "ticks" === t.bounds && tg(e, this, "value"),
          t.reverse
      ...
      getLabelForValue(t) {
        return void 0 === t
          ? "0"
          : tY(t, this.chart.options.locale, this.options.ticks.format);
      }
      configure() {
        let t = this.min;
        super.configure(),
          (this._startValue = th(t)),
          (this._valueRange = th(this.max) - th(t));
      }
      getPixelForValue(t) {
        ...
        null === t || isNaN(t))
          ...
          : this.getPixelForDecimal(
              t === this.min ? 0 : (th(t) - this._startValue) / this._valueRange
            );
      }
      getValueForPixel(t) {
    ...
    function ab(t) {
      ...
      if (e.display && t.display) {
        let t = eo(e.backdropPadding);
        return B(e.font && e.font.size, tQ.font.size) + t.height;
      }
      return 0;
    }
    function ax(t, e, i, s, a) {
      return t === s || t === a
    ...
    function a_(t, e, i, s) {
      let { ctx: a } = t;
      if (i) a.arc(t.xCenter, t.yCenter, e, 0, ti);
      else {
    ...
    class ay extends ad {
      ...
      static defaults = {
        ...
        grid: { circular: !1 },
        startAngle: 0,
        ticks: { showLabelBackdrop: !0, callback: tX.numeric },
        pointLabels: {
      ...
      setDimensions() {
        let t = (this._padding = eo(ab(this.options) / 2)),
      ...
      computeTickLimit() {
        return Math.ceil(this.drawingArea / ab(this.options));
      }
      generateTickLabels(t) {
        ad.prototype.generateTickLabels.call(this, t),
          (this._pointLabels = this.getLabels()
            .map((t, e) => {
              let i = W(this.options.pointLabels.callback, [t, e], this);
              return i || 0 === i ? i : "";
            })
        ...
        t.display && t.pointLabels.display
          ? (function (t) {
              ...
              for (let d = 0; d < n; d++) {
                ...
                s[d] = f;
                let g = ty(t.getIndexAngle(d) + o),
                  p = Math.round((180 / te) * g);
                !(function (t, e, i, s, a) {
                ...
                })(i, e, g, ax(p, c.x, f.w, 0, 180), ax(p, c.y, f.h, 90, 270));
              }
              t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
                (t._pointLabelItems = (function (t, e, i) {
                  let s,
                    ...
                    h = { extra: ab(r) / 2, additionalAngle: o ? te / n : 0 };
                  for (let r = 0; r < n; r++) {
                    ...
                    let n = (function (t, e, i) {
                      ...
                      let d = t.drawingArea,
                        ...
                        m = Math.round((180 / te) * ty(p.angle + tr)),
                        b =
                          ((s = p.y),
                          (a = g.h),
                          90 === (n = m) || 270 === n
      ...
      getIndexAngle(t) {
        return ty(
          t * (ti / (this._pointLabels.length || 1)) +
            tp(this.options.startAngle || 0)
        );
      }
      ...
      getPointLabelContext(t) {
        ...
        if (t >= 0 && t < e.length) {
          ...
          return (
            (i = this.getContext()),
            ed(i, { label: s, index: t, type: "pointLabel" })
          );
        }
      }
      getPointPosition(t, e, i = 0) {
        let s = this.getIndexAngle(t) - tr + i;
        return {
              ...
              for (let a = e - 1; a >= 0; a--) {
                ...
                !(function (t, e, i) {
                  let { left: s, top: a, right: n, bottom: r } = i,
                    { backdropColor: o } = e;
                  if (!E(o)) {
                    let i = er(e.borderRadius),
                      l = eo(e.backdropPadding);
                    t.fillStyle = o;
                    let h = s - l.left,
                      d = a - l.top,
                      c = n - s + l.width,
                ...
                t9(i, t._pointLabels[a], o, l + r.lineHeight / 2, r, {
                  color: n.color,
                  textAlign: h,
                  textBaseline: "middle",
                });
        ...
        i.save(),
          ...
          this.ticks.forEach((n, r) => {
            ...
            let o = a.setContext(this.getContext(r)),
              l = el(o.font);
            if (
              ((t = this.getDistanceFromCenterForValue(this.ticks[r].value)),
              o.showLabelBackdrop)
            ) {
              (i.font = l.string),
                (e = i.measureText(n.label).width),
                (i.fillStyle = o.backdropColor);
              let s = eo(o.backdropPadding);
              i.fillRect(
                -e / 2 - s.left,
                -t - l.size / 2 - s.top,
                e + s.width,
    ...
    function ak(t, e) {
      ...
      F(r) || (r = "string" == typeof s ? i.parse(r, s) : i.parse(r)),
      null === r)
        ? null
        : (a &&
            (r =
    ...
    function aP(t, e, i, s) {
      let a = aM.length;
      for (let n = aM.indexOf(t); n < a - 1; ++n) {
        let t = av[aM[n]],
          a = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
        if (t.common && Math.ceil((i - e) / (a * t.size)) <= s) return aM[n];
      }
      return aM[a - 1];
    }
    function aS(t, e, i) {
    ...
    class aC extends i5 {
      ...
      init(t, e = {}) {
        let i = t.time || (t.time = {}),
          s = (this._adapter = new ix(t.adapters.date));
        s.init(e),
      ...
      parse(t, e) {
        return void 0 === t ? null : ak(this, t);
      }
      beforeLayout() {
      ...
      determineDataLimits() {
        ...
        (n && r) ||
          ...
          (a = F(a) && !isNaN(a) ? a : +e.endOf(Date.now(), i) + 1),
      ...
      buildTicks() {
        ...
        return (
          (this._unit =
            e.unit ||
            (i.autoSkip
              ? aP(e.minUnit, this.min, this.max, this._getLabelCapacity(a))
              : (function (t, e, i, s, a) {
                  for (let n = aM.length - 1; n >= aM.indexOf(i); n--) {
                    let i = aM[n];
                    if (av[i].common && t._adapter.diff(a, s, i) >= e - 1)
                      return i;
                  }
                  return aM[i ? aM.indexOf(i) : 0];
                })(this, n.length, e.minUnit, this.min, this.max))),
          (this._majorUnit =
            i.major.enabled && "year" !== this._unit
              ? (function (t) {
                  for (let e = aM.indexOf(t) + 1, i = aM.length; e < i; ++e)
                    if (av[aM[e]].common) return aM[e];
                })(this._unit)
              : void 0),
          this.initOffsets(s),
          t.reverse && n.reverse(),
          aD(this, n, this._majorUnit)
        );
      }
      afterAutoSkip() {
      ...
      _generate() {
        let t,
          ...
          n = this.options,
          r = n.time,
          o = r.unit || aP(r.minUnit, s, a, this._getLabelCapacity(s)),
          l = B(n.ticks.stepSize, 1),
        ...
        for (t = u, e = 0; t < a; t = +i.add(t, l, o), e++) aS(c, t, f);
        return (
          (t === a || "ticks" === n.bounds || 1 === e) && aS(c, t, f),
          Object.keys(c)
            .sort(aw)
            .map((t) => +t)
        );
      ...
      _getLabelSize(t) {
        let e = this.options.ticks,
          ...
          s = tp(this.isHorizontal() ? e.maxRotation : e.minRotation),
          a = Math.cos(s),
          n = Math.sin(s),
      ...
      _getLabelCapacity(t) {
        let e = this.options.time,
          ...
          a = this._tickFormatFunction(t, 0, aD(this, [t], this._majorUnit), s),
      ...
      getLabelTimestamps() {
        ...
        for (t = 0, e = s.length; t < e; ++t) i.push(ak(this, s[t]));
    ...
    function aO(t, e, i) {
      ...
      i
        ? (e >= t[o].pos &&
            e <= t[l].pos &&
            ({ lo: o, hi: l } = tP(t, "pos", e)),
          ({ pos: s, time: n } = t[o]),
          ({ pos: a, time: r } = t[l]))
        : (e >= t[o].time &&
            e <= t[l].time &&
            ({ lo: o, hi: l } = tP(t, "time", e)),
          ({ time: s, pos: n } = t[o]),
          ({ time: a, pos: r } = t[l]));
      let h = a - s;
    ...
    class aL extends aC {
      ...
      initOffsets() {
        ...
        (this._minPos = aO(e, this.min)),
          (this._tableRange = aO(e, this.max) - this._minPos),
          super.initOffsets(t);
      }
      buildLookupTable(t) {
        let e,
    ...
    function aE(t, e) {
      let i =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : aA,
        s = [];
      t.datasets = e.map((e) => {
    ...
    let aR = (0, s.forwardRef)(function (t, e) {
      let {
          height: i = 150,
          width: a = 300,
          redraw: n = !1,
              ...
              data: (function (t) {
                let e =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ...
                      : aA,
                  i = { labels: [], datasets: [] };
                return (i.labels = t.labels), aE(i, t.datasets, e), i;
              })(l, r),
              options: h && { ...h },
              plugins: d,
            })),
        ...
        b = () => {
          aT(e, null), p.current && (p.current.destroy(), (p.current = null));
        };
      return (
        (0, s.useEffect)(() => {
          var t;
          ...
          !n &&
            p.current &&
            h &&
            ((t = p.current), (e = t.options) && h && Object.assign(e, h));
        }, [n, h]),
        (0, s.useEffect)(() => {
        ...
        (0, s.useEffect)(() => {
          !n &&
            p.current &&
            l.datasets &&
            aE(p.current.config.data, l.datasets, r);
        }, [n, l.datasets]),
        (0, s.useEffect)(() => {
        ...
        s.default.createElement(
          "canvas",
          { ref: g, role: "img", height: i, width: a, ...f },
          c
        )
      );
    });
    function az(t, e) {
      return (
        s_.register(e),
        (0, s.forwardRef)((e, i) =>
          s.default.createElement(aR, { ...e, ref: i, type: t })
        )
      );
    }
    let aF = az("line", ic),
      aV = az("doughnut", id);
    t.s(["Doughnut", () => aV, "Line", () => aF], 81097);
  },
]);

//# debugId=39c8a6e5-d040-b0b1-5009-50a2c014710c
//# sourceMappingURL=1f9e752ded81f322.js.map
