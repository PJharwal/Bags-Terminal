  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "71ce10f4-6579-5ca1-15a2-cab04d35024f");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    function p(t) {
      ...
      return (
        (e.version = e.version || c.SDK_VERSION),
        (e[c.SDK_VERSION] = e[c.SDK_VERSION] || {})
      );
    }
    ...
    let f = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__;
    t.s(["DEBUG_BUILD", () => f], 901020);
    ...
    function E(t) {
      return (
        null === t || v(t) || ("object" != typeof t && "function" != typeof t)
      );
    }
    function T(t) {
      return g(t, "Object");
    ...
    function I(t) {
      return "undefined" != typeof Event && N(t, Event);
    }
    function x(t) {
      return "undefined" != typeof Element && N(t, Element);
    }
    function A(t) {
      return g(t, "RegExp");
    }
    ...
    function w(t) {
      return "undefined" != typeof Request && N(t, Request);
    }
    t.s(
      [
        "isDOMError",
        ...
        for (
          ...
          ((n = (function (t, e) {
            ...
            if (r?.length)
              ...
              t.id && n.push(`#${t.id}`);
              let e = t.className;
              if (e && b(e)) for (let t of e.split(/\s+/)) n.push(`.${t}`);
            }
          ...
          "html" !== n && (!(s > 1) || !(a + 3 * i.length + n.length >= c)));
    ...
    function F() {
      return f ? d("loggerSettings", () => ({ enabled: !1 })) : { enabled: !1 };
    }
    let G = {
      enable: function () {
        F().enabled = !0;
    ...
    function K(t) {
      if (h(t))
        return { message: t.message, name: t.name, stack: t.stack, ...W(t) };
      if (!I(t)) return t;
      {
        let e = {
          type: t.type,
    ...
    function z(t) {
      try {
        return x(t) ? L(t) : Object.prototype.toString.call(t);
      } catch {
        return "<unknown>";
      }
    }
    ...
    let X = /\(error: (.*)\)/,
      Q = /captureMessage|captureException/;
    function Z(...t) {
      ...
      return (t, n = 0, r = 0) => {
        ...
        let o = Array.from(a);
        return (
          /sentryWrapped/.test(te(o).function || "") && o.pop(),
          o.reverse(),
          Q.test(te(o).function || "") &&
            (o.pop(), Q.test(te(o).function || "") && o.pop()),
          o
            .slice(0, 50)
            .map((t) => ({
              ...t,
              filename: t.filename || te(o).filename,
              function: t.function || "?",
            }))
        );
      };
    ...
    function tr(t) {
      try {
        if (!t || "function" != typeof t) return tn;
        return t.name || tn;
      } catch {
        return tn;
      }
    ...
    function tc(t, e) {
      ...
      for (let e = 0; e < t.length; e++) {
        let r = t[e];
        try {
          C(r) ? n.push(ts(r)) : n.push(String(r));
        } catch {
    ...
    function tu(t, e, n = !1) {
      return (
        !!b(t) && (A(e) ? e.test(t) : !!b(e) && (n ? t === e : t.includes(e)))
      );
    }
    function tl(t, e = [], n = !1) {
      return e.some((e) => tu(t, e, n));
    }
    function tp(
      t = (function () {
        let t = u.GLOBAL_OBJ;
      ...
      return (
        e || (e = "10000000100040008000100000000000"),
        e.replace(/[018]/g, (t) =>
          (t ^ ((15 & (16 * Math.random())) >> (t / 4))).toString(16)
        )
      );
    }
    function td(t) {
    ...
    function tS() {
      return (
        n ??
        (n = (function () {
          let { performance: t } = u.GLOBAL_OBJ;
          if (!t?.now || !t.timeOrigin) return tm;
          let e = t.timeOrigin;
          return () => (e + t.now()) / 1e3;
        })())
      )();
    ...
    t.s(
      ...
      t.s(["merge", () => tT], 318746),
      t.s(["generateSpanId", () => tx, "generateTraceId", () => tI], 373382);
    let tA = "_sentrySpan";
    function tO(t, e) {
      e ? H(t, tA, e) : delete t[tA];
    }
    function tk(t) {
      return t[tA];
    }
    t.s(["_getSpanForScope", () => tk, "_setSpanForScope", () => tO], 821061);
    class tN {
      constructor() {
      ...
      setUser(t) {
        return (
          ...
          this._session && tv(this._session, { user: t }),
      ...
      update(t) {
        ...
        let e = "function" == typeof t ? t(this) : t,
          ...
          } = (e instanceof tN ? e.getScopeData() : T(e) ? t : void 0) || {};
        return (
      ...
      addBreadcrumb(t, e) {
        ...
        let r = {
          timestamp: tm(),
          ...t,
          message: t.message ? ta(t.message, 2048) : t.message,
        };
        return (
      ...
      setSDKProcessingMetadata(t) {
        return (
          (this._sdkProcessingMetadata = tT(this._sdkProcessingMetadata, t, 2)),
          this
        );
      }
    ...
    function tw() {
      ...
      return (t.stack =
        t.stack ||
        new tC(
          d("defaultCurrentScope", () => new tN()),
          d("defaultIsolationScope", () => new tN())
        ));
    }
    function tR(t) {
      return tw().withScope(t);
    }
    function tL(t, e) {
      let n = tw();
    ...
    function tP(t) {
      return tw().withScope(() => t(tw().getIsolationScope()));
    }
    function t$(t) {
      let e = p(t);
      return e.acs
        ? e.acs
        : {
            withIsolationScope: tP,
            withScope: tR,
            withSetScope: tL,
            withSetIsolationScope: (t, e) => tP(e),
            getCurrentScope: () => tw().getScope(),
            getIsolationScope: () => tw().getIsolationScope(),
          };
    }
    function tD() {
      return t$(l()).getCurrentScope();
    }
    function tM() {
      return t$(l()).getIsolationScope();
    }
    function tj() {
      return d("globalScope", () => new tN());
    }
    function tB(...t) {
      let e = t$(l());
      if (2 === t.length) {
    ...
    function tG(t) {
      let {
        ...
        i = { trace_id: e, span_id: r || tx() };
      return n && (i.parent_span_id = n), i;
    }
    t.s(["getAsyncContextStrategy", () => t$], 301263),
      t.s(
        [
          "getClient",
          () => tF,
    ...
    let tJ = "sentry.source",
      ...
      tV = "sentry.previous_trace_sample_rate",
      tY = "sentry.op",
      tK = "sentry.origin",
      tz = "sentry.measurement_unit",
      tW = "sentry.measurement_value",
      tq = "sentry.custom_span_name",
      tX = "sentry.profile_id",
      tQ = "sentry.exclusive_time";
    t.s(
      [
    ...
    function t1(t) {
      ...
      let n = Object.entries(e).reduce(
        (t, [e, n]) => (e.match(t0) && (t[e.slice(tZ.length)] = n), t),
        {}
      );
    ...
    function t2(t) {
      if (t && (b(t) || Array.isArray(t)))
        return Array.isArray(t)
          ? t.reduce(
              (t, e) => (
                Object.entries(t4(e)).forEach(([e, n]) => {
                  t[e] = n;
                }),
                t
              ),
    ...
    t.s(
      ...
      t.s(["hasSpansEnabled", () => t8], 10008),
      t.s(["parseSampleRate", () => t6], 170637),
      t.s(
        [
          "SPAN_STATUS_ERROR",
          () => 2,
    ...
    function ea(t) {
      ...
      if (n.orgId) e = String(n.orgId);
        ...
        let t;
        r && ((t = r.match(ee)), (e = t?.[1]));
      }
      return e;
    }
    function eo(t) {
      let e = "string" == typeof t ? ei(t) : es(t);
      if (
        e &&
        (function (t) {
          if (!f) return !0;
          ...
          return (
            !["protocol", "publicKey", "host", "projectId"].find(
              (e) => !t[e] && (G.error(`Invalid Sentry Dsn: ${e} missing`), !0)
            ) &&
            (n.match(/^\d+$/)
              ? "http" !== r && "https" !== r
                ? (G.error(`Invalid Sentry Dsn: Invalid protocol ${r}`), !1)
                : !(e && isNaN(parseInt(e, 10))) ||
                  (G.error(`Invalid Sentry Dsn: Invalid port ${e}`), !1)
    ...
    function eu(t, e) {
      let n = (function (t) {
        ...
        r = t1(e);
      if (!n?.traceId) return { traceId: tI(), sampleRand: Math.random() };
      let i = (function (t, e) {
        let n = t6(e?.sample_rand);
        if (void 0 !== n) return n;
        let r = t6(e?.sample_rate);
      ...
      let { traceId: s, parentSpanId: a, parentSampled: o } = n;
      return {
        traceId: s,
        parentSpanId: a,
        sampled: o,
    ...
    function el(t = tI(), e = tx(), n) {
      let r = "";
      return void 0 !== n && (r = n ? "-1" : "-0"), `${t}-${e}${r}`;
    }
    function ep(t = tI(), e = tx(), n) {
    ...
    function eh(t) {
      let { spanId: e, traceId: n, isRemote: r } = t.spanContext(),
        i = r ? e : ev(t).parent_span_id,
        s = et(t).scope;
      return {
        parent_span_id: i,
        span_id: r ? s?.getPropagationContext().propagationSpanId || tx() : e,
        trace_id: n,
      };
    }
    function eg(t) {
    ...
    let eI = "_sentryChildSpans",
      ex = "_sentryRootSpan";
    function eA(t, e) {
      let n = t[ex] || t;
      H(e, ex, n), t[eI] ? t[eI].add(e) : H(t, eI, new Set([e]));
    }
    function eO(t, e) {
      t[eI] && t[eI].delete(e);
    }
    function ek(t) {
      ...
      return (
        !(function t(n) {
          if (!e.has(n) && eE(n))
            for (let r of (e.add(n), n[eI] ? Array.from(n[eI]) : [])) t(r);
        })(t),
        Array.from(e)
      );
    }
    ...
    function eC() {
      let t = t$(l());
      return t.getActiveSpan ? t.getActiveSpan() : tD()[tA];
    }
    function ew() {
      ef ||
        (j(() => {
    ...
    let eR = "production";
    t.s(["DEFAULT_ENVIRONMENT", () => eR], 373250);
    let eL = "_frozenDsc";
    function eP(t, e) {
      H(t, eL, e);
    }
    ...
    function eM(t) {
      ...
      let n = eN(t),
        ...
        a = s?.get("sentry.sample_rate") ?? i[tH] ?? i[tV];
      function o(t) {
        return (
      ...
      let u = s?.get("sentry.dsc"),
        l = u && t1(u);
      if (l) return o(l);
      let p = e$(t.spanContext().traceId, e),
        d = i[tJ],
        f = r.description;
      return (
        "url" !== d && f && (p.transaction = f),
        t8() &&
          ((p.sampled = String(eE(n))),
          (p.sample_rand =
            s?.get("sentry.sample_rand") ??
            et(n).scope?.getPropagationContext().sampleRand.toString())),
        o(p),
    ...
    class ej {
      constructor(t = {}) {
        (this._traceId = t.traceId || tI()), (this._spanId = t.spanId || tx());
      }
      spanContext() {
    ...
    function eB(e, n = 100, r = Infinity) {
      try {
        return (function e(
          n,
          r,
          ...
          let u = (function (e, n) {
            try {
              ...
              if ("undefined" != typeof document && n === document)
                return "[Document]";
              if (C(n)) return ts(n);
              if (k(n)) return "[SyntheticEvent]";
              if ("number" == typeof n && !Number.isFinite(n)) return `[${n}]`;
              if ("function" == typeof n) return `[Function: ${tr(n)}]`;
    ...
    function eH(t) {
      ...
      function i(t) {
        "string" == typeof r
          ? (r = "string" == typeof t ? r + t : [eJ(r), t])
          : r.push("string" == typeof t ? eJ(t) : t);
      }
      for (let t of n) {
        let [e, n] = t;
        if (
...
`),
    ...
    function eY(t) {
      let e = "string" == typeof t.data ? eJ(t.data) : t.data;
      return [
        {
          type: "attachment",
          length: e.length,
    ...
    t.s(["SentryNonRecordingSpan", () => ej], 728469),
      t.s(
        [
          "normalize",
          () => eB,
    ...
    function eQ(t, e) {
      ...
      for (let r of e) {
        ...
        if ("string" == typeof (n = r) || n instanceof RegExp) {
          if (tu(t.description, r)) return f && eX(t), !0;
          continue;
        }
        if (!r.name && !r.op) continue;
        let e = !r.name || tu(t.description, r.name),
          i = !r.op || (t.op && tu(t.op, r.op));
        if (e && i) return f && eX(t), !0;
      }
      return !1;
    }
    function eZ(t, e) {
      let n = e.parent_span_id,
        r = e.span_id;
      if (n) for (let e of t) e.parent_span_id === r && (e.parent_span_id = n);
    }
    function e0(t, e, n, r) {
      let i = eW(n);
      return eU(
    ...
    function e1(t, e, n, r) {
      ...
      let a = eq(t, i, r, e);
      return delete t.sdkProcessingMetadata, eU(a, [[{ type: s }, t]]);
    }
    function e3(t, e) {
      let n = eM(t[0]),
        r = e?.getDsn(),
        ...
        { beforeSendSpan: a, ignoreSpans: o } = e?.getOptions() || {},
        c = o?.length ? t.filter((t) => !eQ(ev(t), o)) : t,
        u = t.length - c.length;
    ...
    function e2(t, e, n, r = eC()) {
      let i = r && eN(r);
      i &&
        (f &&
          G.log(
            `[Measurement] Setting measurement on root span: ${t} = ${e} ${n}`
          ),
        i.addEvent(t, { [tW]: e, [tz]: n }));
    }
    function e4(t) {
    ...
    t.s(
      ...
      t.s(
        ["reparentChildSpans", () => eZ, "shouldIgnoreSpan", () => eQ],
        454300
      ),
      t.s(
        [
      ...
      t.s(
        ["setMeasurement", () => e2, "timedEventsToMeasurements", () => e4],
        804478
      );
    class e8 {
      constructor(t = {}) {
        (this._traceId = t.traceId || tI()),
          (this._spanId = t.spanId || tx()),
          (this._startTime = t.startTimestamp || tS()),
          (this._links = t.links),
          (this._attributes = {}),
          this.setAttributes({ [tK]: "manual", [tY]: t.op, ...t.attributes }),
          (this._name = t.name),
      ...
      updateStartTime(t) {
        this._startTime = ey(t);
      }
      setStatus(t) {
        return (this._status = t), this;
      }
      updateName(t) {
        return (this._name = t), this.setAttribute(tJ, "custom"), this;
      }
      end(t) {
        this._endTime ||
          ((this._endTime = ey(t)),
      ...
      getSpanJSON() {
        return {
          ...
          op: this._attributes[tY],
          parent_span_id: this._parentSpanId,
          span_id: this._spanId,
          start_timestamp: this._startTime,
          status: eT(this._status),
          timestamp: this._endTime,
          trace_id: this._traceId,
          origin: this._attributes[tK],
          profile_id: this._attributes[tX],
          exclusive_time: this._attributes[tQ],
          measurements: e4(this._events),
          is_segment: (this._isStandaloneSpan && eN(this) === this) || void 0,
          segment_id: this._isStandaloneSpan
            ? eN(this).spanContext().spanId
            : void 0,
          links: eS(this._links),
        };
      }
      isRecording() {
      ...
      addEvent(t, e, n) {
        f && G.log("[Tracing] Adding an event to span:", t);
        let r = e6(e) ? e : n || tS(),
          i = e6(e) ? {} : e || {},
          s = { name: t, time: ey(r), attributes: i };
      ...
      _onSpanEnded() {
        ...
        if (
          ...
          !(this._isStandaloneSpan || this === eN(this)))
        )
          return;
        ...
        e && (et(this).scope || tD()).captureEvent(e);
      }
      _convertSpanToTransaction() {
        if (!e5(ev(this))) return;
        this._name ||
          (f &&
            G.warn(
        ...
        let { scope: t, isolationScope: e } = et(this),
        ...
        let r = ek(this)
            .filter((t) => {
              var e;
              return (
                t !== this && !((e = t) instanceof e8 && e.isStandaloneSpan())
              );
            })
            .map((t) => ev(t))
            .filter(e5),
          i = this._attributes[tJ];
        delete this._attributes[tq],
          r.forEach((t) => {
            delete t.data[tq];
          });
        let s = {
            contexts: { trace: e_(this) },
            spans:
              r.length > 1e3
                ? r
            ...
            sdkProcessingMetadata: {
              ...
              dynamicSamplingContext: eM(this),
            },
            request: n,
    ...
    t.s(["SentrySpan", () => e8], 14177);
    let e9 = "__SENTRY_SUPPRESS_TRACING__";
    function e7(t, e) {
      let n = t$(l());
      if (n.startSpan) return n.startSpan(t, e);
      let r = ni(t),
        { forceTransaction: i, parentSpan: s, scope: a } = t;
      return tB(a?.clone(), () => {
        var n;
        return (void 0 !== (n = s) ? (t) => ne(n, t) : (t) => t())(() => {
          let n = tD(),
            a = na(n, s),
            o =
              t.onlyIfParent && !a
          ...
          return (
            ...
            (function (t, e, n = () => {}, r = () => {}) {
              ...
              () => {
                ...
                o.isRecording() &&
                  (!t || "ok" === t) &&
                  o.setStatus({ code: 2, message: "internal_error" });
              },
              () => {
                o.end();
              }
    ...
    function ne(t, e) {
      ...
      return n.withActiveSpan
        ...
        : tB((n) => (tO(n, t || void 0), e(n)));
    }
    function nn(t) {
      return tB(
        (e) => (
          e.setPropagationContext({ traceId: tI(), sampleRand: Math.random() }),
          f &&
            G.log(
              `Starting a new trace with id ${
                e.getPropagationContext().traceId
              }`
            ),
          ne(null, t)
        )
      ...
      if (t && !n)
        (s = (function (t, e, n) {
          let { spanId: r, traceId: i } = t.spanContext(),
            s = !e.getScopeData().sdkProcessingMetadata[e9] && eE(t),
            a = s
              ? new e8({ ...n, parentSpanId: r, traceId: i, sampled: s })
              : new ej({ traceId: i });
          eA(t, a);
          let o = tF();
          return (
            o &&
              (o.emit("spanStart", a), n.endTimestamp && o.emit("spanEnd", a)),
            a
          );
        })(t, r, e)),
          eA(t, s);
        ...
        let n = eM(t),
          ...
          o = eE(t);
        eP((s = ns({ traceId: i, parentSpanId: a, ...e }, r, o)), n);
      } else {
        let {
          traceId: t,
          dsc: n,
        ...
        (s = ns({ traceId: t, parentSpanId: i, ...e }, r, o)), n && eP(s, n);
      }
      return (
        !(function (t) {
          if (!f) return;
          let {
            ...
            a = eN(t),
            o = a === t,
            c = `[Tracing] Starting ${s ? "sampled" : "unsampled"} ${
              o ? "root " : ""
            }span`,
            u = [`op: ${n}`, `name: ${e}`, `ID: ${i}`];
          if ((r && u.push(`parent ID: ${r}`), !o)) {
            let { op: t, description: e } = ev(a);
            u.push(`root ID: ${a.spanContext().spanId}`),
              t && u.push(`root op: ${t}`),
              e && u.push(`root description: ${e}`);
          }
          G.log(`${c}
  ${u.join("\n  ")}`);
        })(s),
    ...
    function ni(t) {
      let e = { isStandalone: (t.experimental || {}).standalone, ...t };
      if (t.startTime) {
        let n = { ...e };
        return (n.startTimestamp = ey(t.startTime)), delete n.startTime, n;
      }
      return e;
    }
    function ns(t, e, n) {
      ...
      r?.emit("beforeSampling", a, { decision: !1 });
      let o = a.parentSampled ?? n,
        c = a.spanAttributes,
        u = e.getPropagationContext(),
        [l, p, d] = e.getScopeData().sdkProcessingMetadata[e9]
          ? [!1]
          : (function (t, e, n) {
              let r, i;
              if (!t8(t)) return [!1];
              ...
              i,
              {
                ...
                parentSampled: o,
                attributes: c,
                parentSampleRate: t6(u.dsc?.sample_rate),
              },
              u.sampleRand
            ),
        _ = new e8({
    ...
    function na(t, e) {
      ...
      if (!n) return;
      let r = tF();
      return (r ? r.getOptions() : {}).parentSpanIsAlwaysRootSpan ? eN(n) : n;
    }
    function no(t) {
      return new nu((e) => {
        e(t);
    ...
    function nl(t, e) {
      ...
      (function (t, e) {
        ...
        f &&
          (((n = t).contexts = { trace: eh((r = f)), ...n.contexts }),
          (n.sdkProcessingMetadata = {
            dynamicSamplingContext: eM(r),
            ...n.sdkProcessingMetadata,
          }),
          (l = ev(eN(r)).description) &&
            !n.transaction &&
            "transaction" === n.type &&
            (n.transaction = l)),
        (i = t),
    ...
    function np(t, e) {
      ...
      nd(t, "extra", n),
        ...
        nd(t, "user", s),
        nd(t, "contexts", a),
        (t.sdkProcessingMetadata = tT(t.sdkProcessingMetadata, c, 2)),
        o && (t.level = o),
    ...
    function nf(t, e, n, r, c, l) {
      var p, d, _;
      let h,
        { normalizeDepth: g = 3, normalizeMaxBreadth: m = 1e3 } = t,
        S = {
          ...e,
          event_id: e.event_id || n.event_id || tp(),
          timestamp: e.timestamp || tm(),
        },
        y = n.integrations || t.integrations.map((t) => t.name);
      (function (t, e) {
        let { environment: n, release: r, dist: i, maxValueLength: s } = e;
        (t.environment = t.environment || n || eR),
          !t.release && r && (t.release = r),
          !t.dist && i && (t.dist = i);
        let a = t.request;
        a?.url && s && (a.url = ta(a.url, s)),
          s &&
            t.exception?.values?.forEach((t) => {
              t.value && (t.value = ta(t.value, s));
            });
      })(S, t),
        (p = S),
        (d = y).length > 0 &&
          ((p.sdk = p.sdk || {}),
          (p.sdk.integrations = [...(p.sdk.integrations || []), ...d])),
        ...
        void 0 === e.type &&
          ...
          (h = (function (t) {
            ...
            return e && l(r, e), n && l(c, n), o;
          })(t.stackParser)),
          _.exception?.values?.forEach((t) => {
            t.stacktrace?.frames?.forEach((t) => {
              t.filename && (t.debug_id = h[t.filename]);
            });
          }));
      let b = (function (t, e) {
        if (!e) return t;
        let n = t ? t.clone() : new tN();
        return n.update(e), n;
      })(r, n.captureContext);
      n.mechanism && th(S, n.mechanism);
      let v = c ? c.getEventProcessors() : [],
        E = tj().getScopeData();
      l && np(E, l.getScopeData()), b && np(E, b.getScopeData());
      let T = [...(n.attachments || []), ...E.attachments];
      return (
        ...
        (function (t, e, n, r = 0) {
          try {
            let i = (function t(e, n, r, i) {
              ...
              return (f &&
                null === a &&
                G.log(`Event processor "${s.id || "?"}" dropped event`),
              O(a))
                ? a.then((e) => t(e, n, r, i + 1))
                : t(a, n, r, i + 1);
            })(e, n, t, r);
            return O(i) ? i : no(i);
          } catch (t) {
        ...
        })([...v, ...E.eventProcessors], S, n).then((t) =>
          (t &&
            (function (t) {
              let e = {};
              if (
                ...
                let r = {
                  ...
                  ...(t.breadcrumbs && {
                    breadcrumbs: t.breadcrumbs.map((t) => ({
                      ...t,
                      ...(t.data && { data: eB(t.data, e, n) }),
                    })),
                  }),
                  ...(t.user && { user: eB(t.user, e, n) }),
                  ...(t.contexts && { contexts: eB(t.contexts, e, n) }),
                  ...(t.extra && { extra: eB(t.extra, e, n) }),
                };
                return (
                  t.contexts?.trace &&
                    r.contexts &&
                  ...
                  t.contexts?.flags &&
                    r.contexts &&
                    (r.contexts.flags = eB(t.contexts.flags, 3, n)),
                  r
                );
              })(t, g, m)
            : t
    ...
    function n_(t) {
      if (t) {
        var e;
        return (e = t) instanceof tN ||
          "function" == typeof e ||
          Object.keys(t).some((t) => nh.includes(t))
          ? { captureContext: t }
          : t;
      }
    }
    t.s(
      ["rejectedSyncPromise", () => nc, "resolvedSyncPromise", () => no],
      580611
    ),
      t.s(
        ["applyScopeDataToEvent", () => nl, "mergeScopeData", () => np],
        867890
      );
    let nh = [
      "user",
    ...
    function ng(t, e) {
      return tD().captureException(t, n_(e));
    }
    function nm(t, e) {
      return tD().captureEvent(t, e);
    }
    function nS(t, e) {
      tM().setContext(t, e);
    }
    ...
    function nv(t) {
      tM().addEventProcessor(t);
    }
    function nE(t) {
      let e = tM(),
        n = tD(),
        { userAgent: r } = u.GLOBAL_OBJ.navigator || {},
        i = tb({
        ...
        s = e.getSession();
      return (
        s?.status === "ok" && tv(s, { status: "exited" }),
        nT(),
        e.setSession(i),
        i
      );
    ...
    function nT() {
      let t = tM(),
        e = tD().getSession() || t.getSession();
      e && tE(e), nI(), t.setSession();
    }
    function nI() {
      let t = tM(),
        e = tF(),
    ...
    t.s(
      ["parseEventHintOrCaptureContext", () => n_, "prepareEvent", () => nf],
      213186
    ),
      t.s(
        [
...
//# debugId=71ce10f4-6579-5ca1-15a2-cab04d35024f
//# sourceMappingURL=5a491d688b79a4b9.js.map
