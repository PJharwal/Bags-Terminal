  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "792b61f1-9618-ae74-8223-ff389e44d2b0");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    let m = [
      ...
      f = new Set(m),
      v = new Set(["width", "height", "top", "left", "right", "bottom", ...m]),
      g = (t) => (r(t) ? t[t.length - 1] || 0 : t),
      y = (t) => t,
      x = [
        "read",
        "resolveKeyframes",
    ...
    function w(t, e) {
      ...
      return {
        schedule: x.reduce((e, r) => {
          let a = o[r];
          return (
            (e[r] = (e, r = !1, o = !1) => (
              !i && ((i = !0), (s = !0), n.isProcessing || t(p)),
              a.schedule(e, r, o)
            )),
            e
          );
        ...
        cancel: (t) => {
          for (let e = 0; e < x.length; e++) o[x[e]].cancel(t);
        },
        state: n,
        steps: o,
      };
    ...
    let {
      ...
      "undefined" != typeof requestAnimationFrame ? requestAnimationFrame : y,
      !0
    );
    function A() {
      e = void 0;
    ...
    let V = {
      now: () => (
        void 0 === e && V.set(b.isProcessing ? b.timestamp : performance.now()),
        e
      ),
      set: (t) => {
        (e = t), queueMicrotask(A);
      },
    };
    function M(t, e) {
    ...
    class C {
      ...
      add(t) {
        return M(this.subscriptions, t), () => E(this.subscriptions, t);
      }
      notify(t, e, i) {
    ...
    let j = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
      F = "data-" + j("framerAppearId");
    function B(t) {
      let e;
      return () => (void 0 === e && (e = t()), e);
    }
    let O = B(() => void 0 !== window.ScrollTimeline);
    class U {
      constructor(t) {
    ...
    let z = (t) => Array.isArray(t) && "number" == typeof t[0],
      Y,
      H =
        ((i = B(() => {
          try {
      ...
      X = (t, e, i = 10) => {
        ...
        for (let e = 0; e < n; e++) s += t(K(0, n - 1, e)) + ", ";
    ...
    let J = (t) => (e) => e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
      Q = (t) => (e) => 1 - t(1 - e),
      tt = Z(0.33, 1.53, 0.69, 0.99),
      te = Q(tt),
      ti = J(te),
      ts = (t) =>
      ...
      tm = (t, e) => (i) =>
        !!(
          ("string" == typeof i && tp.test(i) && i.startsWith(t)) ||
      ...
      tv = { ...tl, transform: (t) => Math.round(ta(0, 255, t)) },
      tg = {
        test: tm("rgb", "red"),
      ...
      tA = {
        ...tP,
        parse: (t) => tP.parse(t) / 100,
        transform: (t) => tP.transform(100 * t),
      },
      tV = {
        test: tm("hsl", "hue"),
      ...
      let e = t.toString(),
        ...
        o = e
          .replace(
            ...
            (t) => (
              tM.test(t)
                ? (s.color.push(r), n.push(tD), i.push(tM.parse(t)))
                : t.startsWith("var(")
                ? (s.var.push(r), n.push("var"), i.push(t))
                : (s.number.push(r), n.push(tC), i.push(parseFloat(t))),
              ++r,
              "${}"
            )
          )
      ...
      tB = {
        test: function (t) {
          ...
          return (
            isNaN(t) &&
            "string" == typeof t &&
            ((null == (e = t.match(tc)) ? void 0 : e.length) || 0) +
              ((null == (i = t.match(tE)) ? void 0 : i.length) || 0) >
              0
          );
        },
        parse: tL,
    ...
    function t5() {
      ...
      (t1 = !1), (t0 = !1), tQ.forEach((t) => t.complete()), tQ.clear();
    }
    function t3() {
      tQ.forEach((t) => {
    ...
    class t2 {
      ...
      scheduleResolve() {
        (this.isScheduled = !0),
          this.isAsync
            ? (tQ.add(this),
              t0 || ((t0 = !0), P.read(t3), P.resolveKeyframes(t5)))
      ...
      cancel() {
        this.isComplete || ((this.isScheduled = !1), tQ.delete(this));
      }
      resume() {
        this.isComplete || this.scheduleResolve();
      }
    }
    let t9 = (t) => (e) => "string" == typeof e && e.startsWith(t),
      t4 = t9("--"),
      t6 = t9("var(--"),
      t7 = (t) => !!t6(t) && t8.test(t.split("/*")[0].trim()),
      t8 =
    ...
    class en extends t2 {
      ...
      readKeyframes() {
        ...
        for (let i = 0; i < t.length; i++) {
          let s = t[i];
          if ("string" == typeof s && t7((s = s.trim()))) {
      ...
      resolveNoneKeyframes() {
        ...
        i.length &&
          (function (t, e, i) {
            ...
            if (s && i) for (let n of e) t[n] = tH(i, s);
          })(t, i, e);
      }
      measureInitialState() {
    ...
    class el {
      ...
      get resolved() {
        return (
          this._resolved || this.hasAttemptedResolve || (t3(), t5()),
          this._resolved
        );
      }
      onKeyframesResolved(t, e) {
        (this.resolvedAt = V.now()), (this.hasAttemptedResolve = !0);
        let {
          name: i,
          type: s,
          velocity: n,
    ...
    let ev = (t, e) => {
        ...
        let n = { ...i };
        return (t) => (
          (n.red = ep(i.red, s.red, t)),
          (n.green = ep(i.green, s.green, t)),
          (n.blue = ep(i.blue, s.blue, t)),
          (n.alpha = eu(i.alpha, s.alpha, t)),
          tg.transform(n)
        );
      },
      eg = (t, e) => (i) => e(t(i)),
    ...
    function eb(t, e) {
      let i = { ...t, ...e },
        s = {};
      for (let n in i)
        void 0 !== t[n] && void 0 !== e[n] && (s[n] = eP(t[n])(t[n], e[n]));
      return (t) => {
    ...
    let eS = (t, e) => {
      ...
      if ((ex.has(t) && !n.values.length) || (ex.has(e) && !s.values.length))
        return ex.has(t) ? (i) => (i <= 0 ? t : e) : (i) => (i >= 1 ? e : t);
      return ey(
        eT(
          (function (t, e) {
            var i;
    ...
    function eF(t = 0.3, e = 0.3) {
      let i,
          ...
          if (!ej(t, eL) && ej(t, ek))
            if (t.visualDuration) {
              ...
              let i = (function ({
                ...
                let n, r;
                y(t <= $(10), "Spring duration must be 10 seconds or less");
                let o = 1 - e;
                (o = ta(0.05, 1, o)),
                  (t = ta(0.01, 10, t / 1e3)),
                  o < 1
                    ? ((n = (e) => {
                        let s = e * o,
                          n = s * t;
                        return 0.001 - ((s - i) / eR(e, o)) * Math.exp(-n);
                      }),
                      (r = (e) => {
                        let s = e * o * t,
        ...
        x = Math.sqrt(h / d) / 1e3,
        w = 5 > Math.abs(g);
      if ((n || (n = w ? eM : eE), r || (r = w ? eC : eD), v < 1)) {
        let t = eR(x, v);
        i = (e) =>
          a -
          Math.exp(-v * x * e) *
            (((f + v * x * g) / t) * Math.sin(t * e) + g * Math.cos(t * e));
      } else if (1 === v)
        i = (t) => a - Math.exp(-x * t) * (g + (f + x * g) * t);
      else {
        ...
        i = (e) => {
          ...
          return (
            a -
            (i * ((f + v * x * g) * Math.sinh(s) + t * g * Math.cosh(s))) / t
          );
        };
      }
      let P = {
    ...
    let eO = Z(0.42, 0, 1, 1),
      ...
      eN = (t) => {
        ...
        return "string" == typeof t
          ? (y(void 0 !== e$[t], `Invalid easing type '${t}'`), e$[t])
          : t;
      };
    function eW({
      duration: t = 300,
      ...
      var n;
      let r,
        o = Array.isArray(s) && "number" != typeof s[0] ? s.map(eN) : eN(s),
        a = { done: !1, value: e[0] },
        l = (function (t, e, { clamp: i = !0, ease: s, mixer: n } = {}) {
          ...
          let a = (function (t, e, i) {
              ...
              for (let i = 0; i < r; i++) {
                let r = n(t[i], t[i + 1]);
                e && (r = ey(Array.isArray(e) ? e[i] || y : e, r)), s.push(r);
              }
              return s;
            })(e, s, n),
            l = a.length,
          ...
          e,
          {
            ease: Array.isArray(o)
              ? o
              : e.map(() => o || eI).splice(0, e.length - 1),
          }
        );
      return {
    ...
    let ez = (t) => {
      ...
      eY = { decay: eB, inertia: eB, tween: eW, keyframes: eW, spring: eF },
      eH = (t) => t / 100;
    class eK extends el {
      constructor(t) {
        super(t),
        ...
        const {
          ...
          r = (null == s ? void 0 : s.KeyframeResolver) || t2,
          o = (t, e) => this.onKeyframesResolved(t, e);
        (this.resolver = new r(n, o, e, i, s)), this.resolver.scheduleResolve();
      }
      flatten() {
        super.flatten(),
          this._resolved &&
      ...
      initPlayback(t) {
        ...
        "mirror" === o &&
          ...
          null === h.calculatedDuration && (h.calculatedDuration = eh(h));
      ...
      tick(t, e = !1) {
        ...
        g ||
          null === l ||
          (P = this.speed >= 0 ? this.currentTime >= h : this.currentTime <= 0);
        let T =
          null === this.holdTime &&
          ("finished" === this.state || ("running" === this.state && P));
        return (
          T && void 0 !== s && (w.value = ea(a, this.options, s)),
          f && f(w.value),
          T && this.finish(),
          w
        );
      ...
      get duration() {
        let { resolved: t } = this;
        return t ? t.calculatedDuration / 1e3 : 0;
      }
      get time() {
      ...
      play() {
        ...
        let { driver: t = ez, onPlay: e, startTime: i } = this.options;
    ...
    let eX = new Set(["opacity", "clipPath", "filter", "transform"]),
      eq = B(() => Object.hasOwnProperty.call(Element.prototype, "animate")),
      eG = { anticipate: ts, backInOut: ti, circInOut: to };
    class e_ extends el {
      constructor(t) {
        super(t);
        const {
      ...
      initPlayback(t, e) {
        ...
        if (
          ("string" == typeof r && H() && r in eG && (r = eG[r]),
          N((i = this.options).type) ||
            "spring" === i.type ||
            !(function t(e) {
              return !!(
                ("function" == typeof e && H()) ||
                !e ||
                ("string" == typeof e && (e in G || H())) ||
                z(e) ||
        ...
        let u = (function (
          ...
          let u = (function t(e, i) {
            if (e)
              return "function" == typeof e && H()
                ? X(e, i)
                : z(e)
                ? q(e)
                : Array.isArray(e)
                ? e.map((e) => t(e, i) || G.easeOut)
                : G[e];
          })(a, n);
          return (
        ...
        return (
          ...
          this.pendingTimeline
            ? (W(u, this.pendingTimeline), (this.pendingTimeline = void 0))
            : (u.onfinish = () => {
    ...
    let eZ = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
      eJ = { type: "keyframes", duration: 0.8 },
      eQ = { type: "keyframes", ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
      e0 =
        (t, e, i, s = {}, n, r) =>
        (o) => {
          let a = p(s, t) || {},
          ...
          return !r && e_.supports(u) ? new e_(u) : new eK(u);
        };
    function e1(t, e, { delay: i = 0, transitionOverride: s, type: n } = {}) {
      var r;
      let {
      ...
      for (let e in l) {
        ...
        if (window.MotionHandoffAnimation) {
          let i = t.props[F];
          if (i) {
            let t = window.MotionHandoffAnimation(i, e, P);
    ...
    function e5(t, e, i = {}) {
      ...
      let o = n ? () => Promise.all(e1(t, n, i)) : () => Promise.resolve(),
        a =
    ...
    function io(t, e, i, s) {
      return is(t, e, (t) => ii(t) && i(t, ir(t)), s);
    }
    let ia = (t, e) => Math.abs(t - e);
    class il {
      constructor(
        t,
        e,
        ...
        if (
          ...
          (this.updatePoint = () => {
            ...
            let i = id(this.lastMoveEventInfo, this.history),
              s = null !== this.startEvent,
              n =
                ((t = i.offset),
                (e = { x: 0, y: 0 }),
                Math.sqrt(ia(t.x, e.x) ** 2 + ia(t.y, e.y) ** 2) >= 3);
            if (!s && !n) return;
            let { point: r } = i,
              { timestamp: o } = b;
          ...
          (this.handlePointerMove = (t, e) => {
            (this.lastMoveEvent = t),
              (this.lastMoveEventInfo = ih(e, this.transformPagePoint)),
        ...
        const r = ih(ir(t), this.transformPagePoint),
          { point: o } = r,
          { timestamp: a } = b;
        this.history = [{ ...o, timestamp: a }];
        const { onSessionStart: l } = e;
        l && l(t, id(r, this.history)),
          (this.removeListeners = ey(
            io(this.contextWindow, "pointermove", this.handlePointerMove),
            io(this.contextWindow, "pointerup", this.handlePointerUp),
            io(this.contextWindow, "pointercancel", this.handlePointerUp)
          ));
      }
      updateHandlers(t) {
        this.handlers = t;
    ...
    function ig(t, e, i, s) {
      iv(t.x, e.x, i.x, s ? s.originX : void 0),
        iv(t.y, e.y, i.y, s ? s.originY : void 0);
    }
    function iy(t, e, i) {
    ...
    function iD({ top: t, left: e, right: i, bottom: s }) {
    ...
    function iB(t, e = 0, i = 1, s, n) {
      (t.min = iF(t.min, e, i, s, n)), (t.max = iF(t.max, e, i, s, n));
    }
    function iO(t, { x: e, y: i }) {
      iB(t.x, e.translate, e.scale, e.originPoint),
        iB(t.y, i.translate, i.scale, i.originPoint);
    }
    function iU(t, e) {
      (t.min = t.min + e), (t.max = t.max + e);
    }
    function iI(t, e, i, s, n = 0.5) {
      let r = eu(t.min, t.max, n);
      iB(t, e, i, r, s);
    }
    function i$(t, e) {
    ...
    class iY {
      ...
      start(t, { snapToCursor: e = !1 } = {}) {
        ...
        let s = (t) => {
            ...
            i ? this.pauseAnimation() : this.stopAnimation(),
              e && this.snapToCursor(ir(t).point);
          },
          n = (t, e) => {
            let {
              drag: i,
              ...
              iC((t) => {
                ...
                if (tP.test(e)) {
                  ...
                  if (i && i.layout) {
                    ...
                    s && (e = im(s) * (parseFloat(e) / 100));
                  }
                }
                this.originPoint[t] = e;
              }),
              n && P.postRender(() => n(t, e)),
              L(this.visualElement, "transform");
      ...
      updateAxis(t, e, i) {
        ...
        if (!i || !iH(t, s, this.currentDirection)) return;
        ...
        this.constraints &&
          ...
          (r = (function (t, { min: e, max: i }, s) {
            return (
              void 0 !== e && t < e
                ? (t = s ? eu(e, t, s.min) : Math.max(t, e))
                : void 0 !== i &&
                  t > i &&
                  (t = s ? eu(i, t, s.max) : Math.min(t, i)),
              t
            );
            ...
            iC((t) => {
              ...
              !1 !== this.constraints &&
                ...
                (this.constraints[t] =
                  ...
                  (n = {}),
                  void 0 !== i.min && (n.min = i.min - e.min),
      ...
      resolveRefConstraints() {
        ...
        let r = (function (t, e, i) {
            let s = iN(t, i),
              { scroll: n } = e;
            return n && (iU(s.x, n.offset.x), iU(s.y, n.offset.y)), s;
          })(s, n.root, this.visualElement.getTransformPagePoint()),
          o = ((t = n.layout.layoutBox), { x: iT(t.x, r.x), y: iT(t.y, r.y) });
        if (i) {
          let t = i(
            (function ({ x: t, y: e }) {
          ...
          (this.hasMutatedConstraints = !!t), t && (o = iD(t));
        }
        return o;
      }
      startAnimation(t) {
        ...
        return Promise.all(
          iC((o) => {
            if (!iH(o, e, this.currentDirection)) return;
            let l = (a && a[o]) || {};
            r && (l = { min: 0, max: 0 });
            let h = {
              type: "inertia",
      ...
      startAxisValueAnimation(t, e) {
        ...
        return (
          L(this.visualElement, t),
          i.start(e0(t, i, 0, e, this.visualElement, !1))
        );
      }
      stopAnimation() {
        iC((t) => this.getAxisMotionValue(t).stop());
      }
      pauseAnimation() {
        iC((t) => {
          var e;
        ...
        iC((t) => {
          ...
          if (e && !1 !== this.constraints) {
            ...
            s[t] =
              ...
              (o = im(i)),
              (a = im(n)) > o
                ? (r = K(n.min, n.max - o, i.min))
                : o > a && (r = K(i.min, i.max - a, n.min)),
              ta(0, 1, r));
          }
        });
      ...
      addListeners() {
        ...
        let t = io(this.visualElement.current, "pointerdown", (t) => {
    ...
    var iX,
      ...
      iJ = t.i(292296),
      iQ = t.i(379145);
    let i0 = (0, iZ.createContext)({}),
      i1 = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
    function i5(t, e) {
    ...
    let i3 = {
        correct: (t, e) => {
          ...
          let i = i5(t, e.target.x),
            s = i5(t, e.target.y);
          return `${i}% ${s}%`;
        },
      },
      i2 = {},
      { schedule: i9, cancel: i4 } = w(queueMicrotask, !1);
    class i6 extends iZ.Component {
      componentDidMount() {
        let {
            visualElement: t,
            layoutGroup: e,
    ...
    function i7(t) {
      let [e, i] = (0, iJ.usePresence)(),
        s = (0, iZ.useContext)(iQ.LayoutGroupContext);
      return (0, i_.jsx)(i6, {
        ...t,
        layoutGroup: s,
        switchLayoutGroup: (0, iZ.useContext)(i0),
        isPresent: e,
        safeToRemove: i,
      });
    }
    let i8 = {
        ...
        borderTopLeftRadius: i3,
        borderTopRightRadius: i3,
        borderBottomLeftRadius: i3,
        borderBottomRightRadius: i3,
        boxShadow: {
    ...
    let ss = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
      ...
      so = (t) => "number" == typeof t || tT.test(t);
    function sa(t, e) {
    ...
    let sl = su(0, 0.5, tr),
      sh = su(0.5, 0.95, y);
    function su(t, e, i) {
      return (s) => (s < t ? 0 : s > e ? 1 : i(K(t, e, s)));
    }
    function sd(t, e) {
    ...
    function sf(t, e, [i, s, n], r, o) {
      !(function (t, e = 0, i = 1, s = 0.5, n, r = t, o = t) {
        if (
          (tP.test(e) &&
            ((e = parseFloat(e)), (e = eu(o.min, o.max, e / 100) - o.min)),
          "number" != typeof e)
        )
          return;
        let a = eu(r.min, r.max, s);
        t === r && (a -= e),
    ...
    let sv = ["x", "scaleX", "originX"],
      sg = ["y", "scaleY", "originY"];
    function sy(t, e, i, s) {
      sf(t.x, e, sv, i ? i.x : void 0, s ? s.x : void 0),
        sf(t.y, e, sg, i ? i.y : void 0, s ? s.y : void 0);
    }
    function sx(t) {
    ...
    let sM = {
      ...
      sE = "undefined" != typeof window && void 0 !== window.MotionDebug,
      sC = ["", "X", "Y", "Z"],
    ...
    function sL({
      ...
      return class {
        ...
        addEventListener(t, e) {
          return (
            this.eventHandlers.has(t) || this.eventHandlers.set(t, new C()),
            ...
            t(e, () => {
              ...
              (this.root.updateBlockedByResize = !0),
                ...
                i1.hasAnimatedSinceResize &&
                  ((i1.hasAnimatedSinceResize = !1), this.nodes.forEach(sW));
            });
          }
            ...
            !1 !== this.options.animate &&
              ...
              this.addEventListener(
                ...
                ({
                  ...
                  let n =
                      this.options.transition || r.getDefaultTransition() || s_,
                    {
                  ...
                  if (
                    ...
                    let e = { ...p(n, "layout"), onPlay: o, onComplete: a };
        ...
        update() {
          ...
          this.isUpdating || this.nodes.forEach(s$),
            ...
            this.clearAllSnapshots();
          let t = V.now();
          (b.delta = ta(0, 1e3 / 60, t - b.timestamp)),
            (b.timestamp = t),
            (b.isProcessing = !0),
            S.update.process(b),
            S.preRender.process(b),
            S.render.process(b),
            (b.isProcessing = !1);
        }
        didUpdate() {
          this.updateScheduled ||
            ((this.updateScheduled = !0), i9.read(this.scheduleUpdate));
        }
        clearAllSnapshots() {
          this.nodes.forEach(sU), this.sharedNodes.forEach(sK);
        }
        ...
        measurePageBox() {
          ...
          if (
            ...
            t && (iU(i.x, t.offset.x), iU(i.y, t.offset.y));
          }
          return i;
        }
        removeElementScroll(t) {
          var e;
          let i = iE();
          if ((sc(i, t), null == (e = this.scroll) ? void 0 : e.wasRoot))
            return i;
          for (let e = 0; e < this.path.length; e++) {
            ...
            s !== this.root &&
              n &&
              r.layoutScroll &&
              (n.wasRoot && sc(i, t), iU(i.x, n.offset.x), iU(i.y, n.offset.y));
          }
          return i;
        }
        applyTransform(t, e = !1) {
          ...
          for (let t = 0; t < this.path.length; t++) {
            ...
            !e &&
              ...
              s.scroll &&
              s !== s.root &&
              i$(i, { x: -s.scroll.offset.x, y: -s.scroll.offset.y }),
              iL(s.latestValues) && i$(i, s.latestValues);
          }
          return iL(this.latestValues) && i$(i, this.latestValues), i;
        }
        removeTransform(t) {
          let e = iE();
          sc(e, t);
          ...
          return iL(this.latestValues) && sy(e, this.latestValues), e;
        }
        setTargetDelta(t) {
          (this.targetDelta = t),
        ...
        calcProjection() {
          ...
          if (
            ...
            i &&
              ...
              (s = !1),
            this.resolvedRelativeTargetAt === b.timestamp && (s = !1),
            s)
          )
            return;
              ...
              for (let a = 0; a < o; a++) {
                ...
                (!o ||
                  ...
                  (s &&
                    ...
                    n.scroll &&
                    n !== n.root &&
                    i$(t, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }),
                  r && ((e.x *= r.x.scale), (e.y *= r.y.scale), iO(t, r)),
                  s && iL(n.latestValues) && i$(t, n.latestValues));
              }
                ...
                (function (t, e, i, s, n, r) {
                  ...
                  for (let n = 0; n < sn; n++) {
                    ...
                    (void 0 !== o || void 0 !== a) &&
                      ...
                      a || (a = 0),
                      0 === o || 0 === a || so(o) === so(a)
                        ? ((t[r] = Math.max(eu(sr(o), sr(a), s), 0)),
                          (tP.test(a) || tP.test(o)) && (t[r] += "%"))
                        : (t[r] = a));
                  }
                  (e.rotate || i.rotate) &&
                    (t.rotate = eu(e.rotate || 0, i.rotate || 0, s));
        ...
        applyTransformsToTarget() {
          ...
          if (e && i && s) {
            if (
              ...
              this.layout &&
              s &&
              s0(this.options.animationType, this.layout.layoutBox, s.layoutBox)
            ) {
              i = this.target || iE();
              let e = im(this.layout.layoutBox.x);
              (i.x.min = t.target.x.min), (i.x.max = i.x.min + e);
              let s = im(this.layout.layoutBox.y);
              (i.y.min = t.target.y.min), (i.y.max = i.y.min + s);
            }
            sc(e, i),
              i$(e, n),
              ig(this.projectionDeltaWithTransform, this.layoutCorrected, e, n);
          }
        }
        registerSharedNode(t, e) {
          this.sharedNodes.has(t) || this.sharedNodes.set(t, new sV()),
        ...
        resetSkewAndRotation() {
          ...
          for (let e = 0; e < sC.length; e++)
            sk(`rotate${sC[e]}`, t, s, this.animationValues),
              sk(`skew${sC[e]}`, t, s, this.animationValues);
        ...
        getProjectionStyles(t) {
          ...
          if (this.needsReset)
            return (
              ...
              (s.opacity = ""),
              (s.pointerEvents =
                si(null == t ? void 0 : t.pointerEvents) || ""),
    ...
    function sF(t) {
      ...
      if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
        ...
        let a = iV();
        r
          ? ig(a, t.applyTransform(s, !0), i.measuredBox)
          : ig(a, e, i.layoutBox);
        let l = !sw(o),
          h = !1;
        if (!t.resumeFrom) {
    ...
    function sq(t, e, i, s) {
      (t.min = eu(e.min, i.min, s)), (t.max = eu(e.max, i.max, s));
    }
    function sG(t) {
    ...
    let s_ = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
      ...
      sJ = sZ("applewebkit/") && !sZ("chrome/") ? Math.round : y;
    function sQ(t) {
      (t.min = sJ(t.min)), (t.max = sJ(t.max));
    }
    function s0(t, e, i) {
      return (
        "position" === t ||
        ("preserve-aspect" === t && !(0.2 >= Math.abs(sS(e) - sS(i))))
      );
    }
    function s1(t) {
      var e;
    ...
    let s5 = sL({
        attachResizeListener: (t, e) => is(t, "resize", e),
        measureScroll: () => ({
    ...
    function s4(t) {
      return (e) => {
        "touch" === e.pointerType || ie.x || ie.y || t(e);
      };
    }
    function s6(t, e, i) {
      let { props: s } = t;
    ...
    let nr = new WeakMap(),
      ...
      nh = { some: 0, all: 1 },
      nu = (0, iZ.createContext)({ strict: !1 });
    var nd = t.i(709344);
    let nc = (0, iZ.createContext)({});
    function np(t) {
    ...
    let ng = {
      ...
      ny = {};
    for (let t in ng) ny[t] = { isEnabled: (e) => ng[t].some((t) => !!e[t]) };
    let nx = Symbol.for("motionComponentSymbol");
    var nw = t.i(794804),
      nP = t.i(190160);
    let nT = [
      "animate",
    ...
    function nb(t) {
      ...
      else if (nT.indexOf(t) > -1 || /[A-Z]/u.test(t)) return !0;
      return !1;
    }
    var nS = t.i(747734);
    let nA = (t) => (e, i) => {
        let s = (0, iZ.useContext)(nc),
          r = (0, iZ.useContext)(nw.PresenceContext),
          o = () =>
            (function (
              {
        ...
        return i ? o() : (0, nS.useConstant)(o);
      },
      nV = (t, e) => (e && "number" == typeof t ? e.transform(t) : t),
      nM = {
        x: "translateX",
        y: "translateY",
        z: "translateZ",
    ...
    let nD = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
    ...
    function nL(
      ...
      m.transform && (v && (f.transform = m.transform), delete m.transform),
        v &&
          (void 0 !== n || void 0 !== r || f.transform) &&
          ((c = nk(void 0 !== n ? n : 0.5, v.x, v.width)),
          (p = nk(void 0 !== r ? r : 0.5, v.y, v.height)),
          (f.transformOrigin = `${c} ${p}`)),
        void 0 !== e && (m.x = e),
        void 0 !== i && (m.y = i),
        void 0 !== s && (m.scale = s),
        void 0 !== o &&
    ...
    let nj = () => ({
      ...
      nF = () => ({ ...nj(), attrs: {} }),
      nB = (t) => "string" == typeof t && "svg" === t.toLowerCase();
    ...
    function nI(t, e, i, s) {
      for (let i in (nO(t, e, void 0, s), e.attrs))
        t.setAttribute(nU.has(i) ? i : j(i), e.attrs[i]);
    }
    ...
    let nz = ["x", "y", "width", "height", "cx", "cy", "r"],
      nY = {
        useVisualState: nA({
          ...
          onUpdate: ({
            ...
            o &&
              P.read(() => {
                ...
                P.render(() => {
                  nL(s, n, nB(i.tagName), t.transformTemplate), nI(i, s);
                });
              });
          },
        }),
    ...
    function nK(t, e, i) {
      for (let s in e) k(e[s]) || n$(s, i) || (t[s] = e[s]);
    }
    let nX = new Set([
      "animate",
      "exit",
    ...
    try {
      ...
      })().default) && (nG = (t) => (t.startsWith("on") ? !nq(t) : iX(t)));
    } catch (t) {}
    let n_ = { current: null },
      nZ = { current: !1 },
      nJ = [...ei, tM, tB],
    ...
    class n1 {
        ...
        (this.current = null),
          ...
          (this.scheduleRender = () => {
            ...
            this.renderScheduledAt < t &&
              ((this.renderScheduledAt = t), P.render(this.render, !1, !0));
          });
        const { latestValues: a, renderState: l, onUpdate: h } = r;
        (this.onUpdate = h),
          (this.latestValues = a),
          (this.baseTarget = { ...a }),
          ...
          (this.isControllingVariants = np(e)),
      ...
      mount(t) {
        (this.current = t),
          ...
          nZ.current ||
            (function () {
              if (((nZ.current = !0), nv.isBrowser))
                if (window.matchMedia) {
                  let t = window.matchMedia("(prefers-reduced-motion)"),
                    e = () => (n_.current = t.matches);
                  t.addListener(e), e();
                } else n_.current = !1;
            })(),
          (this.shouldReduceMotion =
            "never" !== this.reducedMotionConfig &&
            ("always" === this.reducedMotionConfig || n_.current)),
          this.parent && this.parent.children.add(this),
      ...
      update(t, e) {
        ...
        (this.prevMotionValues = (function (t, e, i) {
          for (let s in e) {
            let n = e[s],
              r = i[s];
            if (k(n)) t.addValue(s, n);
            else if (k(r)) t.addValue(s, R(n, { owner: t }));
            else if (r !== n)
              if (t.hasValue(s)) {
                let e = t.getValue(s);
                ...
                t.addValue(s, R(void 0 !== e ? e : n, { owner: t }));
              }
          }
      ...
      getValue(t, e) {
        ...
        return (
          void 0 === i &&
            void 0 !== e &&
            ((i = R(null === e ? void 0 : e, { owner: this })),
            this.addValue(t, i)),
          i
        );
      }
      readValue(t, e) {
        ...
        if (null != s) {
          ...
          if (
            ...
            let i;
            (i = s), !nJ.find(ee(i)) && tB.test(e) && (s = tH(t, e));
          }
          this.setBaseTarget(t, k(s) ? s.get() : s);
        }
        return k(s) ? s.get() : s;
      }
      setBaseTarget(t, e) {
      ...
      on(t, e) {
        return (
          this.events[t] || (this.events[t] = new C()), this.events[t].add(e)
        );
      }
      notify(t, ...e) {
    ...
    class n5 extends n1 {
      constructor() {
        super(...arguments), (this.KeyframeResolver = en);
      }
      ...
      readValueFromInstance(t, e) {
        ...
        }
        {
          let i = window.getComputedStyle(t),
            s = (t4(e) ? i.getPropertyValue(e) : i[e]) || 0;
    ...
    class n2 extends n5 {
      ...
      readValueFromInstance(t, e) {
        ...
        return (e = nU.has(e) ? e : j(e)), t.getAttribute(e);
      }
      scrapeMotionValuesFromProps(t, e, i) {
        return nW(t, e, i);
      }
      build(t, e, i) {
        nL(t, e, this.isSVGTag, i.transformTemplate);
      }
      ...
      ((iq = {
                  ...
                  (t.animationState = (function (t) {
                          ...
                          e.map(({ animation: e, options: i }) =>
                            (function (t, e, i = {}) {
                              ...
                              if (
                                ...
                                s = Promise.all(e.map((e) => e5(t, e, i)));
                              else if ("string" == typeof e) s = e5(t, e, i);
                              else {
                                let n =
                                  "function" == typeof e
                                    ? u(t, e, i.custom)
                                    : e;
                                s = Promise.all(e1(t, n, i));
                              }
                              return s.then(() => {
                                t.notify("AnimationComplete", e);
                              });
                    ...
                    function h(h) {
                      ...
                      for (let e = 0; e < e4; e++) {
                        ...
                        let c = e9[e],
                          x = i[c],
                          w = void 0 !== u[c] ? u[c] : d[c],
                          P = a(w),
                          T = c === h ? x.isActive : null;
                        !1 === T && (v = e);
                        let b = w === d[c] && w !== u[c] && P;
                        if (
            ...
            startObserver() {
              ...
              let { viewport: i = {} } = this.node.getProps(),
                ...
                a = {
                  ...
                  rootMargin: n,
                  threshold: "number" == typeof r ? r : nh[r],
                },
                l = (t) => {
              ...
              return (
                ...
                (e = (function ({ root: t, ...e }) {
                  ...
                  return (
                    s[n] ||
                      (s[n] = new IntersectionObserver(nl, { root: t, ...e })),
                    s[n]
                  );
                })(a)),
                nr.set(t, l),
            ...
            mount() {
              ...
              t &&
                (this.unmount = (function (t, e, i = {}) {
                  let [s, n, r] = s9(t, i),
                    o = (t) => {
                      ...
                      let r = e(t),
                        ...
                        a = (t) => {
                          o(t, i.useGlobalTarget || s7(s, t.target));
                        },
                        l = (t) => {
                          o(t, !1);
                        };
                  ...
                  t,
                  (t) => (
                    nn(this.node, t, "Start"),
                    (t, { success: e }) =>
                      nn(this.node, t, e ? "End" : "Cancel")
                  ),
        ...
        focus: {
          Feature: class extends e8 {
            ...
            mount() {
              this.unmount = ey(
                is(this.node.current, "focus", () => this.onFocus()),
                is(this.node.current, "blur", () => this.onBlur())
              );
            }
            unmount() {}
          },
            ...
            mount() {
              ...
              t &&
                (this.unmount = (function (t, e, i = {}) {
                  ...
                  t,
                  (t) => (
                    s6(this.node, t, "Start"), (t) => s6(this.node, t, "End")
                  )
                ));
            }
            unmount() {}
          ...
          Feature: class extends e8 {
            ...
            createPanHandlers() {
              ...
              return {
                ...
                onMove: i,
                onEnd: (t, e) => {
                  delete this.session, s && P.postRender(() => s(t, e));
                },
              };
            }
            mount() {
              this.removePointerDownListener = io(
                this.node.current,
                "pointerdown",
        ...
        layout: { ProjectionNode: s2, MeasureLayout: i7 },
      }),
      (iG = (t, e) =>
        nb(t) ? new n2(e) : new n3(e, { allowProjection: t !== iZ.Fragment })),
      function (t, { forwardMotionProps: e } = { forwardMotionProps: !1 }) {
        return (function ({
          ...
          function l(t, r) {
            ...
            let l,
              h = {
                ...(0, iZ.useContext)(nd.MotionConfigContext),
                ...t,
                layoutId: (function ({ layoutId: t }) {
                  let e = (0, iZ.useContext)(iQ.LayoutGroupContext).id;
              ...
              c = s(t, u);
            if (!u && nv.isBrowser) {
              (0, iZ.useContext)(nu).strict;
              let t = (function (t) {
                let { drag: e, layout: i } = ny;
                if (!e && !i) return {};
                let s = { ...e, ...i };
                return {
                  MeasureLayout:
              ...
              (l = t.MeasureLayout),
                (d.visualElement = (function (t, e, i, s, n) {
                  var r, o;
                  let { visualElement: a } = (0, iZ.useContext)(nc),
                    l = (0, iZ.useContext)(nu),
                    h = (0, iZ.useContext)(nw.PresenceContext),
                    u = (0, iZ.useContext)(
                      nd.MotionConfigContext
                    ).reducedMotion,
                    d = (0, iZ.useRef)(null);
                  (s = s || l.renderer),
                    !d.current &&
                  ...
                  return (
                    (0, nP.useIsomorphicLayoutEffect)(() => {
                      c &&
                        ((m.current = !0),
                ...
                })(n, c, h, e, t.ProjectionNode));
            }
            return (0, i_.jsxs)(nc.Provider, {
              value: d,
              children: [
                l && d.visualElement
                  ? (0, i_.jsx)(l, { visualElement: d.visualElement, ...h })
                  : null,
                i(
                  n,
                  t,
          ...
          t &&
            (function (t) {
              for (let e in t) ny[e] = { ...ny[e], ...t[e] };
            })(t),
            (l.displayName = `motion.${
              "string" == typeof n
                ? n
                : `create(${
                    null != (o = null != (r = n.displayName) ? r : n.name)
                      ? o
                      : ""
                  })`
            }`);
          let h = (0, iZ.forwardRef)(l);
          return (h[nx] = n), h;
        })({
          ...(nb(t) ? nY : nH),
          preloadedFeatures: iq,
          useRender: (function (t = !1) {
            return (e, i, s, { latestValues: n }, r) => {
              let o = (
                  nb(e)
                    ? function (t, e, i, s) {
                        let n = (0, iZ.useMemo)(() => {
                          let i = nF();
                          return (
                            nL(i, e, nB(s), t.transformTemplate),
                ...
                l = e !== iZ.Fragment ? { ...a, ...o, ref: s } : {},
                { children: h } = i,
                u = (0, iZ.useMemo)(() => (k(h) ? h.get() : h), [h]);
              return (0, iZ.createElement)(e, { ...l, children: u });
            };
          })(e),
          createVisualElement: iG,
          Component: t,
        });
      })
    );
    t.s(["motion", () => n9], 530589);
  },
]);

//# debugId=792b61f1-9618-ae74-8223-ff389e44d2b0
//# sourceMappingURL=e42a786ec6bd2185.js.map
