  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "8850dda1-3c8a-ccbd-9eae-63ff5653dfa8");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
          ...
          let n = e(t),
            o = (t, e) => {
              window.removeEventListener("pointerup", a),
                ...
                $(t) &&
                  I.has(s) &&
                  (I.delete(s), "function" == typeof n && n(t, { success: e }));
            },
            a = (t) => {
              o(t, i.useGlobalTarget || F(s, t.target));
            },
            l = (t) => {
              o(t, !1);
            };
                ...
                ((t, e) => {
                  ...
                  let s = U(() => {
                    ...
                    i.addEventListener("keyup", t, e),
                      i.addEventListener("blur", () => N(i, "cancel"), e);
                  });
    ...
    let z = [
      ...
      K = new Set(z);
    t.s(["transformPropOrder", () => z, "transformProps", () => K], 681384);
    let Y = new Set([
        "width",
        "height",
        "top",
      ...
      H = (t) => (n(t) ? t[t.length - 1] || 0 : t);
    t.s(
      ["isCustomValue", () => G, "resolveFinalValueInKeyframes", () => H],
      87519
    );
    let X = [
      "read",
    ...
    t.s(["createRenderBatcher", () => q], 4840);
    let {
      schedule: _,
      cancel: Z,
      state: J,
    ...
    let te = {
      now: () => (
        void 0 === e &&
          te.set(J.isProcessing ? J.timestamp : performance.now()),
        e
      ),
      set: (t) => {
        (e = t), queueMicrotask(tt);
      },
    };
    function ti(t, e) {
    ...
    class tn {
      ...
      add(t) {
        return ti(this.subscriptions, t), () => ts(this.subscriptions, t);
      }
      notify(t, e, i) {
    ...
    t.s(["collectMotionValues", () => to, "motionValue", () => tl], 271329);
    let tu = (t) => !!(t && t.getVelocity);
    function th(t, e) {
      let i = t.getValue("willChange");
      if (tu(i) && i.add) return i.add(e);
    }
    t.s(["isMotionValue", () => tu], 298549);
    let tc = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase();
    t.s(["camelToDash", () => tc], 964600);
    let td = "data-" + tc("framerAppearId");
    function tp(t) {
      return t.props[td];
    }
    t.s(["optimizedAppearDataAttribute", () => td], 979386),
      t.s(["getOptimisedAppearId", () => tp], 767369);
    let tm = (t, e, i) =>
    ...
    let tv = (t) => (e) => e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
      tg = (t) => (e) => 1 - t(1 - e),
      ty = tf(0.33, 1.53, 0.69, 0.99),
      tx = tg(ty),
      tP = tv(tx),
      tT = (t) =>
      ...
      tS = tv(tw);
    t.s(
      ["circIn", () => tw, "circInOut", () => tS, "circOut", () => tb],
      268638
    );
    let tA = (t) => /^0[^.\s]+$/u.test(t);
    t.s(["isZeroValueString", () => tA], 869175);
    let tV = (t, e, i) => (i > e ? e : i < t ? t : i);
    t.s(["clamp", () => tV], 974780);
    let tM = {
      ...
      tF = { ...tM, transform: (t) => Math.round(tV(0, 255, t)) },
      tj = {
        test: tB("rgb", "red"),
    ...
    let tY = {
      ...
      tG = {
        test: (t) => tj.test(t) || tO.test(t) || tY.test(t),
        parse: (t) =>
          tj.test(t) ? tj.parse(t) : tY.test(t) ? tY.parse(t) : tO.parse(t),
        transform: (t) =>
          "string" == typeof t
            ? t
      ...
      let e = t.toString(),
        ...
        o = e
          .replace(
            ...
            (t) => (
              tG.test(t)
                ? (s.color.push(n), r.push(tq), i.push(tG.parse(t)))
                : t.startsWith("var(")
                ? (s.var.push(n), r.push("var"), i.push(t))
                : (s.number.push(n), r.push(tX), i.push(parseFloat(t))),
              ++n,
              "${}"
            )
          )
      ...
      t1 = {
        test: function (t) {
          ...
          return (
            isNaN(t) &&
            "string" == typeof t &&
            ((null == (e = t.match(tR)) ? void 0 : e.length) || 0) +
              ((null == (i = t.match(tH)) ? void 0 : i.length) || 0) >
              0
          );
        },
        parse: tJ,
    ...
    t.s(["analyseComplexValue", () => tZ, "complex", () => t1], 102254);
    let t2 = new Set(["brightness", "contrast", "saturate", "opacity"]);
    function t6(t) {
    ...
    let t3 = /\b([a-z-]*)\(.*?\)/gu,
      t5 = {
        ...
        getAnimatableNone: (t) => {
          let e = t.match(t3);
          return e ? e.map(t6).join(" ") : t;
        },
      },
      t9 = { ...tM, transform: Math.round },
      t4 = {
        borderWidth: t$,
        borderTopWidth: t$,
        borderRightWidth: t$,
    ...
    t.s(["getDefaultValueType", () => t7], 726553),
      t.s(["getAnimatableNone", () => et], 573464);
    ...
    class em {
      ...
      scheduleResolve() {
        (this.isScheduled = !0),
          this.isAsync
            ? (el.add(this),
              eu || ((eu = !0), _.read(ed), _.resolveKeyframes(ec)))
    ...
    t.s(
      ["KeyframeResolver", () => em, "flushKeyframeResolvers", () => ep],
      648838
    );
    let ef = (t) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t);
    t.s(["isNumericalString", () => ef], 558213);
    let ev = (t) => (e) => "string" == typeof e && e.startsWith(t),
      eg = ev("--"),
      ey = ev("var(--"),
    ...
    t.s(
      ["isCSSVariableName", () => eg, "isCSSVariableToken", () => ex],
      970272
    );
    let eT = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u,
      ew = (t) => (e) => e.test(t);
    t.s(["testValueType", () => ew], 323016);
    let eb = [
        tM,
        t$,
        tN,
      ...
      eS = (t) => eb.find(ew(t));
    t.s(
      ["dimensionValueTypes", () => eb, "findDimensionValueType", () => eS],
      70170
    );
    class eA extends em {
      ...
      resolveNoneKeyframes() {
        ...
        for (let e = 0; e < t.length; e++) {
          ...
          ("number" == typeof (s = t[e])
            ? 0 === s
            : null === s || "none" === s || "0" === s || tA(s)) && i.push(e);
        }
        i.length &&
          (function (t, e, i) {
            let s,
            ...
            if (s && i) for (let r of e) t[r] = et(i, s);
          })(t, i, e);
      }
      measureInitialState() {
    ...
    t.s(["DOMKeyframesResolver", () => eA], 935902);
    let eV = (t, e) =>
        "zIndex" !== e &&
        !!(
          "number" == typeof t ||
    ...
    class eD {
      ...
      get resolved() {
        return (
          this._resolved || this.hasAttemptedResolve || ep(), this._resolved
        );
      }
    ...
    let ej = (t, e) => {
        ...
        let r = { ...i };
        return (t) => (
          (r.red = eB(i.red, s.red, t)),
          (r.green = eB(i.green, s.green, t)),
          (r.blue = eB(i.blue, s.blue, t)),
          (r.alpha = eE(i.alpha, s.alpha, t)),
          tj.transform(r)
        );
      },
      eO = (t, e) => (i) => e(t(i)),
    ...
    function ez(t, e) {
      let i = { ...t, ...e },
        s = {};
      for (let r in i)
        void 0 !== t[r] && void 0 !== e[r] && (s[r] = e$(t[r])(t[r], e[r]));
      return (t) => {
    ...
    let eK = (t, e) => {
      ...
      if ((eU.has(t) && !r.values.length) || (eU.has(e) && !s.values.length))
        return eU.has(t) ? (i) => (i <= 0 ? t : e) : (i) => (i >= 1 ? e : t);
      return eI(
        eW(
          (function (t, e) {
            var i;
    ...
    function eG(t, e, i) {
      ...
      return (s = i - t(n)), (r = e - n) ? (1e3 / r) * s : 0;
    }
    let eH = 0.01,
      eX = 2,
      eq = 0.005,
    ...
    function e1(t = 0.3, e = 0.3) {
      let i,
          ...
          if (!e0(t, eQ) && e0(t, eJ))
            if (t.visualDuration) {
              let i = (2 * Math.PI) / (1.2 * t.visualDuration),
                s = i * i,
                r = 2 * tV(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(s);
                ...
                (o = tV(0.05, 1, o)),
                  ...
                  o < 1
                    ? ((r = (e) => {
                        let s = e * o,
                          r = s * t;
                        return 0.001 - ((s - i) / eZ(e, o)) * Math.exp(-r);
                      }),
                      (n = (e) => {
                        let s = e * o * t,
        ...
        T = g(Math.sqrt(u / c)),
        b = 5 > Math.abs(P);
      if ((r || (r = b ? eH : eX), n || (n = b ? eq : e_), x < 1)) {
        let t = eZ(T, x);
        i = (e) =>
          a -
          Math.exp(-x * T * e) *
    ...
    let e6 = tf(0.42, 0, 1, 1),
      ...
      e4 = (t) => {
        ...
        return "string" == typeof t
          ? (p(void 0 !== e9[t], `Invalid easing type '${t}'`), e9[t])
          : t;
      };
    function e8(t, e, { clamp: i = !0, ease: s, mixer: r } = {}) {
      let n = t.length;
      if (
        (p(
          n === e.length,
      ...
      let a = (function (t, e, i) {
          ...
          for (let i = 0; i < n; i++) {
            let n = r(t[i], t[i + 1]);
            e && (n = eI(Array.isArray(e) ? e[i] || p : e, n)), s.push(n);
          }
          return s;
        })(e, s, r),
        l = a.length,
    ...
    function e7({
      ...
      var r;
      let n,
        o = Array.isArray(s) && "number" != typeof s[0] ? s.map(e4) : e4(s),
        a = { done: !1, value: e[0] },
        l = e8(
          ((r =
            i && i.length === e.length
          ...
          e,
          {
            ease: Array.isArray(o)
              ? o
              : e.map(() => o || e5).splice(0, e.length - 1),
          }
        );
      return {
    ...
    class is extends eD {
      constructor(t) {
        ...
        const {
          ...
          n = (null == s ? void 0 : s.KeyframeResolver) || em,
      ...
      tick(t, e = !1) {
        ...
        return (
          w && void 0 !== s && (P.value = eC(a, this.options, s)),
          f && f(P.value),
          w && this.finish(),
          P
        );
    ...
    let ir = new Set(["opacity", "clipPath", "filter", "transform"]),
      io = m(() => Object.hasOwnProperty.call(Element.prototype, "animate")),
      ia = { anticipate: tT, backInOut: tP, circInOut: tS };
    class il extends eD {
      constructor(t) {
        super(t);
        const {
      ...
      initPlayback(t, e) {
        ...
        if (
          ("string" == typeof n && M() && n in ia && (n = ia[n]),
    ...
    let iu = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
      ...
      id =
        ...
        (o) => {
          ...
          return !n && il.supports(h) ? new il(h) : new is(h);
        };
    function ip(t, e, { delay: i = 0, transitionOverride: s, type: r } = {}) {
      var n;
      let {
    ...
    function im(t, e, i = {}) {
      ...
      let o = r ? () => Promise.all(ip(t, r, i)) : () => Promise.resolve(),
        a =
    ...
    t.s(["animateMotionValue", () => id], 982363);
    let ig = d.length,
      iy = [...c].reverse(),
      ix = c.length;
    function iP(t = !1) {
    ...
    t.s(["Feature", () => iw], 311129);
    let ib = 0,
      iS = {
        animation: {
          Feature: class extends iw {
            constructor(t) {
              super(t),
                t.animationState ||
                          ...
                          e.map(({ animation: e, options: i }) =>
                            (function (t, e, i = {}) {
                              ...
                              if (
                                ...
                                s = Promise.all(e.map((e) => im(t, e, i)));
                              else if ("string" == typeof e) s = im(t, e, i);
                              else {
                                let r =
                                  "function" == typeof e
                                    ? h(t, e, i.custom)
                                    : e;
                                s = Promise.all(ip(t, r, i));
                              }
                              return s.then(() => {
                                t.notify("AnimationComplete", e);
                              });
    ...
    t.s(["animations", () => iS], 223070),
      t.s(["addDomEvent", () => iA], 426368);
    let iM = (t) => (e) => j(e) && t(e, iV(e));
    function iC(t, e, i, s) {
      return iA(t, e, iM(i), s);
    }
    t.s(["addPointerInfo", () => iM, "extractEventInfo", () => iV], 665536);
    ...
    class iE {
      constructor(
          ...
          (this.updatePoint = () => {
            ...
            let i = iB(this.lastMoveEventInfo, this.history),
              ...
              r =
                ((t = i.offset),
                (e = { x: 0, y: 0 }),
                Math.sqrt(iD(t.x, e.x) ** 2 + iD(t.y, e.y) ** 2) >= 3);
            if (!s && !r) return;
            let { point: n } = i,
              { timestamp: o } = J;
        ...
        const n = iR(iV(t), this.transformPagePoint),
          { point: o } = n,
          { timestamp: a } = J;
        this.history = [{ ...o, timestamp: a }];
        const { onSessionStart: l } = e;
        l && l(t, iB(n, this.history)),
    ...
    function iQ({ top: t, left: e, right: i, bottom: s }) {
    ...
    t.s(["createBox", () => iZ, "createDelta", () => iq], 181699),
      t.s(["eachAxis", () => iJ], 176673);
    function i3(t, e, i) {
      return i + e * (t - i);
    }
    function i5(t, e, i, s, r) {
      return void 0 !== r && (t = s + r * (t - s)), s + i * (t - s) + e;
    }
    function i9(t, e = 0, i = 1, s, r) {
      (t.min = i5(t.min, e, i, s, r)), (t.max = i5(t.max, e, i, s, r));
    }
    function i4(t, { x: e, y: i }) {
      i9(t.x, e.translate, e.scale, e.originPoint),
        i9(t.y, i.translate, i.scale, i.originPoint);
    }
    function i8(t, e, i, s = !1) {
      let r,
        n,
        o = i.length;
      if (o) {
        ...
        for (let a = 0; a < o; a++) {
          ...
          (!o || !o.props.style || "contents" !== o.props.style.display) &&
            (s &&
              ...
              r.scroll &&
              r !== r.root &&
              se(t, { x: -r.scroll.offset.x, y: -r.scroll.offset.y }),
            n && ((e.x *= n.x.scale), (e.y *= n.y.scale), i4(t, n)),
            s && i2(r.latestValues) && se(t, r.latestValues));
        }
    ...
    function st(t, e, i, s, r = 0.5) {
      let n = eE(t.min, t.max, r);
      i9(t, e, i, n, s);
    }
    function se(t, e) {
      st(t.x, e.x, e.scaleX, e.scale, e.originX),
        st(t.y, e.y, e.scaleY, e.scale, e.originY);
    }
    function si(t, e) {
      return iQ(
        (function (t, e) {
    ...
    function ss(t, e, i) {
      let s = si(t, i),
        { scroll: r } = e;
      return r && (i7(s.x, r.offset.x), i7(s.y, r.offset.y)), s;
    }
    t.s(
      [
        "has2DTranslate",
      ...
      t.s(["measurePageBox", () => ss, "measureViewportBox", () => si], 245504);
    ...
    class so {
      ...
      updateAxis(t, e, i) {
        ...
        this.constraints &&
          ...
          (n = (function (t, { min: e, max: i }, s) {
            return (
              void 0 !== e && t < e
                ? (t = s ? eE(e, t, s.min) : Math.max(t, e))
                : void 0 !== i &&
                  t > i &&
                  (t = s ? eE(i, t, s.max) : Math.min(t, i)),
              t
            );
      ...
      resolveConstraints() {
        ...
        e && iF(e)
          ...
          ? (this.constraints = (function (
              ...
              return { x: iK(t.x, i, r), y: iK(t.y, e, s) };
            })(s.layoutBox, e))
          : (this.constraints = !1),
          (this.elastic = (function (t = 0.35) {
            return (
              !1 === t ? (t = 0) : !0 === t && (t = 0.35),
              { x: iG(t, "left", "right"), y: iG(t, "top", "bottom") }
            );
          })(i)),
          r !== this.constraints &&
            s &&
      ...
      resolveRefConstraints() {
        ...
        let n = ss(s, r.root, this.visualElement.getTransformPagePoint()),
          o = ((t = r.layout.layoutBox), { x: iY(t.x, n.x), y: iY(t.y, n.y) });
        if (i) {
          let t = i(
            (function ({ x: t, y: e }) {
  ...
  (t) => {
    ...
    function J(t, e, [i, s, r], n, o) {
      !(function (t, e = 0, i = 1, s = 0.5, r, n = t, o = t) {
        ...
        t === n && (a -= e),
          (t.min = Z(t.min, e, i, a, r)),
          (t.max = Z(t.max, e, i, a, r));
    ...
    function tl(t) {
      return (0, _.calcLength)(t.x) / (0, _.calcLength)(t.y);
    }
    function tu(t, e) {
      return (
        t.translate === e.translate &&
        ...
        applyTransformsToTarget() {
          ...
          if (e && i && s) {
            if (
              ...
              let e = (0, _.calcLength)(this.layout.layoutBox.x);
              (i.x.min = t.target.x.min), (i.x.max = i.x.min + e);
              let s = (0, _.calcLength)(this.layout.layoutBox.y);
    ...
    function tT(t) {
      ...
      if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
        ...
        (0, _.calcBoxDelta)(o, e, i.layoutBox);
        let a = (0, ti.createDelta)();
        n
          ? (0, _.calcBoxDelta)(a, t.applyTransform(s, !0), i.measuredBox)
          : (0, _.calcBoxDelta)(a, e, i.layoutBox);
        let l = !tr(o),
          u = !1;
        if (!t.resumeFrom) {
          ...
          if (s && !s.resumeFrom) {
            ...
            if (r && n) {
              ...
              (0, _.calcRelativePosition)(o, i.layoutBox, r.layoutBox);
              let a = (0, ti.createBox)();
              (0, _.calcRelativePosition)(a, e, n.layoutBox),
                ta(o, a) || (u = !0),
    ...
    function tN(t, e, i) {
      return (
        "position" === t ||
        ("preserve-aspect" === t && !(0, _.isNear)(tl(e), tl(i), 0.2))
      );
    }
    function t$(t) {
      var e;
      ...
      mount() {
        ...
        t &&
          (this.unmount = (0, tX.hover)(
            t,
            (t) => (t_(this.node, t, "Start"), (t) => t_(this.node, t, "End"))
          ));
      }
      unmount() {}
    }
  ...
  (t) => {
    ...
    try {
      ...
      })().default) && (Z = (t) => (t.startsWith("on") ? !_(t) : e(t)));
    } catch (t) {}
    var J = t.i(245504);
    t.i(247167);
    var Q = t.i(167406),
...
//# debugId=8850dda1-3c8a-ccbd-9eae-63ff5653dfa8
//# sourceMappingURL=ed175383fedf4175.js.map
