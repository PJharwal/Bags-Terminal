  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "1570fbee-75a1-5508-0e3b-d6d34027028c");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    class p {
      ...
      writeU64(e) {
        this.maybeResize(),
          this.writeBuffer(n.Buffer.from(new u.default(e).toArray("le", 8)));
      }
      writeU128(e) {
        this.maybeResize(),
          this.writeBuffer(n.Buffer.from(new u.default(e).toArray("le", 16)));
      }
      writeU256(e) {
        this.maybeResize(),
          this.writeBuffer(n.Buffer.from(new u.default(e).toArray("le", 32)));
      }
      writeU512(e) {
        this.maybeResize(),
          this.writeBuffer(n.Buffer.from(new u.default(e).toArray("le", 64)));
      }
      writeBuffer(e) {
        ...
        if ("string" == typeof n) i[`write${b(n)}`](r);
          ...
          switch (n.kind) {
            ...
            case "map":
              i.writeU32(r.size),
                r.forEach((r, s) => {
                  m(e, t, s, n.key, i), m(e, t, r, n.value, i);
                });
              break;
            default:
    ...
    function S(e, t, r) {
      ...
      if ("struct" === n.kind) {
        let n = {};
        for (let [i, s] of e.get(t).fields) n[i] = k(e, i, s, r);
        return new t(n);
      }
      if ("enum" === n.kind) {
        let i = r.readU8();
  ...
  (e, t, r) => {
    ...
    class _ extends o {
      constructor(e, t, r) {
        ...
        if (
          !((t instanceof c && t.isCount()) || (Number.isInteger(t) && 0 <= t))
        )
          throw TypeError(
            "count must be non-negative integer or an unsigned integer ExternalLayout"
          );
        let n = -1;
        t instanceof c || !(0 < e.span) || (n = t * e.span),
          super(n, r),
      ...
      getSpan(e, t = 0) {
        ...
        let r = 0,
          n = this.count;
        if (
          (n instanceof c && (n = n.decode(e, t)), 0 < this.elementLayout.span)
        )
      ...
      decode(e, t = 0) {
        let r = [],
          n = 0,
          i = this.count;
        for (i instanceof c && (i = i.decode(e, t)); n < i; )
      ...
      encode(e, t, r = 0) {
        ...
        return this.count instanceof c && this.count.encode(e.length, t, r), i;
      }
    }
    r.Sequence = _;
    class B extends o {
    ...
    r.UnionDiscriminator = A;
    class E extends A {
      constructor(e, t) {
        if (!(e instanceof c && e.isCount()))
    ...
    r.UnionLayoutDiscriminator = E;
    class P extends o {
      constructor(e, t, r) {
        let n;
        if (e instanceof d || e instanceof h) n = new E(new l(e));
        else if (e instanceof c && e.isCount()) n = new E(e);
        else if (e instanceof A) n = e;
        else
          throw TypeError(
    ...
    class z extends o {
      constructor(e, t) {
        if (
          !((e instanceof c && e.isCount()) || (Number.isInteger(e) && 0 <= e))
        )
          throw TypeError(
            "length must be positive integer or an unsigned integer ExternalLayout"
          );
        let r = -1;
        e instanceof c || (r = e), super(r, t), (this.length = e);
      }
      getSpan(e, t) {
        let r = this.span;
      ...
      encode(e, t, r) {
        let n = this.length;
        if (
          (this.length instanceof c && (n = e.length),
        ...
        return (
          ...
          this.length instanceof c && this.length.encode(n, t, r),
          n
        );
      }
    }
    ...
    (r.Constant = N),
      ...
      (r.f64 = (e) => new x(e)),
      (r.f64be = (e) => new I(e)),
      (r.struct = (e, t, r) => new B(e, t, r)),
      (r.bits = (e, t, r) => new L(e, t, r)),
      (r.seq = (e, t, r) => new _(e, t, r)),
      (r.union = (e, t, r) => new P(e, t, r)),
      (r.unionLayoutDiscriminator = (e, t) => new E(e, t)),
      (r.blob = (e, t) => new z(e, t)),
      (r.cstr = (e) => new U(e)),
      (r.utf8 = (e, t) => new W(e, t)),
      (r.constant = (e, t) => new N(e, t));
  },
  719679,
  (e) => {
    "use strict";
    ...
    function m(e, t, r, n, i, s, o) {
      return b((t & r) | (~t & n), e, t, i, s, o);
    }
    function w(e, t, r, n, i, s, o) {
      return b((t & n) | (r & ~n), e, t, i, s, o);
    }
    function k(e, t, r, n, i, s, o) {
      return b(t ^ r ^ n, e, t, i, s, o);
    }
    function S(e, t, r, n, i, s, o) {
      return b(r ^ (t | ~n), e, t, i, s, o);
    }
        ...
        (function (e, t) {
          ...
          for (
            ...
            var a = r,
              ...
              u = i,
              l = s;
            (r = m(r, n, i, s, e[o], 7, -0x28955b88)),
              (s = m(s, r, n, i, e[o + 1], 12, -0x173848aa)),
              (i = m(i, s, r, n, e[o + 2], 17, 0x242070db)),
              (n = m(n, i, s, r, e[o + 3], 22, -0x3e423112)),
              (r = m(r, n, i, s, e[o + 4], 7, -0xa83f051)),
              (s = m(s, r, n, i, e[o + 5], 12, 0x4787c62a)),
              (i = m(i, s, r, n, e[o + 6], 17, -0x57cfb9ed)),
              (n = m(n, i, s, r, e[o + 7], 22, -0x2b96aff)),
              (r = m(r, n, i, s, e[o + 8], 7, 0x698098d8)),
              (s = m(s, r, n, i, e[o + 9], 12, -0x74bb0851)),
              (i = m(i, s, r, n, e[o + 10], 17, -42063)),
              (n = m(n, i, s, r, e[o + 11], 22, -0x76a32842)),
              (r = m(r, n, i, s, e[o + 12], 7, 0x6b901122)),
              (s = m(s, r, n, i, e[o + 13], 12, -0x2678e6d)),
              (i = m(i, s, r, n, e[o + 14], 17, -0x5986bc72)),
              (n = m(n, i, s, r, e[o + 15], 22, 0x49b40821)),
              ...
              (r = k(r, n, i, s, e[o + 5], 4, -378558)),
              (s = k(s, r, n, i, e[o + 8], 11, -0x788e097f)),
              (i = k(i, s, r, n, e[o + 11], 16, 0x6d9d6122)),
              (n = k(n, i, s, r, e[o + 14], 23, -0x21ac7f4)),
              (r = k(r, n, i, s, e[o + 1], 4, -0x5b4115bc)),
              (s = k(s, r, n, i, e[o + 4], 11, 0x4bdecfa9)),
              (i = k(i, s, r, n, e[o + 7], 16, -0x944b4a0)),
              (n = k(n, i, s, r, e[o + 10], 23, -0x41404390)),
              (r = k(r, n, i, s, e[o + 13], 4, 0x289b7ec6)),
              (s = k(s, r, n, i, e[o], 11, -0x155ed806)),
              (i = k(i, s, r, n, e[o + 3], 16, -0x2b10cf7b)),
              (n = k(n, i, s, r, e[o + 6], 23, 0x4881d05)),
              (r = k(r, n, i, s, e[o + 9], 4, -0x262b2fc7)),
              (s = k(s, r, n, i, e[o + 12], 11, -0x1924661b)),
              (i = k(i, s, r, n, e[o + 15], 16, 0x1fa27cf8)),
              (n = k(n, i, s, r, e[o + 2], 23, -0x3b53a99b)),
              (r = S(r, n, i, s, e[o], 6, -0xbd6ddbc)),
              (s = S(s, r, n, i, e[o + 7], 10, 0x432aff97)),
              (i = S(i, s, r, n, e[o + 14], 15, -0x546bdc59)),
              (n = S(n, i, s, r, e[o + 5], 21, -0x36c5fc7)),
              (r = S(r, n, i, s, e[o + 12], 6, 0x655b59c3)),
              (s = S(s, r, n, i, e[o + 3], 10, -0x70f3336e)),
              (i = S(i, s, r, n, e[o + 10], 15, -1051523)),
              (n = S(n, i, s, r, e[o + 1], 21, -0x7a7ba22f)),
              (r = S(r, n, i, s, e[o + 8], 6, 0x6fa87e4f)),
              (s = S(s, r, n, i, e[o + 15], 10, -0x1d31920)),
              (i = S(i, s, r, n, e[o + 6], 15, -0x5cfebcec)),
              (n = S(n, i, s, r, e[o + 13], 21, 0x4e0811a1)),
              (r = S(r, n, i, s, e[o + 4], 6, -0x8ac817e)),
              (s = S(s, r, n, i, e[o + 11], 10, -0x42c50dcb)),
              (i = S(i, s, r, n, e[o + 2], 15, 0x2ad7d2bb)),
              (n = S(n, i, s, r, e[o + 9], 21, -0x14792c6f)),
              (r = y(r, a)),
              (n = y(n, c)),
              (i = y(i, u)),
              (s = y(s, l));
    ...
    var I = p("v5", 80, function (e) {
      ...
      for (var l = 0; l < s; ++l) {
        for (var d = new Uint32Array(80), h = 0; h < 16; ++h) d[h] = o[l][h];
        for (var f = 16; f < 80; ++f)
          d[f] = x(d[f - 3] ^ d[f - 8] ^ d[f - 14] ^ d[f - 16], 1);
        for (
          var p = r[0], g = r[1], y = r[2], b = r[3], m = r[4], w = 0;
          w < 80;
          ++w
        ) {
      ...
      [
        ...
        function (e, t, i) {
          ...
          if (null == c || null == u) {
            ...
            null == c && (c = r = [1 | f[0], f[1], f[2], f[3], f[4], f[5]]),
              null == u && (u = n = ((f[6] << 8) | f[7]) & 16383);
          }
          var p = void 0 !== e.msecs ? e.msecs : Date.now(),
            g = void 0 !== e.nsecs ? e.nsecs : h + 1,
            y = p - d + (g - h) / 1e4;
          if (
            (y < 0 && void 0 === e.clockseq && (u = (u + 1) & 16383),
            (y < 0 || p > d) && void 0 === e.nsecs && (g = 0),
            g >= 1e4)
          )
  ...
  (e, t, r) => {
    ...
    Object.create &&
      ...
      (u.prototype.removeListener = function (e, t, r, n) {
        ...
        if (o.fn)
          o.fn !== t || (n && !o.once) || (r && o.context !== r) || c(this, s);
        else {
  ...
  (e) => {
    ...
    var t,
      ...
      o = e.i(843943),
      a = e.i(940893);
    let c = BigInt(0x100000000 - 1),
      u = BigInt(32);
    function l(e, t = !1) {
      let r = new Uint32Array(e.length),
        n = new Uint32Array(e.length);
      for (let i = 0; i < e.length; i++) {
        let { h: s, l: o } = (function (e, t = !1) {
          return t
            ? { h: Number(e & c), l: Number((e >> u) & c) }
            : { h: 0 | Number((e >> u) & c), l: 0 | Number(e & c) };
        })(e[i], t);
        [r[i], n[i]] = [s, o];
      }
      return [r, n];
    ...
    let d = (e, t, r) => e >>> r,
      ...
      m = (e, t, r) => (e >>> 0) + (t >>> 0) + (r >>> 0),
      w = (e, t, r, n) => (t + r + n + ((e / 0x100000000) | 0)) | 0,
      k = (e, t, r, n) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0),
      S = (e, t, r, n, i) => (t + r + n + i + ((e / 0x100000000) | 0)) | 0,
      v = (e, t, r, n, i, s) =>
    ...
    class P extends a.HashMD {
      ...
      get() {
        ...
        return [e, t, r, n, i, s, o, a, c, u, l, d, h, f, p, g];
      }
      set(e, t, r, n, i, s, o, a, c, u, l, d, h, f, p, g) {
        (this.Ah = 0 | e),
          (this.Al = 0 | t),
          (this.Bh = 0 | r),
          (this.Bl = 0 | n),
      ...
      process(e, t) {
        for (let r = 0; r < 16; r++, t += 4)
          (A[r] = e.getUint32(t)), (E[r] = e.getUint32((t += 4)));
        for (let e = 16; e < 80; e++) {
          let t = 0 | A[e - 15],
            r = 0 | E[e - 15],
            n = f(t, r, 1) ^ f(t, r, 8) ^ d(t, r, 7),
            i = p(t, r, 1) ^ p(t, r, 8) ^ h(t, r, 7),
            s = 0 | A[e - 2],
            o = 0 | E[e - 2],
            a = f(s, o, 19) ^ g(s, o, 61) ^ d(s, o, 6),
            c = k(
              i,
              p(s, o, 19) ^ y(s, o, 61) ^ h(s, o, 6),
              E[e - 7],
              E[e - 16]
            ),
            u = S(c, n, a, A[e - 7], A[e - 16]);
          (A[e] = 0 | u), (E[e] = 0 | c);
        }
        let {
          Ah: r,
        ...
        for (let e = 0; e < 80; e++) {
          let t = f(l, I, 14) ^ f(l, I, 18) ^ g(l, I, 41),
            d = p(l, I, 14) ^ p(l, I, 18) ^ y(l, I, 41),
            h = (l & P) ^ (~l & C),
            k = x(R, d, (I & T) ^ (~I & L), B[e], E[e]),
            S = v(k, O, t, h, _[e], A[e]),
            z = 0 | k,
            U = f(r, n, 28) ^ g(r, n, 34) ^ g(r, n, 39),
            W = p(r, n, 28) ^ y(r, n, 34) ^ y(r, n, 39),
            N = (r & i) ^ (r & o) ^ (i & o),
            q = (n & s) ^ (n & a) ^ (s & a);
          (O = 0 | C),
            (R = 0 | L),
        ...
        ({ h: r, l: n } = b(0 | this.Ah, 0 | this.Al, 0 | r, 0 | n)),
          ({ h: i, l: s } = b(0 | this.Bh, 0 | this.Bl, 0 | i, 0 | s)),
          ({ h: o, l: a } = b(0 | this.Ch, 0 | this.Cl, 0 | o, 0 | a)),
          ({ h: c, l: u } = b(0 | this.Dh, 0 | this.Dl, 0 | c, 0 | u)),
          ({ h: l, l: I } = b(0 | this.Eh, 0 | this.El, 0 | l, 0 | I)),
          ({ h: P, l: T } = b(0 | this.Fh, 0 | this.Fl, 0 | P, 0 | T)),
          ({ h: C, l: L } = b(0 | this.Gh, 0 | this.Gl, 0 | C, 0 | L)),
          ({ h: O, l: R } = b(0 | this.Hh, 0 | this.Hl, 0 | O, 0 | R)),
          this.set(r, n, i, s, o, a, c, u, l, I, P, T, C, L, O, R);
      }
      roundClean() {
        A.fill(0), E.fill(0);
      }
    ...
    let T = (0, I.wrapConstructor)(() => new P());
    var C = e.i(810588),
      L = e.i(870948),
      O = e.i(5450);
    let R = BigInt(0),
    ...
    function G(e, t) {
      ...
      let n,
        ...
        y,
        b = (0, L.mod)(t * t * t, K),
        m = ((r = e * (0, L.mod)(b * b * t, K)),
        (n = BigInt(10)),
        (i = BigInt(20)),
        (s = BigInt(40)),
        (o = BigInt(80)),
        (a = (((r * r) % K) * r) % K),
        (c = ((0, L.pow2)(a, j, K) * a) % K),
        (u = ((0, L.pow2)(c, F, K) * r) % K),
        (l = ((0, L.pow2)(u, H, K) * u) % K),
        (d = ((0, L.pow2)(l, n, K) * l) % K),
        (h = ((0, L.pow2)(d, i, K) * d) % K),
        (f = ((0, L.pow2)(h, s, K) * h) % K),
        (p = ((0, L.pow2)(f, o, K) * f) % K),
        (g = ((0, L.pow2)(p, o, K) * f) % K),
        (y = ((0, L.pow2)(g, n, K) * l) % K),
        { pow_p_5_8: ((0, L.pow2)(y, j, K) * r) % K, b2: a }).pow_p_5_8,
        w = (0, L.mod)(e * b * m, K),
        k = (0, L.mod)(t * w * w, K),
        S = w,
        v = (0, L.mod)(w * M, K),
      ...
      return (
        x && (w = S),
        (I || _) && (w = v),
        (0, L.isNegativeLE)(w, K) && (w = (0, L.mod)(-w, K)),
        { isValid: x || I, value: w }
      );
    }
    let J = (0, L.Field)(K, void 0, !0),
      Y = (function (e) {
        let t,
          r =
            ((t = (0, C.validateBasic)(e)),
            O.validateObject(
              e,
              {
                hash: "function",
          ...
          g =
            r.domain ||
            ((e, t, r) => {
              if (((0, O.abool)("phflag", r), t.length || r))
                throw Error("Contexts/pre-hash are not supported");
              return e;
            });
        function y(e, t) {
          O.aInRange("coordinate " + e, t, R, l);
        }
        function b(e) {
          if (!(e instanceof k)) throw Error("ExtendedPoint expected");
        }
        let m = (0, O.memoized)((e, t) => {
            let { ex: r, ey: i, ez: s } = e,
              o = e.is0();
            null == t && (t = o ? W : n.inv(s));
            let a = d(r * t),
              c = d(i * t),
              u = d(s * t);
            if (o) return { x: R, y: z };
            if (u !== z) throw Error("invZ was invalid");
            return { x: a, y: c };
          }),
          w = (0, O.memoized)((e) => {
            let { a: t, d: n } = r;
            if (e.is0()) throw Error("bad point: ZERO");
            let { ex: i, ey: s, ez: o, et: a } = e,
              c = d(i * i),
              u = d(s * s),
              l = d(o * o),
              h = d(l * l),
              f = d(c * t);
            if (d(l * d(f + u)) !== d(h + d(n * d(c * u))))
        ...
        class k {
          ...
          static fromAffine(e) {
            if (e instanceof k) throw Error("extended point not allowed");
            let { x: t, y: r } = e || {};
            return y("x", t), y("y", r), new k(t, r, z, d(t * r));
          }
          static normalizeZ(e) {
            let t = n.invertBatch(e.map((e) => e.ez));
            return e.map((e, r) => e.toAffine(t[r])).map(k.fromAffine);
          }
          static msm(e, t) {
            return (0, C.pippenger)(k, h, e, t);
          }
          _setWindowSize(e) {
          ...
          negate() {
            return new k(d(-this.ex), this.ey, this.ez, d(-this.et));
          }
          double() {
            let { a: e } = r,
              { ex: t, ey: n, ez: i } = this,
              ...
              y = d(h * p),
              b = d(l * p);
            return new k(g, y, d(f * h), b);
          }
          add(e) {
            b(e);
            let { a: t, d: n } = r,
              { ex: i, ey: s, ez: o, et: a } = this,
              { ex: c, ey: u, ez: l, et: h } = e;
            if (t === BigInt(-1)) {
              let e = d((s - i) * (u + c)),
                t = d((s + i) * (u - c)),
                r = d(t - e);
              if (r === R) return this.double();
              let n = d(o * U * h),
                f = d(a * U * l),
                p = f + n,
                g = t + e,
            ...
            let f = d(i * c),
              ...
              I = d(S * v),
              _ = d(m * v);
            return new k(x, I, d(w * S), _);
          }
          subtract(e) {
            return this.add(e.negate());
          }
          wNAF(e) {
            return x.wNAFCached(this, e, k.normalizeZ);
          }
          multiply(e) {
            O.aInRange("scalar", e, z, i);
            let { p: t, f: r } = this.wNAF(e);
            return k.normalizeZ([t, r])[0];
          }
          multiplyUnsafe(e, t = k.ZERO) {
            return (O.aInRange("scalar", e, R, i), e === R)
              ? v
              : this.is0() || e === z
              ? this
              : x.wNAFCachedUnsafe(this, e, k.normalizeZ, t);
          }
          isSmallOrder() {
            return this.multiplyUnsafe(u).is0();
          }
          isTorsionFree() {
            return x.unsafeLadder(this, i).is0();
          }
          toAffine(e) {
            return m(this, e);
          }
          clearCofactor() {
            let { h: e } = r;
            return e === z ? this : this.multiplyUnsafe(e);
          }
          static fromHex(e, t = !1) {
            let { d: i, a: s } = r,
              o = n.BYTES;
            (e = (0, O.ensureBytes)("pointHex", e, o)),
              (0, O.abool)("zip215", t);
            let a = e.slice(),
              c = e[o - 1];
            a[o - 1] = -129 & c;
            let u = O.bytesToNumberLE(a),
              h = t ? l : n.ORDER;
            O.aInRange("pointHex.y", u, R, h);
            let p = d(u * u),
              { isValid: g, value: y } = f(d(p - z), d(i * p - s));
            if (!g) throw Error("Point.fromHex: invalid y coordinate");
            let b = (y & z) === z,
              m = (128 & c) != 0;
            if (!t && y === R && m) throw Error("Point.fromHex: x=0 and x_0=1");
            return m !== b && (y = d(-y)), k.fromAffine({ x: y, y: u });
          }
          ...
          toRawBytes() {
            ...
            return (r[r.length - 1] |= e & z ? 128 : 0), r;
          }
          toHex() {
            return O.bytesToHex(this.toRawBytes());
          }
        }
        (k.BASE = new k(r.Gx, r.Gy, z, d(r.Gx * r.Gy))),
          (k.ZERO = new k(R, z, z, R));
        let { BASE: S, ZERO: v } = k,
          x = (0, C.wNAF)(k, 8 * c);
        function I(e) {
          return (0, L.mod)(e, i);
        ...
        function _(e) {
          return I(O.bytesToNumberLE(e));
        }
        function B(e) {
          let t = n.BYTES;
          e = (0, O.ensureBytes)("private key", e, t);
          let r = (0, O.ensureBytes)("hashed private key", o(e), 2 * t),
            i = p(r.slice(0, t)),
            s = r.slice(t, 2 * t),
            a = _(i),
            c = S.multiply(a),
            u = c.toRawBytes();
          return { head: i, prefix: s, scalar: a, point: c, pointBytes: u };
        }
        function A(e = new Uint8Array(), ...t) {
          return _(
            o(g(O.concatBytes(...t), (0, O.ensureBytes)("context", e), !!s))
          );
        }
        return (
          S._setWindowSize(8),
          {
            ...
            getPublicKey: function (e) {
              return B(e).pointBytes;
            },
            sign: function (e, t, r = {}) {
              (e = (0, O.ensureBytes)("message", e)), s && (e = s(e));
              let { prefix: o, scalar: a, pointBytes: c } = B(t),
                u = A(r.context, o, e),
                l = S.multiply(u).toRawBytes(),
                d = I(u + A(r.context, l, c, e) * a);
              O.aInRange("signature.s", d, R, i);
              let h = O.concatBytes(l, O.numberToBytesLE(d, n.BYTES));
              return (0, O.ensureBytes)("result", h, 2 * n.BYTES);
            },
            verify: function (e, t, r, i = N) {
              let o,
                a,
                c,
                { context: u, zip215: l } = i,
                d = n.BYTES;
              (e = (0, O.ensureBytes)("signature", e, 2 * d)),
                (t = (0, O.ensureBytes)("message", t)),
                (r = (0, O.ensureBytes)("publicKey", r, d)),
                void 0 !== l && (0, O.abool)("zip215", l),
                s && (t = s(t));
              let h = O.bytesToNumberLE(e.slice(d, 2 * d));
              try {
                (o = k.fromHex(r, l)),
                  (a = k.fromHex(e.slice(0, d), l)),
                  (c = S.multiplyUnsafe(h));
              } catch (e) {
                return !1;
              }
              if (!l && o.isSmallOrder()) return !1;
              let f = A(u, a.toRawBytes(), o.toRawBytes(), t);
              return a
                .add(o.multiplyUnsafe(f))
                .subtract(c)
                .clearCofactor()
                .equals(k.ZERO);
            },
      ...
      Z = (J.ORDER + $) / V,
      X = J.pow(j, Z),
      Q = J.sqrt(J.neg(J.ONE)),
      ee = (0, L.FpSqrtEven)(J, J.neg(BigInt(486664)));
    (0, q.createHasher)(
      Y.ExtendedPoint,
      (e) =>
        (function (e) {
          ...
          (E = J.cmov(E, J.ZERO, O)),
            ...
            (T = J.cmov(T, J.ONE, O)),
            (C = J.cmov(C, J.ONE, O));
          let R = J.invertBatch([P, C]);
          return { x: J.mul(E, R[0]), y: J.mul(T, R[1]) };
        })(e[0]),
      {
          ...
          (function (e, t = {}) {
            {
              ...
              return (
                Object.keys(t).length &&
                  (r += ` '${btoa(Object.entries(t).map(eo).join("&"))}'`),
                `${r}\``
              );
            }
          })(e, r),
    ...
    var eu =
      (((t = eu || {})[(t.Little = 0)] = "Little"),
      (t[(t.Big = 1)] = "Big"),
      t);
    function el(e) {
      return e?.endian !== 1;
    }
    class ed extends TypeError {
      constructor(e, t) {
        let r;
    ...
    function* eg(e, t, r, n) {
      var i;
      for (let s of ((eh((i = e)) && "function" == typeof i[Symbol.iterator]) ||
        (e = [e]),
      e)) {
    ...
    class eb {
      constructor(e) {
        ...
        (this.type = t),
          ...
          (this.coercer = s),
          n
            ? (this.validator = (e, t) => eg(n(e, t), t, this, e))
            : (this.validator = () => []),
          i
            ? (this.refiner = (e, t) => eg(i(e, t), t, this, e))
            : (this.refiner = () => []);
      }
      assert(e, t) {
        var r = e,
      ...
      is(e) {
        var t, r;
        return (t = e), (r = this), !ew(t, r)[0];
      }
      mask(e, t) {
        var r = e,
          n = this,
          i = t;
        let s = ew(r, n, { coerce: !0, mask: !0, message: i });
        if (!s[0]) return s[1];
        throw s[0];
      }
      validate(e, t = {}) {
    ...
    function em(e, t, r) {
      let n = ew(e, t, { coerce: !0, message: r });
      if (!n[0]) return n[1];
      throw n[0];
    }
    function ew(e, t, r = {}) {
    ...
    function ek(e, t) {
      return new eb({ type: e, schema: null, validator: t });
    }
    function eS(e) {
      return new eb({
        type: "array",
        ...
        *entries(t) {
        ...
        validator: (e) =>
          Array.isArray(e) || `Expected an array value, but received: ${ep(e)}`,
      });
    }
    function ev() {
      return ek("boolean", (e) => "boolean" == typeof e);
    }
    function ex(e) {
      return ek(
        "instance",
        (t) =>
          t instanceof e ||
          `Expected a \`${e.name}\` instance, but received: ${ep(t)}`
      );
    }
    function eI(e) {
      let t = ep(e),
      ...
      return new eb({
        ...
        validator: (r) =>
          r === e || `Expected the literal \`${t}\`, but received: ${ep(r)}`,
      });
    }
    function e_(e) {
      return new eb({
    ...
    function eB() {
      return ek(
        ...
        (e) =>
          ...
          `Expected a number, but received: ${ep(e)}`
      );
    }
    function eA(e) {
      return new eb({
    ...
    function eE(e, t) {
      return new eb({
        ...
        *entries(r) {
        ...
        validator: (e) => ef(e) || `Expected an object, but received: ${ep(e)}`,
        coercer: (e) => (ef(e) ? { ...e } : e),
      });
    }
    function eP() {
      return ek(
        "string",
        (e) =>
          "string" == typeof e || `Expected a string, but received: ${ep(e)}`
      );
    }
    function eT(e) {
      let t = ek("never", () => !1);
      return new eb({
        ...
        *entries(r) {
        ...
        validator: (e) =>
          Array.isArray(e) || `Expected an array, but received: ${ep(e)}`,
        coercer: (e) => (Array.isArray(e) ? e.slice() : e),
      });
    }
    function eC(e) {
      ...
      return new eb({
        ...
        schema: e,
        *entries(r) {
          if (eh(r)) for (let n of t) yield [n, r[n], e[n]];
        },
        validator: (e) => ef(e) || `Expected an object, but received: ${ep(e)}`,
        coercer: (e) => (ef(e) ? { ...e } : e),
      });
    ...
    function eL(e) {
      ...
      return new eb({
        ...
        validator(r, n) {
          ...
          return [
            `Expected the value to satisfy a union of \`${t}\`, but received: ${ep(
              r
            )}`,
            ...i,
          ];
    ...
    function eR(e, t, r) {
      return new eb({
        ...e,
        coercer: (n, i) =>
          ew(n, t)[0] ? e.coercer(n, i) : e.coercer(r(n, i), i),
      });
    }
    var ez = e.i(578217),
      eU = e.i(478492);
      ...
      eK = class extends eW.default {
        ...
        constructor(
          ...
          super(),
            ...
            c ? (this.dataPack = c) : (this.dataPack = new eq()),
            this.autoconnect &&
    ...
    let eF = [],
      ...
      eY = BigInt(256),
      eZ = BigInt(113);
    for (let e = 0, t = eV, r = 1, n = 0; e < 24; e++) {
      ([r, n] = [n, (2 * r + 3 * n) % 5]),
        eF.push(2 * (5 * n + r)),
        ej.push((((e + 1) * (e + 2)) / 2) % 64);
      let i = eH;
      for (let e = 0; e < 7; e++)
        (t = ((t << eV) ^ ((t >> eJ) * eZ)) % eY) & eG &&
          (i ^= eV << ((eV << BigInt(e)) - eV));
      e$.push(i);
    }
    let [eX, eQ] = l(e$, !0),
      e0 = (e, t, r) => {
        ...
        return r > 32
          ? ((n = e), (t << ((i = r) - 32)) | (n >>> (64 - i)))
          : ((s = e), (o = t), (s << (a = r)) | (o >>> (32 - a)));
      },
      e1 = (e, t, r) => {
        let n, i, s, o, a;
        return r > 32
          ? ((n = e), (i = t), (n << ((s = r) - 32)) | (i >>> (64 - s)))
          : ((o = e), (t << (a = r)) | (o >>> (32 - a)));
      };
    class e2 extends eD.Hash {
      constructor(e, t, r, n = !1, i = 24) {
        ...
        (this.state = new Uint8Array(200)),
          (this.state32 = (0, eD.u32)(this.state));
      }
      keccak() {
        eD.isLE || (0, eD.byteSwap32)(this.state32),
          (function (e, t = 24) {
      ...
      writeInto(e) {
        (0, eM.aexists)(this, !1), (0, eM.abytes)(e), this.finish();
        let t = this.state,
          { blockLen: r } = this;
      ...
      xof(e) {
        return (0, eM.anumber)(e), this.xofInto(new Uint8Array(e));
      }
      digestInto(e) {
        if (((0, eM.aoutput)(e, this), this.finished))
    ...
    let e8 = (0, eD.wrapConstructor)(() => new e2(136, 1, 32));
    var e3 = e.i(893554),
      e4 = e.i(5746);
    let e5 = BigInt(
      ...
      tt = (0, L.Field)(e5, void 0, void 0, {
        sqrt: function (e) {
          let t = BigInt(3),
            ...
            c = (e * e * e) % e5,
            u = (c * c * e) % e5,
            l = ((0, L.pow2)(u, t, e5) * u) % e5,
            d = ((0, L.pow2)(l, t, e5) * u) % e5,
            h = ((0, L.pow2)(d, e9, e5) * c) % e5,
            f = ((0, L.pow2)(h, n, e5) * h) % e5,
            p = ((0, L.pow2)(f, i, e5) * f) % e5,
            g = ((0, L.pow2)(p, o, e5) * p) % e5,
            y = ((0, L.pow2)(g, a, e5) * g) % e5,
            b = ((0, L.pow2)(y, o, e5) * p) % e5,
            m = ((0, L.pow2)(b, t, e5) * u) % e5,
            w = ((0, L.pow2)(m, s, e5) * f) % e5,
            k = ((0, L.pow2)(w, r, e5) * c) % e5,
            S = (0, L.pow2)(k, e9, e5);
          if (!tt.eql(tt.sqr(S), e)) throw Error("Cannot find square root");
          return S;
        },
      }),
      tr = (0, e3.createCurve)(
          ...
          endo: {
            ...
            splitScalar: (e) => {
              let t = BigInt("0x3086d221a7d46bcde86c90e49284eb15"),
                r = -e7 * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"),
                n = BigInt("0x114ca50f7a8e2f3f657c1108d9d44cfd8"),
                i = BigInt("0x100000000000000000000000000000000"),
                s = te(t * e, e6),
                o = te(-r * e, e6),
                a = (0, L.mod)(e - s * t - o * n, e6),
                c = (0, L.mod)(-s * r - o * t, e6),
                u = a > i,
                l = c > i;
              if ((u && (a = e6 - a), l && (c = e6 - c), a > i || c > i))
    ...
    let ti = (0, q.isogenyMap)(
      ...
      ts = (0, e4.mapToCurveSimpleSWU)(tt, {
        A: BigInt(
    ...
    function tc(e) {
      try {
        return Y.ExtendedPoint.fromHex(e), !0;
      } catch {
        return !1;
      }
    }
    let tu = (e, t) => Y.sign(e, t.slice(0, 32)),
      tl = Y.verify,
      td = (e) =>
        o.Buffer.isBuffer(e)
          ? e
    ...
    class th {
      ...
      encode() {
        return o.Buffer.from((0, ei.serialize)(tf, this));
      }
      static decode(e) {
        return (0, ei.deserialize)(tf, this, e);
      }
      static decodeUnchecked(e) {
        return (0, ei.deserializeUnchecked)(tf, this, e);
      }
    }
    let tf = new Map(),
      tp = 1;
    class tg extends th {
      constructor(e) {
        if ((super({}), (this._bn = void 0), void 0 !== e._bn))
          ...
          if ("string" == typeof e) {
            const t = er.default.decode(e);
            if (32 != t.length) throw Error("Invalid public key input");
            this._bn = new et.default(t);
          } else this._bn = new et.default(e);
      ...
      static unique() {
        let e = new tg(tp);
        return (tp += 1), new tg(e.toBuffer());
      }
      equals(e) {
        return this._bn.eq(e._bn);
      }
      toBase58() {
        return er.default.encode(this.toBytes());
      }
      toJSON() {
      ...
      static isOnCurve(e) {
        return tc(new tg(e).toBytes());
      }
    }
    (tg.default = new tg("11111111111111111111111111111111")),
      tf.set(tg, { kind: "struct", fields: [["_bn", "u256"]] }),
      new tg("BPFLoader1111111111111111111111111111111111");
    ...
    Object.defineProperty(ty.prototype, "name", {
    ...
    Object.defineProperty(tb.prototype, "name", {
    ...
    let tk = (e = "publicKey") => es.blob(32, e),
      tS = (e = "string") => {
        let t = es.struct(
            [
              es.u32("length"),
              es.u32("lengthPadding"),
              es.blob(es.offset(es.u32(), -8), "chars"),
            ],
            e
          ),
          r = t.decode.bind(t),
        ...
        return (
          ...
          (t.alloc = (e) =>
            es.u32().span + es.u32().span + o.Buffer.from(e, "utf8").length),
          t
        );
      };
    function tv(e) {
    ...
    class t_ {
      ...
      getMessageComponents() {
        ...
        tI(e.length <= 256, "Max static account keys length exceeded");
        ...
        {
          tI(t.length > 0, "Expected at least one writable signer key");
          let [e] = t[0];
          tI(
      ...
      drainKeysFoundInLookupTable(e, t) {
        ...
        for (let [i, s] of this.keyMetaMap.entries())
          if (t(s)) {
            ...
            s >= 0 &&
              (tI(s < 256, "Max lookup table index exceeded"),
              r.push(s),
              n.push(t),
    ...
    let tB = "Reached end of buffer unexpectedly";
    function tA(e) {
      if (0 === e.length) throw Error(tB);
      return e.shift();
    }
    function tE(e, ...t) {
      let [r] = t;
    ...
    class tP {
      constructor(e) {
        (this.header = void 0),
          ...
          (this.accountKeys = e.accountKeys.map((e) => new tg(e))),
      ...
      getAccountKeys() {
        return new tw(this.staticAccountKeys);
      }
      static compile(e) {
        let [t, r] = t_
      ...
      serialize() {
        ...
        let r = this.instructions.map((e) => {
            let { accounts: t, programIdIndex: r } = e,
              n = Array.from(er.default.decode(e.data)),
              i = [];
            tx(i, t.length);
            let s = [];
            return (
        ...
        r.forEach((e) => {
          let t = es
            .struct([
              es.u8("programIdIndex"),
              es.blob(e.keyIndicesCount.length, "keyIndicesCount"),
              es.seq(es.u8("keyIndex"), e.keyIndices.length, "keyIndices"),
              es.blob(e.dataLength.length, "dataLength"),
              es.seq(es.u8("userdatum"), e.data.length, "data"),
            ])
            .encode(e, i, s);
          s += t;
        }),
          (i = i.slice(0, s));
        let a = es.struct([
            es.blob(1, "numRequiredSignatures"),
            es.blob(1, "numReadonlySignedAccounts"),
            es.blob(1, "numReadonlyUnsignedAccounts"),
            es.blob(t.length, "keyCount"),
            es.seq(tk("key"), e, "keys"),
            tk("recentBlockhash"),
          ]),
          c = {
            ...
            keys: this.accountKeys.map((e) => td(e.toBytes())),
            recentBlockhash: er.default.decode(this.recentBlockhash),
          },
      ...
      static from(e) {
        ...
        for (let e = 0; e < u; e++) {
          let e = tA(t),
            ...
            i = tv(t),
            s = tE(t, 0, i),
            a = er.default.encode(o.Buffer.from(s));
        ...
        return new tP({
          ...
          recentBlockhash: er.default.encode(o.Buffer.from(c)),
          accountKeys: a,
          instructions: l,
        });
      }
    ...
    class tT {
      ...
      getAccountKeys(e) {
        ...
        return new tw(this.staticAccountKeys, t);
      }
      isAccountSigner(e) {
        return e < this.header.numRequiredSignatures;
      }
      ...
      static compile(e) {
        let t = t_.compile(e.instructions, e.payerKey),
          r = [],
          n = { writable: [], readonly: [] };
        ...
        let [i, s] = t.getMessageComponents(),
          o = new tw(s, n).compileInstructions(e.instructions);
        return new tT({
          header: i,
          staticAccountKeys: s,
          recentBlockhash: e.recentBlockhash,
      ...
      serialize() {
        let e = [];
        tx(e, this.staticAccountKeys.length);
        let t = this.serializeInstructions(),
          r = [];
        tx(r, this.compiledInstructions.length);
        let n = this.serializeAddressTableLookups(),
          i = [];
        tx(i, this.addressTableLookups.length);
        let s = es.struct([
            es.u8("prefix"),
            es.struct(
              [
                es.u8("numRequiredSignatures"),
                es.u8("numReadonlySignedAccounts"),
                es.u8("numReadonlyUnsignedAccounts"),
              ],
              "header"
            ),
            es.blob(e.length, "staticAccountKeysLength"),
            es.seq(tk(), this.staticAccountKeys.length, "staticAccountKeys"),
            tk("recentBlockhash"),
            es.blob(r.length, "instructionsLength"),
            es.blob(t.length, "serializedInstructions"),
            es.blob(i.length, "addressTableLookupsLength"),
            es.blob(n.length, "serializedAddressTableLookups"),
          ]),
      ...
      serializeInstructions() {
        ...
        for (let r of this.compiledInstructions) {
          let n = [];
          tx(n, r.accountKeyIndexes.length);
          let i = [];
          tx(i, r.data.length);
          let s = es.struct([
            es.u8("programIdIndex"),
            es.blob(n.length, "encodedAccountKeyIndexesLength"),
            es.seq(es.u8(), r.accountKeyIndexes.length, "accountKeyIndexes"),
            es.blob(i.length, "encodedDataLength"),
            es.blob(r.data.length, "data"),
          ]);
          e += s.encode(
            {
      ...
      serializeAddressTableLookups() {
        ...
        for (let r of this.addressTableLookups) {
          let n = [];
          tx(n, r.writableIndexes.length);
          let i = [];
          tx(i, r.readonlyIndexes.length);
          let s = es.struct([
            tk("accountKey"),
            es.blob(n.length, "encodedWritableIndexesLength"),
            es.seq(es.u8(), r.writableIndexes.length, "writableIndexes"),
            es.blob(i.length, "encodedReadonlyIndexesLength"),
            es.seq(es.u8(), r.readonlyIndexes.length, "readonlyIndexes"),
          ]);
          e += s.encode(
            {
      ...
      static deserialize(e) {
        let t = [...e],
          r = tA(t),
          n = 127 & r;
        tI(r !== n, "Expected versioned message but received legacy message"),
          tI(
            0 === n,
            `Expected versioned message with version 0 but found version ${n}`
          );
        let i = {
            numRequiredSignatures: tA(t),
            numReadonlySignedAccounts: tA(t),
            numReadonlyUnsignedAccounts: tA(t),
          },
          s = [],
          o = tv(t);
        for (let e = 0; e < o; e++) s.push(new tg(tE(t, 0, 32)));
        let a = er.default.encode(tE(t, 0, 32)),
          c = tv(t),
          u = [];
        for (let e = 0; e < c; e++) {
          let e = tA(t),
    ...
    let tC = {
        ...
        deserialize: (e) => {
          let t = tC.deserializeMessageVersion(e);
          if ("legacy" === t) return tP.from(e);
          if (0 === t) return tT.deserialize(e);
          throw Error(
    ...
    class tz {
        ...
        return (
          e.forEach((e) => {
            "instructions" in e
              ...
              : this.instructions.push(new tR(e));
          }),
          this
        );
      }
      compileMessage() {
        ...
        t.forEach((e) => {
          ...
          n.forEach((e) => {
            i.push({ pubkey: new tg(e), isSigner: !1, isWritable: !1 });
          });
        let s = [];
        i.forEach((e) => {
        ...
        let h = l.concat(d),
          f = t.map((e) => {
            ...
            return {
              ...
              data: er.default.encode(t),
            };
          });
        return (
          f.forEach((e) => {
            tI(e.programIdIndex >= 0), e.accounts.forEach((e) => tI(e >= 0));
          }),
          new tP({
            header: {
      ...
      _partialSign(e, ...t) {
        let r = e.serialize();
        t.forEach((e) => {
          let t = tu(r, e.secretKey);
          this._addSignature(e.publicKey, td(t));
        });
      }
      addSignature(e, t) {
      ...
      _getMessageSignednessErrors(e, t) {
        ...
        for (let { signature: n, publicKey: i } of this.signatures)
          null === n
            ? t && (r.missing ||= []).push(i)
            : tl(n, e, i.toBytes()) || (r.invalid ||= []).push(i);
...
Missing signature for public key${
      ...
      _serialize(e) {
        ...
        return (
          ...
          t.forEach(({ signature: e }, t) => {
            null !== e &&
              (tI(64 === e.length, "signature has invalid length"),
              o.Buffer.from(e).copy(i, r.length + 64 * t));
          }),
          e.copy(i, r.length + 64 * t.length),
          tI(i.length <= 1232, `Transaction too large: ${i.length} > 1232`),
          i
        );
      }
      get keys() {
        return (
          tI(1 === this.instructions.length),
          this.instructions[0].keys.map((e) => e.pubkey)
        );
      }
      get programId() {
        return (
          tI(1 === this.instructions.length), this.instructions[0].programId
        );
      }
      get data() {
        return tI(1 === this.instructions.length), this.instructions[0].data;
      }
      static from(e) {
        let t = [...e],
          r = tv(t),
        ...
        for (let e = 0; e < r; e++) {
          let e = tE(t, 0, 64);
          n.push(er.default.encode(o.Buffer.from(e)));
        }
        return tz.populate(tP.from(t), n);
      }
      static populate(e, t = []) {
        let r = new tz();
        return (
          ...
          t.forEach((t, n) => {
            let i = {
              signature:
                t == er.default.encode(tO) ? null : er.default.decode(t),
    ...
    class tU {
      ...
      static decompile(e, t) {
        let { header: r, compiledInstructions: n, recentBlockhash: i } = e,
          ...
          c = s - o;
        tI(c > 0, "Message header is invalid");
        let u = e.staticAccountKeys.length - s - a;
        tI(u >= 0, "Message header is invalid");
        ...
        for (let e of n) {
          ...
          h.push(new tR({ programId: n, data: td(e.data), keys: t }));
        }
        return new tU({ payerKey: d, instructions: h, recentBlockhash: i });
      }
    ...
    class tW {
      ...
      serialize() {
        let e = this.message.serialize(),
          t = [];
        tx(t, this.signatures.length);
        let r = es.struct([
            es.blob(t.length, "encodedSignaturesLength"),
            es.seq(
              ((e = "signature") => es.blob(64, e))(),
              this.signatures.length,
              "signatures"
            ),
            es.blob(e.length, "serializedMessage"),
          ]),
      ...
      static deserialize(e) {
        let t = [...e],
          r = [],
          n = tv(t);
        for (let e = 0; e < n; e++) r.push(new Uint8Array(tE(t, 0, 64)));
        return new tW(tC.deserialize(new Uint8Array(t)), r);
      }
      sign(e) {
        ...
        for (let n of e) {
          ...
          tI(
            ...
            (this.signatures[e] = tu(t, n.secretKey));
        }
      }
      addSignature(e, t) {
        tI(64 === t.byteLength, "Signature must be 64 bytes long");
    ...
    let tN = new tg("SysvarC1ock11111111111111111111111111111111");
    new tg("SysvarEpochSchedu1e111111111111111111111111");
    let tq = new tg("Sysvar1nstructions1111111111111111111111111"),
      tK = new tg("SysvarRecentB1ockHashes11111111111111111111"),
      tM = new tg("SysvarRent111111111111111111111111111111111");
    new tg("SysvarRewards111111111111111111111111111111"),
      new tg("SysvarS1otHashes111111111111111111111111111"),
      new tg("SysvarS1otHistory11111111111111111111111111");
    let tD = new tg("SysvarStakeHistory1111111111111111111111111");
...
` +
    ...
    let tG = es.nu64("lamportsPerSignature"),
      tJ = es.struct([
        es.u32("version"),
        es.u32("state"),
        tk("authorizedPubkey"),
        tk("nonce"),
        es.struct([tG], "feeCalculator"),
      ]),
      tY = tJ.span;
    class tZ {
      constructor(e) {
      ...
      static fromAccountData(e) {
        let t = tJ.decode(td(e), 0);
        return new tZ({
          authorizedPubkey: new tg(t.authorizedPubkey),
          nonce: new tg(t.nonce).toString(),
    ...
    function tX(e) {
      let t = (0, es.blob)(8, e),
        ...
        i = ((e = {}) =>
          (function (e, t) {
            if (ec(e) !== ec(t)) throw new ea(8078004);
            if (ec(e) && ec(t) && e.fixedSize !== t.fixedSize)
              throw new ea(8078005, {
                decoderFixedSize: t.fixedSize,
                encoderFixedSize: e.fixedSize,
              });
            if (!ec(e) && !ec(t) && e.maxSize !== t.maxSize)
              throw new ea(8078006, {
              ...
              return Object.freeze({
                ...(r = {
                  ...
                  write(e, r, n) {
                    ...
                    return (
                      t.set(new DataView(i), e, el(t.config)),
              ...
              return Object.freeze({
                ...(r = {
                  ...
                  read(e, r = 0) {
                    ...
                    !(function (e, t, r = 0) {
                      if (t.length - r <= 0)
                        throw new ea(8078e3, { codecDescription: e });
                    })(t.name, e, r),
                      (function (e, t, r, n = 0) {
                        let i = r.length - n;
                        if (i < t)
                          throw new ea(8078001, {
                            bytesLength: i,
                            codecDescription: e,
                            expected: t,
                          });
                    ...
                    return [t.get(c, el(t.config)), r + t.size];
                  },
                }),
    ...
    let tQ = Object.freeze({
      ...
      Assign: {
        index: 1,
        layout: es.struct([es.u32("instruction"), tk("programId")]),
      },
      Transfer: {
        index: 2,
        layout: es.struct([es.u32("instruction"), tX("lamports")]),
      },
      CreateWithSeed: {
        index: 3,
        layout: es.struct([
      ...
      AdvanceNonceAccount: {
        index: 4,
        layout: es.struct([es.u32("instruction")]),
      },
      WithdrawNonceAccount: {
        index: 5,
        layout: es.struct([es.u32("instruction"), es.ns64("lamports")]),
      },
      InitializeNonceAccount: {
        index: 6,
        layout: es.struct([es.u32("instruction"), tk("authorized")]),
      },
      ...
      Allocate: {
        index: 8,
        layout: es.struct([es.u32("instruction"), es.ns64("space")]),
      },
      AllocateWithSeed: {
        index: 9,
        layout: es.struct([
    ...
    class t0 {
      static createAccount(e) {
        let t = tV(tQ.Create, {
          lamports: e.lamports,
          space: e.space,
          programId: td(e.programId.toBuffer()),
        });
        return new tR({
          keys: [
      ...
      static transfer(e) {
        ...
        return (
          "basePubkey" in e
            ...
            : ((t = tV(tQ.Transfer, { lamports: BigInt(e.lamports) })),
              (r = [
                { pubkey: e.fromPubkey, isSigner: !0, isWritable: !0 },
                { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
              ])),
          new tR({ keys: r, programId: this.programId, data: t })
        );
      }
      static assign(e) {
        let t, r;
        return (
          "basePubkey" in e
            ? ((t = tV(tQ.AssignWithSeed, {
                base: td(e.basePubkey.toBuffer()),
                seed: e.seed,
                programId: td(e.programId.toBuffer()),
              })),
              (r = [
            ...
            : ((t = tV(tQ.Assign, { programId: td(e.programId.toBuffer()) })),
              (r = [
      ...
      static nonceInitialize(e) {
        let t = tV(tQ.InitializeNonceAccount, {
          authorized: td(e.authorizedPubkey.toBuffer()),
        });
        return new tR({
          keys: [
            { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
            { pubkey: tK, isSigner: !1, isWritable: !1 },
            { pubkey: tM, isSigner: !1, isWritable: !1 },
          ],
          programId: this.programId,
          data: t,
        });
      ...
      static nonceAdvance(e) {
        let t = tV(tQ.AdvanceNonceAccount);
        return new tR({
          keys: [
            { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
            { pubkey: tK, isSigner: !1, isWritable: !1 },
      ...
      static nonceWithdraw(e) {
        let t = tV(tQ.WithdrawNonceAccount, { lamports: e.lamports });
        return new tR({
          keys: [
            { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
            { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
      ...
      static nonceAuthorize(e) {
        let t = tV(tQ.AuthorizeNonceAccount, {
          authorized: td(e.newAuthorizedPubkey.toBuffer()),
        });
        return new tR({
          keys: [
            { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
      ...
      static allocate(e) {
        ...
        return (
          "basePubkey" in e
            ...
            : ((t = tV(tQ.Allocate, { space: e.space })),
              (r = [
                { pubkey: e.accountPubkey, isSigner: !0, isWritable: !0 },
              ])),
          new tR({ keys: r, programId: this.programId, data: t })
    ...
    t0.programId = new tg("11111111111111111111111111111111");
    class t1 {
      static getMinNumSignatures(e) {
        return 2 * (Math.ceil(e / t1.chunkSize) + 1 + 1);
      }
      static async load(e, t, r, n, i) {
        {
          ...
          if (null !== o) {
            ...
            o.data.length !== i.length &&
              (a = a || new tz()).add(
                t0.allocate({ accountPubkey: r.publicKey, space: i.length })
              ),
              o.owner.equals(n) ||
                (a = a || new tz()).add(
                  t0.assign({ accountPubkey: r.publicKey, programId: n })
                ),
              o.lamports < s &&
                (a = a || new tz()).add(
                  t0.transfer({
          ...
          null !== a && (await t$(e, a, [t, r], { commitment: "confirmed" }));
        }
        let s = es.struct([
            es.u32("instruction"),
            es.u32("offset"),
            es.u32("bytesLength"),
            es.u32("bytesLengthPadding"),
            es.seq(es.u8("byte"), es.offset(es.u32(), -8), "bytes"),
          ]),
          a = t1.chunkSize,
          c = 0,
          u = i,
        ...
        for (; u.length > 0; ) {
          ...
          l.push(t$(e, h, [t, r], { commitment: "confirmed" })),
            e._rpcEndpoint.includes("solana.com") && (await tH(250)),
            (c += a),
            (u = u.slice(a));
        }
        await Promise.all(l);
        {
          let i = es.struct([es.u32("instruction")]),
          ...
          let a = new tz().add({
            ...
            c = "processed",
            u = await e.sendTransaction(a, [t, r], { preflightCommitment: c }),
    ...
    (t1.chunkSize = 932), new tg("BPFLoader2111111111111111111111111111111111");
    var t2 =
      (n = (function () {
        if (s) return i;
        s = 1;
          ...
          var n = (function r(n, i) {
            ...
            switch (typeof n) {
              case "object":
                ...
                for (o = (c = t(n).sort()).length, a = "", s = 0; s < o; )
                  void 0 !== (l = r(n[(u = c[s])], !1)) &&
    ...
    class t6 {
      ...
      static deserialize(e) {
        let t = (function (e, t) {
          ...
          r = e.length - 56;
        tI(r >= 0, "lookup table is invalid"),
          tI(r % 32 == 0, "lookup table is invalid");
        let { addresses: n } = es
          .struct([es.seq(tk(), r / 32, "addresses")])
          .decode(e.slice(56));
        return {
          ...
          authority: 0 !== t.authority.length ? new tg(t.authority[0]) : void 0,
          addresses: n.map((e) => new tg(e)),
        };
      }
    }
    let t7 = {
        ...
        layout: es.struct([
          es.u32("typeIndex"),
          tX("deactivationSlot"),
          es.nu64("lastExtendedSlot"),
          es.u8("lastExtendedStartIndex"),
          es.u8(),
          es.seq(tk(), es.offset(es.u8(), -1), "authority"),
        ]),
      },
      t9 = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i,
      re = eR(ex(tg), eP(), (e) => new tg(e)),
      rt = eT([eP(), eI("base64")]),
      rr = eR(ex(o.Buffer), rt, (e) => o.Buffer.from(e[0], "base64"));
    function rn(e) {
      let t, r;
    ...
    function rs(e) {
      return eL([
        eC({ jsonrpc: eI("2.0"), id: eP(), result: e }),
        eC({
          jsonrpc: eI("2.0"),
          id: eP(),
          error: eC({
    ...
    function ra(e) {
      return eR(rs(e), ro, (t) =>
        "error" in t ? t : { ...t, result: em(t.result, e) }
      );
    }
    function rc(e) {
      return ra(eC({ context: eC({ slot: eB() }), value: e }));
    }
    function ru(e) {
      return eC({ context: eC({ slot: eB() }), value: e });
    }
    function rl(e, t) {
      return 0 === e
        ? new tT({
            header: t.header,
            staticAccountKeys: t.accountKeys.map((e) => new tg(e)),
    ...
    let rd = eC({
      ...
      rf = eS(eC({ slot: eB(), prioritizationFee: eB() })),
      rp = eC({ total: eB(), validator: eB(), foundation: eB(), epoch: eB() }),
      rg = eC({
        epoch: eB(),
        slotIndex: eB(),
        slotsInEpoch: eB(),
        absoluteSlot: eB(),
        blockHeight: eA(eB()),
        transactionCount: eA(eB()),
      }),
      ry = eC({
        slotsPerEpoch: eB(),
        leaderScheduleSlotOffset: eB(),
        warmup: ev(),
        firstNormalEpoch: eB(),
        firstNormalSlot: eB(),
      }),
      ...
      rm = e_(eL([eC({}), eP()])),
      rw = eC({ err: rm }),
      rk = eI("receivedSignature"),
      rS = eC({ "solana-core": eP(), "feature-set": eA(eB()) }),
      rv = eC({ program: eP(), programId: re, parsed: eO() }),
      rx = eC({ programId: re, accounts: eS(re), data: eP() }),
      rI = rc(
        eC({
          err: e_(eL([eC({}), eP()])),
          logs: e_(eS(eP())),
          ...
          unitsConsumed: eA(eB()),
          returnData: eA(
            e_(eC({ programId: eP(), data: eT([eP(), eI("base64")]) }))
          ),
          innerInstructions: eA(
            e_(eS(eC({ index: eB(), instructions: eS(eL([rv, rx])) })))
          ),
        })
      ),
      r_ = rc(
        eC({
          byIdentity: eE(eP(), eS(eB())),
          range: eC({ firstSlot: eB(), lastSlot: eB() }),
        })
      ),
      rB = ra(rd),
      rA = ra(rp),
      ...
      rW = eC({ program: eP(), parsed: eO(), space: eB() }),
      rN = rc(
        eS(
          eC({
            pubkey: re,
      ...
      rq = rc(eS(eC({ lamports: eB(), address: re }))),
      rK = eC({
        executable: ev(),
        owner: re,
        lamports: eB(),
      ...
      rM = eC({ pubkey: re, account: rK }),
      rD = eR(eL([ex(o.Buffer), rW]), eL([rt, rW]), (e) =>
        Array.isArray(e) ? em(e, rr) : e
      ),
      rF = eC({
        executable: ev(),
        owner: re,
      ...
      rG = eC({ subscription: eB(), result: ru(rK) }),
      rJ = eC({ pubkey: re, account: rK }),
      rY = eC({ subscription: eB(), result: ru(rJ) }),
      rZ = eC({ parent: eB(), slot: eB(), root: eB() }),
      rX = eC({ subscription: eB(), result: rZ }),
      rQ = eL([
        eC({
          type: eL([
            eI("firstShredReceived"),
            eI("completed"),
            eI("optimisticConfirmation"),
            eI("root"),
          ]),
          slot: eB(),
          timestamp: eB(),
        ...
        eC({
          ...
          timestamp: eB(),
          stats: eC({
            numTransactionEntries: eB(),
            numSuccessfulTransactions: eB(),
            numFailedTransactions: eB(),
            maxTransactionsPerEntry: eB(),
          }),
        }),
        eC({ type: eI("dead"), slot: eB(), timestamp: eB(), err: eP() }),
      ]),
      r0 = eC({ subscription: eB(), result: rQ }),
      r1 = eC({ subscription: eB(), result: ru(eL([rw, rk])) }),
      r2 = eC({ subscription: eB(), result: eB() }),
      r8 = eC({
        pubkey: eP(),
        gossip: e_(eP()),
        tpu: e_(eP()),
      ...
      r3 = eC({
        ...
        activatedStake: eB(),
        epochVoteAccount: ev(),
        epochCredits: eS(eT([eB(), eB(), eB()])),
        commission: eB(),
        lastVote: eB(),
        rootSlot: e_(eB()),
      }),
      r4 = ra(eC({ current: eS(r3), delinquent: eS(r3) })),
      r5 = eL([eI("processed"), eI("confirmed"), eI("finalized")]),
      r6 = eC({
        slot: eB(),
        confirmations: e_(eB()),
        err: rm,
        confirmationStatus: eA(r5),
      }),
      r7 = rc(eS(e_(r6))),
      r9 = ra(eB()),
      ne = eC({
        accountKey: re,
        writableIndexes: eS(eB()),
        readonlyIndexes: eS(eB()),
      }),
      nt = eC({
        signatures: eS(eP()),
        message: eC({
          accountKeys: eS(eP()),
          header: eC({
            numRequiredSignatures: eB(),
            numReadonlySignedAccounts: eB(),
            numReadonlyUnsignedAccounts: eB(),
          }),
          instructions: eS(
            eC({ accounts: eS(eB()), data: eP(), programIdIndex: eB() })
          ),
          recentBlockhash: eP(),
          addressTableLookups: eA(eS(ne)),
        }),
      }),
      nr = eC({
        pubkey: re,
        signer: ev(),
        writable: ev(),
        source: eA(eL([eI("transaction"), eI("lookupTable")])),
      }),
      nn = eC({ accountKeys: eS(nr), signatures: eS(eP()) }),
      ni = eC({ parsed: eO(), program: eP(), programId: re }),
      ns = eC({ accounts: eS(re), data: eP(), programId: re }),
      no = eR(
        eL([ns, ni]),
        eL([
          eC({ parsed: eO(), program: eP(), programId: eP() }),
          eC({ accounts: eS(eP()), data: eP(), programId: eP() }),
        ]),
        (e) => ("accounts" in e ? em(e, ns) : em(e, ni))
      ),
      na = eC({
        signatures: eS(eP()),
        message: eC({
          ...
          instructions: eS(no),
          recentBlockhash: eP(),
          addressTableLookups: eA(e_(eS(ne))),
        }),
      }),
      nc = eC({
        accountIndex: eB(),
      ...
      nu = eC({ writable: eS(re), readonly: eS(re) }),
      nl = eC({
        err: rm,
        fee: eB(),
        innerInstructions: eA(
        ...
        preBalances: eS(eB()),
        postBalances: eS(eB()),
        logMessages: eA(e_(eS(eP()))),
        preTokenBalances: eA(e_(eS(nc))),
        postTokenBalances: eA(e_(eS(nc))),
        loadedAddresses: eA(nu),
        computeUnitsConsumed: eA(eB()),
      }),
      nd = eC({
        err: rm,
        fee: eB(),
        innerInstructions: eA(
          e_(eS(eC({ index: eB(), instructions: eS(no) })))
        ),
        preBalances: eS(eB()),
        postBalances: eS(eB()),
        logMessages: eA(e_(eS(eP()))),
      ...
      np = ra(
        e_(
          eC({
            blockhash: eP(),
            previousBlockhash: eP(),
            parentSlot: eB(),
            transactions: eS(
              eC({ transaction: nt, meta: e_(nl), version: eA(nh) })
            ),
            rewards: eA(eS(nf)),
            blockTime: e_(eB()),
            blockHeight: e_(eB()),
      ...
      ny = ra(
        e_(
          eC({
            ...
            parentSlot: eB(),
            transactions: eS(
              eC({ transaction: nn, meta: e_(nl), version: eA(nh) })
            ),
            rewards: eA(eS(nf)),
            blockTime: e_(eB()),
            blockHeight: e_(eB()),
      ...
      nb = ra(
        e_(
          eC({
            ...
            parentSlot: eB(),
            transactions: eS(
              eC({ transaction: na, meta: e_(nd), version: eA(nh) })
            ),
            rewards: eA(eS(nf)),
            blockTime: e_(eB()),
            blockHeight: e_(eB()),
      ...
      nm = ra(
        e_(
          eC({
            ...
            parentSlot: eB(),
            transactions: eS(
              eC({ transaction: nn, meta: e_(nd), version: eA(nh) })
            ),
            rewards: eA(eS(nf)),
            blockTime: e_(eB()),
            blockHeight: e_(eB()),
      ...
      nk = ra(
        e_(
          eC({
            ...
            previousBlockhash: eP(),
            parentSlot: eB(),
            transactions: eS(eC({ transaction: nt, meta: e_(nl) })),
            rewards: eA(eS(nf)),
            blockTime: e_(eB()),
          })
        )
      ...
      nI = rc(eC({ blockhash: eP(), lastValidBlockHeight: eB() })),
      n_ = rc(ev()),
      nB = ra(
        eS(
          eC({
      ...
      nA = rc(e_(eC({ feeCalculator: eC({ lamportsPerSignature: eB() }) }))),
      nE = ra(eP()),
      nP = ra(eP()),
      nT = eC({ err: rm, logs: eS(eP()), signature: eP() }),
      nC = eC({ result: ru(nT), subscription: eB() }),
      nL = { "solana-client": "js/1.0.0-maintenance" };
    class nO {
      constructor(e, t) {
        var r;
        let n, i, s, o, a, c;
        (this._commitment = void 0),
          ...
          (this.getBlockHeight = (() => {
            let e = {};
            return async (t) => {
              let { commitment: r, config: n } = rn(t),
          ...
          (this._rpcWebSocket = new t5(this._rpcWsEndpoint, {
            autoconnect: !1,
            max_reconnects: 1 / 0,
          })),
      ...
      async getBalanceAndContext(e, t) {
        let { commitment: r, config: n } = rn(t),
          ...
          s = em(await this._rpcRequest("getBalance", i), rc(eB()));
        if ("error" in s)
          throw new tj(s.error, `failed to get balance for ${e.toBase58()}`);
        return s.result;
      }
      ...
      async getBlockTime(e) {
        let t = em(await this._rpcRequest("getBlockTime", [e]), ra(e_(eB())));
        if ("error" in t)
          throw new tj(t.error, `failed to get block time for slot ${e}`);
        return t.result;
      }
      async getMinimumLedgerSlot() {
        let e = em(await this._rpcRequest("minimumLedgerSlot", []), ra(eB()));
        if ("error" in e)
          throw new tj(e.error, "failed to get minimum ledger slot");
        return e.result;
      }
      async getFirstAvailableBlock() {
        let e = em(await this._rpcRequest("getFirstAvailableBlock", []), rL);
        if ("error" in e)
          throw new tj(e.error, "failed to get first available block");
        return e.result;
      }
      async getSupply(e) {
        let t = {};
        ...
        let r = em(await this._rpcRequest("getSupply", [t]), rO);
        if ("error" in r) throw new tj(r.error, "failed to get supply");
        return r.result;
      }
      async getTokenSupply(e, t) {
        let r = this._buildArgs([e.toBase58()], t),
          n = em(await this._rpcRequest("getTokenSupply", r), rc(rR));
        if ("error" in n) throw new tj(n.error, "failed to get token supply");
        return n.result;
      }
      async getTokenAccountBalance(e, t) {
        let r = this._buildArgs([e.toBase58()], t),
          n = em(await this._rpcRequest("getTokenAccountBalance", r), rc(rR));
        if ("error" in n)
          throw new tj(n.error, "failed to get token account balance");
        return n.result;
      }
      async getTokenAccountsByOwner(e, t, r) {
        let { commitment: n, config: i } = rn(r),
          s = [e.toBase58()];
        "mint" in t
          ? s.push({ mint: t.mint.toBase58() })
          : s.push({ programId: t.programId.toBase58() });
        let o = this._buildArgs(s, n, "base64", i),
          a = em(await this._rpcRequest("getTokenAccountsByOwner", o), rU);
        if ("error" in a)
          throw new tj(
            a.error,
      ...
      async getParsedTokenAccountsByOwner(e, t, r) {
        ...
        let i = this._buildArgs(n, r, "jsonParsed"),
          s = em(await this._rpcRequest("getTokenAccountsByOwner", i), rN);
        if ("error" in s)
          throw new tj(
            s.error,
            `failed to get token accounts owned by account ${e.toBase58()}`
      ...
      async getLargestAccounts(e) {
        let t = { ...e, commitment: (e && e.commitment) || this.commitment },
          ...
          n = em(await this._rpcRequest("getLargestAccounts", r), rq);
        if ("error" in n)
          throw new tj(n.error, "failed to get largest accounts");
        return n.result;
      }
      async getTokenLargestAccounts(e, t) {
        let r = this._buildArgs([e.toBase58()], t),
          n = em(await this._rpcRequest("getTokenLargestAccounts", r), rz);
        if ("error" in n)
          throw new tj(n.error, "failed to get token largest accounts");
        return n.result;
      }
      async getAccountInfoAndContext(e, t) {
        let { commitment: r, config: n } = rn(t),
          i = this._buildArgs([e.toBase58()], r, "base64", n),
          s = em(await this._rpcRequest("getAccountInfo", i), rc(e_(rK)));
        if ("error" in s)
          throw new tj(
            s.error,
      ...
      async getParsedAccountInfo(e, t) {
        let { commitment: r, config: n } = rn(t),
          ...
          s = em(await this._rpcRequest("getAccountInfo", i), rc(e_(rF)));
        if ("error" in s)
          throw new tj(
            s.error,
            `failed to get info about account ${e.toBase58()}`
      ...
      async getMultipleParsedAccounts(e, t) {
        ...
        if ("error" in o)
          throw new tj(o.error, `failed to get info for accounts ${i}`);
        return o.result;
      }
      ...
      async getStakeActivation(e, t, r) {
        let { commitment: n, config: i } = rn(t),
          s = this._buildArgs([e.toBase58()], n, void 0, {
            ...i,
            epoch: null != r ? r : i?.epoch,
          }),
          o = em(await this._rpcRequest("getStakeActivation", s), ra(r$));
        if ("error" in o)
          throw new tj(
            o.error,
      ...
      async getProgramAccounts(e, t) {
        let { commitment: r, config: n } = rn(t),
          ...
          o = this._buildArgs([e.toBase58()], r, i || "base64", {
            ...s,
            ...(s.filters ? { filters: ri(s.filters) } : null),
          }),
          a = await this._rpcRequest("getProgramAccounts", o),
          c = eS(rM),
          u = !0 === s.withContext ? em(a, rc(c)) : em(a, ra(c));
        if ("error" in u)
          throw new tj(
            u.error,
      ...
      async getParsedProgramAccounts(e, t) {
        let { commitment: r, config: n } = rn(t),
          i = this._buildArgs([e.toBase58()], r, "jsonParsed", n),
          s = em(await this._rpcRequest("getProgramAccounts", i), ra(eS(rj)));
        if ("error" in s)
          throw new tj(
            s.error,
            `failed to get accounts owned by program ${e.toBase58()}`
      ...
      async confirmTransaction(e, t) {
        ...
        try {
          n = er.default.decode(r);
        } catch (e) {
          throw Error("signature must be base58 encoded: " + r);
        }
        return (tI(64 === n.length, "signature has invalid length"),
        "string" == typeof e)
      ...
      async confirmTransactionUsingBlockHeightExceedanceStrategy({
        ...
        let i,
          ...
          o = new Promise((t) => {
            ...
            (async () => {
              ...
              if (!s) {
                for (; e <= r; )
                  if ((await tH(1e3), s || ((e = await n()), s))) return;
                t({ __type: tL.BLOCKHEIGHT_EXCEEDED });
              }
            })();
          }),
        ...
        try {
          ...
          if (e.__type === tL.PROCESSED) i = e.response;
          else throw new ty(n);
        } finally {
          (s = !0), a();
        }
      ...
      async confirmTransactionUsingDurableNonceStrategy({
            ...
            (async () => {
              if (((s = await c()), !a))
                for (;;) {
                  if (i !== s)
                    return void t({
                      __type: tL.NONCE_INVALID,
                      slotInWhichNonceDidAdvance: o,
                    });
                  if ((await tH(2e3), a || ((s = await c()), a))) return;
                }
            })();
          }),
        ...
        try {
          ...
          if (t.__type === tL.PROCESSED) o = t.response;
          else {
            let n;
            for (;;) {
            ...
            if (n?.value) {
              ...
              switch (t) {
                ...
                case "single":
                case "singleGossip":
                  if ("confirmed" !== r && "finalized" !== r) throw new tm(s);
                  break;
                case "finalized":
                case "max":
                case "root":
                  if ("finalized" !== r) throw new tm(s);
              }
      ...
      async confirmTransactionUsingLegacyTimeoutStrategy({
        ...
        let r,
          ...
          i = new Promise((t) => {
            ...
            r = setTimeout(() => t({ __type: tL.TIMED_OUT, timeoutMs: n }), n);
          }),
        ...
        try {
          ...
          if (e.__type === tL.PROCESSED) n = e.response;
          else throw new tb(t, e.timeoutMs / 1e3);
        } finally {
          clearTimeout(r), s();
        }
        return n;
      ...
      async getClusterNodes() {
        let e = em(await this._rpcRequest("getClusterNodes", []), ra(eS(r8)));
        if ("error" in e) throw new tj(e.error, "failed to get cluster nodes");
        return e.result;
      }
      async getVoteAccounts(e) {
        let t = this._buildArgs([], e),
          r = em(await this._rpcRequest("getVoteAccounts", t), r4);
        if ("error" in r) throw new tj(r.error, "failed to get vote accounts");
        return r.result;
      }
      async getSlot(e) {
        let { commitment: t, config: r } = rn(e),
          n = this._buildArgs([], t, void 0, r),
          i = em(await this._rpcRequest("getSlot", n), ra(eB()));
        if ("error" in i) throw new tj(i.error, "failed to get slot");
        return i.result;
      }
      async getSlotLeader(e) {
        let { commitment: t, config: r } = rn(e),
          n = this._buildArgs([], t, void 0, r),
          i = em(await this._rpcRequest("getSlotLeader", n), ra(eP()));
        if ("error" in i) throw new tj(i.error, "failed to get slot leader");
        return i.result;
      }
      async getSlotLeaders(e, t) {
        ...
        if ("error" in r) throw new tj(r.error, "failed to get slot leaders");
        return r.result;
      }
      async getSignatureStatus(e, t) {
        let { context: r, value: n } = await this.getSignatureStatuses([e], t);
        return tI(1 === n.length), { context: r, value: n[0] };
      }
      async getSignatureStatuses(e, t) {
        let r = [e];
        t && r.push(t);
        let n = em(await this._rpcRequest("getSignatureStatuses", r), r7);
        if ("error" in n)
          throw new tj(n.error, "failed to get signature status");
        return n.result;
      }
      async getTransactionCount(e) {
        let { commitment: t, config: r } = rn(e),
          n = this._buildArgs([], t, void 0, r),
          i = em(await this._rpcRequest("getTransactionCount", n), ra(eB()));
        if ("error" in i)
          throw new tj(i.error, "failed to get transaction count");
        return i.result;
      }
      ...
      async getInflationGovernor(e) {
        let t = this._buildArgs([], e),
          r = em(await this._rpcRequest("getInflationGovernor", t), rB);
        if ("error" in r) throw new tj(r.error, "failed to get inflation");
        return r.result;
      }
      async getInflationReward(e, t, r) {
        let { commitment: n, config: i } = rn(r),
          ...
          o = em(await this._rpcRequest("getInflationReward", s), rh);
        if ("error" in o)
          throw new tj(o.error, "failed to get inflation reward");
        return o.result;
      }
      async getInflationRate() {
        let e = em(await this._rpcRequest("getInflationRate", []), rA);
        if ("error" in e) throw new tj(e.error, "failed to get inflation rate");
        return e.result;
      }
      async getEpochInfo(e) {
        let { commitment: t, config: r } = rn(e),
          n = this._buildArgs([], t, void 0, r),
          i = em(await this._rpcRequest("getEpochInfo", n), rP);
        if ("error" in i) throw new tj(i.error, "failed to get epoch info");
        return i.result;
      }
      async getEpochSchedule() {
        let e = em(await this._rpcRequest("getEpochSchedule", []), rT);
        if ("error" in e) throw new tj(e.error, "failed to get epoch schedule");
        let t = e.result;
        return new t3(
          t.slotsPerEpoch,
      ...
      async getLeaderSchedule() {
        let e = em(await this._rpcRequest("getLeaderSchedule", []), rC);
        if ("error" in e)
          throw new tj(e.error, "failed to get leader schedule");
        return e.result;
      }
      ...
      async getRecentPerformanceSamples(e) {
        ...
        if ("error" in t)
          throw new tj(t.error, "failed to get recent performance samples");
        return t.result;
      }
      async getFeeCalculatorForBlockhash(e, t) {
        let r = this._buildArgs([e], t),
          n = em(await this._rpcRequest("getFeeCalculatorForBlockhash", r), nA);
        if ("error" in n) throw new tj(n.error, "failed to get fee calculator");
        let { context: i, value: s } = n.result;
        return { context: i, value: null !== s ? s.feeCalculator : null };
      }
      async getFeeForMessage(e, t) {
        let r = td(e.serialize()).toString("base64"),
          n = this._buildArgs([r], t),
          i = em(await this._rpcRequest("getFeeForMessage", n), rc(e_(eB())));
        if ("error" in i)
          throw new tj(i.error, "failed to get fee for message");
      ...
      async getRecentPrioritizationFees(e) {
        let t = e?.lockedWritableAccounts?.map((e) => e.toBase58()),
          r = t?.length ? [t] : [],
          n = em(await this._rpcRequest("getRecentPrioritizationFees", r), rE);
        if ("error" in n)
          throw new tj(n.error, "failed to get recent prioritization fees");
        return n.result;
      }
      ...
      async getLatestBlockhashAndContext(e) {
        let { commitment: t, config: r } = rn(e),
          n = this._buildArgs([], t, void 0, r),
          i = em(await this._rpcRequest("getLatestBlockhash", n), nI);
        if ("error" in i)
          throw new tj(i.error, "failed to get latest blockhash");
        return i.result;
      }
      async isBlockhashValid(e, t) {
        let { commitment: r, config: n } = rn(t),
          i = this._buildArgs([e], r, void 0, n),
          s = em(await this._rpcRequest("isBlockhashValid", i), n_);
        if ("error" in s)
          throw new tj(
            s.error,
      ...
      async getVersion() {
        let e = em(await this._rpcRequest("getVersion", []), ra(rS));
        if ("error" in e) throw new tj(e.error, "failed to get version");
        return e.result;
      }
      async getGenesisHash() {
        let e = em(await this._rpcRequest("getGenesisHash", []), ra(eP()));
        if ("error" in e) throw new tj(e.error, "failed to get genesis hash");
        return e.result;
      }
      async getBlock(e, t) {
        let { commitment: r, config: n } = rn(t),
        ...
        try {
                ...
                ? {
                    ...
                    transactions: t.transactions.map(
                      ({ transaction: e, meta: t, version: r }) => ({
                        meta: t,
                        transaction: { ...e, message: rl(r, e.message) },
                        version: r,
                      })
                    ),
                  }
          ...
          throw new tj(e, "failed to get confirmed block");
        }
      }
      async getParsedBlock(e, t) {
        ...
        try {
          ...
          throw new tj(e, "failed to get block");
        }
      }
      async getBlockProduction(e) {
        ...
        let n = this._buildArgs([], r, "base64", t),
          i = em(await this._rpcRequest("getBlockProduction", n), r_);
        if ("error" in i)
          throw new tj(i.error, "failed to get block production information");
        return i.result;
      }
      async getTransaction(e, t) {
        let { commitment: r, config: n } = rn(t),
          i = this._buildArgsAtLeastConfirmed([e], r, void 0, n),
          s = em(await this._rpcRequest("getTransaction", i), nv);
        if ("error" in s) throw new tj(s.error, "failed to get transaction");
        let o = s.result;
        return o
          ? {
              ...o,
              transaction: {
                ...o.transaction,
                message: rl(o.version, o.transaction.message),
              },
            }
          : o;
      }
      async getParsedTransaction(e, t) {
        let { commitment: r, config: n } = rn(t),
          i = this._buildArgsAtLeastConfirmed([e], r, "jsonParsed", n),
          s = em(await this._rpcRequest("getTransaction", i), nx);
        if ("error" in s) throw new tj(s.error, "failed to get transaction");
        return s.result;
      }
      async getParsedTransactions(e, t) {
        ...
        return (await this._rpcBatchRequest(i)).map((e) => {
          let t = em(e, nx);
          if ("error" in t) throw new tj(t.error, "failed to get transactions");
          return t.result;
        });
      }
        ...
        return (await this._rpcBatchRequest(i)).map((e) => {
          ...
          return r
            ? {
                ...
                transaction: {
                  ...r.transaction,
                  message: rl(r.version, r.transaction.message),
                },
              }
            : r;
        });
      ...
      async getConfirmedBlock(e, t) {
        let r = this._buildArgsAtLeastConfirmed([e], t),
          n = em(await this._rpcRequest("getBlock", r), nk);
        if ("error" in n)
          throw new tj(n.error, "failed to get confirmed block");
        let i = n.result;
        if (!i) throw Error("Confirmed block " + e + " not found");
        let s = {
          ...i,
          transactions: i.transactions.map(({ transaction: e, meta: t }) => {
            let r = new tP(e.message);
        ...
        return {
          ...
          transactions: s.transactions.map(({ transaction: e, meta: t }) => ({
            meta: t,
            transaction: tz.populate(e.message, e.signatures),
          })),
        };
      }
      async getBlocks(e, t, r) {
        let n = this._buildArgsAtLeastConfirmed(void 0 !== t ? [e, t] : [e], r),
          i = em(await this._rpcRequest("getBlocks", n), ra(eS(eB())));
        if ("error" in i) throw new tj(i.error, "failed to get blocks");
        return i.result;
      }
      async getBlockSignatures(e, t) {
        let r = this._buildArgsAtLeastConfirmed([e], t, void 0, {
          ...
          n = em(await this._rpcRequest("getBlock", r), nS);
        if ("error" in n) throw new tj(n.error, "failed to get block");
        let i = n.result;
      ...
      async getConfirmedTransaction(e, t) {
        let r = this._buildArgsAtLeastConfirmed([e], t),
          n = em(await this._rpcRequest("getTransaction", r), nv);
        if ("error" in n) throw new tj(n.error, "failed to get transaction");
        let i = n.result;
        if (!i) return i;
        let s = new tP(i.transaction.message),
          o = i.transaction.signatures;
        return { ...i, transaction: tz.populate(s, o) };
      }
      async getParsedConfirmedTransaction(e, t) {
        let r = this._buildArgsAtLeastConfirmed([e], t, "jsonParsed"),
          n = em(await this._rpcRequest("getTransaction", r), nx);
        if ("error" in n)
          throw new tj(n.error, "failed to get confirmed transaction");
        return n.result;
      }
      async getParsedConfirmedTransactions(e, t) {
        ...
        return (await this._rpcBatchRequest(r)).map((e) => {
          let t = em(e, nx);
          if ("error" in t)
            throw new tj(t.error, "failed to get confirmed transactions");
          return t.result;
        });
      }
      ...
      async getSignaturesForAddress(e, t, r) {
        let n = this._buildArgsAtLeastConfirmed([e.toBase58()], r, void 0, t),
          i = em(await this._rpcRequest("getSignaturesForAddress", n), rV);
        if ("error" in i)
          throw new tj(i.error, "failed to get signatures for address");
        return i.result;
      }
      async getAddressLookupTable(e, t) {
        let { context: r, value: n } = await this.getAccountInfoAndContext(
          ...
          i = null;
        return (
          null !== n && (i = new t6({ key: e, state: t6.deserialize(n.data) })),
          { context: r, value: i }
        );
      }
      async getNonceAndContext(e, t) {
        let { context: r, value: n } = await this.getAccountInfoAndContext(
          ...
          i = null;
        return (
          null !== n && (i = tZ.fromAccountData(n.data)),
          { context: r, value: i }
        );
      }
      async getNonce(e, t) {
      ...
      async requestAirdrop(e, t) {
        ...
        if ("error" in r)
          throw new tj(r.error, `airdrop to ${e.toBase58()} failed`);
        return r.result;
      }
      async _blockhashWithExpiryBlockHeight(e) {
        if (!e) {
          for (; this._pollingBlockhash; ) await tH(100);
      ...
      async getStakeMinimumDelegation(e) {
        ...
        if ("error" in i)
          throw new tj(i.error, "failed to get stake minimum delegation");
        return i.result;
      }
      async simulateTransaction(e, t, r) {
        ...
        if ("message" in e) {
          ...
          let a = [i, s],
            c = em(await this._rpcRequest("simulateTransaction", a), rI);
          if ("error" in c)
        ...
        let u = [a, c],
          l = em(await this._rpcRequest("simulateTransaction", u), rI);
        if ("error" in l) {
          let e;
          if (
            "data" in l.error &&
      ...
      async sendEncodedTransaction(e, t) {
        ...
        let s = [e, r],
          o = em(await this._rpcRequest("sendTransaction", s), nP);
        if ("error" in o) {
          let e;
          throw (
      ...
      _wsOnAccountNotification(e) {
        let { result: t, subscription: r } = em(e, rG);
      ...
      _wsOnProgramAccountNotification(e) {
        let { result: t, subscription: r } = em(e, rY);
      ...
      onProgramAccountChange(e, t, r, n) {
        let { commitment: i, config: s } = rn(r),
          o = this._buildArgs(
            [e.toBase58()],
            i || this._commitment || "finalized",
            "base64",
            s || (n ? { filters: ri(n) } : void 0)
          );
        return this._makeSubscription(
          {
            callback: t,
      ...
      _wsOnLogsNotification(e) {
        let { result: t, subscription: r } = em(e, nC);
        this._handleServerNotification(r, [t.value, t.context]);
      }
      _wsOnSlotNotification(e) {
        let { result: t, subscription: r } = em(e, rX);
      ...
      _wsOnSlotUpdatesNotification(e) {
        let { result: t, subscription: r } = em(e, r0);
        this._handleServerNotification(r, [t]);
      }
      onSlotUpdate(e) {
        return this._makeSubscription(
      ...
      _wsOnSignatureNotification(e) {
        let { result: t, subscription: r } = em(e, r1);
      ...
      _wsOnRootNotification(e) {
        let { result: t, subscription: r } = em(e, r2);
        this._handleServerNotification(r, [t]);
      }
      onRootChange(e) {
        return this._makeSubscription(
    ...
    class nR {
      constructor(e) {
        (this._keypair = void 0), (this._keypair = e ?? to());
      }
      static generate() {
        return new nR(to());
      }
      static fromSecretKey(e, t) {
        ...
        if (!t || !t.skipValidation) {
          let t = ta(e.slice(0, 32));
          for (let e = 0; e < 32; e++)
            if (r[e] !== t[e]) throw Error("provided secretKey is invalid");
        }
        return new nR({ publicKey: r, secretKey: e });
      }
      static fromSeed(e) {
        let t = ta(e),
          r = new Uint8Array(64);
        return r.set(e), r.set(t, 32), new nR({ publicKey: t, secretKey: r });
      }
      get publicKey() {
        return new tg(this._keypair.publicKey);
      }
      get secretKey() {
    ...
    Object.freeze({
      ...
      ExtendLookupTable: {
        ...
        layout: es.struct([
          es.u32("instruction"),
          tX(),
          es.seq(tk(), es.offset(es.u32(), -8), "addresses"),
        ]),
      },
      ...
      new tg("AddressLookupTab1e1111111111111111111111111");
    let nz = Object.freeze({
      RequestUnits: {
        ...
        layout: es.struct([
          es.u8("instruction"),
          es.u32("units"),
          es.u32("additionalFee"),
        ]),
      },
      RequestHeapFrame: {
        index: 1,
        layout: es.struct([es.u8("instruction"), es.u32("bytes")]),
      },
      SetComputeUnitLimit: {
        index: 2,
        layout: es.struct([es.u8("instruction"), es.u32("units")]),
      },
      SetComputeUnitPrice: {
        index: 3,
        layout: es.struct([es.u8("instruction"), tX("microLamports")]),
      },
    });
    class nU {
      static requestUnits(e) {
        let t = tV(nz.RequestUnits, e);
        return new tR({ keys: [], programId: this.programId, data: t });
      }
      static requestHeapFrame(e) {
        let t = tV(nz.RequestHeapFrame, e);
        return new tR({ keys: [], programId: this.programId, data: t });
      }
      static setComputeUnitLimit(e) {
        let t = tV(nz.SetComputeUnitLimit, e);
        return new tR({ keys: [], programId: this.programId, data: t });
      }
      static setComputeUnitPrice(e) {
        let t = tV(nz.SetComputeUnitPrice, {
          microLamports: BigInt(e.microLamports),
        });
        return new tR({ keys: [], programId: this.programId, data: t });
      }
    }
    nU.programId = new tg("ComputeBudget111111111111111111111111111111");
    let nW = es.struct([
      es.u8("numSignatures"),
      es.u8("padding"),
      es.u16("signatureOffset"),
      es.u16("signatureInstructionIndex"),
      es.u16("publicKeyOffset"),
      es.u16("publicKeyInstructionIndex"),
      es.u16("messageDataOffset"),
      es.u16("messageDataSize"),
      es.u16("messageInstructionIndex"),
    ]);
    class nN {
      static createInstructionWithPublicKey(e) {
        ...
        return (
          ...
          u.fill(n, a),
          u.fill(r, c),
          new tR({ keys: [], programId: nN.programId, data: u })
        );
      }
    ...
    (nN.programId = new tg("Ed25519SigVerify111111111111111111111111111")),
      tr.utils.isValidPrivateKey;
    let nq = tr.getPublicKey,
      nK = es.struct([
        es.u8("numSignatures"),
        es.u16("signatureOffset"),
        es.u8("signatureInstructionIndex"),
        es.u16("ethAddressOffset"),
        es.u8("ethAddressInstructionIndex"),
        es.u16("messageDataOffset"),
        es.u16("messageDataSize"),
        es.u8("messageInstructionIndex"),
        es.blob(20, "ethAddress"),
        es.blob(64, "signature"),
        es.u8("recoveryId"),
      ]);
    class nM {
      static publicKeyToEthAddress(e) {
        ...
        try {
          return o.Buffer.from(e8(td(e))).slice(-20);
        } catch (e) {
      ...
      static createInstructionWithPublicKey(e) {
        ...
        return nM.createInstructionWithEthAddress({
          ethAddress: nM.publicKeyToEthAddress(t),
          message: r,
          signature: n,
          recoveryId: i,
          instructionIndex: s,
      ...
      static createInstructionWithEthAddress(e) {
        ...
        let c = 12 + t.length,
          u = c + i.length + 1,
          l = o.Buffer.alloc(nK.span + n.length);
        return (
          nK.encode(
            {
              numSignatures: 1,
          ...
          l.fill(td(n), nK.span),
          new tR({ keys: [], programId: nM.programId, data: l })
        );
      }
      static createInstructionWithPrivateKey(e) {
        let { privateKey: t, message: r, instructionIndex: n } = e;
        ...
        try {
          ...
          let e,
            ...
            a = nq(s, !1).slice(1),
            [c, u] =
              ((i = o.Buffer.from(e8(td(r)))),
              [(e = tr.sign(i, s)).toCompactRawBytes(), e.recovery]);
          return this.createInstructionWithPublicKey({
            publicKey: a,
            message: r,
            signature: c,
    ...
    nM.programId = new tg("KeccakSecp256k11111111111111111111111111111");
    let nD = new tg("StakeConfig11111111111111111111111111111111");
    class nF {
      constructor(e, t, r) {
    ...
    nF.default = new nF(0, 0, tg.default);
    let nj = Object.freeze({
        Initialize: {
          ...
          layout: es.struct([
            es.u32("instruction"),
            ((e = "authorized") =>
              es.struct([tk("staker"), tk("withdrawer")], e))(),
            ((e = "lockup") =>
              es.struct(
                [es.ns64("unixTimestamp"), es.ns64("epoch"), tk("custodian")],
                e
              ))(),
          ]),
        },
        Authorize: {
          ...
          layout: es.struct([
            es.u32("instruction"),
            tk("newAuthorized"),
            es.u32("stakeAuthorizationType"),
          ]),
        },
        Delegate: { index: 2, layout: es.struct([es.u32("instruction")]) },
        Split: {
          index: 3,
          layout: es.struct([es.u32("instruction"), es.ns64("lamports")]),
        },
        ...
        Deactivate: { index: 5, layout: es.struct([es.u32("instruction")]) },
        Merge: { index: 7, layout: es.struct([es.u32("instruction")]) },
        AuthorizeWithSeed: {
          index: 8,
          layout: es.struct([
            es.u32("instruction"),
      ...
      n$ = Object.freeze({ Staker: { index: 0 }, Withdrawer: { index: 1 } });
    class nH {
      static initialize(e) {
        let { stakePubkey: t, authorized: r, lockup: n } = e,
          ...
          s = tV(nj.Initialize, {
            authorized: {
              staker: td(r.staker.toBuffer()),
              withdrawer: td(r.withdrawer.toBuffer()),
            },
            lockup: {
              unixTimestamp: i.unixTimestamp,
              epoch: i.epoch,
              custodian: td(i.custodian.toBuffer()),
            },
          });
        return new tR({
          keys: [
      ...
      static delegate(e) {
        ...
        return new tz().add({
          keys: [
            ...
            { pubkey: tD, isSigner: !1, isWritable: !1 },
            { pubkey: nD, isSigner: !1, isWritable: !1 },
      ...
      static authorize(e) {
        let {
          ...
          o = tV(nj.Authorize, {
            newAuthorized: td(n.toBuffer()),
            stakeAuthorizationType: i.index,
          }),
          a = [
            { pubkey: t, isSigner: !1, isWritable: !0 },
            { pubkey: tN, isSigner: !1, isWritable: !0 },
            { pubkey: r, isSigner: !0, isWritable: !1 },
          ];
        return (
          s && a.push({ pubkey: s, isSigner: !0, isWritable: !1 }),
          new tz().add({ keys: a, programId: this.programId, data: o })
        );
      }
      static authorizeWithSeed(e) {
        let {
          ...
          c = tV(nj.AuthorizeWithSeed, {
            newAuthorized: td(s.toBuffer()),
            stakeAuthorizationType: o.index,
            authoritySeed: n,
            authorityOwner: td(i.toBuffer()),
          }),
          u = [
            { pubkey: t, isSigner: !1, isWritable: !0 },
            { pubkey: r, isSigner: !0, isWritable: !1 },
        ...
        return (
          ...
          new tz().add({ keys: u, programId: this.programId, data: c })
        );
      }
    ...
    (nH.programId = new tg("Stake11111111111111111111111111111111111111")),
      (nH.space = 200);
        ...
        layout: es.struct([
          ...
          ((e = "voteAuthorizeWithSeedArgs") =>
            es.struct(
              [
                es.u32("voteAuthorizationType"),
                tk("currentAuthorityDerivedKeyOwnerPubkey"),
                tS("currentAuthorityDerivedKeySeed"),
                tk("newAuthorized"),
              ],
              e
            ))(),
    ...
    class nG {
      static initializeAccount(e) {
        let { votePubkey: t, nodePubkey: r, voteInit: n } = e,
          i = tV(nV.InitializeAccount, {
            voteInit: {
              nodePubkey: td(n.nodePubkey.toBuffer()),
              authorizedVoter: td(n.authorizedVoter.toBuffer()),
              authorizedWithdrawer: td(n.authorizedWithdrawer.toBuffer()),
      ...
      static authorizeWithSeed(e) {
        let {
          ...
          a = tV(nV.AuthorizeWithSeed, {
            voteAuthorizeWithSeedArgs: {
              currentAuthorityDerivedKeyOwnerPubkey: td(r.toBuffer()),
              currentAuthorityDerivedKeySeed: n,
              newAuthorized: td(i.toBuffer()),
    ...
    (nG.programId = new tg("Vote111111111111111111111111111111111111111")),
      (nG.space = 3762),
      new tg("Va1idator1nfo111111111111111111111111111111"),
      eC({
        name: eP(),
        website: eA(eP()),
        details: eA(eP()),
        iconUrl: eA(eP()),
        keybaseUsername: eA(eP()),
      }),
      new tg("Vote111111111111111111111111111111111111111"),
      es.struct([
        tk("nodePubkey"),
        tk("authorizedWithdrawer"),
        es.u8("commission"),
        es.nu64(),
        es.seq(
          es.struct([es.nu64("slot"), es.u32("confirmationCount")]),
          es.offset(es.u32(), -8),
          "votes"
        ),
        es.u8("rootSlotValid"),
        ...
        es.nu64(),
        es.seq(
          es.struct([es.nu64("epoch"), tk("authorizedVoter")]),
          es.offset(es.u32(), -8),
          "authorizedVoters"
        ),
        es.struct(
          [
            es.seq(
              es.struct([
                tk("authorizedPubkey"),
                es.nu64("epochOfLastAuthorizedSwitch"),
                es.nu64("targetEpoch"),
              ]),
              32,
              "buf"
        ...
        es.struct([es.nu64("slot"), es.nu64("timestamp")], "lastTimestamp"),
      ]),
      e.s(
        [
...
//# debugId=1570fbee-75a1-5508-0e3b-d6d34027028c
//# sourceMappingURL=644d843793258fe4.js.map
