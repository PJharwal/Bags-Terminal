  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "37ea4c1a-a5d0-7b79-e54f-fe2fe6876884");
  } catch (e) {}
})();
  ...
  (e) => {
    ...
    function l(e, r) {
      ...
      if (((t = i && !i[0]), (n = s && !s[0]), t || n))
        return t ? (n ? 0 : -f) : o;
      if (o != f) return o;
      if (((t = o < 0), (n = u == l), !i || !s)) return n ? 0 : !i ^ t ? 1 : -1;
      ...
      return (
        ...
        (G.isBigNumber = function (e) {
          ...
          e: if ("[object Array]" == {}.toString.call(s)) {
            if ((1 === f || -1 === f) && o >= -1e9 && o <= 1e9 && o === n(o)) {
              if (0 === s[0]) {
                if (0 === o && 1 === s.length) return !0;
                break e;
              }
              if (
                ((r = (o + 1) % 14) < 1 && (r += 14), String(s[0]).length == r)
              ) {
        ...
        (A.decimalPlaces = A.dp =
          function (e, r) {
            ...
            if (((n = ((i = t.length - 1) - f(this.e / 14)) * 14), (i = t[i])))
              for (; i % 10 == 0; i /= 10, n--);
            return n < 0 && (n = 0), n;
          }),
        (A.dividedBy = A.div =
          ...
          function (e, r) {
            ...
            for (
              ...
              if (f) {
                if (0 === (f = n(f / 2))) break;
                g = f % 2;
              } else if ((q((e = e.times(s)), e.e + 1, 1), e.e > 14)) g = a(e);
              else {
                if (0 == (f = +$(e))) break;
                g = f % 2;
              }
              ...
              ? e.c && (!this.c || this.c[0])
                ? (9 == U
                    ? ((n = e.s),
                      ...
                      (t.s *= n))
                    : (t = b(this, e, 0, U)),
                  (e = this.minus(t.times(e))).c[0] || 1 != U || (e.s = this.s),
                  e)
                : new G(this)
              : new G(NaN);
          }),
            ...
            if (
              ...
              for ((o = (l = t.e) + c) < 3 && (o = 0); ; )
                if (
                  ...
                  if (
                    (t.e < l && --o,
                    "9999" != (r = r.slice(o - 3, o + 1)) && (n || "4999" != r))
                  ) {
    ...
    e.s(["BigNumber", () => p, "default", 0, p]);
  },
]);

//# debugId=37ea4c1a-a5d0-7b79-e54f-fe2fe6876884
//# sourceMappingURL=784a9ad12e496bb1.js.map
