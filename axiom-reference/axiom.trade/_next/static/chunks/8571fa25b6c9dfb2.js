  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "7356cae4-b540-cf8d-b227-bfa85784501c");
  } catch (e) {}
})();
  ...
  (t, e, r) => {
    ...
    (r.byteLength = function (t) {
      ...
      (r.fromByteArray = function (t) {
        for (
          var e, r = t.length, i = r % 3, o = [], f = 0, u = r - i;
          f < u;
          f += 16383
        )
          o.push(
  ...
  (t, e, r) => {
    ...
    function s(t, e, r) {
      if ("string" == typeof t) {
        var n = t,
          i = e;
        if (
          (("string" != typeof i || "" === i) && (i = "utf8"), !u.isEncoding(i))
        )
    ...
    (r.Buffer = u),
      ...
      (u.prototype.write = function (t, e, r, n) {
        ...
        for (;;)
          switch (n) {
            ...
            case "utf8":
            case "utf-8":
              return (i = e), (o = r), N($(t, this.length - i), this, i, o);
            case "ascii":
            case "latin1":
            case "binary":
              return (
      ...
      (u.prototype.readUint16LE = u.prototype.readUInt16LE =
        function (t, e) {
          return (
            (t >>>= 0), e || E(t, 2, this.length), this[t] | (this[t + 1] << 8)
          );
        }),
      (u.prototype.readUint16BE = u.prototype.readUInt16BE =
        function (t, e) {
          return (
            (t >>>= 0), e || E(t, 2, this.length), (this[t] << 8) | this[t + 1]
          );
        }),
        ...
        throw (
          ((n =
            o > 3
              ...
              : `>= ${e}${i} and <= ${r}${i}`),
          new x.ERR_OUT_OF_RANGE("value", n, t))
        );
      }
      S(i, "offset"),
        (void 0 === n[i] || void 0 === n[i + o]) && _(i, n.length - (o + 1));
    }
    function S(t, e) {
      if ("number" != typeof t)
    ...
    function _(t, e, r) {
      if (Math.floor(t) !== t)
        throw (S(t, r), new x.ERR_OUT_OF_RANGE(r || "offset", "an integer", t));
...
//# debugId=7356cae4-b540-cf8d-b227-bfa85784501c
//# sourceMappingURL=b2dc04fd9e95fbec.js.map
