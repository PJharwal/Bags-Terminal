  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "86512bad-00a4-174a-d194-e44f634835e6");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    let i = {
        protocols: {
          ...
          "Pancakeswap V2": !1,
          "Pancakeswap V3": !1,
          "Generic Uniswap V2": !1,
          "Generic Uniswap V3": !1,
          "Generic Uniswap V4": !1,
          "Generic Pancakeswap V2": !1,
          "Generic Pancakeswap V3": !1,
        },
        searchKeywords: [],
        excludeKeywords: [],
        dexPaid: !1,
      ...
      s = { newPairs: i, finalStretch: i, migrated: i };
    t.s(
      ["DEFAULT_ALL_BNB_FILTERS", 0, s, "DEFAULT_BNB_FILTER_STATE", 0, i],
      261980
    );
    let a = {
        "Fourmeme V2": {
          name: "Four.meme",
          color: "#7ce660",
          icon: "/images/evm/protocols/fourmeme.svg",
          social: {
            glyph: "icon-fourmeme",
            link: ({ tokenAddress: t }) =>
              t ? `https://four.meme/token/${t}` : "https://four.meme",
          },
          migratedInfo: {
            ...
            icon: "/images/evm/protocols/fourmeme-grad.svg",
            social: {
              glyph: "icon-fourmeme",
              link: ({ tokenAddress: t }) =>
                t ? `https://four.meme/token/${t}` : "https://four.meme",
        ...
        "Uniswap V2": {
          name: "Uniswap V2",
          color: "#F50DB4",
          icon: "/images/evm/protocols/uniswap.svg",
          migratedInfo: null,
        },
        "Uniswap V3": {
          name: "Uniswap V3",
        ...
        "Pancakeswap V2": {
          name: "Pancakeswap V2",
          color: "#D1884F",
          icon: "/images/evm/protocols/pancake.svg",
          migratedInfo: null,
        },
        "Pancakeswap V3": {
          name: "Pancakeswap V3",
        ...
        "Generic Uniswap V2": {
          name: "Generic Uniswap V2",
          color: "#F50DB4",
          icon: "/images/evm/protocols/uniswap.svg",
          migratedInfo: null,
        },
        "Generic Uniswap V3": {
          name: "Generic Uniswap V3",
          color: "#F50DB4",
          icon: "/images/evm/protocols/uniswap.svg",
          migratedInfo: null,
        },
        "Generic Uniswap V4": {
          name: "Generic Uniswap V4",
          color: "#F50DB4",
          icon: "/images/evm/protocols/uniswap.svg",
          migratedInfo: null,
        },
        "Generic Pancakeswap V2": {
          name: "Generic Pancakeswap V2",
          color: "#D1884F",
          icon: "/images/evm/protocols/pancake.svg",
          migratedInfo: null,
        },
        "Generic Pancakeswap V3": {
          name: "Generic Pancakeswap V3",
          color: "#D1884F",
          icon: "/images/evm/protocols/pancake.svg",
          migratedInfo: null,
        },
        Binance: {
          name: "X Mode",
          color: "#F0B90B",
          icon: "/images/evm/protocols/binance.svg",
          social: {
            glyph: "icon-binance",
            link: ({ tokenAddress: t }) =>
              t
                ? `https://web3.binance.com/en/token/bsc/${t}`
                : "https://web3.binance.com/en/markets/trending?chain=bsc",
          },
          migratedInfo: {
            protocol: "Binance",
            name: "X Mode",
            color:
              "linear-gradient(219deg, #FFD700 0%, #DAA520 48.97%, #B8860B 48.98%, #996515 100%)",
            icon: "/images/evm/protocols/binance-grad.svg",
            social: {
              glyph: "icon-binance",
              link: ({ tokenAddress: t }) =>
                t
      ...
      f = {
        newPairs: [
          ...
          "Binance",
          {
            ...
            color: "#D1884F",
            icon: "/images/evm/protocols/pancake.svg",
            protocols: ["Pancakeswap V2", "Pancakeswap V3"],
          },
          {
            name: "Uniswap",
            color: "#F50DB4",
        ...
        finalStretch: ["Fourmeme V2", "Binance"],
        migrated: ["Fourmeme V2", "Binance"],
      };
    t.s(
      [
        "BNB_ENABLED_PROTOCOLS_BY_TABLE",
        0,
        f,
        "BNB_PROTOCOL_INFO",
        0,
        a,
        "isNonTransferrableProtocol",
        0,
        (t) => "Fourmeme V2" === t || "Binance" === t,
      ],
      562406
    );
    let u = {
        wbnb: {
          symbol: "WBNB",
          icon: "/images/evm/tokens/bnb.svg",
          decimals: 18,
          color: "#F0B90B",
        ...
        usdt: {
          symbol: "USDT",
          icon: "/images/evm/tokens/usdt.svg",
          decimals: 18,
          color: "#009393",
        ...
        usd1: {
          symbol: "USD1",
          icon: "/images/evm/tokens/usd1.svg",
          decimals: 18,
          color: "#EAAC0D",
        ...
        cake: {
          symbol: "CAKE",
          icon: "/images/evm/tokens/cake.svg",
          decimals: 18,
          color: "#53DEE9",
        ...
        aster: {
          symbol: "ASTER",
          icon: "/images/evm/tokens/aster.png",
          decimals: 18,
          color: "#F9D3A8",
          address: "0x000ae314e2a2172a039b26378814c252734f556a",
          intermediatePool: {
            address: "0x7d98804119551f915a75cE278526ac7eE5077087",
            fee: 3e3,
          },
        },
        lisusd: {
          symbol: "lisUSD",
          icon: "/images/evm/tokens/lisusd.png",
          decimals: 18,
          color: "#746DE5",
        ...
        usdc: {
          symbol: "USDC",
          icon: "/images/evm/tokens/usdc.svg",
          decimals: 18,
          color: "#2775CA",
        ...
        u: {
          symbol: "U",
          icon: "/images/evm/tokens/u.svg",
          decimals: 18,
          color: "#BDA357",
          address: "0xce24439f2d9c6a2289f741120fe202248b666666",
          intermediatePool: {
            address: "0x882e23dba77bfe0e514cf5bcdad7a58aceb01522",
            fee: 500,
          },
        },
      },
      c = Object.fromEntries(Object.keys(u).map((t) => [u[t].address, t]));
    function l(t, e, r) {
      let n = t.toLowerCase(),
        o = e?.toLowerCase(),
        i = r?.toLowerCase();
      return n in c && (void 0 === i || i !== n)
        ? c[n]
        : o && o in c && (void 0 === i || i !== o)
        ? c[o]
        : null;
    }
    t.s(
      [
        "BNB_QUOTE_TOKEN_ADDRESS_TO_NAME",
        0,
        c,
        "BNB_QUOTE_TOKEN_INFO",
        0,
        u,
        "getQuoteTokenFromAddresses",
        () => l,
      ],
      734532
    );
    ...
    let p = (t) => {
        try {
          return new h.PublicKey(t).toBase58() === t;
        } catch {
          return !1;
        }
      },
      d = (t) => {
        try {
          return /^0x[0-9a-fA-F]{40}$/.test(t) || /^0x[0-9a-fA-F]{64}$/.test(t);
        } catch {
          return !1;
        }
      };
    t.s(["isValidEvmAddress", 0, d, "isValidSolanaAddress", 0, p], 253646);
    var g = t.i(447800);
    let m = {
        sol: {
          ticker: "SOL",
          ...
          explorer: {
            name: "Solscan",
            link: ({ tokenAddress: t, txHash: e, address: r }) =>
              t
                ? `https://solscan.io/token/${t}`
                : e
                ? `https://solscan.io/tx/${e}`
                : r
                ? `https://solscan.io/account/${r}`
                : "https://solscan.io",
          },
          type: "sol",
          insightxChainId: "solana",
          config: {
            quoteTokenAddressToName: {},
            quoteTokenInfo: {},
            protocolInfo: {},
            enabledProtocolsByTable: {
              newPairs: [],
              finalStretch: [],
              migrated: [],
            },
            defaultAllFilters: { newPairs: {}, finalStretch: {}, migrated: {} },
          },
          fundingWalletMap: g.FUNDING_WALLET_MAP,
          kolWallets: g.SOL_KOL_WALLETS,
        },
        bnb: {
          ticker: "BNB",
          full: "BNB",
          ...
          explorer: {
            ...
            link: ({ tokenAddress: t, txHash: e, address: r }) =>
              t
                ? `https://bscscan.com/token/${t}`
                : e
                ? `https://bscscan.com/tx/${e}`
                : r
                ? `https://bscscan.com/address/${r}`
                : "https://bscscan.com",
          },
          type: "evm",
          insightxChainId: "56",
          config: {
            quoteTokenInfo: u,
            protocolInfo: a,
            enabledProtocolsByTable: f,
            defaultAllFilters: s,
            quoteTokenAddressToName: c,
          },
          fundingWalletMap: g.BNB_FUNDING_WALLET_MAP,
          kolWallets: g.BNB_KOL_WALLETS,
        },
      },
      y = ["/yield", "/vision"];
    function b() {
      let t = new URLSearchParams(window.location.search).get("chain"),
        e = "sol";
      if ("bnb" === t) e = "bnb";
      else if ("sol" === t) e = "sol";
      else
        try {
          let t = localStorage.getItem("currentChain");
          if (t) {
            let r = JSON.parse(t);
            ("bnb" === r || "sol" === r) && (e = r);
          }
      ...
      return "bnb" === e && y.includes(r)
        ? ((window.location.href = "/pulse?chain=bnb"), "bnb")
        : e;
    }
    let w = (0, e.atom)(b());
    w.onMount = (t) => {
      if (!new URLSearchParams(window.location.search).get("chain")) {
        let t = b(),
          e = window.location.pathname;
        if (!("bnb" === t && y.includes(e))) {
          let e = new URL(window.location.href);
          e.searchParams.set("chain", t),
      ...
      let e = () => {
        ...
        if ("bnb" === e && y.includes(r)) {
          window.location.href = "/pulse?chain=bnb";
          return;
        }
        t(e);
        try {
          localStorage.setItem("currentChain", JSON.stringify(e));
        } catch {}
      };
      return (
    ...
    let v = (0, e.atom)(
        (t) => t(w),
        (t, e, r) => {
          let n = "object" == typeof r ? r.chain : r,
            o = "object" == typeof r && r.skipUrlUpdate;
          if (t(w) !== n) {
            e(w, n);
            try {
              localStorage.setItem("currentChain", JSON.stringify(n));
            } catch {}
            if (!o) {
              let t = new URL(window.location.href);
              t.searchParams.set("chain", n),
    ...
    (0, e.atom)(0);
    let A = (0, e.atom)((t) => t(v)),
      E = { "/yield": "/pulse", "/vision": "/pulse" },
      U = [{ pattern: /^\/meme\//, redirectTo: "/discover" }];
    function k() {
      return "bnb" === new URLSearchParams(window.location.search).get("chain")
        ? "bnb"
        : "sol";
    }
    t.s(
      [
        ...
        (t) => {
          if (p(t)) return "sol";
          if (d(t)) return "bnb";
          throw Error(`Invalid address ${t} on chain ${t.slice(0, 4)}...`);
        },
        "getChainFromUrl",
        () => k,
        "totalBnbBalanceAtom",
        0,
        B,
        "trackedWalletsChainAtom",
        0,
        A,
        "useCurrentChainInfo",
        0,
        () => m[(0, r.useAtomValue)(v)],
        "useUpdateChain",
        0,
        () => {
          let t = (0, r.useSetAtom)(v),
            e = (0, r.useAtomValue)(v),
            i = (0, n.useRouter)();
          return (0, o.useCallback)(
            (r) => {
              ...
              let n = (function (t, e) {
                let r = E[t];
                if (r && "bnb" === e) return r;
                let n = U.find((e) => e.pattern.test(t));
                return n ? n.redirectTo : null;
              })(window.location.pathname, r);
              n
                ? (t({ chain: r, skipUrlUpdate: !0 }),
                  i.push(`${n}?chain=${r}`))
                : t(r);
            },
            [t, e, i]
          ...
          function f(t, e, r) {
            ...
            if (
              ...
              ("undefined" != typeof SharedArrayBuffer &&
                (I(t, SharedArrayBuffer) ||
                  (t && I(t.buffer, SharedArrayBuffer))))
            )
            ...
            if (null != c && c !== t) return a.from(c, e, r);
            var d = (function (t) {
              if (a.isBuffer(t)) {
                var e = 0 | h(t.length),
                  r = s(e);
          ...
          (a.isBuffer = function (t) {
            ...
            (a.concat = function (t, e) {
              ...
              for (r = 0; r < t.length; ++r) {
                var i = t[r];
                if ((I(i, Uint8Array) && (i = a.from(i)), !a.isBuffer(i)))
                  throw TypeError(
          ...
          (a.prototype.write = function (t, e, r, n) {
            ...
            for (var p = !1; ; )
              switch (n) {
                ...
                case "utf8":
                case "utf-8":
                  return (o = e), (i = r), T(U(t, this.length - o), this, o, i);
                case "ascii":
                  return (s = e), (a = r), T(k(t), this, s, a);
                case "latin1":
                case "binary":
                  return (function (t, e, r, n) {
                    return T(k(e), t, r, n);
            ...
            (a.prototype.writeInt32LE = function (t, e, r) {
              return (
                (t *= 1),
                (e >>>= 0),
                r || v(this, t, e, 4, 0x7fffffff, -0x80000000),
                (this[e] = 255 & t),
                (this[e + 1] = t >>> 8),
                (this[e + 2] = t >>> 16),
                (this[e + 3] = t >>> 24),
              ...
              for (
                isNaN((e = Math.abs(e))) || e === 1 / 0
                  ...
                  : ((s = Math.floor(Math.log(e) / Math.LN2)),
                    ...
                    s + l >= 1 ? (e += h / f) : (e += h * Math.pow(2, 1 - l)),
                    e * f >= 2 && (s++, (f /= 2)),
                    s + l >= c
                      ? ((a = 0), (s = c))
                      : s + l >= 1
  ...
  (t) => {
    ...
    function p(t) {
      return "string" == typeof t && (t = h(t)), r(t), t;
    }
    function d(...t) {
      let e = 0;
    ...
    function y(t) {
      let e = (e, r) => t(r).update(p(e)).digest(),
        r = t({});
      return (
        (e.outputLen = r.outputLen),
        (e.blockLen = r.blockLen),
    ...
    function b(t = 32) {
      ...
      if (s && "function" == typeof s.randomBytes) return s.randomBytes(t);
    ...
    class x extends g {
      ...
      digestInto(t) {
        o(this), i(t, this), (this.finished = !0);
        let { buffer: e, view: r, blockLen: n, isLE: s } = this,
          { pos: a } = this;
        (e[a++] = 128),
        ...
        for (let t = 0; t < l; t++) u.setUint32(4 * t, h[t], s);
      }
      digest() {
    ...
    t.s(["Chi", () => w, "HashMD", () => x, "Maj", () => v], 940893);
    ...
    class U extends x {
      ...
      process(t, e) {
        for (let r = 0; r < 16; r++, e += 4) E[r] = t.getUint32(e, !1);
        for (let t = 16; t < 64; t++) {
          let e = E[t - 15],
            r = E[t - 2],
            n = u(e, 7) ^ u(e, 18) ^ (e >>> 3),
            o = u(r, 17) ^ u(r, 19) ^ (r >>> 10);
          E[t] = (o + E[t - 7] + n + E[t - 16]) | 0;
        }
        let { A: r, B: n, C: o, D: i, E: s, F: a, G: f, H: c } = this;
        for (let t = 0; t < 64; t++) {
          var l;
          let e =
              (c +
                ...
                E[t]) |
              0,
            h = ((u(r, 2) ^ u(r, 13) ^ u(r, 22)) + v(r, n, o)) | 0;
          (c = f),
            (f = a),
            (a = s),
            (s = (i + e) | 0),
...
//# debugId=86512bad-00a4-174a-d194-e44f634835e6
//# sourceMappingURL=366d6c00161e5210.js.map
