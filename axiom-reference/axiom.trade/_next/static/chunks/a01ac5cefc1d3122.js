  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "ce8c83f7-7bad-7184-4bb7-0ad491e9d2dd");
  } catch (e) {}
})();
  ...
  (e) => {
    ...
    class n extends t.Hash {
      ...
      update(e) {
        ...
        let { view: r, buffer: i, blockLen: n } = this,
          o = e.length;
        for (let a = 0; a < o; ) {
          let f = Math.min(n - this.pos, o - a);
          if (f === n) {
            let r = (0, t.createView)(e);
            for (; n <= o - a; a += n) this.process(r, a);
            continue;
          }
          i.set(e.subarray(a, a + f), this.pos),
            (this.pos += f),
            (a += f),
      ...
      digestInto(e) {
        ...
        (r[a++] = 128),
          ...
          this.padOffset > n - a && (this.process(i, 0), (a = 0));
        for (let e = a; e < n; e++) r[e] = 0;
        !(function (e, t, r, i) {
    ...
    class c extends n {
      ...
      get() {
        let { A: e, B: t, C: r, D: i, E: n, F: o, G: a, H: f } = this;
        return [e, t, r, i, n, o, a, f];
      }
      set(e, t, r, i, n, o, a, f) {
        (this.A = 0 | e),
          (this.B = 0 | t),
      ...
      process(e, r) {
        ...
        for (let e = 16; e < 64; e++) {
          let r = u[e - 15],
            i = u[e - 2],
            n = (0, t.rotr)(r, 7) ^ (0, t.rotr)(r, 18) ^ (r >>> 3),
            o = (0, t.rotr)(i, 17) ^ (0, t.rotr)(i, 19) ^ (i >>> 10);
          u[e] = (o + u[e - 7] + n + u[e - 16]) | 0;
        }
        let { A: n, B: o, C: a, D: f, E: s, F: l, G: c, H: h } = this;
        for (let e = 0; e < 64; e++) {
          var b;
          let r =
              (h +
                ((0, t.rotr)(s, 6) ^ (0, t.rotr)(s, 11) ^ (0, t.rotr)(s, 25)) +
                (((b = s) & l) ^ (~b & c)) +
                d[e] +
                u[e]) |
              0,
            x =
              (((0, t.rotr)(n, 2) ^ (0, t.rotr)(n, 13) ^ (0, t.rotr)(n, 22)) +
                i(n, o, a)) |
              0;
          (h = c),
            (c = l),
    ...
    class y extends n {
      ...
      get() {
        ...
        return [e, t, r, i, n, o, a, f, s, l, d, u, c, h, b, x];
      }
      set(e, t, r, i, n, o, a, f, s, l, d, u, c, h, b, x) {
        (this.Ah = 0 | e),
          (this.Al = 0 | t),
          (this.Bh = 0 | r),
          (this.Bl = 0 | i),
      ...
      process(e, t) {
        ...
        for (let e = 16; e < 80; e++) {
          let t = 0 | p[e - 15],
            r = 0 | m[e - 15],
            i = l.rotrSH(t, r, 1) ^ l.rotrSH(t, r, 8) ^ l.shrSH(t, r, 7),
            n = l.rotrSL(t, r, 1) ^ l.rotrSL(t, r, 8) ^ l.shrSL(t, r, 7),
            o = 0 | p[e - 2],
            a = 0 | m[e - 2],
            f = l.rotrSH(o, a, 19) ^ l.rotrBH(o, a, 61) ^ l.shrSH(o, a, 6),
            s = l.rotrSL(o, a, 19) ^ l.rotrBL(o, a, 61) ^ l.shrSL(o, a, 6),
            d = l.add4L(n, s, m[e - 7], m[e - 16]),
            u = l.add4H(d, i, f, p[e - 7], p[e - 16]);
          (p[e] = 0 | u), (m[e] = 0 | d);
        }
        let {
          Ah: r,
        ...
        for (let e = 0; e < 80; e++) {
          let t = l.rotrSH(u, c, 14) ^ l.rotrSH(u, c, 18) ^ l.rotrBH(u, c, 41),
            B = l.rotrSL(u, c, 14) ^ l.rotrSL(u, c, 18) ^ l.rotrBL(u, c, 41),
            A = (u & h) ^ (~u & y),
            S = (c & b) ^ (~c & w),
            I = l.add5L(v, B, S, g[e], m[e]),
            O = l.add5H(I, E, t, A, x[e], p[e]),
            H = 0 | I,
            R = l.rotrSH(r, i, 28) ^ l.rotrBH(r, i, 34) ^ l.rotrBH(r, i, 39),
            q = l.rotrSL(r, i, 28) ^ l.rotrBL(r, i, 34) ^ l.rotrBL(r, i, 39),
            U = (r & n) ^ (r & a) ^ (n & a),
            N = (i & o) ^ (i & f) ^ (o & f);
          (E = 0 | y),
            (v = 0 | w),
            ...
            (o = 0 | i);
          let C = l.add3L(H, q, N);
          (r = l.add3H(C, O, R, U)), (i = 0 | C);
        }
        ({ h: r, l: i } = l.add(0 | this.Ah, 0 | this.Al, 0 | r, 0 | i)),
          ({ h: n, l: o } = l.add(0 | this.Bh, 0 | this.Bl, 0 | n, 0 | o)),
          ({ h: a, l: f } = l.add(0 | this.Ch, 0 | this.Cl, 0 | a, 0 | f)),
          ({ h: s, l: d } = l.add(0 | this.Dh, 0 | this.Dl, 0 | s, 0 | d)),
          ({ h: u, l: c } = l.add(0 | this.Eh, 0 | this.El, 0 | u, 0 | c)),
          ({ h: h, l: b } = l.add(0 | this.Fh, 0 | this.Fl, 0 | h, 0 | b)),
          ({ h: y, l: w } = l.add(0 | this.Gh, 0 | this.Gl, 0 | y, 0 | w)),
          ({ h: E, l: v } = l.add(0 | this.Hh, 0 | this.Hl, 0 | E, 0 | v)),
          this.set(r, i, n, o, a, f, s, d, u, c, h, b, y, w, E, v);
      }
      roundClean() {
        (0, t.clean)(p, m);
      }
    ...
    let E = (0, t.createHasher)(() => new c()),
      v = (0, t.createHasher)(() => new h()),
      B = (0, t.createHasher)(() => new y()),
      A = (0, t.createHasher)(() => new w());
    e.s(
      [
        "SHA224",
        () => h,
    ...
    class I extends S.Hash {
      constructor(e, t) {
        super(), (this.finished = !1), (this.destroyed = !1), (0, S.ahash)(e);
        ...
        this.oHash.update(n), (0, S.clean)(n);
      }
      update(e) {
        return (0, S.aexists)(this), this.iHash.update(e), this;
      }
      digestInto(e) {
        (0, S.aexists)(this),
          (0, S.abytes)(e, this.outputLen),
          (this.finished = !0),
    ...
    let O = (e, t, r) => new I(e, t).update(r).digest();
    ...
    function U(e) {
      if (!q(e)) throw Error("Uint8Array expected");
    }
    function N(e, t) {
    ...
    function L(e) {
      ...
      return "" === e ? H : BigInt("0x" + e);
    }
    let T =
        "function" == typeof Uint8Array.from([]).toHex &&
        "function" == typeof Uint8Array.fromHex,
      P = Array.from({ length: 256 }, (e, t) =>
        t.toString(16).padStart(2, "0")
      );
    function D(e) {
      if ((U(e), T)) return e.toHex();
      let t = "";
      for (let r = 0; r < e.length; r++) t += P[e[r]];
      return t;
    }
    function F(e) {
      return e >= 48 && e <= 57
    ...
    function Z(e) {
      if ("string" != typeof e)
        throw Error("hex string expected, got " + typeof e);
      if (T) return Uint8Array.fromHex(e);
      let t = e.length,
        r = t / 2;
      if (t % 2)
      ...
      for (let t = 0, n = 0; t < r; t++, n += 2) {
        let r = F(e.charCodeAt(n)),
          o = F(e.charCodeAt(n + 1));
    ...
    function V(e) {
      return U(e), L(D(Uint8Array.from(e).reverse()));
    }
    function z(e, t) {
      return Z(e.toString(16).padStart(2 * t, "0"));
    }
    function k(e, t) {
      return z(e, t).reverse();
    }
    function j(e, t, r) {
      let i;
      if ("string" == typeof t)
      ...
      else if (q(t)) i = Uint8Array.from(t);
    ...
    let X = (e) => (R << BigInt(e)) - R,
      J = (e) => new Uint8Array(e),
      Q = {
        bigint: (e) => "bigint" == typeof e,
        function: (e) => "function" == typeof e,
        boolean: (e) => "boolean" == typeof e,
        string: (e) => "string" == typeof e,
        stringOrUint8Array: (e) => "string" == typeof e || q(e),
    ...
    function ed(e, t) {
      if (e === et) throw Error("invert: expected non-zero number");
      if (t <= et) throw Error("invert: expected positive modulus, got " + t);
      let r = es(e, t),
        i = t,
        n = et,
        o = er,
      ...
      for (; r !== et; ) {
        let e = i / r,
          ...
          s = n - a * e,
          l = o - f * e;
        (i = r), (r = t), (n = a), (o = f), (a = s), (f = l);
      }
      if (i !== er) throw Error("invert: does not exist");
      return es(n, t);
    }
    function eu(e, t) {
      let r = (e.ORDER + er) / eo,
    ...
    function ep(e, r) {
      void 0 !== r && (0, t.anumber)(r);
      let i = void 0 !== r ? r : e.toString(2).length,
        n = Math.ceil(i / 8);
      return { nBitLength: i, nByteLength: n };
    }
    function em(e, t, r = !1, i = {}) {
      let n;
      if (e <= et) throw Error("invalid field: expected ORDER > 0, got " + e);
      let { nBitLength: o, nByteLength: a } = ep(e, t);
      if (a > 2048)
      ...
      let f = Object.freeze({
        ...
        pow: (e, t) =>
          (function (e, t, r) {
            if (r < et) throw Error("invalid exponent, negatives unsupported");
            if (r === et) return e.ONE;
            if (r === er) return t;
            let i = e.ONE,
              n = t;
            for (; r > et; )
              r & er && (i = e.mul(i, n)), (n = e.sqr(n)), (r >>= er);
            return i;
          })(f, e, t),
        div: (t, r) => es(t * ed(r, e), e),
        sqrN: (e) => e * e,
        addN: (e, t) => e + t,
        subN: (e, t) => e - t,
        mulN: (e, t) => e * t,
    ...
    function eE(e, t, r = !1) {
      ...
      let a = es(r ? V(e) : _(e), t - er) + er;
      return r ? k(a, n) : z(a, n);
    }
    e.s(
      [
        "Field",
    ...
    function eO(e, t, r) {
      let { windowSize: i, mask: n, maxNumber: o, shiftBy: a } = r,
        f = Number(e & n),
        s = e >> a;
      f > i && ((f -= o), (s += eB));
      let l = t * i,
    ...
    function eN(e) {
      void 0 !== e.lowS && N("lowS", e.lowS),
        void 0 !== e.prehash && N("prehash", e.prehash);
    }
    let eC = {
        ...
        toSig(e) {
          let { Err: t, _int: r, _tlv: i } = eC,
            n = j("signature", e),
            { v: o, l: a } = i.decode(48, n);
          if (a.length)
            throw new t("invalid signature: left bytes after parsing");
          let { v: f, l: s } = i.decode(2, o),
            { v: l, l: d } = i.decode(2, s);
          if (d.length)
            throw new t("invalid signature: left bytes after parsing");
    ...
    function eZ(e) {
      let t,
        ...
        { Fp: i, n: n, nByteLength: o, nBitLength: a } = r,
        f = i.BYTES + 1,
        s = 2 * i.BYTES + 1;
      function l(e) {
        return es(e, n);
      ...
      let {
          ...
          let r = (function (e) {
            ...
            { Fp: i } = r,
            n = em(r.n, r.nBitLength),
            o =
              r.toBytes ||
              ((e, t, r) => {
                let n = t.toAffine();
                return K(Uint8Array.from([4]), i.toBytes(n.x), i.toBytes(n.y));
              }),
            a =
              r.fromBytes ||
              ((e) => {
          ...
          function f(e) {
            let { a: t, b: n } = r,
              o = i.sqr(e),
              a = i.mul(o, e);
            return i.add(i.add(a, i.mul(e, t)), n);
          }
          function s(e, t) {
            let r = i.sqr(t),
              n = f(e);
          ...
          let l = i.mul(i.pow(r.a, eD), eF),
            d = i.mul(i.sqr(r.b), BigInt(27));
          if (i.is0(i.add(l, d))) throw Error("bad curve params: a or b");
          function u(e) {
            let t,
              {
            ...
            try {
              t = "bigint" == typeof e ? e : _(j("private key", e, n));
            } catch (t) {
              throw Error(
            ...
            return o && (t = es(t, a)), Y("private key", t, eT, a), t;
          }
          function c(e) {
          ...
          let h = ee((e, t) => {
            ...
            b = ee((e) => {
              ...
              if (!s(t, n)) throw Error("bad point: equation left != right");
              if (!e.isTorsionFree())
          ...
          class x {
            ...
            static fromHex(e) {
              let t = x.fromAffine(a(j("pointHex", e)));
            ...
            equals(e) {
              ...
              let { px: t, py: r, pz: n } = this,
                { px: o, py: a, pz: f } = e,
                s = i.eql(i.mul(t, f), i.mul(o, n)),
                l = i.eql(i.mul(r, f), i.mul(a, n));
              return s && l;
            }
            negate() {
            ...
            multiplyUnsafe(e) {
              ...
              let o = x.ZERO;
              if (e === eL) return o;
              if (this.is0() || e === eT) return this;
              if (!t || m.hasPrecomputes(this))
                return m.wNAFCachedUnsafe(this, e, x.normalizeZ);
              let { k1neg: a, k1: f, k2neg: s, k2: l } = t.splitScalar(e),
                d = o,
                u = o,
                c = this;
              for (; f > eL || l > eL; )
              ...
              return (
                a && (d = d.negate()),
                s && (u = u.negate()),
                (u = new x(i.mul(u.px, t.beta), u.py, u.pz)),
                d.add(u)
              );
            }
            multiply(e) {
              let t,
                n,
                { endo: o, n: a } = r;
              if ((Y("scalar", e, eT, a), o)) {
                let { k1neg: r, k1: a, k2neg: f, k2: s } = o.splitScalar(e),
                  { p: l, f: d } = this.wNAF(a),
                  { p: u, f: c } = this.wNAF(s);
                (l = m.constTimeNegate(r, l)),
                  (u = m.constTimeNegate(f, u)),
                  (u = new x(i.mul(u.px, o.beta), u.py, u.pz)),
                  (t = l.add(u)),
                  (n = d.add(c));
              } else {
            ...
            toRawBytes(e = !0) {
              return N("isCompressed", e), this.assertValidity(), o(x, this, e);
            }
            toHex(e = !0) {
              return N("isCompressed", e), D(this.toRawBytes(e));
            }
          }
          (x.BASE = new x(r.Gx, r.Gy, i.ONE)),
            (x.ZERO = new x(i.ZERO, i.ONE, i.ZERO));
          let { endo: g, nBitLength: p } = r,
            m =
              ((t = g ? Math.ceil(p / 2) : p),
              {
                constTimeNegate: eA,
                hasPrecomputes: (e) => 1 !== eq(e),
                unsafeLadder(e, t, r = x.ZERO) {
                  let i = e;
                  for (; t > ev; )
                    t & eB && (r = r.add(i)), (i = i.double()), (t >>= eB);
                  return r;
                },
                precomputeWindow(e, r) {
                  let { windows: i, windowSize: n } = eI(r, t),
                    o = [],
                    a = e,
                    f = a;
                  for (let e = 0; e < i; e++) {
                    (f = a), o.push(f);
                    for (let e = 1; e < n; e++) (f = f.add(a)), o.push(f);
                    a = f.double();
                  }
                  return o;
                },
                wNAF(e, r, i) {
                  ...
                  for (let e = 0; e < a.windows; e++) {
                    ...
                    (i = t),
                      s ? (o = o.add(eA(d, r[u]))) : (n = n.add(eA(l, r[f])));
                  }
                  return { p: n, f: o };
                },
                wNAFUnsafe(e, r, i, n = x.ZERO) {
                  let o = eI(e, t);
                  for (let e = 0; e < o.windows && i !== ev; e++) {
                    let {
                      nextN: t,
                      offset: a,
                      isZero: f,
          ...
          toBytes(e, t, r) {
            let n = t.toAffine(),
              o = i.toBytes(n.x);
            return (N("isCompressed", r), r)
              ? K(Uint8Array.from([t.hasEvenY() ? 2 : 3]), o)
              : K(Uint8Array.from([4]), o, i.toBytes(n.y));
          },
          fromBytes(e) {
            let t = e.length,
              r = e[0],
            ...
            if (t === f && (2 === r || 3 === r)) {
              let e,
                t = _(n);
              if (!W(t, eT, i.ORDER)) throw Error("Point is not on curve");
              let o = c(t);
              try {
                e = i.sqrt(o);
              } catch (e) {
      ...
      class x {
        ...
        static fromCompact(e) {
          return new x(
            b((e = j("compactSignature", e, 2 * o)), 0, o),
            b(e, o, 2 * o)
          );
        }
        static fromDER(e) {
          let { r: t, s: r } = eC.toSig(j("DER", e));
          return new x(t, r);
        }
        assertValidity() {}
        addRecoveryBit(e) {
        ...
        recoverPublicKey(e) {
          ...
          if (s >= i.ORDER) throw Error("recovery id 2 or 3 invalid");
          let u = (1 & a) == 0 ? "02" : "03",
            c = d.fromHex(u + D(z(s, i.BYTES))),
            h = ed(s, n),
            b = l(-f * h),
            x = l(o * h),
            g = d.BASE.multiplyAndAddUnsafe(c, b, x);
      ...
      return (
        d.BASE._setWindowSize(8),
        {
          ...
          getSharedSecret: function (e, t, r = !0) {
            if (!0 === g(e)) throw Error("first arg must be private key");
            if (!1 === g(t)) throw Error("second arg must be public key");
          ...
          sign: function (e, t, o = E) {
            let { seed: a, k2sig: f } = (function (e, t, o = E) {
              ...
              null == s && (s = !0),
                (e = j("msgHash", e)),
                eN(o),
                c && (e = j("prehashed msgHash", a(e)));
              let g = m(e),
                y = u(t),
                v = [w(y), w(g)];
              if (null != b && !1 !== b) {
                let e = !0 === b ? f(i.BYTES) : b;
                v.push(j("extraEntropy", e));
              }
              return {
                seed: K(...v),
                k2sig: function (e) {
                  ...
                  let f = l(i * l(g + a * y));
                  if (f === eL) return;
                  let u = (2 * (o.x !== a)) | Number(o.y & eT),
                    c = f;
                  return (
                    s &&
                      f > n >> eT &&
                      ((c = (t = f) > n >> eT ? l(-t) : t), (u ^= 1)),
                    new x(a, c, u)
                  );
                },
              };
            ...
            return (function (e, t, r) {
              ...
              let i = J(e),
                ...
                s = (e = J(0)) => {
                  let t;
                  if (
                    ((n = f(((t = [0]), Uint8Array.from(t)), e)),
                    (i = f()),
                    0 !== e.length)
                  ) {
                    let t;
                    (n = f(((t = [1]), Uint8Array.from(t)), e)), (i = f());
                  }
                },
                l = () => {
          ...
          verify: function (e, t, i, o = v) {
            ...
            let { r: g, s: p } = f,
              ...
              E = l(y * w),
              B = l(g * w),
              A = d.BASE.multiplyAndAddUnsafe(a, E, B)?.toAffine();
            return !!A && l(A.x) === g;
          },
          ProjectivePoint: d,
          Signature: x,
    ...
    function e_(e, t) {
      if ((eb(e), !e.isValid(t.A) || !e.isValid(t.B) || !e.isValid(t.Z)))
        throw Error("mapToCurveSimpleSWU: invalid opts");
      let r = (function (e, t) {
        let r = e.ORDER,
          i = eL;
        for (let e = r - eT; e % eP === eL; e /= eP) i += eT;
        let n = i,
          o = eP << (n - eT - eT),
          a = o * eP,
          f = (r - eT) / a,
    ...
    function eV(e, r) {
      let i = (r) =>
        eZ({
          ...
          ...{
            hash: r,
            hmac: (e, ...i) => O(r, e, (0, t.concatBytes)(...i)),
    ...
    function ej(e, t, r) {
      ...
      let { p: n, k: o, m: a, hash: f, expand: s, DST: l } = r;
      U(e), ek(t);
      let d = "string" == typeof l ? M(l) : l,
        u = Math.ceil((n.toString(2).length + o) / 8),
        c = t * a * u;
      if ("xmd" === s)
        i = (function (e, t, r, i) {
          U(e),
            U(t),
            ek(r),
            t.length > 255 && (t = i(K(M("H2C-OVERSIZE-DST-"), t)));
          let { outputLen: n, blockLen: o } = i,
            a = Math.ceil(r / n);
          if (r > 65535 || a > 255)
            throw Error("expand_message_xmd: invalid lenInBytes");
          let f = K(t, ez(t.length, 1)),
            s = ez(0, o),
            l = ez(r, 2),
            d = Array(a),
            u = i(K(s, e, l, ez(0, 1), f));
          d[0] = i(K(u, ez(1, 1), f));
          for (let e = 1; e <= a; e++) {
            let t = [
              (function (e, t) {
          ...
          return K(...d).slice(0, r);
        })(e, d, c, f);
      else if ("xof" === s)
        i = (function (e, t, r, i, n) {
          if ((U(e), U(t), ek(r), t.length > 255)) {
            let e = Math.ceil((2 * i) / 8);
            t = n
              .create({ dkLen: e })
              .update(M("H2C-OVERSIZE-DST-"))
              .update(t)
              .digest();
          }
          ...
          return n
            ...
            .update(ez(r, 2))
            .update(t)
            .update(ez(t.length, 1))
            .digest();
        })(e, d, c, o, f);
      else if ("_internal_pass" === s) i = e;
    ...
    function eK(e, t) {
      ...
      return (t, i) => {
        let [n, o, a, f] = r.map((r) =>
          ...
          [s, l] = ex(e, [o, f], !0);
        return (t = e.mul(n, s)), (i = e.mul(i, e.mul(a, l))), { x: t, y: i };
      };
    }
    function eM(e, t, r) {
      ...
      return {
        defaults: r,
        hashToCurve(e, t) {
          let o = ej(e, 2, { ...r, DST: r.DST, ...t }),
            a = i(o[0]),
            f = i(o[1]);
          return n(a.add(f));
        },
        encodeToCurve: (e, t) =>
          n(i(ej(e, 1, { ...r, DST: r.encodeDST, ...t })[0])),
        mapToCurve(e) {
    ...
    e.s(["mapToCurveSimpleSWU", () => e_, "weierstrass", () => eZ], 573230),
      e.s(["createCurve", () => eV], 747663),
      e.s(["createHasher", () => eM, "isogenyMap", () => eK], 241826);
    let eG = BigInt(
    ...
    function e$(e) {
      let t = BigInt(3),
        ...
        w = (el(y, r, eG) * s) % eG,
        E = el(w, eJ, eG);
      if (!e0.eql(e0.sqr(E), e)) throw Error("Cannot find square root");
      return E;
    }
    let e0 = em(eG, void 0, void 0, { sqrt: e$ }),
      e1 = eV(
        {
          a: eY,
          b: BigInt(7),
    ...
    function e8(e, ...t) {
      let r = e2[e];
      if (void 0 === r) {
        let t = E(Uint8Array.from(e, (e) => e.charCodeAt(0)));
        (r = K(t, t)), (e2[e] = r);
      }
      return E(K(r, ...t));
    }
    let e3 = (e) => e.toRawBytes(!0).slice(1),
      e4 = e1.ProjectivePoint;
    function e6(e) {
      let t = e1.utils.normPrivateKeyToScalar(e),
        r = e4.fromPrivateKey(t);
      return { scalar: r.hasEvenY() ? t : es(-t, eW), bytes: e3(r) };
    }
    function e5(e) {
      Y("x", e, eX, eG);
      let t = es(e * e, eG),
        r = e$(es(t * e + BigInt(7), eG));
      r % eJ !== eY && (r = es(-r, eG));
      let i = new e4(e, r, eX);
      return i.assertValidity(), i;
    }
    function e7(...e) {
      return es(_(e8("BIP0340/challenge", ...e)), eW);
    }
    function e9(e, t, r) {
      let i = j("signature", e, 64),
        n = j("message", t),
        o = j("publicKey", r, 32);
      try {
        let e,
          ...
          r = e5(_(o)),
          a = _(i.subarray(0, 32));
        if (!W(a, eX, eG)) return !1;
        let f = _(i.subarray(32, 64));
        if (!W(f, eX, eW)) return !1;
        let s = e7(z(a, 32), e3(r), n),
          l =
            ((e = -s), (t = es(e, eW)), e4.BASE.multiplyAndAddUnsafe(r, f, t));
    ...
    let te = {
        ...
        sign: function (e, r, i = (0, t.randomBytes)(32)) {
          let n = j("message", e),
            { bytes: o, scalar: a } = e6(r),
            f = z(a ^ _(e8("BIP0340/aux", j("auxRand", i, 32))), 32),
            s = es(_(e8("BIP0340/nonce", f, o, n)), eW);
          if (s === eY) throw Error("sign failed: k is zero");
          let { bytes: l, scalar: d } = e6(s),
            u = e7(l, o, n),
            c = new Uint8Array(64);
          if ((c.set(l, 0), c.set(z(es(d + u * a, eW), 32), 32), !e9(c, n, o)))
            throw Error("sign: Invalid signature produced");
          return c;
        },
        verify: e9,
        utils: {
          randomPrivateKey: e1.utils.randomPrivateKey,
          lift_x: e5,
          pointToBytes: e3,
          numberToBytesBE: z,
          bytesToNumberBE: _,
      ...
      tr = e_(e0, {
        ...
        B: BigInt("1771"),
        Z: e0.create(BigInt("-11")),
      }),
      ti = eM(
        e1.ProjectivePoint,
        (e) => {
          let { x: t, y: r } = tr(e0.create(e[0]));
          return tt(t, r);
        },
        {
...
//# debugId=ce8c83f7-7bad-7184-4bb7-0ad491e9d2dd
//# sourceMappingURL=45eaaa8276e89914.js.map
