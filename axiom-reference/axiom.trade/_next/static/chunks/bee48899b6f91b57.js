  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "b74d3938-cc1e-a506-4650-d4a7ae0b0368");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let _ = b("ArrayBuffer"),
      ...
      k = b("FileList"),
      j = b("URLSearchParams"),
      [C, L, N, M] = ["ReadableStream", "Request", "Response", "Headers"].map(
        b
      );
    ...
    let I =
      ...
      B = (e) => !w(e) && e !== I,
      q =
        ((r = "undefined" != typeof Uint8Array && d(Uint8Array)),
        (e) => r && e instanceof r),
      F = b("HTMLFormElement"),
      W = (
        ({ hasOwnProperty: e }) =>
      ...
      G =
        "undefined" != typeof queueMicrotask
          ...
          : (void 0 !== l.default && l.default.nextTick) || V,
      J = {
        isArray: m,
        isArrayBuffer: _,
        isBuffer: v,
        ...
        isRegExp: H,
        isFunction: E,
        isStream: (e) => O(e) && E(e.pipe),
        isURLSearchParams: j,
        isTypedArray: q,
        isFileList: k,
        forEach: U,
        merge: function e() {
          let { caseless: t, skipUndefined: r } = (B(this) && this) || {},
            n = {},
            i = (i, o) => {
              let a = (t && D(n, o)) || o;
              x(n[a]) && x(i)
        ...
        isAsyncFn: z,
        isThenable: (e) => e && (O(e) || E(e)) && E(e.then) && E(e.catch),
        setImmediate: V,
        asap: G,
    ...
    let er = J.toFlatObject(J, {}, null, function (e) {
        ...
        function l(e, r, i) {
          ...
          if (e && !i && "object" == typeof e)
            if (J.endsWith(r, "{}"))
              ...
              var l;
              if (
                (J.isArray(e) && ((l = e), J.isArray(l) && !l.some(Q))) ||
          ...
          return !!Q(e) || (t.append(et(i, r, o), u(e)), !1);
        }
        let c = [],
          f = Object.assign(er, {
            defaultVisitor: l,
                ...
                J.forEach(r, function (r, o) {
                  !0 ===
                    (!(J.isUndefined(r) || null === r) &&
                      i.call(t, r, J.isString(o) ? o.trim() : o, n, f)) &&
                    e(r, n ? n.concat(o) : [o]);
                }),
                c.pop();
            }
    ...
    let el = class {
      ...
      ef = "undefined" != typeof URLSearchParams ? URLSearchParams : eo,
      ...
      eb =
        ep &&
        (!ey || 0 > ["ReactNative", "NativeScript", "NS"].indexOf(ey.product)),
      eg =
    ...
    let ew = {
        ...e.i(557536),
        isBrowser: !0,
        classes: { URLSearchParams: ef, FormData: ed, Blob: eh },
          ...
          function (e, t) {
            ...
            if (o) {
              if (n.indexOf("application/x-www-form-urlencoded") > -1) {
                ...
                en(a, new ew.classes.URLSearchParams(), {
    ...
    function eO(e) {
      return !1 === e || null == e ? e : J.isArray(e) ? e.map(eO) : String(e);
    }
    ...
    class eA {
      ...
      delete(e, t) {
        ...
        return J.isArray(e) ? e.forEach(i) : i(e), n;
      }
      clear(e) {
    ...
    eA.accessor([
      ...
      J.reduceDescriptors(eA.prototype, ({ value: e }, t) => {
    ...
    let eC = function (e, t) {
      ...
      eU =
        ...
        (...t) =>
          J.asap(() => e(...t)),
      eD = ew.hasStandardBrowserEnv
        ? ((n = new URL(ew.origin)),
          (i = ew.navigator && /(msie|trident)/i.test(ew.navigator.userAgent)),
          (e) => (
            (e = new URL(e, ew.origin)),
      ...
      eI = ew.hasStandardBrowserEnv
        ? {
            write(e, t, r, n, i, o, a) {
              ...
              J.isNumber(r) && s.push(`expires=${new Date(r).toUTCString()}`),
                J.isString(n) && s.push(`path=${n}`),
                J.isString(i) && s.push(`domain=${i}`),
                !0 === o && s.push("secure"),
                J.isString(a) && s.push(`SameSite=${a}`),
    ...
    function eF(e, t) {
      ...
      return (
        J.forEach(Object.keys({ ...e, ...t }), function (n) {
          let o = u[n] || i,
            a = o(e[n], t[n], n);
    ...
    let eW = (e) => {
        ...
        if (
          ((t.headers = a = eA.from(a)),
          (t.url = eu(
            eB(t.baseURL, t.url, t.allowAbsoluteUrls),
            e.params,
            e.paramsSerializer
          )),
          s &&
        ...
        if (
          ...
          (n && J.isFunction(n) && (n = n(t)), n || (!1 !== n && eD(t.url)))
        ) {
          let e = i && o && eI.read(o);
          e && a.set(i, e);
        }
      ...
      eH =
        ...
        function (e) {
          return new Promise(function (t, r) {
            ...
            g.open(c.method.toUpperCase(), c.url, !0),
              (g.timeout = c.timeout),
              "onloadend" in g
                ? (g.onloadend = m)
              ...
              (g.onabort = function () {
                g &&
                  (r(new X("Request aborted", X.ECONNABORTED, e, g)),
                  (g = null));
              }),
              ...
              "setRequestHeader" in g &&
                J.forEach(d.toJSON(), function (e, t) {
                  g.setRequestHeader(t, e);
                }),
              J.isUndefined(c.withCredentials) ||
                (g.withCredentials = !!c.withCredentials),
              h && "json" !== h && (g.responseType = c.responseType),
              y && (([a, u] = eN(y, !0)), g.addEventListener("progress", a)),
              p &&
                g.upload &&
                (([o, s] = eN(p)),
            ...
            let w =
              ((n = c.url),
              ((l = /^([-+\w]{1,25})(:?\/\/|:)/.exec(n)) && l[1]) || "");
            w && -1 === ew.protocols.indexOf(w)
              ? r(
                  new X("Unsupported protocol " + w + ":", X.ERR_BAD_REQUEST, e)
                )
              : g.send(f || null);
          });
        },
      ...
      { isFunction: eJ } = J,
      eK = (({ Request: e, Response: t }) => ({ Request: e, Response: t }))(
        J.global
      ),
      { ReadableStream: eX, TextEncoder: eY } = J.global,
      eZ = (e, ...t) => {
        try {
          return !!e(...t);
        } catch (e) {
      ...
      eQ = (e) => {
        let t,
          {
            ...
            Request: n,
            Response: i,
          } = (e = J.merge.call({ skipUndefined: !0 }, eK, e)),
          o = r ? eJ(r) : "function" == typeof fetch,
          a = eJ(n),
          s = eJ(i);
        if (!o) return !1;
        let u = o && eJ(eX),
          ...
          f = s && u && eZ(() => J.isReadableStream(new i("").body)),
          d = { stream: f && ((e) => e.body) };
        o &&
        ...
        let h = async (e) => {
            ...
            if (J.isSpecCompliantForm(e)) {
              let t = new n(ew.origin, { method: "POST", body: e });
          ...
          try {
            if (
              ...
              if (
                ...
                let [e, n] = eM(t, eN(eU(g)));
                u = eG(r.body, 65536, e, n);
              }
            }
            J.isString(v) || (v = v ? "include" : "omit");
            ...
            R = a && new n(o, l);
            let h = await (a ? S(R, _) : S(o, l)),
              y = f && ("stream" === m || "response" === m);
            if (f && (b || (y && O))) {
              let e = {};
              ["status", "statusText", "headers"].forEach((t) => {
                e[t] = h[t];
              });
              let t = J.toFiniteNumber(h.headers.get("content-length")),
                [r, n] = (b && eM(t, eN(eU(b), !0))) || [];
              h = new i(
                eG(h.body, 65536, r, () => {
                  n && n(), O && O();
                }),
            ...
            m = m || "text";
            let x = await d[J.findKey(d, m) || "text"](h, e);
            return (
              !y && O && O(),
              await new Promise((t, r) => {
                ej(t, r, {
                  data: x,
                  headers: eA.from(h.headers),
                  status: h.status,
      ...
      e1 = (e) => {
        ...
        for (; a--; )
          (s = o[a]),
            void 0 === (u = l.get(s)) && l.set(s, (u = a ? new Map() : eQ(t))),
            (l = u);
        return u;
      };
    e1();
    let e2 = { http: null, xhr: eH, fetch: { get: e1 } };
    J.forEach(e2, (e, t) => {
      if (e) {
        try {
    ...
    let e3 = (e) => `- ${e}`,
      e4 = (e) => J.isFunction(e) || null === e || !1 === e,
      e6 = function (e, t) {
        let r,
          n,
          { length: i } = (e = J.isArray(e) ? e : [e]),
          o = {};
        for (let a = 0; a < i; a++) {
          let i;
          if (
            ((n = r = e[a]),
            !e4(r) && void 0 === (n = e2[(i = String(r)).toLowerCase()]))
          )
            throw new X(`Unknown adapter '${i}'`);
          if (n && (J.isFunction(n) || (n = n.get(t)))) break;
          o[i || "#" + a] = n;
        }
        if (!n) {
    ...
    class tr {
      ...
      _request(e, t) {
        ...
        void 0 !== i &&
          tt(
            i,
            {
              silentJSONParsing: e5.transitional(e5.boolean),
              forcedJSONParsing: e5.transitional(e5.boolean),
              clarifyTimeoutError: e5.transitional(e5.boolean),
            },
            !1
          ),
          null != o &&
            (J.isFunction(o)
              ...
              : tt(o, { encode: e5.function, serialize: e5.function }, !0)),
          ...
          tt(
            t,
            {
              baseUrl: e5.spelling("baseURL"),
              withXsrfToken: e5.spelling("withXSRFToken"),
            },
            !0
          ),
          (t.method = (
        ...
        if (!l) {
          ...
          for (
            e.unshift(...u), e.push(...c), n = e.length, r = Promise.resolve(t);
            f < n;
      ...
      getUri(e) {
        return eu(
          eB((e = eF(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls),
          e.params,
          e.paramsSerializer
        );
      }
    ...
    let to = (function e(t) {
      let r = new tr(t),
        n = c(tr.prototype.request, r);
      return (
        J.extend(n, tr.prototype, r, { allOwnKeys: !0 }),
    ...
    (to.Axios = tr),
      ...
      (to.mergeConfig = eF),
      (to.AxiosHeaders = eA),
      (to.formToJSON = (e) => ev(J.isHTMLForm(e) ? new FormData(e) : e)),
      (to.getAdapter = e6),
      (to.HttpStatusCode = ti),
      (to.default = to),
      e.s(["default", 0, to], 581949);
    let {
      Axios: ta,
      AxiosError: ts,
      CanceledError: tu,
    ...
    e.s(["AxiosError", () => ts, "isAxiosError", () => tp], 191476),
      e.s(["getErrorMessage", () => tS], 247317);
  },
  91204,
  (e) => {
    "use strict";
        ...
        return new Promise(function (r, n) {
          ...
          g(e, t, u, { once: !0 }),
            "error" !== t &&
              ...
              (o = s),
              (a = { once: !0 }),
              "function" == typeof i.on && g(i, "error", o, a));
        });
      }),
      (s.EventEmitter = s),
    ...
    Object.defineProperty(s, "defaultMaxListeners", {
      ...
      (s.prototype.emit = function (e) {
        ...
        if ("function" == typeof u) o(u, this, t);
          ...
          for (var l = u.length, c = b(u, l), r = 0; r < l; ++r)
            o(c[r], this, t);
        return !0;
      }),
      ...
      (s.prototype.removeListener = function (e, t) {
        var r, n, i, o, a;
        if ((l(t), void 0 === (n = this._events) || void 0 === (r = n[e])))
          return this;
        if (r === t || r.listener === t)
          0 == --this._eventsCount
  ...
  (e, t, r) => {
      ...
      o = {
        ...
        3197: function (e, t, r) {
          ...
          var n,
            ...
            k = r(8737),
            j = {},
            C = "undefined" != typeof Uint8Array && x ? x(Uint8Array) : n,
            L = {
              __proto__: null,
              "%AggregateError%":
          ...
          var M = function e(t) {
            ...
            D = r(1212),
            I = r(3270),
            B = D.call(k, Array.prototype.concat),
            q = D.call(P, Array.prototype.splice),
            F = D.call(k, String.prototype.replace),
            W = D.call(k, String.prototype.slice),
            H = D.call(k, RegExp.prototype.exec),
            $ =
              /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
            z = /\\(\\)?/g,
            V = function (e) {
              ...
              var n = [];
              return (
                F(e, $, function (e, t, r, i) {
                  n[n.length] = r ? F(i, z, "$1") : t || e;
                }),
                n
              );
            },
            G = function (e, t) {
              var r,
                n = e;
              if ((I(U, n) && (n = "%" + (r = U[n])[0] + "%"), I(L, n))) {
                var i = L[n];
                if ((i === j && (i = M(n)), void 0 === i && !t))
                  throw new c(
                    "intrinsic " +
                      e +
        ...
        7823: function (e, t, r) {
          "use strict";
          e.exports = r(2811).getPrototypeOf || null;
        },
        7904: function (e) {
          "use strict";
          e.exports =
        ...
        994: function (t, r, n) {
          ...
          var i = n(6144),
            ...
            u = n(9942)() && "symbol" == typeof Symbol.toStringTag,
            l = o(),
            c =
          ...
          u &&
            ...
            i(l, function (t) {
              ...
              i || (i = h(p(n), Symbol.toStringTag)), (d[t] = i.get);
            });
          var y = function (e) {
            var t = !1;
            return (
        ...
        3143: function (e, t, r) {
          ...
          e.exports = function (e, t) {
            ...
            return (
              (n || l || !r) &&
                (o ? i(e, "length", t, !0, !0) : i(e, "length", t)),
              e
            );
          };
        },
        ...
        5584: function (e, t, r) {
          ...
          function A(e) {
            return (
              void 0 !== O &&
              (void 0 === x.working && (x.working = x(new O())),
              x.working ? x(e) : e instanceof O)
            );
          }
          function T(e) {
            return b(e, f);
        ...
        8177: function (e, t, r) {
          ...
          (t.format = function (e) {
            ...
            (t.deprecate = function (e, r) {
              if (void 0 !== i.default && !0 === i.default.noDeprecation)
                return e;
              if (void 0 === i.default)
                return function () {
              ...
              return function () {
                if (!n) {
                  if (i.default.throwDeprecation) throw Error(r);
                  i.default.traceDeprecation
                    ? console.trace(r)
                    : console.error(r),
                    (n = !0);
                }
          ...
          var a = {},
            s = /^$/;
          if (i.default.env.NODE_DEBUG) {
            var u = i.default.env.NODE_DEBUG;
            s = RegExp(
              "^" +
                (u = u
                  .replace(/[|\\{}()[\]^$+?.]/g, "\\$&")
          ...
          function _(e) {
            return S(e) && "[object RegExp]" === x(e);
          }
          function S(e) {
            return "object" == typeof e && null !== e;
          }
          function E(e) {
            return S(e) && "[object Date]" === x(e);
          }
          function R(e) {
            return S(e) && ("[object Error]" === x(e) || e instanceof Error);
          }
          function O(e) {
          ...
          (t.promisify = function (e) {
            ...
            (t.callbackify = function (e) {
              ...
              function t() {
                ...
                e.apply(this, t).then(
                  function (e) {
                    i.default.nextTick(a.bind(null, null, e));
                  },
                  function (e) {
                    i.default.nextTick(j.bind(null, e, a));
                  }
                );
              }
              return (
          ...
          u &&
            ...
            i(l, function (t) {
              if ("function" == typeof e.g[t]) {
                ...
                i || (i = d(h(n), Symbol.toStringTag)), (f[t] = i.get);
              }
            });
          var p = function (e) {
              var t = !1;
    ...
    function s(e) {
      ...
      var r = (a[e] = { exports: {} }),
        n = !0;
      try {
        o[e](r, r.exports, s), (n = !1);
      } finally {
        n && delete a[e];
      }
      return r.exports;
    }
    (s.ab = "/ROOT/node_modules/next/dist/compiled/util/"),
      (t.exports = s(8177));
  },
  612569,
  (e, t, r) => {
    var n = e.i(247167),
      i = {
        ...
        403: function (e, t, r) {
          ...
          function f() {
            this._writableState.ended || n.default.nextTick(d, this);
          }
          function d(e) {
            e.end();
          }
        ...
        709: function (t, r, i) {
          "use strict";
          (t.exports = x), (x.ReadableState = O), i(361).EventEmitter;
          var o,
            a,
            s,
            u,
          ...
          function x(e) {
            if (((o = o || i(403)), !(this instanceof x))) return new x(e);
          ...
          function A(e, t, r, n, i) {
            ...
            if (null === t)
              ...
              if (
                ...
                u.endEmitted ? E(e, new S()) : T(e, u, t, !0);
              else if (u.ended) E(e, new v());
              else {
                if (u.destroyed) return !1;
                (u.reading = !1),
                  u.decoder && !r
                    ? ((t = u.decoder.write(t)),
                      u.objectMode || 0 !== t.length ? T(e, u, t, !1) : C(e, u))
                    : T(e, u, t, !1);
              }
          ...
          function C(e, t) {
            t.readingMore ||
              ((t.readingMore = !0), n.default.nextTick(L, e, t));
          }
          function L(e, t) {
            for (
              ;
          ...
          function B(e) {
            ...
            a("endReadable", t.endEmitted),
              t.endEmitted || ((t.ended = !0), n.default.nextTick(q, t, e));
          }
          function q(e, t) {
            if (
          ...
          Object.defineProperty(x.prototype, "destroyed", {
            ...
            (x.prototype.pipe = function (e, t) {
              ...
              o.endEmitted ? n.default.nextTick(s) : i.once("end", s),
              ...
              function y() {
                a("onfinish"), e.removeListener("close", p), b();
              }
              function b() {
                a("unpipe"), i.unpipe(e);
              }
              ...
              return (
                "data" === e
                  ...
                  : "readable" !== e ||
                    ...
                    i.length
                      ? k(this)
                      : i.reading || n.default.nextTick(M, this)),
                r
              );
            }),
            ...
            "function" == typeof Symbol &&
              (x.from = function (e, t) {
                return void 0 === l && (l = i(727)), l(x, e, t);
              });
        },
        170: function (e, t, r) {
          "use strict";
                ...
                !(function (e, t) {
                  ...
                  if (
                    ...
                    a ||
                      ...
                      !r.bufferedRequest ||
                      P(e, r),
                      i ? n.default.nextTick(T, e, r, a, o) : T(e, r, a, o);
                  }
                })(t, e);
              }),
              (this.writecb = null),
          ...
          "function" == typeof Function.prototype[Symbol.hasInstance]
            ? ((s = Function.prototype[Symbol.hasInstance]),
              Object.defineProperty(x, Symbol.hasInstance, {
                value: function (e) {
                  return (
                    !!s.call(this, e) ||
                    (this === x && e && e._writableState instanceof O)
                  );
                },
              }))
            : (s = function (e) {
            ...
            (x.prototype.write = function (e, t, r) {
              var i,
                ...
                p = !1,
                b = !h.objectMode && ((i = e), c.isBuffer(i) || i instanceof f);
              return (
                (b && !c.isBuffer(e) && ((o = e), (e = c.from(o))),
                "function" == typeof t && ((r = t), (t = null)),
                b ? (t = "buffer") : t || (t = h.defaultEncoding),
                "function" != typeof r && (r = R),
                h.ending)
                  ? ((a = r), E(this, (s = new _())), n.default.nextTick(a, s))
                  : (b ||
                      ((u = e),
                      (l = r),
                      null === u
                      ...
                      !d || (E(this, d), n.default.nextTick(l, d), 0))) &&
                    (h.pendingcb++,
            ...
            (x.prototype.end = function (e, t, r) {
              ...
              return (
                ...
                s.ending ||
                  ...
                  C(i, o),
                  a &&
                    (o.finished ? n.default.nextTick(a) : i.once("finish", a)),
                  (o.ended = !0),
                  (i.writable = !1)),
                this
              );
        ...
        871: function (e, t, r) {
          ...
          function y(e) {
            ...
            if (null !== t) {
              var r = e[h].read();
              null !== r &&
                ((e[f] = null), (e[s] = null), (e[u] = null), t(p(r, !1)));
            }
          }
          function b(e) {
            n.default.nextTick(y, e);
          }
            ...
            return (
              ...
              a(e, function (e) {
                if (e && "ERR_STREAM_PREMATURE_CLOSE" !== e.code) {
                  var t = r[u];
                  null !== t &&
                    ((r[f] = null), (r[s] = null), (r[u] = null), t(e)),
                    (r[l] = e);
                  return;
                }
                var n = r[s];
                        ...
                        ? a._writableState
                          ? a._writableState.errorEmitted
                            ...
                            : ((a._writableState.errorEmitted = !0),
                              n.default.nextTick(t, a, e))
                          : n.default.nextTick(t, a, e)
                        : o
                        ? (n.default.nextTick(r, a), o(e))
                        : n.default.nextTick(r, a);
                    })),
                this
              );
          ...
          e.exports = function e(t, r, o) {
            ...
            return (
              t.setHeader && "function" == typeof t.abort
                ...
                : l && !t._writableState && (t.on("end", c), t.on("close", c)),
              t.on("end", p),
              t.on("finish", d),
              ...
              return (
                (e = function* () {
                  try {
                    var e = yield a.next(),
                      t = e.value;
                    e.done ? s.push(null) : s.push(yield t) ? l() : (u = !1);
                  } catch (e) {
                    s.destroy(e);
                  }
                }),
          ...
          e.exports = function () {
            ...
            var h = c.map(function (e, i) {
              ...
              return (
                ...
                void 0 === n && (n = r(698)),
                n(e, { readable: b, writable: o }, function (e) {
                  if (e) return s(e);
                  (p = !0), s();
                }),
                (y = !1),
                function (t) {
                  if (!p && !y) {
                    if (((y = !0), e.setHeader && "function" == typeof e.abort))
                      return e.abort();
    ...
    function a(e) {
      ...
      var r = (o[e] = { exports: {} }),
        n = !0;
      try {
        i[e](r, r.exports, a), (n = !1);
      } finally {
        n && delete o[e];
      }
      return r.exports;
    }
    (a.ab = "/ROOT/node_modules/next/dist/compiled/stream-browserify/"),
      (t.exports = a(173));
  },
  343954,
  (e, t, r) => {
    !(function () {
      ...
      n.ab = "/ROOT/node_modules/next/dist/compiled/querystring-es3/";
      var i = {};
  ...
  (e, t, r) => {
    ...
    o.ab = "/ROOT/node_modules/next/dist/compiled/native-url/";
    var a = {};
    !(function () {
      var e,
        t =
      ...
      function c(e, t) {
        ...
        r.protocol &&
          ...
          a &&
            o.protocol &&
            ((a = ""),
            o.slashes || ((a = o.protocol), (t = t.replace(o.protocol, ""))));
        var c = e.match(u);
        c &&
          !o.protocol &&
          ((e = e.substr((a = c[1] + (c[2] || "")).length)),
          /^\/\/[^/]/.test(t) && (a = a.slice(0, -1)));
        var f = new URL(e, s + "/"),
          d = new URL(t, f).toString().replace(s, ""),
          h = o.protocol || r.protocol;
        return (
          (h += r.slashes || o.slashes ? "//" : ""),
          !a && h ? (d = d.replace(i, h)) : a && (d = d.replace(i, "")),
          l.test(d) ||
            ~t.indexOf(".") ||
            "/" === e.slice(-1) ||
            "/" === t.slice(-1) ||
      ...
      function g(e, r, i) {
        ...
        var a = !/(^javascript)/.test(e) && e.match(p),
          ...
          l = "";
        a &&
          (d.test(a[1]) || ((l = a[1].toLowerCase()), (e = "" + a[2] + a[3])),
          a[2] ||
            ((u = !1),
            d.test(a[1]) ? ((l = a[1]), (e = "" + a[3])) : (e = "//" + a[3])),
          (3 !== a[2].length && 1 !== a[2].length) ||
            ((l = a[1]), (e = "/" + a[3])));
        var c,
          g = (o ? o[1] : e).match(/^https?:\/\/[^/]+(:[0-9]+)(?=\/|$)/),
          m = g && g[1],
          w = new f(),
          v = "",
          _ = "";
        ...
        (w.slashes = u && !_),
          (w.host = "w.w" === c.host ? "" : c.host),
          (w.hostname =
            "w.w" === c.hostname ? "" : c.hostname.replace(/(\[|\])/g, "")),
          (w.protocol = v ? l || null : c.protocol),
          (w.search = c.search.replace(/\\/g, "%5C")),
          (w.hash = c.hash.replace(/\\/g, "%5C"));
        var S = e.split("#");
        !w.search && ~S[0].indexOf("?") && (w.search = "?"),
          w.hash || "" !== S[1] || (w.hash = "#"),
          (w.query = r ? t.decode(c.search.substr(1)) : w.search.substr(1)),
          (w.pathname =
            _ +
            (a
              ? c.pathname
          ...
          (w.auth = [c.username, c.password]
            .map(decodeURIComponent)
            .filter(Boolean)
            .join(":")),
          (w.port = c.port),
          m && !w.host.endsWith(m) && ((w.host += m), (w.port = m.slice(1))),
          (w.href = _ ? "" + w.pathname + w.search + w.hash : n(w));
  ...
  (e, t, r) => {
    var n = e.i(247167),
      ...
      o = {
        ...
        726: function (e, t, r) {
          var i = r(781);
          "disable" === n.default.env.READABLE_STREAM && i
        ...
        813: function (t, r, n) {
          var i = n(450),
            ...
            s = n(523),
            u = n(310);
          (r.request = function (t, r) {
            t = "string" == typeof t ? u.parse(t) : a(t);
            var n =
                -1 === e.g.location.protocol.search(/^https?:$/) ? "http:" : "",
              o = t.protocol || n,
              s = t.hostname || t.host,
              l = t.port,
              c = t.path || "/";
            ...
            (r.ClientRequest = i),
            (r.IncomingMessage = o.IncomingMessage),
            (r.Agent = function () {}),
        ...
        301: function (t, r) {
          ...
          function i() {
            ...
            if (e.g.XMLHttpRequest) {
              n = new e.g.XMLHttpRequest();
              try {
                n.open("GET", e.g.XDomainRequest ? "/" : "https://example.com");
              } catch (e) {
                n = null;
              }
            } else n = null;
          ...
          (r.fetch = a(e.g.fetch) && a(e.g.ReadableStream)),
            (r.writableStream = a(e.g.WritableStream)),
            (r.abortController = a(e.g.AbortController)),
            (r.arraybuffer = r.fetch || o("arraybuffer")),
            (r.msstream = !r.fetch && o("ms-stream")),
            (r.mozchunkedarraybuffer =
              !r.fetch && o("moz-chunked-arraybuffer")),
            (r.overrideMimeType =
              r.fetch || (!!i() && a(i().overrideMimeType))),
            (n = null);
        },
        450: function (t, r, o) {
          var a = o(301),
            ...
            d = (t.exports = function (e) {
              ...
              l.Writable.call(o),
                ...
                e.auth &&
                  o.setHeader(
                    "Authorization",
                    "Basic " + i.Buffer.from(e.auth).toString("base64")
                  ),
          ...
          s(d, l.Writable),
                ...
                if (
                  ...
                  if (a.abortController) {
                    ...
                    (u = l.signal),
                      ...
                      "requestTimeout" in r &&
                        0 !== r.requestTimeout &&
                        (t._fetchTimer = e.g.setTimeout(function () {
                  ...
                  e.g
                    ...
                    .then(
                      ...
                      function (r) {
                        e.g.clearTimeout(t._fetchTimer),
                          t._destroyed || t.emit("error", r);
                      }
                    );
                } else {
                  var c = (t._xhr = new e.g.XMLHttpRequest());
                  try {
                  ...
                  "responseType" in c && (c.responseType = t._mode),
            ...
            (d.prototype.abort = d.prototype.destroy =
              function () {
                (this._destroyed = !0),
                  e.g.clearTimeout(this._fetchTimer),
        ...
        254: function (t, r, o) {
          var a = o(301),
            ...
            c = (r.IncomingMessage = function (t, r, o, s) {
              var l = this;
              if (
                (u.Readable.call(l),
                (l._mode = o),
                ...
                if (
                  ...
                  var c = new WritableStream({
                    write: function (e) {
                      return new Promise(function (t, r) {
                        l._destroyed
                          ? r()
                          : l.push(i.Buffer.from(e))
                          ? t()
                          : (l._resumeFetch = t);
                      });
                    },
                    close: function () {
                      e.g.clearTimeout(s), l._destroyed || l.push(null);
                    },
                    abort: function (e) {
                  ...
                  try {
                    r.body.pipeTo(c).catch(function (t) {
                      e.g.clearTimeout(s), l._destroyed || l.emit("error", t);
                    });
                    return;
                  } catch (e) {}
                }
                ...
                !(function t() {
                  f.read()
                    .then(function (r) {
                      if (!l._destroyed) {
                        if (r.done) {
                          e.g.clearTimeout(s), l.push(null);
                          return;
                        }
                        l.push(i.Buffer.from(r.value)), t();
                      }
                    })
                    .catch(function (t) {
                      e.g.clearTimeout(s), l._destroyed || l.emit("error", t);
          ...
          s(c, u.Readable),
            ...
            (c.prototype._onXHRProgress = function () {
              ...
              switch (t._mode) {
                case "text":
                  if ((n = r.responseText).length > t._pos) {
                    var o = n.substr(t._pos);
                    if ("x-user-defined" === t._charset) {
                      for (
                        var a = i.Buffer.alloc(o.length), s = 0;
                        s < o.length;
                        s++
                      )
                  ...
                  break;
                case "arraybuffer":
                  if (r.readyState !== l.DONE || !r.response) break;
                  (n = r.response), t.push(i.Buffer.from(new Uint8Array(n)));
                  break;
                case "moz-chunked-arraybuffer":
                  if (((n = r.response), r.readyState !== l.LOADING || !n))
                    break;
                  t.push(i.Buffer.from(new Uint8Array(n)));
                  break;
                case "ms-stream":
                  if (((n = r.response), r.readyState !== l.LOADING)) break;
                  var u = new e.g.MSStreamReader();
                  (u.onprogress = function () {
                    u.result.byteLength > t._pos &&
                      (t.push(
                        i.Buffer.from(new Uint8Array(u.result.slice(t._pos)))
                      ),
        ...
        781: function (t) {
          "use strict";
          t.exports = e.r(612569);
        },
        310: function (t) {
          "use strict";
          t.exports = e.r(421342);
        },
        837: function (t) {
          "use strict";
          t.exports = e.r(477398);
    ...
    (s.ab = "/ROOT/node_modules/next/dist/compiled/stream-http/"),
      (t.exports = s(813));
  },
  892542,
  (e, t, r) => {
    ...
    (o.ab = "/ROOT/node_modules/next/dist/compiled/https-browserify/"),
      (t.exports = o(528));
  },
  957645,
  (e, t, r) => {
  ...
  (e, t, r) => {
    ...
    for (var l in u) n(s, l, { get: u[l], enumerable: !0 });
    function c(e) {
      var t;
      let r = [
        ...
        );
      {
        var b,
          ...
          m = {
            ...
            path: u,
            ...(l && {
              sameSite: h.includes((b = (b = l).toLowerCase())) ? b : void 0,
            }),
            ...(c && { secure: !0 }),
            ...(y && {
              priority: p.includes((g = (g = y).toLowerCase())) ? g : void 0,
            }),
            ...(d && { partitioned: !0 }),
          };
        let e = {};
      ...
      if ((t && "object" == typeof t) || "function" == typeof t)
        for (let u of o(t))
          a.call(e, u) ||
            ...
            n(e, u, {
              get: () => t[u],
              enumerable: !(s = i(t, u)) || s.enumerable,
            });
      return e;
  ...
  (e, t, r) => {
    ...
    class f extends Response {
      ...
      static redirect(e, t) {
        ...
        return (
          i.set("Location", (0, o.validateURL)(e)),
          new f(null, { ...n, headers: i, status: r })
        );
      }
      static rewrite(e, t) {
  ...
  (e, t, r) => {
        ...
        226: function (t, r) {
          !(function (n, i) {
            ...
            var o = "function",
              ...
              G = function (e, t) {
                for (var r, n, i, a, u, l, c = 0; c < t.length && !u; ) {
                  var f = t[c],
                    d = t[c + 1];
              ...
              Y = function (e, t) {
                ...
                return (
                  ...
                  (this.getCPU = function () {
                    var e = {};
                    return (e[y] = void 0), G.call(e, i, w.cpu), e;
                  }),
                  ...
                  (this.setUA = function (e) {
                    return (
                      (i = typeof e === u && e.length > 350 ? V(e, 350) : e),
                      this
                    );
                  }),
                  this.setUA(i),
    ...
    (o.ab = "/ROOT/node_modules/next/dist/compiled/ua-parser-js/"),
      (t.exports = o(226));
  },
  653291,
  (e, t, r) => {
    ...
    let a = (n = e.r(275600)) && n.__esModule ? n : { default: n };
    function s(e) {
        ...
        if (t)
          switch (t.type) {
            ...
            case "prerender-legacy":
              return (0, o.throwToInterruptStaticGeneration)(
                "connection",
                e,
                t
              );
  ...
  (e, t, r) => {
    let n = {
      NextRequest: e.r(434591).NextRequest,
      NextResponse: e.r(709256).NextResponse,
      ImageResponse: e.r(274370).ImageResponse,
      userAgentFromString: e.r(653291).userAgentFromString,
      userAgent: e.r(653291).userAgent,
      URLPattern: e.r(773533).URLPattern,
      after: e.r(547227).after,
      connection: e.r(272623).connection,
    };
    (t.exports = n),
  ...
  (e) => {
    "use strict";
    let t =
      "true" === e.i(247167).default.env.NEXT_PUBLIC_RECORD_REQUESTS_ENABLED;
    class r {
      requests = [];
      isActive = !1;
      constructor() {
        this.checkUrlParameter(),
          this.isActive &&
            (window.exportRecordedRequests = this.exportRequests.bind(this));
      }
      checkUrlParameter() {
        let e = new URLSearchParams(window.location.search);
        this.isActive = "true" === e.get("next_public_record_requests_enabled");
      }
      recordRequest(e, t, r, n, i) {
      ...
      exportRequests() {
        return (
          (window.recordedRequests = this.requests),
    ...
    function i(e, i, o, a, s) {
      t && (n || (n = new r()), n.recordRequest(e, i, o, a, s));
    }
    e.s(["recordRequest", () => i]);
  },
  268804,
  (e) => {
    ...
    var t = e.i(247167),
      ...
      i = e.i(622184),
      o = e.i(892542);
    e.i(223397), e.i(465903);
    var a = e.i(700479);
    e.i(247317), e.i(91204);
    var s = e.i(944325),
      u = e.i(984224);
    let l = new o.Agent({ keepAlive: !0, keepAliveMsecs: 6e5 }),
      c = new i.Agent({ keepAlive: !0, keepAliveMsecs: 6e5 }),
      f = r.default.create({ httpsAgent: l, httpAgent: c });
    "true" === t.default.env.NEXT_PUBLIC_RECORD_REQUESTS_ENABLED &&
      f.interceptors.request.use((e) => {
        {
          let t = e.url || "",
            ...
            i = e.data,
            o = e.params;
          (0, u.recordRequest)(t, r, n, i, o);
        }
        return e;
      });
    let d = "/api";
    async function h(e, t, i, o = 1) {
      t.startsWith(`${d}/`)
        ? (t = t.slice(d.length + 1))
        : t.startsWith("/") && (t = t.slice(1));
      try {
        if ("get" === e)
          return (await r.default.get(`${d}/${t}`, { params: i })).data;
        if ("post" === e) return (await r.default.post(`${d}/${t}`, i)).data;
        throw Error(`Invalid REST method: ${e}`);
      } catch (r) {
        if (
          (0, n.isAxiosError)(r) &&
          o > 0 &&
          ([502, 503, 504].includes(r.response?.status ?? 0) ||
            "ERR_NETWORK" === r.code)
        )
          return h(e, t, i, o - 1);
        throw r;
    ...
    class b {
      ...
      constructor(e) {
        (this.failCount = 0),
          (this.isAsiaV2 = (function () {
            try {
              let e = window.localStorage.getItem("regionsV4");
              if (e) {
                let t = JSON.parse(e);
                return t?.name === s.Region.ASIA_V2;
              }
            } catch {}
            return !1;
          })()),
          (this.useBunnyProxy = (function () {
            try {
              let e = window.localStorage.getItem("experimentalSettings");
              if (e) {
                let t = JSON.parse(e);
                return t?.useBunnyProxy === !0;
              }
            } catch {}
            return !1;
          })()),
          (this.currentApiUrl = y()),
          (this.failThreshold = e),
          this.setupStorageListener();
      }
      setupStorageListener() {
        (this.storageListener = (e) => {
          "regionsV4" === e.key && e.newValue
            ? this.handleRegionChange(e.newValue)
            : "experimentalSettings" === e.key &&
              e.newValue &&
              this.handleExperimentalSettingsChange(e.newValue);
        }),
          window.addEventListener("storage", this.storageListener);
        try {
          let e = window.localStorage.setItem;
          window.localStorage.setItem = (t, r) => {
            e.call(window.localStorage, t, r),
              "regionsV4" === t
                ? this.handleRegionChange(r)
                : "experimentalSettings" === t &&
                  this.handleExperimentalSettingsChange(r);
          };
        } catch {}
      }
      handleRegionChange(e) {
        try {
          let t = JSON.parse(e),
            r = this.isAsiaV2;
          (this.isAsiaV2 = t?.name === s.Region.ASIA_V2),
            r !== this.isAsiaV2 && (this.failCount = 0);
        } catch {}
      }
      handleExperimentalSettingsChange(e) {
        try {
          let t = JSON.parse(e),
            r = this.useBunnyProxy;
          (this.useBunnyProxy = t?.useBunnyProxy === !0),
            r !== this.useBunnyProxy && (this.failCount = 0);
        } catch {}
      }
      static getInstance(e = 5) {
        return b.instance || (b.instance = new b(e)), b.instance;
      }
      incrementFailCount() {
        ++this.failCount,
          this.failCount > this.failThreshold &&
            ((this.currentApiUrl = y(this.currentApiUrl)),
            (this.failCount = 0));
      }
      getCurrentApiUrl() {
      ...
      isAsiaV2Region() {
        return this.isAsiaV2;
      }
      isBunnyProxyEnabled() {
        return this.useBunnyProxy;
      }
      shouldUseBunnyProxy() {
        return !this.isAsiaV2 && this.useBunnyProxy;
      }
      getProxyUrl() {
        return this.isAsiaV2
          ? "https://api-asia.axiom.trade"
          : this.useBunnyProxy
          ? "https://api-bny.axiom.trade"
          : "";
      }
      shouldUseProxy() {
        return this.isAsiaV2 || this.useBunnyProxy;
    ...
    async function m(e, t, i, o) {
      ...
      if (
        ...
        try {
          let e = new URL(o.urlOverride).hostname;
          if ("axiom.trade" !== e && !e.endsWith(".axiom.trade"))
            throw Error(
              "urlOverride must be an axiom.trade domain for security reasons"
            );
        } catch (e) {
          if (e instanceof TypeError)
            throw Error("urlOverride must be a valid URL");
          throw e;
        }
      let s = g.shouldUseProxy(),
        u = o?.urlOverride ?? g.getCurrentApiUrl(),
        l = { ...o?.headers };
      if (s && !o?.urlOverride) {
        a = g.getProxyUrl();
        let e = new URL(u).host;
        Object.assign(l, { Host: e, "X-Target-Host": e });
      } else a = u;
      try {
        {
          let n = { ...o, headers: l, withCredentials: !0 };
          if ("get" === e)
            return (await r.default.get(`${a}/${t}`, { ...n, params: i })).data;
          if ("post" === e)
            return (await r.default.post(`${a}/${t}`, i, n)).data;
          throw Error(`Invalid REST method: ${e}`);
        }
      } catch (r) {
        if (
          ...
          if (s) return m(e, t, i, { ...o, urlOverride: u });
          else {
            let r = y(u);
            return g.incrementFailCount(), m(e, t, i, { ...o, urlOverride: r });
          }
        throw r;
      }
    }
    let w = async (e, t, r, n, i, o) => {
      let a = `https://friends.axiom.trade${t.startsWith("/") ? t : `/${t}`}`,
        s = { ...r };
      s = { ...s, v: 2 };
      try {
        if ("get" === e)
          return (await f.get(a, { ...i, params: s, withCredentials: !0 }))
            .data;
        return (await f.post(a, n, { ...i, params: s, withCredentials: !0 }))
          .data;
      } catch (e) {
        throw e;
      }
    ...
    e.s([
      "axiomApi",
      0,
      { get: (e, t) => h("get", e, t), post: (e, t) => h("post", e, t) },
      "axiomApiV2",
      0,
      {
        get: (e, t, r) => m("get", e, t, r),
        post: (e, t, r) => m("post", e, t, r),
      },
      "socialApi",
      0,
      {
        get: (e, t, r, n) => w("get", e, t, void 0, n, r),
        post: (e, t, r, n, i) => w("post", e, r, t, i, n),
      },
    ]);
  },
]);

//# debugId=b74d3938-cc1e-a506-4650-d4a7ae0b0368
//# sourceMappingURL=f7567395c0576585.js.map
