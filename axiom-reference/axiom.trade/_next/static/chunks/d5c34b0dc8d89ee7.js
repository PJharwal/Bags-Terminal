  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "dc0ad16d-7001-fdb9-0d21-ef14d7a5ae1d");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function m(e) {
      return o(e), d(a(Uint8Array.from(e).reverse()));
    }
    function g(e, t) {
    ...
    function w(e, t, r) {
      ...
      else if (i(t)) n = Uint8Array.from(t);
    ...
    function T(e, n, i) {
      return e | ((i ? r : t) << BigInt(n));
    }
    let R = (e) => (n << BigInt(e - 1)) - r,
    ...
    function q(e, t, r) {
      ...
      let n = I(e),
        ...
        a = (e = I()) => {
          let t;
          if (
            ((i = s(((t = [0]), Uint8Array.from(t)), e)),
            (n = s()),
            0 !== e.length)
          ) {
            let t;
            (i = s(((t = [1]), Uint8Array.from(t)), e)), (n = s());
          }
        },
        u = () => {
    ...
    function j(e, t, r) {
      if (t < U) throw Error("invalid exponent, negatives unsupported");
      if (r <= U) throw Error("invalid modulus");
      if (r === C) return U;
      let n = C;
      for (; t > U; ) t & C && (n = (n * e) % r), (e = (e * e) % r), (t >>= C);
      return n;
    }
    function _(e, t, r) {
      let n = e;
    ...
    function k(e, t) {
      ...
      for (; r !== U; ) {
        let e = n / r,
          ...
          a = i - l * e,
          u = o - s * e;
        (n = r), (r = t), (i = l), (o = s), (l = a), (s = u);
      }
      if (n !== C) throw Error("invert: does not exist");
      return D(i, t);
    }
    let M = [
      "create",
    ...
    function Y(e, t, r = !1, n = {}) {
      let i;
      if (e <= U) throw Error("invalid field: expected ORDER > 0, got " + e);
      let { nBitLength: o, nByteLength: l } = W(e, t);
      if (l > 2048)
      ...
      let s = Object.freeze({
        ...
        pow: (e, t) =>
          (function (e, t, r) {
            if (r < U) throw Error("invalid exponent, negatives unsupported");
            if (r === U) return e.ONE;
            if (r === C) return t;
            let n = e.ONE,
              i = t;
            for (; r > U; )
              r & C && (n = e.mul(n, i)), (i = e.sqr(i)), (r >>= C);
            return n;
          })(s, e, t),
        div: (t, r) => D(t * k(r, e), e),
        sqrN: (e) => e * e,
              ...
              (i = (function (e) {
                ...
                return (function (e) {
                  let t,
                    ...
                    n,
                    i = (e - C) / z;
                  for (t = e - C, r = 0; t % z === U; t /= z, r++);
                  for (n = z; n < e && j(n, i, e) !== e - C; n++)
                    if (n > 1e3)
                      throw Error(
        ...
        invertBatch: (e) => {
          ...
          return (
            (t = Array(e.length)),
            (r = e.reduce(
              (e, r, n) => (s.is0(r) ? e : ((t[n] = e), s.mul(e, r))),
              s.ONE
            )),
            (n = s.inv(r)),
            e.reduceRight(
              (e, r, n) =>
                s.is0(r) ? e : ((t[n] = s.mul(e, t[n])), s.mul(e, r)),
              n
            ),
            t
          );
        ...
        cmov: (e, t, r) => (r ? t : e),
        toBytes: (e) => (r ? p(e, l) : g(e, l)),
        fromBytes: (e) => {
          if (e.length !== l)
            throw Error(
              "Field.fromBytes: expected " + l + " bytes, got " + e.length
            );
          return r ? m(e) : c(e);
        },
      });
    ...
    function X(e, t, r = !1) {
      ...
      let l = D(r ? m(e) : c(e), t - C) + C;
      return r ? p(l, i) : g(l, i);
    }
    e.s(
      [
        "Field",
    ...
    function en(e, t) {
      return (
        er(e, t), { windows: Math.ceil(t / e) + 1, windowSize: 2 ** (e - 1) }
      );
    }
    let ei = new WeakMap(),
      eo = new WeakMap();
    ...
    function es(e, t) {
      return {
        constTimeNegate: et,
        hasPrecomputes: (e) => 1 !== el(e),
        unsafeLadder(t, r, n = e.ZERO) {
          let i = t;
          for (; r > $; )
            r & ee && (n = n.add(i)), (i = i.double()), (r >>= ee);
          return n;
        },
        precomputeWindow(e, r) {
          let { windows: n, windowSize: i } = en(r, t),
            o = [],
            l = e,
            s = l;
          for (let e = 0; e < n; e++) {
            (s = l), o.push(s);
            for (let e = 1; e < i; e++) (s = s.add(l)), o.push(s);
            l = s.double();
          }
          return o;
        },
        wNAF(r, n, i) {
          let { windows: o, windowSize: l } = en(r, t),
            s = e.ZERO,
            a = e.BASE,
            u = BigInt(2 ** r - 1),
            d = 2 ** r,
          ...
          for (let e = 0; e < o; e++) {
            ...
            let o = t + Math.abs(r) - 1,
              h = e % 2 != 0,
              c = r < 0;
            0 === r ? (a = a.add(et(h, n[t]))) : (s = s.add(et(c, n[o])));
          }
          return { p: s, f: a };
        },
        wNAFUnsafe(r, n, i, o = e.ZERO) {
          let { windows: l, windowSize: s } = en(r, t),
            a = BigInt(2 ** r - 1),
            u = 2 ** r,
            d = BigInt(r);
          for (let e = 0; e < l; e++) {
            ...
            if (i === $) break;
            let r = Number(i & a);
            if (((i >>= d), r > s && ((r -= u), (i += ee)), 0 === r)) continue;
            let l = n[t + Math.abs(r) - 1];
            r < 0 && (l = l.negate()), (o = o.add(l));
          }
          return o;
        },
        getPrecomputes(e, t, r) {
          ...
          return (
            n ||
              ((n = this.precomputeWindow(t, e)), 1 !== e && ei.set(t, r(n))),
            n
          );
        },
        wNAFCached(e, t, r) {
    ...
    function ea(e, t, r, n) {
      ...
      for (let e = u; e >= 0; e -= l) {
        ...
        for (let t = 0; t < n.length; t++) {
          let i = Number((n[t] >> BigInt(e)) & BigInt(s));
          a[i] = a[i].add(r[t]);
        }
        let t = i;
        for (let e = a.length - 1, r = i; e > 0; e--)
          (r = r.add(a[e])), (t = t.add(r));
        if (((d = d.add(t)), 0 !== e))
    ...
    function eu(e) {
      return (
        ...
        Object.freeze({ ...W(e.n, e.nBitLength), ...e, ...{ p: e.Fp.ORDER } })
      );
    }
    e.s(
      ["pippenger", () => ea, "validateBasic", () => eu, "wNAF", () => es],
      810588
    );
  },
  933795,
  (e) => {
    ...
    function l(e, t, n, l) {
      ...
      let { outputLen: s, blockLen: a } = l,
        u = Math.ceil(n / s);
      if (n > 65535 || u > 255)
        throw Error("expand_message_xmd: invalid lenInBytes");
      let d = (0, r.concatBytes)(t, i(t.length, 1)),
        f = i(0, a),
        h = i(n, 2),
        c = Array(u),
        m = l((0, r.concatBytes)(f, e, h, i(0, 1), d));
      c[0] = l((0, r.concatBytes)(m, i(1, 1), d));
      for (let e = 1; e <= u; e++) {
        let t = [
          (function (e, t) {
        ...
        c[e] = l((0, r.concatBytes)(...t));
      }
      return (0, r.concatBytes)(...c).slice(0, n);
    }
    function s(e, s, a) {
      let u;
      (0, r.validateObject)(a, {
      ...
      let { p: d, k: f, m: h, hash: c, expand: m, DST: g } = a;
      (0, r.abytes)(e), o(s);
      let p = "string" == typeof g ? (0, r.utf8ToBytes)(g) : g,
        y = Math.ceil((d.toString(2).length + f) / 8),
        w = s * h * y;
      if ("xmd" === m) u = l(e, p, w, c);
      else if ("xof" === m)
        u = (function (e, t, n, l, s) {
          if (((0, r.abytes)(e), (0, r.abytes)(t), o(n), t.length > 255)) {
            let e = Math.ceil((2 * l) / 8);
            t = s
              .create({ dkLen: e })
    ...
    function a(e, t) {
      ...
      return (t, n) => {
        ...
        return (t = e.div(i, o)), (n = e.mul(n, e.div(l, s))), { x: t, y: n };
      };
    }
    function u(e, t, r) {
      ...
      return {
        hashToCurve(n, i) {
          let o = s(n, 2, { ...r, DST: r.DST, ...i }),
            l = e.fromAffine(t(o[0])),
            a = e.fromAffine(t(o[1])),
            u = l.add(a).clearCofactor();
          return u.assertValidity(), u;
        },
        encodeToCurve(n, i) {
          let o = s(n, 1, { ...r, DST: r.encodeDST, ...i }),
            l = e.fromAffine(t(o[0])).clearCofactor();
  ...
  (e) => {
    ...
    class n extends r.Hash {
      constructor(e, n) {
        ...
        const o = this.blockLen,
          l = new Uint8Array(o);
        l.set(i.length > o ? e.create().update(i).digest() : i);
        for (let e = 0; e < l.length; e++) l[e] ^= 54;
        this.iHash.update(l), (this.oHash = e.create());
        for (let e = 0; e < l.length; e++) l[e] ^= 106;
    ...
    let i = (e, t, r) => new n(e, t).update(r).digest();
    (i.create = (e, t) => new n(e, t)), e.s(["hmac", 0, i]);
  },
  893554,
  5746,
  (e) => {
    ...
    let { bytesToNumberBE: s, hexToBytes: a } = o,
      u = {
        ...
        _tlv: {
          encode: (e, t) => {
            ...
            let n = t.length / 2,
              i = o.numberToHexUnpadded(n);
            if ((i.length / 2) & 128)
              throw new r("tlv.encode: long form length too big");
            let l = n > 127 ? o.numberToHexUnpadded((i.length / 2) | 128) : "";
            return o.numberToHexUnpadded(e) + l + i + t;
          },
          decode(e, t) {
            let { Err: r } = u,
              n = 0;
            ...
            if (128 & i) {
              ...
              let l = t.subarray(n, n + e);
              if (l.length !== e)
                throw new r("tlv.decode: length bytes not complete");
              if (0 === l[0])
                throw new r("tlv.decode(long): zero leftmost byte");
              for (let e of l) o = (o << 8) | e;
              if (((n += e), o < 128))
                throw new r("tlv.decode(long): not minimal encoding");
            } else o = i;
            let l = t.subarray(n, n + o);
            if (l.length !== o) throw new r("tlv.decode: wrong value length");
            return { v: l, l: t.subarray(n + o) };
          },
        },
        _int: {
          encode(e) {
        ...
        toSig(e) {
          let { Err: t, _int: r, _tlv: n } = u,
            i = "string" == typeof e ? a(e) : e;
          o.abytes(i);
          let { v: l, l: s } = n.decode(48, i);
          if (s.length)
            throw new t("invalid signature: left bytes after parsing");
          let { v: d, l: f } = n.decode(2, l),
            { v: h, l: c } = n.decode(2, f);
          if (c.length)
            throw new t("invalid signature: left bytes after parsing");
          return { r: r.decode(d), s: r.decode(h) };
        },
        hexFromSig(e) {
          let { _tlv: t, _int: r } = u,
    ...
    function g(e) {
      ...
      let {
          ...
          function u(e) {
            let { a: n, b: i } = t,
              o = r.sqr(e),
              l = r.mul(o, e);
            return r.add(r.add(l, r.mul(e, n)), i);
          }
          if (!r.eql(r.sqr(t.Gy), u(t.Gx)))
          ...
          function h(e) {
            ...
            try {
              r =
                "bigint" == typeof e
                  ? e
                  : o.bytesToNumberBE((0, o.ensureBytes)("private key", e, l));
            } catch (t) {
              throw Error(
            ...
            return (
              s && (r = (0, i.mod)(r, a)), o.aInRange("private key", r, f, a), r
            );
          }
          function m(e) {
            if (!(e instanceof y)) throw Error("ProjectivePoint expected");
          }
          let g = (0, o.memoized)((e, t) => {
              let { px: n, py: i, pz: o } = e;
              if (r.eql(o, r.ONE)) return { x: n, y: i };
              let l = e.is0();
              null == t && (t = l ? r.ONE : r.inv(o));
              let s = r.mul(n, t),
                a = r.mul(i, t),
                u = r.mul(o, t);
              if (l) return { x: r.ZERO, y: r.ZERO };
          ...
          class y {
            ...
            static fromHex(e) {
              let t = y.fromAffine(a((0, o.ensureBytes)("pointHex", e)));
              return t.assertValidity(), t;
            }
            static fromPrivateKey(e) {
              return y.BASE.multiply(h(e));
            }
            static msm(e, t) {
              return (0, n.pippenger)(y, l, e, t);
            }
            _setWindowSize(e) {
            ...
            equals(e) {
              ...
              let { px: t, py: n, pz: i } = this,
                { px: o, py: l, pz: s } = e,
                a = r.eql(r.mul(t, s), r.mul(o, i)),
                u = r.eql(r.mul(n, s), r.mul(l, i));
              return a && u;
            }
            negate() {
            ...
            wNAF(e) {
              return E.wNAFCached(this, e, y.normalizeZ);
            }
            multiplyUnsafe(e) {
              let { endo: n, n: i } = t;
              o.aInRange("scalar", e, d, i);
              let l = y.ZERO;
              if (e === d) return l;
              if (this.is0() || e === f) return this;
              if (!n || E.hasPrecomputes(this))
                return E.wNAFCachedUnsafe(this, e, y.normalizeZ);
              let { k1neg: s, k1: a, k2neg: u, k2: h } = n.splitScalar(e),
                c = l,
                m = l,
                g = this;
              for (; a > d || h > d; )
              ...
              return (
                s && (c = c.negate()),
                u && (m = m.negate()),
                (m = new y(r.mul(m.px, n.beta), m.py, m.pz)),
                c.add(m)
              );
            }
            multiply(e) {
              let n,
                i,
                { endo: l, n: s } = t;
              if ((o.aInRange("scalar", e, f, s), l)) {
                let { k1neg: t, k1: o, k2neg: s, k2: a } = l.splitScalar(e),
                  { p: u, f: d } = this.wNAF(o),
                  { p: f, f: h } = this.wNAF(a);
                (u = E.constTimeNegate(t, u)),
                  (f = E.constTimeNegate(s, f)),
                  (f = new y(r.mul(f.px, l.beta), f.py, f.pz)),
                  (n = u.add(f)),
                  (i = d.add(h));
              } else {
            ...
            toHex(e = !0) {
              return (
                (0, o.abool)("isCompressed", e),
                o.bytesToHex(this.toRawBytes(e))
              );
            }
          }
          (y.BASE = new y(t.Gx, t.Gy, r.ONE)),
            (y.ZERO = new y(r.ZERO, r.ONE, r.ZERO));
          let w = t.nBitLength,
            E = (0, n.wNAF)(y, t.endo ? Math.ceil(w / 2) : w);
          return {
            CURVE: t,
            ProjectivePoint: y,
          ...
          toBytes(e, t, r) {
            ...
            return ((0, o.abool)("isCompressed", r), r)
              ? l(Uint8Array.from([t.hasEvenY() ? 2 : 3]), i)
              : l(Uint8Array.from([4]), i, s.toBytes(n.y));
          },
          fromBytes(e) {
            let t = e.length,
              r = e[0],
            ...
            if (t === h && (2 === r || 3 === r)) {
              let e,
                t = o.bytesToNumberBE(n);
              if (!o.inRange(t, f, s.ORDER))
        ...
        B = (e) => o.bytesToHex(o.numberToBytesBE(e, r.nByteLength)),
        v = (e, t, r) => o.bytesToNumberBE(e.slice(t, r));
      class x {
        constructor(e, t, r) {
          (this.r = e),
            (this.s = t),
        ...
        static fromCompact(e) {
          let t = r.nByteLength;
          return new x(
            v((e = (0, o.ensureBytes)("compactSignature", e, 2 * t)), 0, t),
            v(e, t, 2 * t)
          );
        }
        static fromDER(e) {
          let { r: t, s: r } = u.toSig((0, o.ensureBytes)("DER", e));
          return new x(t, r);
        }
        assertValidity() {
          o.aInRange("r", this.r, f, a), o.aInRange("s", this.s, f, a);
        }
        addRecoveryBit(e) {
        ...
        recoverPublicKey(e) {
          let { r: t, s: n, recovery: i } = this,
            l = O((0, o.ensureBytes)("msgHash", e));
          if (null == i || ![0, 1, 2, 3].includes(i))
            throw Error("recovery id invalid");
          let a = 2 === i || 3 === i ? t + r.n : t;
          if (a >= s.ORDER) throw Error("recovery id 2 or 3 invalid");
          let u = (1 & i) == 0 ? "02" : "03",
            d = y.fromHex(u + B(a)),
            f = p(a),
            h = g(-l * f),
            c = g(n * f),
            m = y.BASE.multiplyAndAddUnsafe(d, h, c);
        ...
        normalizeS() {
          return this.hasHighS()
            ? new x(this.r, g(-this.s), this.recovery)
            : this;
        }
        toDERRawBytes() {
      ...
      let S =
        ...
        T = o.bitMask(r.nBitLength);
      function R(e) {
        return (
          o.aInRange("num < 2^" + r.nBitLength, e, d, T),
          o.numberToBytesBE(e, r.nByteLength)
        );
      }
      let I = { lowS: r.lowS, prehash: !1 },
        q = { lowS: r.lowS, prehash: !1 };
      return (
        y.BASE._setWindowSize(8),
        {
          ...
          getSharedSecret: function (e, t, r = !0) {
            if (A(e)) throw Error("first arg must be private key");
            if (!A(t)) throw Error("second arg must be public key");
            return y.fromHex(t).multiply(w(e)).toRawBytes(r);
          },
          sign: function (e, t, n = I) {
            let { seed: i, k2sig: u } = (function (e, t, n = I) {
              if (["recovered", "canonical"].some((e) => e in n))
                throw Error("sign() legacy options not supported");
              let { hash: i, randomBytes: u } = r,
                { lowS: h, prehash: c, extraEntropy: m } = n;
              null == h && (h = !0),
                (e = (0, o.ensureBytes)("msgHash", e)),
                l(n),
                c && (e = (0, o.ensureBytes)("prehashed msgHash", i(e)));
              let E = O(e),
                B = w(t),
                v = [R(B), R(E)];
              if (null != m && !1 !== m) {
                let e = !0 === m ? u(s.BYTES) : m;
                v.push((0, o.ensureBytes)("extraEntropy", e));
              }
              return {
                seed: o.concatBytes(...v),
                k2sig: function (e) {
                  var t;
                  let r = S(e);
                  if (!b(r)) return;
                  let n = p(r),
                    i = y.BASE.multiply(r).toAffine(),
                    o = g(i.x);
                  if (o === d) return;
                  let l = g(n * g(E + o * B));
                  if (l === d) return;
                  let s = (2 * (i.x !== o)) | Number(i.y & f),
                    u = l;
                  return (
                    h &&
                      l > a >> f &&
          ...
          verify: function (e, t, n, i = q) {
            let s, a;
            (t = (0, o.ensureBytes)("msgHash", t)),
              (n = (0, o.ensureBytes)("publicKey", n));
            let { lowS: d, prehash: f, format: h } = i;
            if ((l(i), "strict" in i))
              throw Error("options.strict was renamed to lowS");
            if (void 0 !== h && "compact" !== h && "der" !== h)
              throw Error("format must be compact or der");
            let c = "string" == typeof e || o.isBytes(e),
              m =
                !c &&
                !h &&
                "object" == typeof e &&
            ...
            try {
              if ((m && (a = new x(e.r, e.s)), c)) {
                try {
                  "compact" !== h && (a = x.fromDER(e));
                } catch (e) {
                  if (!(e instanceof u.Err)) throw e;
                }
                a || "der" === h || (a = x.fromCompact(e));
              }
              s = y.fromHex(n);
            } catch (e) {
              return !1;
            ...
            let { r: w, s: E } = a,
              ...
              v = g(b * B),
              A = g(w * B),
              S = y.BASE.multiplyAndAddUnsafe(s, v, A)?.toAffine();
            return !!S && g(S.x) === w;
          },
          ProjectivePoint: y,
          Signature: x,
          utils: {
            ...
            normPrivateKeyToScalar: w,
            randomPrivateKey: () => {
              let e = (0, i.getMinHashLength)(r.n);
              return (0, i.mapHashToField)(r.randomBytes(e), r.n);
            },
    ...
    function p(e, t) {
      ...
      return (n) => {
        ...
        (i = e.sqr(n)),
          ...
          (o = e.add(o, a)),
          (d = e.mul(i, l));
        let { isValid: h, value: c } = r(o, u);
        (f = e.mul(i, n)),
          (f = e.mul(f, c)),
          (d = e.cmov(d, l, h)),
          (f = e.cmov(f, c, h));
        let m = e.isOdd(n) === e.isOdd(f);
        return (f = e.cmov(e.neg(f), f, m)), { x: (d = e.div(d, s)), y: f };
      };
    }
    function y(e, n) {
      let i = (n) =>
        g({
          ...
          ...{
            hash: n,
            hmac: (e, ...i) => (0, t.hmac)(n, e, (0, r.concatBytes)(...i)),
            randomBytes: r.randomBytes,
          },
        });
      return { ...i(n), create: i };
    }
    e.s(["mapToCurveSimpleSWU", () => p, "weierstrass", () => g], 5746),
      e.s(["createCurve", () => y], 893554);
  },
]);

//# debugId=dc0ad16d-7001-fdb9-0d21-ef14d7a5ae1d
//# sourceMappingURL=78def129f9271aeb.js.map
