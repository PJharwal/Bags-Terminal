  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "51284785-fd3d-5b5b-f2ca-b3d0141e6a24");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let n =
      "undefined" == typeof window ? e.r(563599).workAsyncStorage : void 0;
    function o({ error: e }) {
      if (n) {
        let t = n.getStore();
  ...
  (e, t, r) => {
    ...
    class p extends u.default.Component {
      constructor(e) {
        super(e),
          (this.reset = () => {
  ...
  (e, t, r) => {
    ...
    let a = e.r(954839),
      i = {
        [a.METADATA_BOUNDARY_NAME]: function ({ children: e }) {
          return e;
        },
        [a.VIEWPORT_BOUNDARY_NAME]: function ({ children: e }) {
          return e;
        },
        [a.OUTLET_BOUNDARY_NAME]: function ({ children: e }) {
          return e;
        },
        [a.ROOT_LAYOUT_BOUNDARY_NAME]: function ({ children: e }) {
          return e;
        },
      },
      u = i[a.METADATA_BOUNDARY_NAME.slice(0)],
      s = i[a.VIEWPORT_BOUNDARY_NAME.slice(0)],
      l = i[a.OUTLET_BOUNDARY_NAME.slice(0)],
      c = i[a.ROOT_LAYOUT_BOUNDARY_NAME.slice(0)];
  },
  742732,
  (e, t, r) => {
    "use strict";
  ...
  (e, t, r) => {
    ...
    let n = e.r(927711),
      ...
      a = e.r(59084);
    function i(e, t) {
      let { basePath: r, i18n: i, trailingSlash: u } = t.nextConfig ?? {},
        s = { pathname: e, trailingSlash: "/" !== e ? e.endsWith("/") : u };
      r &&
        (0, a.pathHasPrefix)(s.pathname, r) &&
        ((s.pathname = (0, o.removePathPrefix)(s.pathname, r)),
        (s.basePath = r));
      let l = s.pathname;
      if (
      ...
      if (i) {
        let e = t.i18nProvider
          ...
          : (0, n.normalizeLocalePath)(s.pathname, i.locales);
        (s.locale = e.detectedLocale),
          ...
          !e.detectedLocale &&
            ...
            (e = t.i18nProvider
              ...
              : (0, n.normalizeLocalePath)(l, i.locales)).detectedLocale &&
            (s.locale = e.detectedLocale);
      }
      return s;
    }
  ...
  (e, t, r) => {
    ...
    let a = e.r(555682),
      ...
      E = (e) => {
        ...
        a
          ...
          "worker" === u && h.setAttribute("type", "text/partytown"),
          h.setAttribute("data-nscript", u),
          c &&
            ((e) => {
    ...
    function m(e) {
      ...
      (0, l.useEffect)(() => {
        let e = t || r;
        b.current || (o && e && _.has(e) && o(), (b.current = !0));
      }, [o, t, r]);
      let O = (0, l.useRef)(!1);
      if (
        ((0, l.useEffect)(() => {
          if (!O.current) {
            if ("afterInteractive" === a) E(e);
            else
              "lazyOnload" === a &&
...
//# debugId=51284785-fd3d-5b5b-f2ca-b3d0141e6a24
//# sourceMappingURL=c9f6bc68983258ed.js.map
