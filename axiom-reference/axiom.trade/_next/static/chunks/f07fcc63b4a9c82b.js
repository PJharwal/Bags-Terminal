  ...
  try {
    ...
    n &&
      ((e._debugIds || (e._debugIds = {}))[n] =
        "6ca11a53-bd59-c578-717b-fa41a3182638");
  } catch (e) {}
})();
    ...
    !(function () {
          ...
          if (n._webAudio) {
            var m = function () {
              ...
              h.gain.setValueAtTime(e, o.ctx.currentTime),
                ...
                l !== 1 / 0 &&
                  (n._endTimers[s._id] = setTimeout(n._ended.bind(n, s), l)),
                t ||
                  setTimeout(function () {
            ...
            "running" === o.state && "interrupted" !== o.ctx.state
              ? m()
              : ((n._playLock = !0), n.once("resume", m), n._clearTimer(s._id));
          } else {
            var v = function () {
              (h.currentTime = d),
            ...
            if (h.readyState >= 3 || A) v();
              ...
              h.addEventListener(o._canPlayEvent, y, !1), n._clearTimer(s._id);
            }
          }
          return s._id;
        },
            ...
            (n = this._soundById(r[i])) &&
              ...
              this._webAudio &&
                ...
                e &&
                  ...
                  this.playing(r[i]) &&
                    (this.pause(r[i], !0), this.play(r[i], !0)))));
          return this;
        },
        rate: function () {
          var e,
        ...
        seek: function () {
          ...
          if (i)
            if ("number" == typeof e && e >= 0) {
              ...
              var d = n.playing(t) ? o.ctx.currentTime - i._playStart : 0,
      ...
      i.prototype = {
        ...
        create: function () {
          var e = this._parent,
            t =
              o._muted || this._muted || this._parent._muted ? 0 : this._volume;
          return (
            e._webAudio
              ? ((this._node =
      ...
      var a = {},
        ...
        d = function (e, t) {
          var n = function () {
            ...
            r = function (e) {
              e && t._sounds.length > 0 ? ((a[t._src] = e), _(t, e)) : n();
            };
      ...
      "function" == typeof define && define.amd && e.v({ Howler: o, Howl: r }),
        (n.Howler = o),
        (n.Howl = r),
        (e.g.HowlerGlobal = t),
        (e.g.Howler = o),
        ...
        (HowlerGlobal.prototype._pos = [0, 0, 0]),
            ...
            for (var a = i._getSoundIds(r), s = 0; s < a.length; s++) {
              ...
              if (u)
                if ("number" != typeof e) return u._pos;
                  ...
                  (u._pos = [e, t, n]),
                    u._node &&
                      ((!u._panner || u._panner.pan) && o(u, "spatial"),
          ...
          (Howl.prototype.orientation = function (e, t, n, r) {
            ...
            if (
              ...
              else i._orientation = [e, t, n];
            for (var a = i._getSoundIds(r), s = 0; s < a.length; s++) {
              var u = i._soundById(a[s]);
              if (u)
                if ("number" != typeof e) return u._orientation;
                else
                  (u._orientation = [e, t, n]),
                    u._node &&
                      (u._panner ||
                      ...
                      void 0 !== u._panner.orientationX
                        ...
                        : u._panner.setOrientation(e, t, n)),
          ...
          (Howl.prototype.pannerAttr = function () {
            ...
            for (var i = this._getSoundIds(t), a = 0; a < i.length; a++)
              if ((n = this._soundById(i[a]))) {
                var s = n._pannerAttr;
                s = {
                  coneInnerAngle:
...
//# debugId=6ca11a53-bd59-c578-717b-fa41a3182638
//# sourceMappingURL=8bab393d65aeda71.js.map
