...
export const metadata: Metadata = {
  title: "BAGS Terminal — an Axiom alternative",
  description:
    "Axiom is a fast buy button. BAGS Terminal is the creator-fee lifecycle: discover, launch with fee sharing up to 100 claimers, and get paid — on one Solana wallet.",
  openGraph: {
    title: "BAGS Terminal — an Axiom alternative",
    description:
      "Compete on the payout axis, not speed. Launch with built-in fee sharing and claim creator fees on one Solana wallet.",
    url: "/axiom-alternative",
    images: [{ url: "/api/og?v=2", width: 1200, height: 630, alt: "BAGS Terminal — an Axiom alternative" }],
  },
  twitter: {
...
const lifecycle: { icon: typeof Rocket; step: string; title: string; body: string }[] = [
  {
    ...
    step: "01",
    title: "DISCOVER",
    body: "Watch tokens move across their lifecycle in the live Pulse feed — bonding curve, final stretch, migrated.",
  },
  {
    icon: Rocket,
    step: "02",
...
const compare: { axis: string; incumbent: string; bags: string }[] = [
  {
    axis: "Primary job",
    incumbent: "Execution / discovery — a fast buy button for trading tokens.",
...
export default function AxiomAlternativePage() {
  return (
    <div className="min-h-[calc(100vh-92px)] bg-[#050505] text-[#EDEDED] font-mono max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-xl font-bold tracking-tight text-display">
        BAGS Terminal — an Axiom<span className="text-[#39FF14]">_</span>alternative
      </h1>
      ...
      <p className="text-[13px] leading-relaxed text-[#aaa] mt-6 max-w-2xl">
        Axiom is built to be a fast buy button — execution and discovery for trading Solana tokens.
        BAGS Terminal is built for the other side of the trade: the creator. We don&apos;t claim to be
        faster or to have live spot execution. We compete on one axis only — the creator-fee lifecycle.
        Launch a token with fee sharing baked in, then claim what it earns from a single Solana wallet.
      </p>
