    ...
    <div className="min-h-[100vh] w-full flex flex-col p-6 sm:p-12 lg:p-24 font-sans relative overflow-hidden" style={{ backgroundColor: '#F2EFE9' }}>
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto my-auto pt-12 md:pt-0">
        ...
        >
          {/* Header */}
          <div className="mb-20">
            <div className="text-meta uppercase tracking-[0.2em] font-bold text-fg-soft mb-2">
              PRETEXT
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-16 lg:gap-24">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[17px] text-muted-mid mb-12 leading-relaxed max-w-lg">
              ...
              <div className="grid gap-4 w-full">
                <div className="bg-[#fdfcf9] border border-[#e5e3de] rounded-2xl p-6 shadow-sm shadow-black/5">
                  ...
                  <p className="text-sm text-muted-mid leading-relaxed">Side-steps getBoundingClientRect entirely, preventing layout thrashing.</p>
                </div>
                <div className="bg-[#fdfcf9] border border-[#e5e3de] rounded-2xl p-6 shadow-sm shadow-black/5">
                  <h3 className="text-base font-bold text-[#111] mb-2">AI-Friendly Iteration</h3>
                  <p className="text-sm text-muted-mid leading-relaxed">Uses the browser&apos;s font engine as source of ground truth, isolated from DOM coupling.</p>
                </div>
                <div className="bg-[#fdfcf9] border border-[#e5e3de] rounded-2xl p-6 shadow-sm shadow-black/5">
                  <h3 className="text-base font-bold text-[#111] mb-2">Language Support</h3>
                  <p className="text-sm text-muted-mid leading-relaxed">Fully supports complex scripts, emojis, and mixed-bidi right out of the box.</p>
                </div>
              </div>
            ...
            <div className="flex flex-col relative w-full pt-2">
               ...
               <div className="bg-[#fcfcfa] rounded-3xl p-8 border border-[#e5e3de] shadow-lg shadow-black/[0.03]">
                 ...
                 <p className="text-sm text-muted-high mb-8 leading-relaxed">
                   ...
                   {status === 'success' ? (
                     ...
                     >
                       ...
                       <div className="text-center mt-2">
                         <p className="text-meta text-fg-soft uppercase tracking-widest font-medium">
