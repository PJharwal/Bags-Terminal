  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="border border-red-500/30 bg-red-500/5 p-8 max-w-md w-full">
        <h2 className="text-red-400 font-mono text-lg mb-2">TOKEN DATA ERROR</h2>
        <p className="text-zinc-400 text-sm mb-6">
          Failed to load token data. The token may not exist or the data source is temporarily unavailable.
        </p>
        <button
          onClick={reset}
