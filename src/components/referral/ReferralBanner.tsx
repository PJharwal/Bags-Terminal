    ...
    <div className="border border-[#39FF14]/10 bg-[#0A0A0A] p-3 font-mono">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-2 min-w-0">
          <Share2 size={14} className="text-acid-green shrink-0" />
          <span className="text-meta text-fg-soft uppercase tracking-widest shrink-0">
        ...
        <div className="flex items-center gap-2">
          <span className="text-meta text-muted-high truncate max-w-[200px]">
            {shortLink}
          </span>
          <button
            onClick={copyLink}
            className="flex items-center gap-1 px-2 py-1 text-meta uppercase tracking-widest border border-[#39FF14]/20 text-acid-green hover:bg-acid-green/10 transition-colors"
          >
            {copied ? (
              <>
                <Check size={10} />
