  ...
  if (!connected || !publicKey) {
    return (
      <div className="card p-6 text-center">
        <p className="text-[11px] text-[#666] font-mono">Connect wallet to access referrals</p>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="card p-5">
        ...
        <div className="flex items-center gap-2 p-3 bg-[#050505] border border-white/5 mb-4">
          <span className="text-[10px] text-[#888] font-mono truncate flex-1">
            {referralLink}
          </span>
          <button
            onClick={copyLink}
            className="btn-primary flex items-center gap-1 px-3 py-1.5 text-[10px] shrink-0"
          >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2 text-[10px] font-mono uppercase tracking-widest border border-white/10 text-[#888] hover:text-white hover:border-white/20 transition-colors"
        >
          <Share2 size={12} />
          Share on X
        </button>
      ...
      <div className="card p-5">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 bg-[#39FF14]/10 flex items-center justify-center shrink-0">
              <Link2 size={12} className="text-[#39FF14]" />
            </div>
            <div>
              <p className="text-[11px] text-white font-mono">Share your referral link</p>
              <p className="text-[10px] text-[#666] font-mono">Your wallet address is your partner key</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[11px] text-white font-mono">Friends launch tokens</p>
              <p className="text-[10px] text-[#666] font-mono">Your partner key auto-fills in their launch</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[11px] text-white font-mono">Earn ongoing fee share</p>
              <p className="text-[10px] text-[#666] font-mono">Receive fees from every token launched with your key</p>
            </div>
          </div>
        </div>
      </div>
