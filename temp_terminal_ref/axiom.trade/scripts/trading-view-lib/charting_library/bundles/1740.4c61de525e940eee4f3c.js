                  ...
                  (n._getItemStyle = function (t) {
                    ...
                    if (l.hasOwnProperty(t)) e = l[t];
                      ...
                      var u = i(n.props, t, n._instanceProps),
                        ...
                        d = 'rtl' === o,
                        p = h ? u : 0;
                      l[t] = e = { position: 'absolute', left: d ? void 0 : p, right: d ? p : void 0, top: h ? 0 : u, height: h ? '100%' : f, width: h ? f : '100%' };
                    }
                    return e;
                  }),
              ...
              return (
                (n.scrollTo = function (t) {
                  (t = Math.max(0, t)),
                    this.setState(function (e) {
                      return e.scrollOffset === t ? null : { scrollDirection: e.scrollOffset < t ? 'forward' : 'backward', scrollOffset: t, scrollUpdateWasRequested: !0 };
                ...
                (n.render = function () {
                  var t = this.props,
                    ...
                    E = [];
                  if (f > 0)
                    for (var R = x; R <= z; R++) E.push((0, u.createElement)(e, { data: h, key: p(R, h), index: R, isScrolling: y ? w : void 0, style: this._getItemStyle(R) }));
                  ...
                  return (0, u.createElement)(
                    _ || g || 'div',
                    {
                      ...
                      style: r({ position: 'relative', height: o, width: S, overflow: 'auto', WebkitOverflowScrolling: 'touch', willChange: 'transform', direction: i }, b),
                    },
                    (0, u.createElement)(c || l || 'div', { children: E, ref: s, style: { height: O ? '100%' : T, pointerEvents: w ? 'none' : void 0, width: O ? T : '100%' } }),
                  );
                }),
