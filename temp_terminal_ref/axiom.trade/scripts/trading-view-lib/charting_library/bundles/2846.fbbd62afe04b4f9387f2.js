                ...
                (t = [].concat(o(t), [h])),
                  ...
                  (e.ontouchmove = function (o) {
                    ...
                    1 === o.targetTouches.length &&
                      ...
                      !v(l.target) && ((n && 0 === n.scrollTop && 0 < t) || ((i = n) && i.scrollHeight - i.scrollTop <= i.clientHeight && t < 0) ? d(l) : l.stopPropagation()));
                  }),
      ...
      const t = [
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [{ name: 'LineToolParallelChannel' }, { name: 'LineToolRegressionTrend' }, { name: 'LineToolFlatBottom' }, { name: 'LineToolDisjointAngle' }],
            },
            {
              title: n.t(null, void 0, l(73359)),
              items: [{ name: 'LineToolPitchfork' }, { name: 'LineToolSchiffPitchfork2' }, { name: 'LineToolSchiffPitchfork' }, { name: 'LineToolInsidePitchfork' }],
            },
          ],
          trackLabel: null,
        },
        ...
        },
        {
          ...
          sections: [
            ...
            { title: n.t(null, void 0, l(89967)), items: [{ name: 'LineToolAnchoredVWAP' }, { name: 'LineToolFixedRangeVolumeProfile' }, null].filter(i.isExistent) },
            { title: n.t(null, void 0, l(79961)), items: [{ name: 'LineToolPriceRange' }, { name: 'LineToolDateRange' }, { name: 'LineToolDateAndPriceRange' }] },
          ],
          trackLabel: null,
        },
        {
    ...
    78036: (e, o, l) => {
      ...
      const h = (0, v.humanReadableModifiers)(v.Modifiers.Shift, !1),
        ...
        T = {
          ...
          eraser: {},
          group: {},
          hideAllDrawings: { iconActive: a.drawingToolsIcons.hideAllDrawingsActive, hotKey: (0, t.hotKeySerialize)({ keys: [u, m, 'H'], text: '{0} + {1} + {2}' }) },
