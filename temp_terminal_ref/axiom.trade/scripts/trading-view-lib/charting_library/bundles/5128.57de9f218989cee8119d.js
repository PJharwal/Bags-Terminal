  ...
  [5128],
  {
                ...
                (i = [].concat(t(i), [d])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(n.target) && ((o && 0 === o.scrollTop && 0 < i) || ((s = o) && s.scrollHeight - s.scrollTop <= s.clientHeight && i < 0) ? h(n) : n.stopPropagation()));
                  }),
    ...
    70673: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        c = n.n(l);
      function u(e) {
        const t = s(c().box, c()[`intent-${e.intent}`], { [c().check]: !e.indeterminate, [c().dot]: Boolean(e.indeterminate), [c().noOutline]: -1 === e.tabIndex }),
            ...
            (this._registerSubmenu = () => {
              ...
              return null === (e = this.context) || void 0 === e
                ...
                : e.registerSubmenu(
                    ...
                    (e) => (0, s.ensureNotNull)(this._itemRef).contains(e) || (null !== this._menuElementRef.current && this._menuElementRef.current.contains(e)),
                  );
            }),
    ...
    50267: (e, t, n) => {
      ...
      class f extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              g && void 0 !== a && o.createElement('td', null, o.createElement(c.FavoriteButton, { className: l.favourite, isFilled: a, onClick: this.props.onFavouriteClick })),
        ...
        _renderToolboxContent() {
          return this.props.toolbox && this.props.toolbox.type === h.ToolboxType.Delete ? o.createElement(l.RemoveButton, { onClick: this.props.toolbox.action }) : null;
        }
      }
    },
    91561: (e, t, n) => {
      ...
      function x(e) {
        const { items: t, parentAction: n, closeNested: s } = e,
          i = !n && t.every((e) => !('separator' !== e.type && (e.getState().icon || e.getState().checkable)));
        return o.createElement(
                ...
                o.createElement(d.MatchMedia, { rule: 'screen and (max-width: 430px)' }, (t) =>
                  this._isDrawer(t)
                    ? o.createElement(
                        k.Provider,
                        { value: { type: 'drawer' } },
                        o.createElement(b.Drawer, { onClose: this._handleClose, position: 'Bottom', 'data-name': v['data-name'] }, o.createElement(x, { items: n })),
                      )
                    : o.createElement(
                        k.Provider,
                        { value: { type: 'menu' } },
                        o.createElement(
                          ...
                          (t) =>
                            o.createElement(
                              ...
                              o.createElement(u.ActionsTable, { items: n, menuStatName: r, parentStatName: m, parentIsOpened: e, onRequestUpdate: this._handleRequestUpdate }),
                            ),
                        ),
                      ),
                ),
      ...
      function p(e) {
        ...
        return s
          ...
          : o.createElement(
              ...
              o.createElement('span', { className: i()(m.label) }, !S && _ ? _.map(({ text: e, ...t }, n) => o.createElement('span', { key: n, style: t }, e)) : null != S ? S : C),
              !!y &&
                o.createElement(r.Icon, {
                  onClick: function () {
                    y && y.action();
    ...
    65890: (e) => {
      e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11 9" width="11" height="9" fill="none"><path strokeWidth="2" d="M0.999878 4L3.99988 7L9.99988 1"/></svg>';
    },
    66493: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="none"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2" d="M16.5 20L11 14.5 16.5 9"/></svg>';
    },
    79978: (e) => {
