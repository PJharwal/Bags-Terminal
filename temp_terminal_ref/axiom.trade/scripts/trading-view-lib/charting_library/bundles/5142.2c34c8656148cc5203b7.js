(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5142],
  {
    ...
    34026: (e, t, n) => {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.pointInCircle = t.pointInPolygon = t.pointInBox = t.pointInTriangle = t.pointInHalfplane = void 0);
      var r = n(5531);
      ...
      (t.intersectLineSegmentAndBox = function (e, t) {
        ...
        (t.intersectRayAndBox = function (e, t, n) {
          var r = a(e, t, n.min, new u.Point(n.max.x, n.min.y)),
            ...
            c = [];
          if ((null !== r && r >= 0 && c.push(r), null !== o && o >= 0 && c.push(o), null !== i && i >= 0 && c.push(i), null !== s && s >= 0 && c.push(s), 0 === c.length))
            return null;
          c.sort(function (e, t) {
            return e - t;
          });
      ...
      !(function (u) {
        ...
        function p(e, t, n, r) {
          ...
          if (t < 1)
            ...
            if (
              ((r = (1 === n && u[t] >= 5) || (2 === n && (u[t] > 5 || (5 === u[t] && (r || u[t + 1] !== _ || 1 & u[t - 1])))) || (3 === n && (r || !!u[0]))), (u.length = t--), r)
            )
    ...
    31468: (e, t, n) => {
      ...
      const c = function (e, t) {
        ...
        for (var b in e)
          (!t && !s.call(e, b)) ||
            (_ && ('length' == b || (f && ('offset' == b || 'parent' == b)) || (l && ('buffer' == b || 'byteLength' == b || 'byteOffset' == b)) || (0, i.default)(b, p))) ||
            h.push(b);
        return h;
      };
    },
    ...
    17873: (e, t, n) => {
      ...
      var c = n(28177),
        ...
        w = (0, f.default)(s),
        x = c.default;
      ((o && x(new o(new ArrayBuffer(1))) != b) || (d.default && x(new d.default()) != l) || (i && x(i.resolve()) != _) || (a && x(new a()) != h) || (s && x(new s()) != p)) &&
        (x = function (e) {
          var t = (0, c.default)(e),
    ...
    12481: (e, t, n) => {
      ...
      const s = function (e, t, n) {
        ...
        return (
          (t = (0, d.default)(t) || 0),
          (0, r.default)(n) && ((p = !!n.leading), (c = (b = 'maxWait' in n) ? i((0, d.default)(n.maxWait) || 0, t) : c), (v = 'trailing' in n ? !!n.trailing : v)),
          (j.cancel = function () {
    ...
    38651: (e, t, n) => {
      ...
      const l = function (e) {
        if (null == e) return !0;
        if ((0, i.default)(e) && ((0, d.default)(e) || 'string' == typeof e || 'function' == typeof e.splice || (0, a.default)(e) || (0, c.default)(e) || (0, o.default)(e)))
          return !e.length;
        var t = (0, u.default)(e);
      ...
      const H = (function (e) {
        return U(function (t, n) {
          var r = -1,
            ...
            d = u > 2 ? n[2] : void 0;
          for (
            o = e.length > 3 && 'function' == typeof o ? (u--, o) : void 0, d && (0, W.default)(n[0], n[1], d) && ((o = u < 3 ? void 0 : o), (u = 1)), t = Object(t);
            ++r < u;
    ...
    43370: (e, t, n) => {
      ...
      const o = function (e, t, n) {
        ...
        if ('function' != typeof e) throw new TypeError('Expected a function');
        return (
          (0, u.default)(n) && ((o = 'leading' in n ? !!n.leading : o), (d = 'trailing' in n ? !!n.trailing : d)), (0, r.default)(e, t, { leading: o, maxWait: t, trailing: d })
        );
      };
    },
    45582: (e, t, n) => {
    ...
    49483: (e, t, n) => {
      ...
      const f = { Android: () => r.isAndroid, BlackBerry: () => r.isBlackBerry, iOS: () => r.isIOS, Opera: () => r.isOperaMini, isIPad: () => r.isIPad, any: () => r.isAnyMobile };
      function l() {
        const e = [
            '^widgetembed/?$',
            '^cmewidgetembed/?$',
              ...
              if (null !== n) {
                var u = null !== (t = null === (e = this._devicePixelRatioObservable) || void 0 === e ? void 0 : e.value) && void 0 !== t ? t : n.devicePixelRatio,
                  ...
                  d =
                    void 0 !== o[0]
                      ? (function (e, t) {
                          return r({ width: Math.round(e.left * t + e.width * t) - Math.round(e.left * t), height: Math.round(e.top * t + e.height * t) - Math.round(e.top * t) });
                        })(o[0], u)
