        ...
        function N(e) {
          ...
          s.CheckMobile.iOS() && C.current && (C.current.style.overflow = 'hidden'),
            ...
            requestAnimationFrame(() => {
              var t;
              null === (t = g.current) || void 0 === t || t.scrollToItem(e, 'start'), s.CheckMobile.iOS() && C.current && (C.current.style.overflow = 'auto'), (b.current = !1);
            });
        }
      }
    },
    ...
    85034: (e, t, n) => {
      ...
      function m(e) {
        ...
        return l.PLATFORM_ACCESSIBILITY_ENABLED
          ? o.createElement('button', { ref: u, tabIndex: v, onClick: h, className: a()(s.wrapper, n && s.isActive, s.button, m), type: 'button', 'aria-pressed': n }, i)
        ...
        (0, o.useEffect)(() => {
          ...
          const n = (t) => {
            ...
            null !== n &&
              ...
              ((0, r.isKeyboardClick)(t) || (n.contains(document.activeElement) && 'INPUT' !== document.activeElement.tagName && document.activeElement.blur()));
          };
