(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7260],
  {
                ...
                (n = [].concat(t(n), [h])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !d(s.target) && ((r && 0 === r.scrollTop && 0 < n) || ((a = r) && a.scrollHeight - a.scrollTop <= a.clientHeight && n < 0) ? u(s) : s.stopPropagation()));
                  }),
      ...
      function p(e) {
        ...
        return a
          ...
          : r.createElement(
              ...
              r.createElement('span', { className: n()(m.label) }, !M && C ? C.map(({ text: e, ...t }, s) => r.createElement('span', { key: s, style: t }, e)) : null != M ? M : k),
              !!w &&
                r.createElement(i.Icon, {
                  onClick: function () {
                    w && w.action();
    ...
    85616: (e) => {
      e.exports = { button: 'button-x1dCOTP3', disabled: 'disabled-x1dCOTP3', hover: 'hover-x1dCOTP3', clicked: 'clicked-x1dCOTP3', accessible: 'accessible-x1dCOTP3' };
    },
    91348: (e) => {
        ...
        (0, r.useEffect)(() => {
          ...
          const s = (t) => {
            ...
            null !== s &&
              ...
              ((0, a.isKeyboardClick)(t) || (s.contains(document.activeElement) && 'INPUT' !== document.activeElement.tagName && document.activeElement.blur()));
          };
    ...
    33279: (e, t, s) => {
      ...
      function M(e) {
        const t = (function (e) {
            ...
            if (r.isWeeks()) return ((e) => n.t(null, { plural: '{str} weeks', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, s(67518)))(r.multiplier());
            if (r.isMonths()) {
              const e = r.multiplier();
              return e % 12 != 0
          ...
          r = (function (e) {
            ...
            var a;
            var i;
            if (r.isDays()) return ((e) => n.t(null, { plural: '{str} days intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, s(81693)))(r.multiplier());
            if (r.isWeeks())
              return ((e) => n.t(null, { plural: '{str} weeks intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, s(58667)))(r.multiplier());
            if (r.isMonths()) {
              const e = r.multiplier();
              return e % 12 != 0
      ...
      class Xe extends r.PureComponent {
        constructor(e, t) {
          super(e, t), (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired, chartApiInstance: i.any.isRequired }), (this.state = { availableSessions: [] });
        }
        componentDidMount() {
          const { chartWidget: e } = this.context;
          e.withModel(null, () => {
        ...
        Ke =
          ...
          ((et = class extends r.PureComponent {
            ...
            render() {
              ...
              return r.createElement(Qe, { ...this._priceAxisHighlighter.handlers(), className: e, isLogarithm: t, isDisabled: null === s, onClick: this._handleSelect });
            }
          ...
          return (
            ((t = class extends r.PureComponent {
              ...
              render() {
                ...
                return r.createElement(e, { ...this._priceAxisHighlighter.handlers(), className: t, isAuto: s, isDisabled: null === a, onClick: this._handleSelect });
              }
              _handleMainSeriesPriceScaleChanged(e) {
                null !== this._priceScale && this._priceScale.modeChanged().unsubscribe(this, this._handleModeChanged),
                  (this._priceScale = e),
          ...
          return (
            ((t = class extends r.PureComponent {
              ...
              render() {
                const { className: t } = this.props,
                  { isActive: s, series: a } = this.state;
                return r.createElement(e, { ...this._priceAxisHighlighter.handlers(), className: t, isPercentage: s, isDisabled: null === a, onClick: this._handleSelect });
              }
              _handleMainSeriesPriceScaleChanged(e) {
              ...
              null === this._raf &&
                (this._raf = requestAnimationFrame(() => {
                  ...
                  const i = t.offsetWidth,
                    ...
                    l = s.offsetWidth,
                    c = !s.textContent || i - o - l <= 0 ? 'collapsed' : 'expanded';
                  if ((Object.assign(e, { dateRangeMode: c }), 'expanded' !== c)) {
                    const t = i - (0, v.ensureNotNull)(this._rangeCollapsed).offsetWidth - 0;
                    let s = 0,
                      a = 0;
                    for (const n of r) (s += n.width), n.name in nt ? ((a += n.width), Object.assign(e, { [n.name]: !1 })) : Object.assign(e, { [n.name]: t <= s });
          ...
          return r.createElement(
            ...
            t &&
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement('div', { className: o(Ze.dateRangeCollapsed) }, r.createElement(J, { goToDateButton: this.props.goToDateEnabled, className: Ze.dateRange })),
                ),
                r.createElement(
                  'div',
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                l && this.state.isFullscreenable && r.createElement(at, { className: Ze.item, mobileChangeLayoutEnabled: this.props.mobileChangeLayoutEnabled }),
                !1,
              ),
            ),
          );
      ...
      class gt {
        constructor(e, t, s, n, i, o, l) {
          this._container = e;
          const c = r.createElement(pt, { onContentBoxChanged: t, computeContentBox: s, chartWidgetCollection: n, chartApiInstance: i, chartWidgetOptions: o, options: l });
    ...
    39750: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="none"><path stroke="currentColor" stroke-linecap="round" strokeWidth="1.5" d="M7 15l5 5L23 9"/></svg>';
    },
    69311: (e) => {
      e.exports =
