  ...
  [2878],
  {
          ...
          [
            ...
            function (t) {
              ...
              if (e) {
                ...
                (r = ((h = i), Array.from(h.querySelectorAll('button:not([disabled]):not([aria-disabled])')).filter((0, s.createScopedVisibleElementFilter)(h))).sort(
    ...
    16396: (e, t, o) => {
      ...
      function d(e) {
        ...
        return n.createElement(
          ...
          H && n.createElement(r.CircleLogo, { ...V, className: l['disclosure-item-circle-logo'], size: 'xxxsmall', logoUrl: H.logoUrl, placeholderLetter: H.placeholderLetter }),
          g &&
    ...
    75038: (e, t, o) => {
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  {
                    ...(function () {
                      if (!m) return l.mobiletouch ? (p ? { onTouchStart: K, onTouchEnd: J, onTouchMove: G } : { onClick: Z }) : { onMouseDown: K, onMouseUp: q };
                      return {};
                    })(),
      ...
      class it extends n.PureComponent {
        ...
        render() {
          return this.state.isVisible ? n.createElement(L, { action: this._handleClick, isTransparent: !0, toolName: 'zoom-out' }) : n.createElement('div', null);
        }
        _activeChartWidget() {
            ...
            n.createElement(
              ...
              a.map((a, r) => {
                ...
                return n.createElement(ct.AccessibleMenuItem, {
                  ...
                  toolbox: i && !p ? n.createElement(lt.MenuFavoriteButton, { isActive: o && e === h, isFilled: t[h], onClick: () => this._handleClickFavorite(h) }) : void 0,
                });
              }),
            ),
          );
      ...
      class Dt extends n.PureComponent {
        ...
        componentWillUnmount() {
          (this._promise = null),
            null !== this._instance &&
              (this._instance.canBeShown().unsubscribe(this._bindedForceUpdate), this._instance.visibility().unsubscribe(this._bindedForceUpdate), (this._instance = null));
        }
        render() {
      ...
      var Wt = o(77975),
        ...
        Pt = o(85470);
      const Vt = {
        [Ot.MagnetMode.WeakMagnet]: { id: Ot.MagnetMode.WeakMagnet, name: 'weakMagnet', icon: Z.drawingToolsIcons.magnet, localizedName: B.t(null, void 0, o(45265)) },
        [Ot.MagnetMode.StrongMagnet]: { id: Ot.MagnetMode.StrongMagnet, name: 'strongMagnet', icon: Z.drawingToolsIcons.strongMagnet, localizedName: B.t(null, void 0, o(85422)) },
      };
      function Ht(e) {
        const { isSmallTablet: t } = e,
      ...
      function $t(e) {
        ...
        return n.createElement(
          'svg',
          { xmlns: Yt, width: '9', height: '27', viewBox: '0 0 9 27', className: a(o.container, 'right' === t ? o.mirror : null), onContextMenu: Ut.preventDefault },
          n.createElement(
            'g',
      ...
      class po extends n.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._handleWidgetbarSettled = (e) => {
              var t;
              this.setState({ isWidgetbarVisible: Boolean(null === (t = window.widgetbar) || void 0 === t ? void 0 : t.visible().value()), widgetbarSettled: e });
            }),
        ...
        componentDidUpdate(e, t) {
          ...
          n !== t.isVisible && (h.emit('toggle_sidebar', !n), c.setValue('ChartDrawingToolbarWidget.visible', n), this._negotiateResizer()),
            t.widgetbarSettled !== i && i && v.CheckMobile.any() && (null === (o = window.widgetbar) || void 0 === o || o.visible().subscribe(this._handleWidgetbarVisible));
        }
        render() {
                      ...
                      n.createElement(
                        ...
                        !o &&
                          n.createElement(
                            ...
                            this._features.tools && n.createElement(ot, { property: d.lockDrawings(), toolName: 'lockAllDrawings', onClick: this._handleLockClick }),
