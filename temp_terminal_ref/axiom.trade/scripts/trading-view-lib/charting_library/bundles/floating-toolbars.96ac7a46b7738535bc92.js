  ...
  [2306],
  {
    ...
    94720: (e, t, o) => {
      ...
      var u = o(34094),
        ...
        m = o(90186);
      function g(e) {
        const { className: t, color: o, variant: i, size: n, stretch: r, animated: s, icon: l, iconOnly: a, startIcon: c, endIcon: h, primaryText: d, secondaryText: u, ...p } = e;
    ...
    61259: (e, t, o) => {
      ...
      function y(e) {
        ...
        return i.createElement(
          ...
          f.map(({ value: e, icon: t }) => i.createElement(c.PopupMenuItem, { key: e, theme: w, label: `${e}px`, icon: t, isActive: e === y, onClick: C, onClickArg: e })),
        );
        function C(e) {
          e &&
            t &&
          ...
          [
            ...
            function (t) {
              ...
              if (e) {
                ...
                (l = ((u = n), Array.from(u.querySelectorAll('button:not([disabled]):not([aria-disabled])')).filter((0, r.createScopedVisibleElementFilter)(u))).sort(
    ...
    35789: (e, t, o) => {
      ...
      function x(e) {
        ...
        return i.createElement(
          ...
          i.createElement('button', {
            ...
            className: n(C.swatch, l.PLATFORM_ACCESSIBILITY_ENABLED && C.accessible, h && C.hover, r && C.selected, !t && C.empty, String(t).toLowerCase() === y.white && C.white),
            onClick: function () {
              a(t);
            },
      ...
      class N extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            { tabIndex: l.PLATFORM_ACCESSIBILITY_ENABLED ? 0 : -1, className: r()(l.PLATFORM_ACCESSIBILITY_ENABLED && z.accessible, e), onKeyDown: this._handleKeyDown },
            i.createElement(
              'div',
              {
      ...
      class I extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            { className: r()(W.hue, l.PLATFORM_ACCESSIBILITY_ENABLED && W.accessible, e), tabIndex: l.PLATFORM_ACCESSIBILITY_ENABLED ? 0 : -1, onKeyDown: this._handleKeyDown },
            i.createElement(
              'div',
              { className: W.pointerContainer, ref: this._refContainer, onMouseDown: this._mouseDown, onTouchStart: this._handleTouch, onTouchMove: this._handleTouch },
      ...
      function j(e) {
        const { color: t, opacity: o, selectCustom: n, selectOpacity: s, customColors: c, onRemoveCustomColor: h, onToggleCustom: d, onOpacityChange: u, menu: p } = e,
          [m, g] = (0, i.useState)(!1),
                      ...
                      i.createElement(
                        ...
                        l.PLATFORM_ACCESSIBILITY_ENABLED
                          ? (null == c ? void 0 : c.length)
                            ? i.createElement('button', { title: K, onClick: b, className: r()(H.customButton, H.accessible, 'apply-common-tooltip'), tabIndex: -1 })
                            : i.createElement(
                                'div',
                                { 'data-role': 'row' },
                                i.createElement('button', { title: K, onClick: b, className: r()(H.customButton, H.accessible, 'apply-common-tooltip'), tabIndex: -1 }),
    ...
    3809: (e, t, o) => {
          ...
          (this._helper = null),
                ...
                containment:
                  this._containment instanceof HTMLElement
                    ...
                    : 'window' === this._containment
                      ? [window.scrollX, window.scrollY, window.scrollX + document.documentElement.offsetWidth - i, window.scrollY + document.documentElement.offsetHeight - n]
                      : null,
              }),
            ...
            (this._handleDragMove = (e) => {
              ...
              if (null !== this._helper.containment) {
                ...
                l && this._helper.nextTop && ((this._helper.nextTop = Math.min(this._helper.nextTop, i)), (this._helper.nextTop = Math.max(this._helper.nextTop, t))),
                  a && this._helper.nextLeft && ((this._helper.nextLeft = Math.min(this._helper.nextLeft, o)), (this._helper.nextLeft = Math.max(this._helper.nextLeft, e)));
              }
      ...
      class g {
        ...
        _createEvent(e, t) {
          return (0, d.assert)(null !== this._initial), new CustomEvent(e, { bubbles: !0, cancelable: !0, detail: { backend: this, initial: this._initial, current: t } });
        }
      }
      var v = o(70027),
        _ = o(25388);
      ...
      class y {
        ...
        _onWindowResize() {
          if ('auto' === (this._options.layout || 'auto')) {
            ...
            (this._isVertical = this._determineCurrentLayoutVertical(t)), this._updateLayoutType(), e !== this._isVertical && this._onVerticalChanged(this._isVertical, e);
          }
        ...
        _init() {
          this._loadPosition(),
            (this._draggable = new m({ source: this._widget, containment: 'window', handle: '.js-drag', start: i.globalCloseMenu, stop: this._savePosition.bind(this) })),
    ...
    44296: (e, t, o) => {
      ...
      class g extends m.default {
        ...
        unsubscribe(e, t) {
          var o;
          const i = (0, p.ensureDefined)(null === (o = this._listenersMappers.find((o) => o.obj === e && o.method === t)) || void 0 === o ? void 0 : o.callback);
      ...
      function C(e) {
        const { templateButton: t, propertyButtons: o, commonButtons: n, isDrawingFinished: r, isToolbarFixed: s, buttonClassName: l, activeChartWidget: a } = e,
                ...
                i.createElement(
                  ...
                  r &&
                    i.createElement(
                      ...
                      null,
                      Boolean(o.length) &&
                        o.map((o, n) => i.createElement(o.component, { ...o.props, key: `${o.props.title}_${n}`, className: w()(T, l), isSmallScreen: e || t, isToolbarFixed: s })),
                      Boolean(n.length) &&
                        n.map((o, n) => {
                          const r = e || t;
                          return r
        ...
        return i.createElement(L.ToolWidgetIconButton, {
          ...
          onClick: async function () {
            ...
            const e = o.model().selection().lineDataSources(),
              t = e.length;
            1 === t ? await o.showChartPropertiesForSource(e[0], void 0, { onWidget: o.onWidget() }) : t > 1 && (await o.showChartPropertiesForSources({ sources: e }));
          },
          'data-name': 'settings',
        });
      }
              ...
              n &&
                d().then((t) => {
                  ...
                  window.matchMedia(b.DialogBreakpoints.TabletSmall).matches || !R.isAnyMobile
                    ? H.ContextMenuManager.showMenu(o, e, { mode: R.isAnyMobile ? 'drawer' : 'menu', 'data-name': 'more-menu' }, { menuName: 'LineToolFloatingToolbarMoreMenu' })
                    : a(o);
                });
            },
            [n, d],
          ...
          d = (0, i.useMemo)(
            () => [
              new U.Action({
                ...
                options: { icon: ee, label: r.t(null, void 0, o(1277)), active: J.LineStyle.Solid === h, onExecute: () => n.setProperty(t, J.LineStyle.Solid, l) },
              }),
              new U.Action({
                actionId: 'Chart.LineTool.Toolbar.ChangeLineStyleToDashed',
                options: { icon: te, label: r.t(null, void 0, o(59317)), active: J.LineStyle.Dashed === h, onExecute: () => n.setProperty(t, J.LineStyle.Dashed, l) },
              }),
              new U.Action({
                actionId: 'Chart.LineTool.Toolbar.ChangeLineStyleToDotted',
                options: { icon: oe, label: r.t(null, void 0, o(42973)), active: J.LineStyle.Dotted === h, onExecute: () => n.setProperty(t, J.LineStyle.Dotted, l) },
              }),
            ],
            [n, t, h],
          );
      ...
      class be {
        ...
        _propertyApplierImpl() {
          return (
            this._propertyApplier || (this._propertyApplier = new ue.PropertyApplierWithoutSavingChart(() => this.activeChartWidget().model(), new a.WatchedValue(false))),
        ...
        _createLineStyleButton(e) {
          ...
          if (1 === t.length) {
            ...
            (o = new d.CollectiblePropertyUndoWrapper(new u.LineToolCollectedProperty(e), ge, this._propertyApplierImpl())), (i = { ...i, setProperty: (e, t) => e.setValue(t) });
          }
        ...
        _createProperty(e, t, o, i) {
          ...
          if (e && e.visible())
            return this._isWidthProperty(e) ? new u.MultipleLineWidthsProperty([e]) : new v.CollectibleColorPropertyDirectWrapper(new u.MultipleLineColorsProperty([e]));
        }
    ...
    78036: (e, t, o) => {
      ...
      const u = (0, h.humanReadableModifiers)(h.Modifiers.Shift, !1),
        ...
        w = {
          ...
          eraser: {},
          group: {},
          hideAllDrawings: { iconActive: l.drawingToolsIcons.hideAllDrawingsActive, hotKey: (0, r.hotKeySerialize)({ keys: [m, p, 'H'], text: '{0} + {1} + {2}' }) },
      ...
      class A extends n {
        ...
        _createWidthsButton(e, t) {
          ...
          return (
            this._addPropertyButton({
              component: s,
              props: { title: o, multipleProperty: this._lineWidthsProperty, propertyApplier: this._propertyApplierImpl(), 'data-name': 'line-tool-width', undoText: p },
            }),
            !0
          );
        }
        _createColorsButton(e, t) {
          return (
            ...
            !this._lineColorsProperty ||
              (this._addPropertyButton({
                component: r,
                props: { icon: l, title: g, property: this._lineColorsProperty, propertyApplier: this._propertyApplierImpl(), 'data-name': 'line-tool-color', undoText: h },
              }),
              !0)
          );
        }
        _createBackgroundsButton(e, t) {
          return (
            ...
            !this._backgroundsProperty ||
              (this._addPropertyButton({
                component: r,
                props: { icon: a, title: f, property: this._backgroundsProperty, propertyApplier: this._propertyApplierImpl(), 'data-name': 'background-color', undoText: d },
              }),
              !0)
          );
        }
        _createTextColorsButton(e, t) {
          return (
            ...
            !this._textColorsProperty ||
              (this._addPropertyButton({
                component: r,
                props: { icon: c, title: _, property: this._textColorsProperty, propertyApplier: this._propertyApplierImpl(), 'data-name': 'text-color', undoText: u },
              }),
              !0)
          );
        }
            ...
            for (var n = {}, s = 0; s < i.length; s++) {
              ...
              if ('function' != typeof d || d(a, t)) {
                ...
                if (((this._propertiesVisible = !0), 'combobox' !== l.inputType)) {
                  const e = {
                    component: r,
                    props: { icon: l.iconSvgCode, title: l.title, 'data-name': l.dataName, property: a, propertyApplier: this._propertyApplierImpl(), undoText: l.undoText },
                  };
        ...
        _rangeExceptionCases() {
          return [
            ...
            { name: 'backgroundColor', inputType: 'colorPicker', iconSvgCode: a, title: w, dataName: 'background-color', showIf: this._shouldShowBackgroundProperty, undoText: d },
            { name: 'linesWidths', inputType: 'combobox', factory: A.prototype._createWidthsButton },
          ];
        }
        _brushPropertiesExceptionCase() {
          return [
            { name: 'linesColors', inputType: 'colorPicker', iconSvgCode: l, title: m, factory: A.prototype._createColorsButton, dataName: 'line-tool-color' },
            { name: 'backgroundsColors', inputType: 'colorPicker', iconSvgCode: a, title: w, dataName: 'background-color', factory: A.prototype._createBackgroundsButton },
            { name: 'linesWidths', inputType: 'combobox', factory: A.prototype._createWidthsButton },
          ];
        }
        ...
        _textPropertiesExceptionCases() {
          return [
            ...
            { name: 'backgroundColor', title: w, inputType: 'colorPicker', iconSvgCode: a, dataName: 'background-color', showIf: this._shouldShowBackgroundProperty, undoText: d },
