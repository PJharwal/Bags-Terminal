        ...
        (0, n.useEffect)(() => {
          ...
          const s = (t) => {
            ...
            null !== s &&
              ...
              ((0, r.isKeyboardClick)(t) || (s.contains(document.activeElement) && 'INPUT' !== document.activeElement.tagName && document.activeElement.blur()));
          };
    ...
    46618: (e, t, s) => {
                          ...
                          n.Children.toArray([
                            (e.SymbolSearch || (!U && e.Compare)) &&
                              n.createElement(
                                y,
                                { key: 'symbol' },
                                e.SymbolSearch && n.createElement(e.SymbolSearch, { id: h ? void 0 : P.SymbolSearch, isActionsVisible: t.allowSymbolSearchSpread }),
                            ...
                            U &&
                              e.Compare &&
                              !e.SymbolSearch &&
                              n.createElement(y, { key: 'compare' }, n.createElement(e.Compare, { id: h ? void 0 : P.Compare, className: X.button, displayMode: s })),
                            e.Indicators &&
                              n.createElement(
                                y,
                                { key: 'indicators' },
                            ...
                            e.AlertReferral && n.createElement(y, { key: 'alert-referral' }, n.createElement(e.AlertReferral, { className: X.button, displayMode: s })),
                          ...
                          n.Children.toArray([
                            ...
                            (e.Layout || e.SaveLoad) &&
                              n.createElement(
                                ...
                                e.SaveLoad &&
                                  n.createElement(e.SaveLoad, { id: h ? void 0 : P.SaveLoad, chartSaver: r, isReadOnly: o, displayMode: s, isFake: h, stateSyncEmitter: l }),
                              ),
                            e.SaveLoadReferral && n.createElement(y, { key: 'save-load-referral' }, n.createElement(e.SaveLoadReferral, { isReadOnly: o, displayMode: s })),
      ...
      class ve {
        ...
        _saveFavs() {
          ...
          this._settings.setJSON('studyMarket.favorites', e, { forceFlush: !0 }), re.TVXWindowEvents.emit('StudyFavoritesChanged', JSON.stringify({ favorites: e }));
        }
        _stateToSave() {
      ...
      class Ve extends n.PureComponent {
        constructor(e) {
          ...
          (this._showScrollbarWhen = (0, i.ensureDefined)(e.allowedModes).slice(-1)),
            (this._panelWidthChangeHandlers = { full: this._handleFullWidthChange, medium: this._handleFavoritesWidthChange, small: this._handleCollapseWidthChange });
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(j, { key: 'live', showScrollbarWhen: this._showScrollbarWhen, displayMode: r, onAvailableSpaceChange: this._handleMeasure, ...u }),
                ),
              ),
            ),
          );
