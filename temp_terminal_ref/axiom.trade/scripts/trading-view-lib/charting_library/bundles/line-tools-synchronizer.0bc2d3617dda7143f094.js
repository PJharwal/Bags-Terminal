      ...
      class B {
        ...
        _onSymbolResolved(e) {
          const t = this._sharingModesToUse().map((t) => {
            const o = { requestType: 'mainSeriesLineTools', seriesSourceId: this._chartModel.mainSeries().id(), symbol: e.pro_name, brokerName: '', sharingMode: t },
          ...
          return this._savePromise('mainSeriesLineTools' === e.requestType)
            ...
            .then(async (o) => {
              if (null !== o && null !== o.sources) {
                const i = o.sources;
                t((e) => i.has(e)), await this._applyLineToolsAndGroupsDTO(o, e.sharingMode), o.serverRequestId && console.log(`PROCESSED:${o.serverRequestId}`);
              }
            });
        }
              ...
              if (null === t) {
                if (r) {
                  ...
                  (r.lineTools()[0].sharingMode().value() === o || (0 === o && !this._doNotSaveSharedLineToolsToCharts.value())) &&
                    ((e && 0 !== o) ||
                      (new b.ExcludeLineToolsFromGroupUndoCommand(this._chartModel, r, r.lineTools()).redo(), this._setOriginalLineToolGroupsSharingMode(n, null)));
                }
              } else {
        ...
        _restoreLineTool(e, t, o, i) {
          ...
          if ((null === n && t.state.linkKey && (n = (0, g.lineToolByLinkKey)(this._chartModel, t.state.linkKey)), null !== n && !(0, g.isLineTool)(n))) return null;
            ...
            if (null === e) {
              ...
              (e.sharingMode().value() === s || (0 === s && !this._doNotSaveSharedLineToolsToCharts.value())) &&
                ...
                this._origin.clientId !== (null == n ? void 0 : n.clientId) &&
                  ((o && 0 !== s && !this._doNotSaveSharedLineToolsToCharts.value()) || (this._removeLineTool(t), this._setOriginalLineToolSharingMode(t, null))));
            } else {
              ...
              if (r) {
                if (e.groupId) {
                  ...
                  if ((null !== t && (t.excludeLineTool(r), 0 === t.lineTools().length && this._chartModel.lineToolsGroupModel().removeGroup(t)), i && !i.containsLineTool(r)))
                    i.addLineTools([r]);
        ...
        _invalidateLineToolGroup(e, t, o) {
          (this._ignoreInvalidatingEventsDepth > 0 && !o) ||
            (this._invalidatedLineToolGroups.set(e, { timestamp: t, invalidatedViaSyncOnly: this.invalidateViaSync() }), this._hasChanges.setValue(!0), this._debouncedSave());
        }
        _prepareDTOItem(e, t) {
          const o = new Map(),
            i = new Map(),
          ...
          return (
            ...
            { sources: o, groups: i, clientId: this._generateOrigin(), lineToolsToValidate: Array.from(o.keys()).concat(s), groupsToValidate: Array.from(i.keys()).concat(n) }
          );
        }
