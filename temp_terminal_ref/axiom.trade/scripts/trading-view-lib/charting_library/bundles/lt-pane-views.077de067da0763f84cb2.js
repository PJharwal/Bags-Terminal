  ...
  [1583],
  {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (this._data.points.length < 3)
            return (t.strokeStyle = this._data.color), (t.lineWidth = this._data.linewidth), t.beginPath(), t.moveTo(i.x, i.y), t.lineTo(o.x, o.y), void t.stroke();
          let a = this._data.points[2];
    ...
    93011: (e, t, i) => {
      ...
      class u extends r.LineSourcePaneView {
        constructor() {
          super(...arguments), (this._arrowMarkRenderer = new c()), (this._textRenderer = new a.TextRenderer()), (this._renderer = null), (this._anchorsOffset = null);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        }
    ...
    97747: (e, t, i) => {
      ...
      class _ extends n.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            (this._textRendererData = { text: '', color: '', vertAlign: 'middle', horzAlign: 'center', font: '', offsetX: 10, offsetY: 10, points: [], forceTextAlign: !0 }),
          ...
          if (
            ...
            if (((this._drawAsCircle = 0 === n && Math.abs(r) < 1e-8), (this._textRendererData.points = [e[0]]), this._drawAsCircle)) {
              ...
              Math.abs(t.x) >= Math.abs(t.y)
                ? (e[1].x > e[0].x ? (this._textRendererData.horzAlign = 'right') : (this._textRendererData.horzAlign = 'left'), (this._textRendererData.vertAlign = 'middle'))
                : (e[1].y > e[0].y ? (this._textRendererData.vertAlign = 'bottom') : (this._textRendererData.vertAlign = 'top'), (this._textRendererData.horzAlign = 'center'));
            }
          }
        }
      }
          ...
          if (_ > 0 && 2 === u.length) {
            ...
            if (t === g.LineToolBarsPatternMode.Bars || t === g.LineToolBarsPatternMode.OpenClose) {
              ...
              for (let t = 0; t < _; t++) {
                ...
                s.setData({ points: r, color: l, backcolor: l, linewidth: 1, fillBackground: !0, transparency: 10, extendLeft: !1, extendRight: !1 }), x.append(s);
              }
      ...
      class p extends r.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            this._data.fillBack &&
              this._data.points.length > 2 &&
              ((r.fillStyle = this._data.backColor), r.beginPath(), r.moveTo(t.x, t.y), r.quadraticCurveTo(o.x, o.y, n.x, n.y), r.quadraticCurveTo(a.x, a.y, i.x, i.y), r.fill()),
              r.beginPath(),
    ...
    48188: (e, t, i) => {
      ...
      class s extends r.BrushBasePaneView {
        _createPolygonRendererData() {
          ...
          return (
            e.fillBackground.value() && this._model.lineBeingCreated() !== this._source && ((t.filled = !0), (t.fillBackground = !0), (t.transparency = e.transparency.value())), t
          );
        }
      }
    },
    70326: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.x > c + o ? (p = 20) : t.x > c && (p = 10),
            ...
            n.beginPath(),
            n.moveTo(8, 0),
            10 === p ? (_ ? (n.lineTo(i.x - 8, 0), n.lineTo(t.x, t.y), n.lineTo(i.x + 8, 0), n.lineTo(o - 8, 0)) : (n.lineTo(t.x, t.y), n.lineTo(o - 8, 0))) : n.lineTo(o - 8, 0),
            20 === p ? (n.lineTo(t.x, t.y), n.lineTo(o, 8)) : n.arcTo(o, 0, o, 8, 8),
            21 === p ? (g ? (n.lineTo(o, i.y - 8), n.lineTo(t.x, t.y), n.lineTo(o, i.y + 8), n.lineTo(o, a - 8)) : (n.lineTo(t.x, t.y), n.lineTo(o, a - 8))) : n.lineTo(o, a - 8),
            22 === p ? (n.lineTo(t.x, t.y), n.lineTo(o - 8, a)) : n.arcTo(o, a, o - 8, a, 8),
            12 === p ? (_ ? (n.lineTo(i.x + 8, a), n.lineTo(t.x, t.y), n.lineTo(i.x - 8, a), n.lineTo(8, a)) : (n.lineTo(t.x, t.y), n.lineTo(8, a))) : n.lineTo(8, a),
            2 === p ? (n.lineTo(t.x, t.y), n.lineTo(0, a - 8)) : n.arcTo(0, a, 0, a - 8, 8),
            1 === p ? (g ? (n.lineTo(0, i.y + 8), n.lineTo(t.x, t.y), n.lineTo(0, i.y - 8), n.lineTo(0, 8)) : (n.lineTo(t.x, t.y), n.lineTo(0, 8))) : n.lineTo(0, 8),
      ...
      class v extends _.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if ((this._calloutRenderer.setData(h), this._renderer.append(this._calloutRenderer), this._renderer.append(this.createLineAnchor({ points: [t] }, 0)), void 0 !== a)) {
            const e = h.points[1],
      ...
      class c extends o.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          this._circleRenderer.setData({
            ...
            t.showLabel.value() && (null === (e = t.text) || void 0 === e ? void 0 : e.value()) && (this._updateTextRenderer(), this._renderer.append(this._textRenderer)),
    ...
    51084: (e, t, i) => {
      ...
      class l extends n.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const t = { color: this._getSource().lineColor(), linestyle: this._getSource().lineStyle(), linewidth: this._getSource().lineWidth(), x: e[0].x, y: e[0].y };
    ...
    47346: (e, t, i) => {
      ...
      class c extends a.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          } else this._renderer.append(this.createLineAnchor({ points: [new n.Point(this._points[0].x, r.height() / 2)], hittestResult: d.HitTarget.MovePoint }, 1));
        }
      }
    },
    25615: (e, t, i) => {
      ...
      class p {
        ...
        draw(e, t) {
          ...
          if (this._data.showCircle) {
            ...
            (e.strokeStyle = this._data.color), (e.lineWidth = this._data.circleBorderWidth * i), e.beginPath(), e.moveTo(s + t, o), e.arc(s, o, t, 0, 2 * Math.PI, !1), e.stroke();
          }
      ...
      class f extends _.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          const t = this._data.points[0],
            ...
            s = e.context;
          if (this._data.points.length < 3)
            return (s.strokeStyle = this._data.color), (s.lineWidth = this._data.linewidth), s.beginPath(), s.moveTo(t.x, t.y), s.lineTo(i.x, i.y), void s.stroke();
            ...
            for (var s = this._source.properties(), c = this._source.levelsCount(), u = 1; u <= c; u++) {
              ...
              if (p.visible.value()) {
                var _ = p.coeff.value(),
                  g = p.color.value(),
                  f = [];
                f.push(new n(this._center.x - 0.5 * i * _, this._center.y - 0.5 * r * _)), f.push(new n(this._center.x + 0.5 * i * _, this._center.y + 0.5 * r * _));
        ...
        _updateImpl(e, t) {
          ...
          for (let i = 0; i < this._levels.length; i++) {
            ...
            if ((null === c || c.isOutOfScreen(t, e) || this._renderer.append(c), L)) {
              ...
              p.setData(u), p.setHitTest(new a.HitTestResult(a.HitTarget.MovePoint, { snappingPrice: this._levels[i].price }, this._levels[i].index)), this._renderer.append(p);
            }
          }
      ...
      class u extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          (i.lineCap = 'round'),
            ...
            i.beginPath(),
            t.fullCircles ? i.arc(0, 0, t.radius, 2 * Math.PI, 0, !1) : t.dir > 0 ? i.arc(0, 0, t.radius, 0, Math.PI, !1) : i.arc(0, 0, t.radius, Math.PI, 0, !1),
            i.stroke(),
            t.fillBackground &&
              (t.radius2 &&
                (t.fullCircles ? i.arc(0, 0, t.radius2, 2 * Math.PI, 0, !0) : t.dir > 0 ? i.arc(0, 0, t.radius2, Math.PI, 0, !0) : i.arc(0, 0, t.radius2, 0, Math.PI, !0)),
        ...
        _updateImpl() {
          ...
          for (let e = 0; e < g.length; e++) {
            ...
            if (u.grid.childs().visible.value()) {
              const e = { points: [t, i], color: S, linewidth: M, linestyle: I, extendleft: !1, extendright: !1, leftend: d.LineEnd.Normal, rightend: d.LineEnd.Normal },
        ...
        _updateImpl(e, t) {
          ...
          for (let e = 1; e <= 11; e++) {
            ...
            const i = Math.round(_ + t.coeff.value() * g),
              n = { index: e, x: a.indexToCoordinate(i), color: t.color.value(), width: t.linewidth.value(), style: t.linestyle.value(), text: String(t.coeff.value()) };
            this._levels.push(n);
          }
          ...
          for (let o = 0; o < this._levels.length; o++) {
            ...
            if (p.showLabels.value()) {
              ...
              const l = { points: [r], text: this._levels[o].text, color: d, vertAlign: v, horzAlign: f, font: c.CHART_FONT_FAMILY, offsetX: 2, offsetY: 0, fontsize: 12 },
          ...
          2 === this._source.points().length
            ...
            : this._points.length > 0 && this._renderer.append(this.createLineAnchor({ points: [new n.Point(this._points[0].x, e / 2)], hittestResult: l.HitTarget.MovePoint }, 0));
        }
        _needLabelExclusionPath(e) {
      ...
      class u extends h.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          for (let e = 0; e < h.length; e++) {
            ...
            if (f)
              if (h[e].index < 4) {
                const r = { p1: t, p2: i, p3: t, p4: new n.Point(h[e + 1].x, h[e + 1].y), color: h[e].color, transparency: v, hittestOnBackground: !0, extendLeft: !1 },
        ...
        _updateImpl(e, t) {
          ...
          if (s.showLabel.value() && 1 === this._points.length && s.text.value().length > 0) {
            ...
            this._labelRenderer.setData(_),
              ...
              this._needLabelExclusionPath(this._labelRenderer) && (h = null !== (i = (0, o.getTextBoundaries)(this._labelRenderer, t, e)) && void 0 !== i ? i : void 0),
          ...
          this._lineRenderer.setData(p), this._lineRenderer.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, { snappingPrice: this._source.points()[0].price }));
    ...
    57964: (e, t, i) => {
      ...
      class _ extends u.BitmapCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          return Math.abs(e.y - this._data.points[0].y) <= t ? new a.HitTestResult(this._data.hitTestResult, { snappingPrice: this._data.snappingPrice }) : null;
        }
        _drawImpl(e) {
          if (null === this._data || 0 === this._data.points.length) return;
        ...
        _updateImpl(e, t) {
          ...
          if (l.showLabel.value() && 1 === this._points.length) {
            ...
            this._labelRenderer.setData(m),
              ...
              this._needLabelExclusionPath(this._labelRenderer) && (h = null !== (i = (0, s.getTextBoundaries)(this._labelRenderer, t, e)) && void 0 !== i ? i : void 0);
          }
          const u = {
            points: this._points,
    ...
    134: (e, t, i) => {
      ...
      class d extends r.LineSourcePaneView {
        ...
        _updateLabelForLevel({ i: e, levelIndex: t, leftPoint: i, rightPoint: r, price: s, color: o, horzAlign: a, vertAlign: d, extendLeft: h = !1, extendRight: c = !1 }) {
          var u, p, _, g, f;
      ...
      class f extends d.MediaCoordinatesPaneRenderer {
          ...
          return this._adapter.getEditable() && e.x >= i.bodyRight && e.x < i.quantityRight
            ...
            : this._adapter.getCancellable() && e.x >= i.quantityRight && e.x < i.right
              ? new h.HitTestResult(h.HitTarget.Custom, {
                  ...
                  tooltip: { text: this._adapter.getCancelTooltip() || g, rect: { x: i.quantityRight, y: i.top, w: i.right - i.quantityRight, h: i.bottom - i.top } },
                })
              : null;
        }
        _drawImpl(e) {
        ...
        _drawQuantity(e, t, i, n) {
          ...
          const r = this._quantityWidth(e),
            s = this._height();
          e.fillRect(t + 0.5, i + 0.5, r - 1, s - 1), n && e.clip && (e.beginPath(), e.rect(t + 0.5, i - 0.5, r + 1, s + 1), e.clip()), e.strokeRect(t, i, r, s), e.restore();
        }
        ...
        _updateImpl(e) {
          if ((super._updateImpl(), (this._selectionData = null), this.isSelectedSource() && this._points.length > 0)) {
            const t = this._points[0].y,
              ...
              s = [new n.Point(i, t)];
            this._selectionData = { barSpacing: this._model.timeScale().barSpacing(), points: s, bgColors: this._lineAnchorColors(s), hittestResult: r, visible: !0 };
          }
    ...
    26013: (e, t, i) => {
      ...
      class u extends d.AlertableLineSourcePaneView {
        constructor() {
          super(...arguments), (this._channelRenderer = new l.ParallelChannelRenderer()), (this._labelTextRenderer = new h.TextRenderer()), (this._renderer = null);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        }
        _updateImpl() {
          ...
          const u = t.linewidth.value(),
            ...
            g = {
              ...
              middleLine:
                null === d || null === h ? void 0 : { color: t.midlinecolor.value(), lineStyle: t.midlinestyle.value(), lineWidth: t.midlinewidth.value(), points: [d, h] },
    ...
    95337: (e, t, i) => {
      'use strict';
      i.r(t), i.d(t, { InsidePitchforkLinePaneView: () => p, PitchforkLinePaneView: () => h, SchiffPitchfork2LinePaneView: () => u, SchiffPitchforkLinePaneView: () => c });
      var n = i(86441),
        r = i(18807),
        s = i(14146),
        o = i(19266),
                ...
                if (h) {
                  {
                    const i = this._medianPoint.addScaled(n, d),
                      r = { p1: u, p2: _, p3: i, p4: i.add(o), color: p.color.value(), transparency: c, hittestOnBackground: !0, extendLeft: t.childs().extendLines.value() },
                      a = new s.ChannelRenderer();
                    a.setData(r), e.append(a);
                  }
                  {
                    const i = this._medianPoint.addScaled(n, -d),
                      r = { p1: g, p2: f, p3: i, p4: i.add(o), color: p.color.value(), transparency: c, hittestOnBackground: !0, extendLeft: t.childs().extendLines.value() },
                      a = new s.ChannelRenderer();
                    a.setData(r), e.append(a);
                  }
                }
    ...
    46258: (e, t, i) => {
      ...
      class f extends h {
        ...
        hitTest(e) {
          return null === this._data || 0 === this._data.points.length || e.y < this._cache.top || e.y > this._cache.bottom || e.x < this._cache.left || this._cache.right < e.x
            ? null
              ...
              : e.x >= this._cache.bodyRight && e.x < this._cache.quantityRight && this._adapter._onModifyCallback
                ? new s(o.Custom, {
                    ...
                    tooltip: {
                      ...
                      rect: { x: this._cache.bodyRight, y: this._cache.top, w: this._cache.quantityRight - this._cache.bodyRight, h: this._cache.bottom - this._cache.top },
                    },
                  })
      ...
      t.PositionPaneView = class extends n {
        ...
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer.setData({ points: this._points, width: this._model.timeScale().width() }), this._renderer;
        }
      };
    },
    75061: (e, t, i) => {
      ...
      t.PredictionPaneView = class extends r {
        ...
        _updateImpl() {
          if (
            ...
            n.time &&
              t.time &&
              ((a = TradingView.isString(n.time) ? new Date(Date.parse(n.time)) : n.time), (d = TradingView.isString(t.time) ? new Date(Date.parse(t.time)) : t.time));
            ...
            w && ((this._sourceLine2 = new u().format(w)), h || (this._sourceLine2 = this._sourceLine2 + ' ' + new p(v ? g : _).format(w))),
              ...
              (this._finished =
                this._model.lineBeingCreated() !== this._source && this._model.lineBeingEdited() !== this._source && !this._model.sourcesBeingMoved().includes(this._source));
            var R = {};
    ...
    29734: (e, t, i) => {
      ...
      class m extends l.LineSourcePaneView {
        constructor() {
          super(...arguments), (this._renderer = new o.CompositeRenderer()), (this._priceNoteRenderer = new x()), (this._customLabelRenderer = new a.TextRenderer());
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
      ...
      class A extends o.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          const m = this._points[v.RiskRewardPointIndex.Entry].y,
            ...
            C = this._points[v.RiskRewardPointIndex.ActualClose] ? this._points[v.RiskRewardPointIndex.ActualClose].x : this._points[v.RiskRewardPointIndex.Close].x,
          ...
          if (
            ...
            f !== this._lastSymbolInfo && ((this._pipFormatter = new _.PipFormatter(f.pricescale, f.minmov, f.type, f.minmove2, f.typespecs)), (this._lastSymbolInfo = f)),
        ...
        _createBackgroundRenderers(e, t) {
          ...
          if (e.pl < 0 && e.entryX !== e.right) {
            const t = new n.Point(e.entryX, e.entryLevel),
              ...
              o = 100 - 100 * (1 - s * s * s),
              a = { points: [t, r], color: 'white', linewidth: 0, backcolor: i.stopBackground.value(), fillBackground: !0, transparency: o, extendLeft: !1, extendRight: !1 };
          ...
          if (e.pl > 0 && e.entryX !== e.right) {
            const t = new n.Point(e.entryX, e.entryLevel),
              ...
              o = 100 - 100 * (1 - s * s * s),
              a = { points: [t, r], color: 'white', linewidth: 0, backcolor: i.profitBackground.value(), fillBackground: !0, transparency: o, extendLeft: !1, extendRight: !1 };
        ...
        _createTargetLabel(e, t) {
          ...
          return (
            ...
            this._addCenterLabel(t, this._profitLabelRenderer, { p: f, txt: v, color: u.profitBackground.value(), vertAlign: a < l ? 'top' : 'bottom', offsetY: 0 })
          );
        }
      ...
      class R {
        ...
        hitTest(e, t) {
          ...
          const [i, r, s] = (function (e, t) {
            ...
            let a = !1;
            if (!o && void 0 !== s) {
              const o = e.inverseAnchorPosition ? e.anchorY + s.circleRadius * e.direction : e.anchorY + (e.labelHeight + s.poleTailHeight + s.circleRadius) * e.direction;
              ...
              (function (e, t, i, n, r) {
                ...
                if (((e.lineWidth = v), e.beginPath(), e.arc(_, g, x, 0, 2 * Math.PI, !0), e.closePath(), e.stroke(), i.outsideBorderWidth)) {
                  ...
                  const t = Math.round(i.outsideBorderWidth * s),
                    n = x + v / 2 + t / 2;
                  (e.lineWidth = t), (e.strokeStyle = i.outsideBorderColor), e.beginPath(), e.arc(_, g, n, 0, 2 * Math.PI, !0), e.closePath(), e.stroke(), e.restore();
                }
      ...
      class L extends l.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          const r = this._points[0],
            s = new n.Point(r.x, i);
          (s.data = r.data), (s.square = !0), this._renderer.append(this.createLineAnchor({ points: [s], pointsCursorType: [o.PaneCursorType.VerticalResize] }, 0));
        }
        _itemAnchorY() {
      ...
      class _ extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          a && ((l.fillStyle = o), (l.strokeStyle = p), l.beginPath(), l.rect(-h, -h, t, t), l.closePath(), l.fill(), l.stroke()),
            i && (l.translate(-h, -h), null !== s && (l.fillStyle = s), i.render(l, { targetViewBox: { x: 0, y: 0, width: t, height: t }, doNotApplyColors: null !== s }));
        }
      }
        ...
        _updateImpl(e, t) {
          ...
          if (this._points.length > 0 && null !== c) {
            const e = Math.cos(c),
              t = -Math.sin(c),
              i = new r.Point(e, t);
            (this._secondPoint = this._points[0].addScaled(i, n.distance())), (this._middlePoint = this._source.calcMiddlePoint(this._points[0], this._secondPoint));
          }
          this._invalidated = !1;
          ...
          this._angleLabelRenderer.setData(C), this._renderer.append(this._angleLabelRenderer), R.points.length >= 2 && this._addAlertRenderer(this._renderer, R.points);
        ...
        _updateImpl(e, t) {
          ...
          if (3 === this._source.points().length) {
            ...
            for (let i = 1; i <= x; i++) {
              ...
              this._levels.push({ color: s, price: a, y: o, linewidth: p.levelsStyle.childs().linewidth.value(), linestyle: p.levelsStyle.childs().linestyle.value(), index: i });
            }
          }
          ...
          for (let i = 0; i < this._levels.length; i++) {
            ...
            null !== u && (this._renderer.append(u), 'middle' === p.vertLabelsAlign.value() && (c = null !== (a = (0, h.getTextBoundaries)(u, e, t)) && void 0 !== a ? a : void 0));
            const _ = {
              points: [r, d],
              color: this._levels[i].color,
              linewidth: this._levels[i].linewidth,
            ...
            g.setData(_), g.setHitTest(new o.HitTestResult(o.HitTarget.MovePoint, { snappingPrice: this._levels[i].price }, this._levels[i].index)), this._renderer.append(g);
          }
          this.addAnchors(this._renderer);
        }
      }
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (3 === this._source.points().length) {
            ...
            for (let t = 1; t <= 11; t++) {
              ...
              const n = i.coeff.value(),
                o = i.color.value(),
                l = Math.round(s + n * r),
                d = { x: e.indexToCoordinate(l), coeff: n, color: o, linewidth: i.linewidth.value(), linestyle: i.linestyle.value(), index: t, text: String(n) };
              this._levels.push(d);
            }
          }
          if (this._points.length < 2) return;
          ...
          for (let o = 0; o < this._levels.length; o++) {
            ...
            const d = { x: this._levels[o].x, color: this._levels[o].color, linewidth: this._levels[o].linewidth, linestyle: this._levels[o].linestyle, excludeBoundaries: a },
        ...
        _updateImpl(e, t) {
          ...
          if (x.showLabel && x.showLabel.value() && x.text.value().length > 0) {
            ...
            this._labelRenderer.setData(c),
              ...
              this._needLabelExclusionPath(this._labelRenderer) && (R = null !== (i = (0, l.getTextBoundaries)(this._labelRenderer, t, e)) && void 0 !== i ? i : void 0);
          }
      ...
      class S {
          ...
          if (this._rect) {
            if (
              ...
              this._data.backgroundRoundRect
                ? ((0, m.drawRoundRect)(e, r.x, r.y, r.w, r.h, this._data.backgroundRoundRect), (e.fillStyle = this._data.backgroundColor), e.fill(), (e.globalAlpha = 1))
        ...
        _preRender() {
          ...
          if ('right' === this._data.horzAlign || 'center' === this._data.horzAlign) {
            ...
            (i += n - u.x),
              (u.x = n),
              !0 !== this._data.doNotAlignText && ('right' === this._data.horzAlign ? ((e.textAlign = 'end'), (i += h)) : ((e.textAlign = 'center'), (i += h / 2)));
          }
          u.w % 2 != 0 && u.w++,
            (u.x += 0.5),
            (u.y += 0.5),
      ...
      class W extends A.AlertableLineSourcePaneView {
        ...
        getCacheRects(e, t) {
          ...
          let c = l[h].x + 10,
            u = l[h].y;
          const p =
            (this._points[1].y < this._points[0].y && this._points[1].x < this._points[0].x) || (this._points[1].y > this._points[0].y && this._points[1].x > this._points[0].x);
        ...
        _priceRange() {
          ...
          if (this._source.priceScale() && (o || a || l)) {
            ...
            c && c !== this._lastSymbolInfo && ((this._pipFormatter = new u.PipFormatter(c.pricescale, c.minmov, c.type, c.minmove2, c.typespecs)), (this._lastSymbolInfo = c)),
        ...
        _statLabelData() {
          ...
          if (g || f || v) {
            ...
            v && (l && (l += ', '), (l += o.t(null, void 0, i(26273)).format({ number: (0, a.forceLTRStr)(this._numericFormatter.format(Math.round(Number(p)))) }))),
              l && s.push('barsRange');
          }
          if (x) {
            let e;
    ...
    23545: (e, t, i) => {
      ...
      class p extends c.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (this._points.length > 3) {
            const e = g(a, 'D');
            a.y < i.y ? ((e.vertAlign = 'bottom'), (e.offsetY = 5)) : ((e.vertAlign = 'top'), (e.offsetY = 5)), this._dLabelRenderer.setData(e), _.append(this._dLabelRenderer);
          }
    ...
    77444: (e, t, i) => {
      ...
      class u extends h.AlertableLineSourcePaneView {
        constructor(e, t, i) {
          super(e, t), (this._lineRenderer = new a.VerticalLineRenderer()), (this._labelRenderer = new s.TextRenderer()), (this._renderer = null), (this._pane = i);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            if (1 === this._points.length) {
              const t = new n.Point(this._points[0].x, e / 2);
              (t.data = 0), (t.square = !0), (t.snappingIndex = this._source.points()[0].index), a.append(this.createLineAnchor({ points: [t], pointsCursorType: c }, 0));
            }
            this._renderer = a;
          }
        }
      ...
      class u extends c.MediaCoordinatesPaneRenderer {
        ...
        _visiblePolygon(e) {
          const t = (0, r.ensureNotNull)(this._data),
            ...
            o = t.p3,
            l = t.p4;
          if ((0, s.equalPoints)(i, n) || (0, s.equalPoints)(o, l) || ((0, a.distanceToLine)(i, n, o).distance < 1e-6 && (0, a.distanceToLine)(i, n, l).distance < 1e-6))
            return null;
    ...
    23966: (e, t, i) => {
      ...
      class g {
        ...
        setData(e) {
          ...
          if ((0, s.equalPoints)(t, i) || (0, s.equalPoints)(n, r) || ((0, a.distanceToLine)(t, i, n).distance < 1e-6 && (0, a.distanceToLine)(t, i, r).distance < 1e-6))
        ...
        if (e.x === t.x) {
          ...
          if (null !== p)
            if (d > 0 && (e.x <= 0 || (i && e.x < t.x))) {
              const t = e.x <= 0 ? Math.sqrt(Math.pow(0 - e.x, 2) + Math.pow(p - e.y, 2)) % d : d - (Math.sqrt(Math.pow(0 - e.x, 2) + Math.pow(p - e.y, 2)) % d);
              (h = Math.cos(Math.atan(s)) * t), (c = s * h), u.push(new n.Point(-h, p - c));
            } else u.push(new n.Point(0, p));
          const _ = r(s * a + o, 0, l);
          if (null !== _)
            if (d > 0 && (e.x >= a || (i && e.x > t.x))) {
              const t = e.x >= a ? Math.sqrt(Math.pow(e.x - a, 2) + Math.pow(e.y - _, 2)) % d : d - (Math.sqrt(Math.pow(e.x - a, 2) + Math.pow(e.y - _, 2)) % d);
      ...
      class f extends p.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          const { line1: t, line2: i, middleLine: n, skipLines: r, skipTopLine: s, fillBackground: o, backColor: a } = this._data,
            l = e.context;
          if (((l.lineCap = 'round'), r || this._drawLine(l, t, this._data, e.mediaSize), r || s || !i || this._drawLine(l, i, this._data, e.mediaSize), o && i)) {
        ...
        _getBackgroundPolygon(e, t) {
          var i;
          return this._backgroundPolygon || (this._backgroundPolygon = null !== (i = this._getBackgroundPolygonImpl(e, t)) && void 0 !== i ? i : []), this._backgroundPolygon;
        }
        _getBackgroundPolygonImpl(e, t) {
          if (void 0 === e.line2) return null;
          const [i, n] = e.line1.points,
            [r, s] = e.line2.points;
          if ((0, l.equalPoints)(i, n) || (0, l.equalPoints)(r, s) || (0, d.distanceToLine)(i, n, r).distance < 1e-6 || (0, d.distanceToLine)(i, n, s).distance < 1e-6) return null;
      ...
      class p extends o.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (this._data.fillBackground && Math.abs((s.x - a.x) * (o.y - a.y) - (o.x - a.x) * (s.y - a.y)) > 1e-10) {
            ...
            if (
              ((e = (0, h.clipPolygonByEdge)(e, s, o, [o, a])), (e = (0, h.clipPolygonByEdge)(e, o, a, [a, s])), (e = (0, h.clipPolygonByEdge)(e, a, s, [s, o])), e && e.length > 1)
            ) {
