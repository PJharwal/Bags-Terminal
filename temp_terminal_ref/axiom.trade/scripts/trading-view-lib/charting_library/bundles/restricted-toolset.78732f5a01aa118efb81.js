(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5516, 9685],
  {
                ...
                (o = [].concat(t(o), [u])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !h(n.target) && ((a && 0 === a.scrollTop && 0 < o) || ((i = a) && i.scrollHeight - i.scrollTop <= i.clientHeight && o < 0) ? d(n) : n.stopPropagation()));
                  }),
    ...
    14877: (e) => {
      e.exports = { favorite: 'favorite-_FRQhM5Y', hovered: 'hovered-_FRQhM5Y', disabled: 'disabled-_FRQhM5Y', active: 'active-_FRQhM5Y', checked: 'checked-_FRQhM5Y' };
    },
    33963: (e) => {
    ...
    27306: (e) => {
      e.exports = { button: 'button-iLKiGOdQ', hovered: 'hovered-iLKiGOdQ', disabled: 'disabled-iLKiGOdQ', active: 'active-iLKiGOdQ', hidden: 'hidden-iLKiGOdQ' };
    },
    17946: (e, t, n) => {
      'use strict';
    ...
    20461: (e) => {
      e.exports = { wrapper: 'wrapper-psOC5oyI', labelRow: 'labelRow-psOC5oyI', label: 'label-psOC5oyI', labelHint: 'labelHint-psOC5oyI', labelOn: 'labelOn-psOC5oyI' };
    },
    40670: (e) => {
      e.exports = {
        ...
        (0, a.useEffect)(() => {
          ...
          const n = (t) => {
            ...
            null !== n &&
              ...
              ((0, i.isKeyboardClick)(t) || (n.contains(document.activeElement) && 'INPUT' !== document.activeElement.tagName && document.activeElement.blur()));
          };
    ...
    69297: (e, t, n) => {
      ...
      function h(e) {
        ...
        return a.createElement(
          ...
          a.createElement('span', { className: r()['thumb-wrapper'] }, a.createElement('span', { className: r().track }), a.createElement('span', { className: r().thumb })),
        );
      }
      var d = n(9745),
        u = n(16838),
      ...
      function C(e) {
        ...
        return a.createElement(
          ...
          a.createElement('div', { className: S.labelRow }, a.createElement('div', { className: E }, s), l && a.createElement('div', { className: S.labelHint }, l)),
          a.createElement(
            'div',
    ...
    2464: (e, t, n) => {
        ...
        return i.createElement('div', {
          ...
          onKeyDown: (0, M.createSafeMulticastEventHandler)(function (e) {
            ...
            const s = () => {
                ...
                a[o].dispatchEvent(new CustomEvent('roving-tabindex:secondary-element')), a[e].dispatchEvent(new CustomEvent('roving-tabindex:main-element')), a[e].focus();
              },
              l = () => {
                const e = (o + a.length + 1) % a.length;
                a[o].dispatchEvent(new CustomEvent('roving-tabindex:secondary-element')), a[e].dispatchEvent(new CustomEvent('roving-tabindex:main-element')), a[e].focus();
          ...
          0 !== i.size &&
            t.push(
              (0, re.studyMetaInfoRepository)()
                ...
                .then((e) => {
                  const t = new Map();
                  for (const n of e) !n.is_hidden_study && i.has(n.id) && t.set(n.id, { name: n.description, localizedName: n.description_localized, studyMarketShittyObject: n });
                  return t;
                })
                .then((e) => {
      ...
      class ye extends i.PureComponent {
        ...
        componentDidMount() {
          ...
          e.visible().subscribe(this._setActiveState),
            void 0 !== t && (t.favoritesChanged().subscribe(this, this._handleFavoriteIndicatorsChange), n.activeChartWidget.subscribe(this._handleChangeActiveWidget)),
        ...
        componentWillUnmount() {
          ...
          e.visible().unsubscribe(this._setActiveState),
            void 0 !== t && (t.favoritesChanged().unsubscribe(this, this._handleFavoriteIndicatorsChange), n.activeChartWidget.unsubscribe(this._handleChangeActiveWidget)),
            ...
            (i = [...i].sort((e, t) => we(e).localeCompare(we(t)))),
              this.setState({ infos: i, isLoading: !1 }, () => {
                ...
                null === (e = this._menu.current) || void 0 === e || e.update(),
                  this._menuItemsContainer.current && document.activeElement === this._menuItemsContainer.current && (0, le.focusFirstMenuItem)(this._menuItemsContainer.current);
              });
          }));
        }
        _trackClick() {
        ...
        _mapFundamentalToFavoriteItemInfo(e) {
          return { item: { type: 'pine', pineId: e.scriptIdPart }, info: { name: e.scriptName, localizedName: getLocalizedFundamentalsName(e), studyMarketShittyObject: void 0 } };
        }
      }
      function we(e) {
      ...
      var Le = n(90186),
        ...
        He = n(867);
      function Be(e) {
        const { interval: t, hint: n, isActive: a, isDisabled: o, isFavorite: s, isSignaling: l, onClick: r, onClickRemove: c, onClickFavorite: h, isSmallTablet: d } = e,
      ...
      const qe = { openDialog: s.t(null, void 0, n(79353)), timeInterval: s.t(null, void 0, n(32916)) },
        ...
        $e = i.lazy(async () => ({
          default: (
            await Promise.all([n.e(956), n.e(2109), n.e(5145), n.e(855), n.e(2191), n.e(6221), n.e(4215), n.e(7194), n.e(2676), n.e(6408), n.e(5057), n.e(4403), n.e(4013)]).then(
              n.bind(n, 44762),
            )
      ...
      class Je extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._handleSelectInterval = (e) => {
              void 0 !== e && e !== l.linking.interval.value() && this.context.chartWidgetCollection.setResolution(e), e && (0, K.trackEvent)('GUI', 'Time Interval', e);
            }),
            (this._handleClickFavorite = (e) => {
              ...
              i.createElement(
                  ...
                  i.createElement(
                    d.ToolbarMenuButton,
                    {
                      ...
                      content:
                        c || null === m
                          ? void 0
                          : i.createElement(p, { className: je.menuContent }, i.createElement(Me, { value: m.mayOmitMultiplier ? void 0 : m.multiplier, metric: m.shortKind })),
                      hotKey: c ? Ye : void 0,
                      className: je.menu,
                      ref: this._menu,
                      isDrawer: e,
                ...
                e &&
                  ...
                  i.createElement(
                    i.Suspense,
                    { fallback: null },
                    i.createElement($e, { onAdd: this._handleAddInterval, onClose: this._handleCloseAddIntervalDialog, onUnmount: this._handleCloseAddIntervalDialog }),
                  ),
              ),
            ),
          );
        ...
        _renderResolutionsGroup(e, t = !1, n) {
          ...
          if (t) a.push(...o);
            ...
            const s = i.createElement(Qe, { key: e.id, className: je.section, summary: e.name, open: !n[e.id], onStateChange: this._getHandleSectionStateChange(e.id) }, o);
            a.push(s);
          }
          return (
            (!e.mayOmitSeparator || e.items.length > 1) &&
              (a.unshift(i.createElement(S.PopupMenuSeparator, { key: `begin-${e.name}` })), a.push(i.createElement(S.PopupMenuSeparator, { key: `end-${e.name}` }))),
            a
          );
        }
      ...
      class ot extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleClick = () => {
              ...
              a.withModel(null, () => {
                t.post(parent, 'openChartInPopup', { symbol: a.model().mainSeries().actualSymbol(), interval: a.model().mainSeries().interval(), fundamental: n });
              });
            }),
        ...
        render() {
          ...
          return i.createElement(G.ToolbarIconButton, { className: u(e, nt.button), icon: at, onClick: this._handleClick, tooltip: s.t(null, void 0, n(55520)) });
        }
      }
      ot.contextType = it;
      var st = n(48449);
      ...
      class rt extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._handleClick = (e) => {
              ...
              (0, K.trackEvent)('GUI', 'Chart Header Toolbar', 'chart properties'), n.showGeneralChartProperties(void 0, { shouldReturnFocus: (0, Q.isKeyboardClick)(e) });
            }),
            (0, w.validateRegistry)(t, { chartWidgetCollection: o.any.isRequired }),
        ...
        render() {
          ...
          return i.createElement(G.ToolbarIconButton, { ...this.props, icon: st, isOpened: e, onClick: this._handleClick, tooltip: s.t(null, void 0, n(74207)) });
        }
      }
      rt.contextType = lt;
      var ct = n(4741),
            ...
            t
              ...
              : i.createElement(
                  ...
                  C &&
                    i.createElement(
                      d.ToolbarMenuButton,
                      { 'data-name': g, arrow: !0, isDrawer: v, drawerPosition: 'Bottom', onClick: this._trackClick, onOpen: m, tooltip: s.t(null, void 0, n(58219)) },
      ...
      function zt(e) {
        ...
        return i.createElement('div', null, i.createElement('span', { className: t }, e.children), i.createElement('span', { className: n }, i.createElement(ve.Loader, null)));
      }
      var Vt = n(76974),
        Zt = n(49483),
        Kt = n(67487),
      ...
      const nn =
        ...
        ((on = class extends i.PureComponent {
          ...
          render() {
            const { className: e, id: t } = this.props;
            return i.createElement(an, { id: t, className: e, tooltip: Ot.takeSnapshot, serverSnapshot: this._serverSnapshot, clientSnapshot: this._clientSnapshot });
          }
        }).contextType = Ht),
        on);
      var an,
      ...
      function gn(e) {
        ...
        return k.PLATFORM_ACCESSIBILITY_ENABLED
          ? i.createElement(
              'button',
              { type: 'button', className: u(n, pn.item, pn.accessible, 'apply-common-tooltip'), onClick: r, 'data-tooltip': a.name, 'aria-label': a.name, tabIndex: l, ref: s },
              i.createElement(
                'div',
                { className: pn.round },
                null !==
      ...
      var Nn = n(36001);
      function Fn(e) {
        const { templates: t, favorites: n, onTemplateSave: a, onTemplateRemove: o, onTemplateSelect: s, onTemplateFavorite: l, isTabletSmall: r, isLoading: c } = e,
        ...
        const b = (e) =>
          i.createElement(Tn, { key: e.name, item: e, isFavoritingAllowed: Boolean(l), favorite: u.has(e.name), onApply: s, onFavor: l, onRemove: o, isTabletSmall: r });
        return i.createElement(
          'div',
        ...
        return i.createElement(
          ...
          a.length > 0 &&
            ...
            i.createElement(
              ...
              null,
              i.createElement(S.PopupMenuSeparator, null),
              i.createElement(Qe, { summary: s.t(null, void 0, n(43399)), open: !l.get().defaultsCollapsed, onStateChange: (e) => l.set({ defaultsCollapsed: !e }) }, t.map(o)),
            ),
          0 === a.length &&
            t.length > 0 &&
            i.createElement(
        ...
        constructor(e, t) {
          ...
          (this._isFavoriteEnabled = a.enabled('items_favoriting')),
            ...
            (this.handleDropdownOpen = () => {
              this._setState({ isLoading: !0 }), this._studyTemplates.invalidate(), this._studyTemplates.refreshStudyTemplateList(() => this._setState({ isLoading: !1 }));
            }),
          ...
          (this._state = new Bn.WatchedValue({ isLoading: !1, studyTemplatesList: s, favorites: o })),
            ...
            this._isFavoriteEnabled && (null === (i = this._favoriteStudyTemplatesService) || void 0 === i || i.getOnChange().subscribe(this, this._handleFavoritesChange));
        }
        destroy() {
          var e;
          this._studyTemplates.getOnChange().unsubscribe(this, this._handleTemplatesChange),
            this._isFavoriteEnabled && (null === (e = this._favoriteStudyTemplatesService) || void 0 === e || e.getOnChange().unsubscribe(this, this._handleFavoritesChange));
        }
        state() {
      ...
      function Vn(e) {
        const { id: t, className: a, mode: o, favorites: l, templates: r, isMenuOpen: c, onTemplateSelect: h, onTemplateSave: u, onTemplateFavorite: m, onTemplateRemove: g } = e,
          b = (0, i.useRef)(null),
          C = (0, i.useRef)(null),
        ...
        return i.createElement(
          ...
          i.createElement(_.MatchMedia, { rule: f.DialogBreakpoints.TabletSmall }, (t) =>
            i.createElement(
              ...
              i.createElement(Fn, { onTemplateSave: u, onTemplateSelect: h, onTemplateRemove: E, onTemplateFavorite: m, templates: r, favorites: y, isTabletSmall: t }),
            ),
          ),
          w &&
            i.createElement(Zn, {
      ...
      class Xn extends i.PureComponent {
        ...
        _getStateFromUndoHistory() {
          const { chartWidgetCollection: e } = this.context,
            ...
            a = n.head(),
            i = t.head();
          return { isEnabledRedo: !n.isEmpty(), isEnabledUndo: !t.isEmpty(), redoStack: a ? a.text().translatedText() : '', undoStack: i ? i.text().translatedText() : '' };
        }
      }
      Xn.contextType = Gn;
      const $n = (e) => {
          ...
          super(e),
            ...
            (this._handleClick = (e) => {
              ...
              t({ shouldReturnFocus: (0, Q.isKeyboardClick)(e) }).then((e) => {
                var t;
                null === (t = this._dialog) || void 0 === t || t.visible().unsubscribe(this._updateState), (this._dialog = e), e.visible().subscribe(this._updateState);
              });
            }),
    ...
    25931: (e, t, n) => {
      ...
      n.d(t, { nanoid: () => a });
      let a = (e = 21) =>
        crypto.getRandomValues(new Uint8Array(e)).reduce((e, t) => (e += (t &= 63) < 36 ? t.toString(36) : t < 62 ? (t - 26).toString(36).toUpperCase() : t > 62 ? '-' : '_'), '');
    },
  },
]);
