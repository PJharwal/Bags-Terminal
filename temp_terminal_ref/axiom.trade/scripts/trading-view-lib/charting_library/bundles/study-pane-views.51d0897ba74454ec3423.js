  ...
  [507],
  {
          ...
          i.forEach((t, i) => {
            ...
            t.forEach((t) => {
              ...
              d === i - 1 && (h = l || h),
                (l = c),
                (d = o),
                (h < 0 && c < 0) || (h > e.width() && c > e.width()) || this._data.push({ x1: h, x2: c, color: r.color.value(), transparency: r.transparency.value() });
            });
          });
        }
      }
    ...
    21335: (t, e, i) => {
      ...
      function m(t, e, i) {
        ...
        (t.font = `${n}px ${u.CHART_FONT_FAMILY}`), (t.fillStyle = r), (t.textAlign = a), (0, h.drawScaled)(t, e.pixelRatio, e.pixelRatio, () => t.fillText(s, o.x, o.y));
      }
      var x = i(87095);
      class y {
        ...
        _prepareStyles() {
          ...
          const i = (0, r.ensureDefined)(this._provider.graphicsInfo().hhists),
            ...
            o =
              (null === (e = null === (t = this._provider.properties().child('inputs')) || void 0 === t ? void 0 : t.child('volume')) || void 0 === e ? void 0 : e.value()) ===
              a.HHistVolumeMode.Delta;
          for (const t of s) {
        ...
        _updateDataForRenderers(t, e, i) {
          ...
          const d =
              (null === (n = null === (s = this._provider.properties().child('inputs')) || void 0 === s ? void 0 : s.child('volume')) || void 0 === n ? void 0 : n.value()) ===
              a.HHistVolumeMode.Delta,
            h = (function (t, e, i) {
