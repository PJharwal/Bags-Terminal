  ...
  [8020],
  {
    ...
    5972: (t, e, i) => {
      ...
      class h {
        ...
        show(t) {
          this._clearTimeouts(),
            performance.now() < this._deferredActions.hideItemTime + 100 ? this._showImpl(t) : (this._deferredActions.showItemTimerId = setTimeout(() => this._showImpl(t), 400));
        }
        _showImpl(t) {
        ...
        _render(t) {
          ...
          this._container !== e && (this._unmountComponent(), (this._container = e), this._container.appendChild(this._tooltipContainer)),
            n.render(o.createElement(d, { handler: t.onClickOutside, child: o.createElement(this._tooltipFactory, t.factoryProps) }), this._tooltipContainer, this._updatePosition);
        }
        _unmountComponent() {
          null !== this._container && (n.unmountComponentAtNode(this._tooltipContainer), this._tooltipContainer.remove(), (this._container = null), this._clearTimeouts());
        }
        _clearTimeouts() {
          void 0 !== this._deferredActions.showItemTimerId && (clearTimeout(this._deferredActions.showItemTimerId), (this._deferredActions.showItemTimerId = void 0)),
            void 0 !== this._deferredActions.hideItemTimerId && (clearTimeout(this._deferredActions.hideItemTimerId), (this._deferredActions.hideItemTimerId = void 0));
        }
      }
      function d(t) {
